...
begin_comment
comment|/**  *<pre>  * A Duration represents a signed, fixed-length span of time represented  * as a count of seconds and fractions of seconds at nanosecond  * resolution. It is independent of any calendar and concepts like "day"  * or "month". It is related to Timestamp in that the difference between  * two Timestamp values is a Duration and it can be added or subtracted  * from a Timestamp. Range is approximately +-10,000 years.  * Example 1: Compute Duration from two Timestamps in pseudo code.  *     Timestamp start = ...;  *     Timestamp end = ...;  *     Duration duration = ...;  *     duration.seconds = end.seconds - start.seconds;  *     duration.nanos = end.nanos - start.nanos;  *     if (duration.seconds&lt; 0&amp;&amp; duration.nanos&gt; 0) {  *       duration.seconds += 1;  *       duration.nanos -= 1000000000;  *     } else if (durations.seconds&gt; 0&amp;&amp; duration.nanos&lt; 0) {  *       duration.seconds -= 1;  *       duration.nanos += 1000000000;  *     }  * Example 2: Compute Timestamp from Timestamp + Duration in pseudo code.  *     Timestamp start = ...;  *     Duration duration = ...;  *     Timestamp end = ...;  *     end.seconds = start.seconds + duration.seconds;  *     end.nanos = start.nanos + duration.nanos;  *     if (end.nanos&lt; 0) {  *       end.seconds -= 1;  *       end.nanos += 1000000000;  *     } else if (end.nanos&gt;= 1000000000) {  *       end.seconds += 1;  *       end.nanos -= 1000000000;  *     }  * Example 3: Compute Duration from datetime.timedelta in Python.  *     td = datetime.timedelta(days=3, minutes=10)  *     duration = Duration()  *     duration.FromTimedelta(td)  *</pre>  *  * Protobuf type {@code google.protobuf.Duration}  */
end_comment
...
comment|// @@protoc_insertion_point(message_implements:google.protobuf.Duration)
name|DurationOrBuilder
block|{
comment|// Use Duration.newBuilder() to construct.
specifier|private
name|Duration
parameter_list|(
name|org
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:google.protobuf.Duration)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.com.google.protobuf.Duration.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
return|;
block|}
comment|// @@protoc_insertion_point(builder_scope:google.protobuf.Duration)
block|}
comment|// @@protoc_insertion_point(class_scope:google.protobuf.Duration)
specifier|private
specifier|static
specifier|final
name|org
