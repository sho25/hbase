...
begin_comment
comment|/**  *<pre>  * `ListValue` is a wrapper around a repeated field of values.  * The JSON representation for `ListValue` is JSON array.  *</pre>  *  * Protobuf type {@code google.protobuf.ListValue}  */
end_comment
...
comment|// @@protoc_insertion_point(message_implements:google.protobuf.ListValue)
name|ListValueOrBuilder
block|{
comment|// Use ListValue.newBuilder() to construct.
specifier|private
name|ListValue
parameter_list|(
name|org
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:google.protobuf.ListValue)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.com.google.protobuf.ListValue.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
return|;
block|}
comment|// @@protoc_insertion_point(builder_scope:google.protobuf.ListValue)
block|}
comment|// @@protoc_insertion_point(class_scope:google.protobuf.ListValue)
specifier|private
specifier|static
specifier|final
name|org
