...
argument_list|()
decl_stmt|;
comment|/**    * This is a hack for GAE, where {@code FileOutputStream} is unavailable.    */
specifier|private
specifier|static
specifier|final
name|Class
...
name|?
argument_list|>
name|FILE_OUTPUT_STREAM_CLASS
init|=
name|safeGetClass
argument_list|(
literal|"java.io.FileOutputStream"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|long
name|CHANNEL_FIELD_OFFSET
init|=
name|getChannelFieldOffset
argument_list|(
name|FILE_OUTPUT_STREAM_CLASS
argument_list|)
decl_stmt|;
