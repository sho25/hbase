...
begin_comment
comment|/**  *<pre>  * Wrapper message for `int32`.  * The JSON representation for `Int32Value` is JSON number.  *</pre>  *  * Protobuf type {@code google.protobuf.Int32Value}  */
end_comment
...
comment|// @@protoc_insertion_point(message_implements:google.protobuf.Int32Value)
name|Int32ValueOrBuilder
block|{
comment|// Use Int32Value.newBuilder() to construct.
specifier|private
name|Int32Value
parameter_list|(
name|org
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:google.protobuf.Int32Value)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.com.google.protobuf.Int32Value.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
return|;
block|}
comment|// @@protoc_insertion_point(builder_scope:google.protobuf.Int32Value)
block|}
comment|// @@protoc_insertion_point(class_scope:google.protobuf.Int32Value)
specifier|private
specifier|static
specifier|final
name|org
