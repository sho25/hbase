...
extends|extends
comment|// @@protoc_insertion_point(interface_extends:hbase.pb.SnapshotDescription)
name|org
operator|.
name|apache
operator|.
...
parameter_list|()
function_decl|;
comment|/**      *<pre>      * not needed for delete, but checked for in taking snapshot      *</pre>      *      *<code>optional string table = 2;</code>      */
name|boolean
name|hasTable
parameter_list|()
function_decl|;
...
parameter_list|()
function_decl|;
comment|/**      *<code>optional int64 creation_time = 3 [default = 0];</code>      */
name|boolean
...
parameter_list|()
function_decl|;
comment|/**      *<code>optional int32 version = 5;</code>      */
name|boolean
name|hasVersion
parameter_list|()
function_decl|;
...
parameter_list|()
function_decl|;
comment|/**      *<code>optional string owner = 6;</code>      */
name|boolean
name|hasOwner
parameter_list|()
function_decl|;
...
parameter_list|()
function_decl|;
comment|/**      *<code>optional .hbase.pb.UsersAndPermissions users_and_permissions = 7;</code>      */
name|boolean
...
name|getUsersAndPermissionsOrBuilder
parameter_list|()
function_decl|;
block|}
comment|/**    *<pre>    **    * Description of the snapshot to take    *</pre>    *    * Protobuf type {@code hbase.pb.SnapshotDescription}    */
specifier|public
specifier|static
specifier|final
class|class
...
comment|// @@protoc_insertion_point(message_implements:hbase.pb.SnapshotDescription)
name|SnapshotDescriptionOrBuilder
block|{
comment|// Use SnapshotDescription.newBuilder() to construct.
specifier|private
name|SnapshotDescription
parameter_list|(
name|org
...
specifier|final
name|int
name|USERS_AND_PERMISSIONS_FIELD_NUMBER
init|=
literal|7
decl_stmt|;
specifier|private
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:hbase.pb.SnapshotDescription)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.SnapshotProtos.SnapshotDescription.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
condition|)
block|{
name|getUsersAndPermissionsFieldBuilder
argument_list|()
expr_stmt|;
block|}
block|}
...
if|if
condition|(
name|usersAndPermissionsBuilder_
operator|==
literal|null
condition|)
block|{
...
operator|.
name|Builder
name|getUsersAndPermissionsBuilder
parameter_list|()
block|{
name|bitField0_
operator||=
...
extends|extends
comment|// @@protoc_insertion_point(interface_extends:hbase.pb.SnapshotFileInfo)
name|org
operator|.
name|apache
operator|.
...
name|GeneratedMessageV3
implements|implements
comment|// @@protoc_insertion_point(message_implements:hbase.pb.SnapshotFileInfo)
name|SnapshotFileInfoOrBuilder
block|{
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:hbase.pb.SnapshotFileInfo)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.SnapshotProtos.SnapshotFileInfo.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
extends|extends
comment|// @@protoc_insertion_point(interface_extends:hbase.pb.SnapshotRegionManifest)
name|org
operator|.
name|apache
operator|.
...
name|GeneratedMessageV3
implements|implements
comment|// @@protoc_insertion_point(message_implements:hbase.pb.SnapshotRegionManifest)
name|SnapshotRegionManifestOrBuilder
block|{
...
extends|extends
comment|// @@protoc_insertion_point(interface_extends:hbase.pb.SnapshotRegionManifest.StoreFile)
name|org
operator|.
name|apache
operator|.
...
parameter_list|()
function_decl|;
comment|/**        *<pre>        * TODO: Add checksums or other fields to verify the file        *</pre>        *        *<code>optional uint64 file_size = 3;</code>        */
name|boolean
name|hasFileSize
parameter_list|()
function_decl|;
...
name|GeneratedMessageV3
implements|implements
comment|// @@protoc_insertion_point(message_implements:hbase.pb.SnapshotRegionManifest.StoreFile)
name|StoreFileOrBuilder
block|{
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:hbase.pb.SnapshotRegionManifest.StoreFile)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.SnapshotProtos.SnapshotRegionManifest.StoreFile.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
name|FamilyFilesOrBuilder
extends|extends
comment|// @@protoc_insertion_point(interface_extends:hbase.pb.SnapshotRegionManifest.FamilyFiles)
name|org
operator|.
name|apache
operator|.
...
name|GeneratedMessageV3
implements|implements
comment|// @@protoc_insertion_point(message_implements:hbase.pb.SnapshotRegionManifest.FamilyFiles)
name|FamilyFilesOrBuilder
block|{
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:hbase.pb.SnapshotRegionManifest.FamilyFiles)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.SnapshotProtos.SnapshotRegionManifest.FamilyFiles.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:hbase.pb.SnapshotRegionManifest)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.SnapshotProtos.SnapshotRegionManifest.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
extends|extends
comment|// @@protoc_insertion_point(interface_extends:hbase.pb.SnapshotDataManifest)
name|org
operator|.
name|apache
operator|.
...
name|GeneratedMessageV3
implements|implements
comment|// @@protoc_insertion_point(message_implements:hbase.pb.SnapshotDataManifest)
name|SnapshotDataManifestOrBuilder
block|{
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:hbase.pb.SnapshotDataManifest)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.SnapshotProtos.SnapshotDataManifest.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
operator|+
literal|"l.proto\032\010FS.proto\032\013HBase.proto\"\223\002\n\023Snaps"
operator|+
literal|"hotDescription\022\014\n\004name\030\001 \002(\t\022\r\n\005table\030\002 "
operator|+
literal|"\001(\t\022\030\n\rcreation_time\030\003 \001(\003:\0010\0227\n\004type\030\004 "
operator|+
literal|"\001(\0162\".hbase.pb.SnapshotDescription.Type:"
operator|+
literal|"\005FLUSH\022\017\n\007version\030\005 \001(\005\022\r\n\005owner\030\006 \001(\t\022<"
operator|+
literal|"\n\025users_and_permissions\030\007 \001(\0132\035.hbase.pb"
operator|+
literal|".UsersAndPermissions\".\n\004Type\022\014\n\010DISABLED"
operator|+
literal|"\020\000\022\t\n\005FLUSH\020\001\022\r\n\tSKIPFLUSH\020\002\"\222\001\n\020Snapsho"
operator|+
literal|"tFileInfo\022-\n\004type\030\001 \002(\0162\037.hbase.pb.Snaps"
block|,
literal|"hotFileInfo.Type\022\r\n\005hfile\030\003 \001(\t\022\022\n\nwal_s"
operator|+
literal|"erver\030\004 \001(\t\022\020\n\010wal_name\030\005 \001(\t\"\032\n\004Type\022\t\n"
operator|+
literal|"\005HFILE\020\001\022\007\n\003WAL\020\002\"\323\002\n\026SnapshotRegionMani"
operator|+
literal|"fest\022\017\n\007version\030\001 \001(\005\022)\n\013region_info\030\002 \002"
operator|+
literal|"(\0132\024.hbase.pb.RegionInfo\022B\n\014family_files"
operator|+
literal|"\030\003 \003(\0132,.hbase.pb.SnapshotRegionManifest"
operator|+
literal|".FamilyFiles\032T\n\tStoreFile\022\014\n\004name\030\001 \002(\t\022"
operator|+
literal|"&\n\treference\030\002 \001(\0132\023.hbase.pb.Reference\022"
operator|+
literal|"\021\n\tfile_size\030\003 \001(\004\032c\n\013FamilyFiles\022\023\n\013fam"
operator|+
literal|"ily_name\030\001 \002(\014\022?\n\013store_files\030\002 \003(\0132*.hb"
block|,
literal|"ase.pb.SnapshotRegionManifest.StoreFile\""
operator|+
literal|"\177\n\024SnapshotDataManifest\022+\n\014table_schema\030"
operator|+
literal|"\001 \002(\0132\025.hbase.pb.TableSchema\022:\n\020region_m"
operator|+
literal|"anifests\030\002 \003(\0132 .hbase.pb.SnapshotRegion"
operator|+
literal|"ManifestBK\n1org.apache.hadoop.hbase.shad"
operator|+
literal|"ed.protobuf.generatedB\016SnapshotProtosH\001\210"
operator|+
