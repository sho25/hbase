...
begin_comment
comment|/**  *<pre>  * Wrapper message for `int64`.  * The JSON representation for `Int64Value` is JSON string.  *</pre>  *  * Protobuf type {@code google.protobuf.Int64Value}  */
end_comment
...
comment|// @@protoc_insertion_point(message_implements:google.protobuf.Int64Value)
name|Int64ValueOrBuilder
block|{
comment|// Use Int64Value.newBuilder() to construct.
specifier|private
name|Int64Value
parameter_list|(
name|org
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:google.protobuf.Int64Value)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.com.google.protobuf.Int64Value.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
return|;
block|}
comment|// @@protoc_insertion_point(builder_scope:google.protobuf.Int64Value)
block|}
comment|// @@protoc_insertion_point(class_scope:google.protobuf.Int64Value)
specifier|private
specifier|static
specifier|final
name|org
