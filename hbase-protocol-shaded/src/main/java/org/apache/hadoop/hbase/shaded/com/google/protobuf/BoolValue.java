...
begin_comment
comment|/**  *<pre>  * Wrapper message for `bool`.  * The JSON representation for `BoolValue` is JSON `true` and `false`.  *</pre>  *  * Protobuf type {@code google.protobuf.BoolValue}  */
end_comment
...
comment|// @@protoc_insertion_point(message_implements:google.protobuf.BoolValue)
name|BoolValueOrBuilder
block|{
comment|// Use BoolValue.newBuilder() to construct.
specifier|private
name|BoolValue
parameter_list|(
name|org
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:google.protobuf.BoolValue)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.com.google.protobuf.BoolValue.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
return|;
block|}
comment|// @@protoc_insertion_point(builder_scope:google.protobuf.BoolValue)
block|}
comment|// @@protoc_insertion_point(class_scope:google.protobuf.BoolValue)
specifier|private
specifier|static
specifier|final
name|org
