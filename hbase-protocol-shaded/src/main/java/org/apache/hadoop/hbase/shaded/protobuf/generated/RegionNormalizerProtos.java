...
begin_comment
comment|// source: RegionNormalizer.proto
end_comment
...
specifier|public
interface|interface
name|RegionNormalizerStateOrBuilder
extends|extends
comment|// @@protoc_insertion_point(interface_extends:RegionNormalizerState)
name|org
operator|.
name|apache
operator|.
...
block|{
comment|/**      *<code>optional bool normalizer_on = 1;</code>      */
name|boolean
name|hasNormalizerOn
parameter_list|()
function_decl|;
comment|/**      *<code>optional bool normalizer_on = 1;</code>      */
name|boolean
...
function_decl|;
block|}
comment|/**    * Protobuf type {@code RegionNormalizerState}    */
specifier|public
specifier|static
specifier|final
class|class
...
comment|// @@protoc_insertion_point(message_implements:RegionNormalizerState)
name|RegionNormalizerStateOrBuilder
block|{
comment|// Use RegionNormalizerState.newBuilder() to construct.
specifier|private
name|RegionNormalizerState
parameter_list|(
name|org
...
name|RegionNormalizerProtos
operator|.
name|internal_static_RegionNormalizerState_descriptor
return|;
block|}
specifier|protected
name|org
...
name|RegionNormalizerProtos
operator|.
name|internal_static_RegionNormalizerState_fieldAccessorTable
operator|.
...
specifier|final
name|int
name|NORMALIZER_ON_FIELD_NUMBER
init|=
literal|1
decl_stmt|;
specifier|private
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:RegionNormalizerState)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.RegionNormalizerProtos.RegionNormalizerState.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
return|;
block|}
comment|// @@protoc_insertion_point(builder_scope:RegionNormalizerState)
block|}
comment|// @@protoc_insertion_point(class_scope:RegionNormalizerState)
specifier|private
specifier|static
specifier|final
name|org
...
operator|+
literal|"izerState\022\025\n\rnormalizer_on\030\001 \001(\010BP\n1org."
operator|+
literal|"apache.hadoop.hbase.shaded.protobuf.gene"
operator|+
literal|"ratedB\026RegionNormalizerProtosH\001\240\001\001"
block|}
decl_stmt|;
name|org
operator|.
