...
begin_comment
comment|// source: MapReduce.proto
end_comment
...
extends|extends
comment|// @@protoc_insertion_point(interface_extends:hbase.pb.ScanMetrics)
name|org
operator|.
name|apache
operator|.
...
comment|// @@protoc_insertion_point(message_implements:hbase.pb.ScanMetrics)
name|ScanMetricsOrBuilder
block|{
comment|// Use ScanMetrics.newBuilder() to construct.
specifier|private
name|ScanMetrics
parameter_list|(
name|org
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:hbase.pb.ScanMetrics)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.MapReduceProtos.ScanMetrics.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
specifier|public
interface|interface
name|TableSnapshotRegionSplitOrBuilder
extends|extends
comment|// @@protoc_insertion_point(interface_extends:hbase.pb.TableSnapshotRegionSplit)
name|org
operator|.
name|apache
operator|.
...
name|MessageOrBuilder
block|{
comment|/**      *<code>repeated string locations = 2;</code>      */
name|java
operator|.
name|util
operator|.
...
name|GeneratedMessageV3
implements|implements
comment|// @@protoc_insertion_point(message_implements:hbase.pb.TableSnapshotRegionSplit)
name|TableSnapshotRegionSplitOrBuilder
block|{
comment|// Use TableSnapshotRegionSplit.newBuilder() to construct.
specifier|private
name|TableSnapshotRegionSplit
parameter_list|(
name|org
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:hbase.pb.TableSnapshotRegionSplit)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.MapReduceProtos.TableSnapshotRegionSplit.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
operator|+
literal|".hbase.pb.RegionInfoBI\n1org.apache.hadoo"
operator|+
literal|"p.hbase.shaded.protobuf.generatedB\017MapRe"
operator|+
literal|"duceProtosH\001\240\001\001"
block|}
decl_stmt|;
name|org
operator|.
