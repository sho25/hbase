...
extends|extends
comment|// @@protoc_insertion_point(interface_extends:hbase.pb.RPCTInfo)
name|org
operator|.
name|apache
operator|.
...
function_decl|;
block|}
comment|/**    *<pre>    *Used to pass through the information necessary to continue    *a trace after an RPC is made. All we need is the traceid     *(so we know the overarching trace this message is a part of), and    *the id of the current span when this message was sent, so we know     *what span caused the new span we will create when this message is received.    *</pre>    *    * Protobuf type {@code hbase.pb.RPCTInfo}    */
specifier|public
specifier|static
specifier|final
class|class
...
comment|// @@protoc_insertion_point(message_implements:hbase.pb.RPCTInfo)
name|RPCTInfoOrBuilder
block|{
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:hbase.pb.RPCTInfo)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.TracingProtos.RPCTInfo.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
operator|+
literal|"neratedB\rTracingProtosH\001\240\001\001"
block|}
decl_stmt|;
name|org
operator|.
