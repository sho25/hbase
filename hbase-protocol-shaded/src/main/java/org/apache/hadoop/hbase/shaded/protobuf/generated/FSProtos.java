...
extends|extends
comment|// @@protoc_insertion_point(interface_extends:hbase.pb.HBaseVersionFileContent)
name|org
operator|.
name|apache
operator|.
...
function_decl|;
block|}
comment|/**    *<pre>    **    * The ${HBASE_ROOTDIR}/hbase.version file content    *</pre>    *    * Protobuf type {@code hbase.pb.HBaseVersionFileContent}    */
specifier|public
specifier|static
specifier|final
class|class
...
comment|// @@protoc_insertion_point(message_implements:hbase.pb.HBaseVersionFileContent)
name|HBaseVersionFileContentOrBuilder
block|{
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:hbase.pb.HBaseVersionFileContent)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.FSProtos.HBaseVersionFileContent.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
extends|extends
comment|// @@protoc_insertion_point(interface_extends:hbase.pb.Reference)
name|org
operator|.
name|apache
operator|.
...
name|MessageOrBuilder
block|{
comment|/**      *<code>required bytes splitkey = 1;</code>      */
name|boolean
name|hasSplitkey
parameter_list|()
function_decl|;
...
function_decl|;
block|}
comment|/**    *<pre>    **    * Reference file content used when we split an hfile under a region.    *</pre>    *    * Protobuf type {@code hbase.pb.Reference}    */
specifier|public
specifier|static
specifier|final
class|class
...
name|GeneratedMessageV3
implements|implements
comment|// @@protoc_insertion_point(message_implements:hbase.pb.Reference)
name|ReferenceOrBuilder
block|{
...
block|{
comment|/**        *<code>TOP = 0;</code>        */
name|TOP
argument_list|(
literal|0
argument_list|)
block|,
comment|/**        *<code>BOTTOM = 1;</code>        */
name|BOTTOM
argument_list|(
literal|1
argument_list|)
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:hbase.pb.Reference)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.FSProtos.Reference.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
operator|+
literal|"OTTOM\020\001BB\n1org.apache.hadoop.hbase.shade"
operator|+
literal|"d.protobuf.generatedB\010FSProtosH\001\240\001\001"
block|}
decl_stmt|;
name|org
operator|.
