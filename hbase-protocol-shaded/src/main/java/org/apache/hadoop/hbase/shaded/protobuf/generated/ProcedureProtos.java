...
argument_list|)
block|,
comment|/**      *<pre>      * Procedure added to the executor, and ready to be executed      *</pre>      *      *<code>RUNNABLE = 2;</code>      */
name|RUNNABLE
argument_list|(
literal|2
argument_list|)
block|,
comment|/**      *<pre>      * The procedure is waiting on children to be completed      *</pre>      *      *<code>WAITING = 3;</code>      */
name|WAITING
argument_list|(
literal|3
argument_list|)
block|,
comment|/**      *<pre>      * The procedure is waiting a timout or an external event      *</pre>      *      *<code>WAITING_TIMEOUT = 4;</code>      */
name|WAITING_TIMEOUT
argument_list|(
literal|4
argument_list|)
block|,
comment|/**      *<pre>      * The procedure failed and was rolledback      *</pre>      *      *<code>ROLLEDBACK = 5;</code>      */
name|ROLLEDBACK
argument_list|(
literal|5
argument_list|)
...
extends|extends
comment|// @@protoc_insertion_point(interface_extends:hbase.pb.Procedure)
name|org
operator|.
name|apache
operator|.
...
block|{
comment|/**      *<pre>      * internal "static" state      *</pre>      *      *<code>required string class_name = 1;</code>      */
name|boolean
name|hasClassName
parameter_list|()
function_decl|;
...
parameter_list|()
function_decl|;
comment|/**      *<pre>      * parent if not a root-procedure otherwise not set      *</pre>      *      *<code>optional uint64 parent_id = 2;</code>      */
name|boolean
name|hasParentId
parameter_list|()
function_decl|;
...
parameter_list|()
function_decl|;
comment|/**      *<pre>      * internal "runtime" state      *</pre>      *      *<code>required .hbase.pb.ProcedureState state = 6;</code>      */
name|boolean
name|hasState
parameter_list|()
function_decl|;
...
parameter_list|()
function_decl|;
comment|/**      *<pre>      * stack indices in case the procedure was running      *</pre>      *      *<code>repeated uint32 stack_id = 7;</code>      */
name|java
operator|.
name|util
operator|.
...
parameter_list|()
function_decl|;
comment|/**      *<pre>      * user state/results      *</pre>      *      *<code>optional .hbase.pb.ForeignExceptionMessage exception = 10;</code>      */
name|boolean
name|hasException
parameter_list|()
function_decl|;
...
parameter_list|()
function_decl|;
comment|/**      *<pre>      * opaque (user) result structure      *</pre>      *      *<code>optional bytes result = 11;</code>      */
name|boolean
name|hasResult
parameter_list|()
function_decl|;
...
parameter_list|()
function_decl|;
comment|/**      *<pre>      * opaque (user) procedure internal-state      *</pre>      *      *<code>optional bytes state_data = 12;</code>      */
name|boolean
name|hasStateData
parameter_list|()
function_decl|;
...
parameter_list|()
function_decl|;
comment|/**      *<pre>      * Nonce to prevent same procedure submit by multiple times      *</pre>      *      *<code>optional uint64 nonce_group = 13 [default = 0];</code>      */
name|boolean
name|hasNonceGroup
parameter_list|()
function_decl|;
...
function_decl|;
block|}
comment|/**    *<pre>    **    * Procedure metadata, serialized by the ProcedureStore to be able to recover the old state.    *</pre>    *    * Protobuf type {@code hbase.pb.Procedure}    */
specifier|public
specifier|static
specifier|final
class|class
...
implements|implements
comment|// @@protoc_insertion_point(message_implements:hbase.pb.Procedure)
name|ProcedureOrBuilder
block|{
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:hbase.pb.Procedure)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.ProcedureProtos.Procedure.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
extends|extends
comment|// @@protoc_insertion_point(interface_extends:hbase.pb.SequentialProcedureData)
name|org
operator|.
name|apache
operator|.
...
function_decl|;
block|}
comment|/**    *<pre>    **    * SequentialProcedure data    *</pre>    *    * Protobuf type {@code hbase.pb.SequentialProcedureData}    */
specifier|public
specifier|static
specifier|final
class|class
...
name|GeneratedMessageV3
implements|implements
comment|// @@protoc_insertion_point(message_implements:hbase.pb.SequentialProcedureData)
name|SequentialProcedureDataOrBuilder
block|{
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:hbase.pb.SequentialProcedureData)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.ProcedureProtos.SequentialProcedureData.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
extends|extends
comment|// @@protoc_insertion_point(interface_extends:hbase.pb.StateMachineProcedureData)
name|org
operator|.
name|apache
operator|.
...
function_decl|;
block|}
comment|/**    *<pre>    **    * StateMachineProcedure data    *</pre>    *    * Protobuf type {@code hbase.pb.StateMachineProcedureData}    */
specifier|public
specifier|static
specifier|final
class|class
...
name|GeneratedMessageV3
implements|implements
comment|// @@protoc_insertion_point(message_implements:hbase.pb.StateMachineProcedureData)
name|StateMachineProcedureDataOrBuilder
block|{
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:hbase.pb.StateMachineProcedureData)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.ProcedureProtos.StateMachineProcedureData.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
extends|extends
comment|// @@protoc_insertion_point(interface_extends:hbase.pb.ProcedureWALHeader)
name|org
operator|.
name|apache
operator|.
...
function_decl|;
block|}
comment|/**    *<pre>    **    * Procedure WAL header    *</pre>    *    * Protobuf type {@code hbase.pb.ProcedureWALHeader}    */
specifier|public
specifier|static
specifier|final
class|class
...
name|GeneratedMessageV3
implements|implements
comment|// @@protoc_insertion_point(message_implements:hbase.pb.ProcedureWALHeader)
name|ProcedureWALHeaderOrBuilder
block|{
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:hbase.pb.ProcedureWALHeader)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.ProcedureProtos.ProcedureWALHeader.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
extends|extends
comment|// @@protoc_insertion_point(interface_extends:hbase.pb.ProcedureWALTrailer)
name|org
operator|.
name|apache
operator|.
...
function_decl|;
block|}
comment|/**    *<pre>    **    * Procedure WAL trailer    *</pre>    *    * Protobuf type {@code hbase.pb.ProcedureWALTrailer}    */
specifier|public
specifier|static
specifier|final
class|class
...
name|GeneratedMessageV3
implements|implements
comment|// @@protoc_insertion_point(message_implements:hbase.pb.ProcedureWALTrailer)
name|ProcedureWALTrailerOrBuilder
block|{
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:hbase.pb.ProcedureWALTrailer)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.ProcedureProtos.ProcedureWALTrailer.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
extends|extends
comment|// @@protoc_insertion_point(interface_extends:hbase.pb.ProcedureStoreTracker)
name|org
operator|.
name|apache
operator|.
...
name|GeneratedMessageV3
implements|implements
comment|// @@protoc_insertion_point(message_implements:hbase.pb.ProcedureStoreTracker)
name|ProcedureStoreTrackerOrBuilder
block|{
...
name|TrackerNodeOrBuilder
extends|extends
comment|// @@protoc_insertion_point(interface_extends:hbase.pb.ProcedureStoreTracker.TrackerNode)
name|org
operator|.
name|apache
operator|.
...
name|GeneratedMessageV3
implements|implements
comment|// @@protoc_insertion_point(message_implements:hbase.pb.ProcedureStoreTracker.TrackerNode)
name|TrackerNodeOrBuilder
block|{
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:hbase.pb.ProcedureStoreTracker.TrackerNode)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.ProcedureProtos.ProcedureStoreTracker.TrackerNode.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:hbase.pb.ProcedureStoreTracker)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.ProcedureProtos.ProcedureStoreTracker.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
extends|extends
comment|// @@protoc_insertion_point(interface_extends:hbase.pb.ProcedureWALEntry)
name|org
operator|.
name|apache
operator|.
...
name|GeneratedMessageV3
implements|implements
comment|// @@protoc_insertion_point(message_implements:hbase.pb.ProcedureWALEntry)
name|ProcedureWALEntryOrBuilder
block|{
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:hbase.pb.ProcedureWALEntry)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.ProcedureProtos.ProcedureWALEntry.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
