...
begin_comment
comment|/**  * An implementation of {@link LongList} on top of a primitive array.  *  * @author dweis@google.com (Daniel Weis)  */
end_comment
...
name|size
decl_stmt|;
comment|/**    * Constructs a new mutable {@code LongArrayList} with default capacity.    */
name|LongArrayList
parameter_list|()
block|{
name|this
...
expr_stmt|;
block|}
comment|/**    * Constructs a new mutable {@code LongArrayList}    * containing the same elements as {@code other}.    */
specifier|private
name|LongArrayList
parameter_list|(
name|long
...
expr_stmt|;
block|}
comment|/**    * Like {@link #add(Long)} but more efficient in that it doesn't box the element.    */
annotation|@
name|Override
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**    * Like {@link #add(int, Long)} but more efficient in that it doesn't box the element.    */
specifier|private
name|void
name|addLong
parameter_list|(
...
throw|;
block|}
comment|// We specialize when adding another LongArrayList to avoid boxing elements.
if|if
condition|(
operator|!
operator|(
