...
extends|extends
comment|// @@protoc_insertion_point(interface_extends:hbase.pb.ClusterId)
name|org
operator|.
name|apache
operator|.
...
block|{
comment|/**      *<pre>      * This is the cluster id, a uuid as a String      *</pre>      *      *<code>required string cluster_id = 1;</code>      */
name|boolean
name|hasClusterId
parameter_list|()
function_decl|;
...
function_decl|;
block|}
comment|/**    *<pre>    **    * Content of the '/hbase/hbaseid', cluster id, znode.    * Also cluster of the ${HBASE_ROOTDIR}/hbase.id file.    *</pre>    *    * Protobuf type {@code hbase.pb.ClusterId}    */
specifier|public
specifier|static
specifier|final
class|class
...
comment|// @@protoc_insertion_point(message_implements:hbase.pb.ClusterId)
name|ClusterIdOrBuilder
block|{
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:hbase.pb.ClusterId)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.shaded.protobuf.generated.ClusterIdProtos.ClusterId.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
operator|+
literal|"p.hbase.shaded.protobuf.generatedB\017Clust"
operator|+
literal|"erIdProtosH\001\240\001\001"
block|}
decl_stmt|;
name|org
operator|.
