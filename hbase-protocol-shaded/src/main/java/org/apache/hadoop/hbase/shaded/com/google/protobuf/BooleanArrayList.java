...
begin_comment
comment|/**  * An implementation of {@link BooleanList} on top of a primitive array.  *  * @author dweis@google.com (Daniel Weis)  */
end_comment
...
name|size
decl_stmt|;
comment|/**    * Constructs a new mutable {@code BooleanArrayList} with default capacity.    */
name|BooleanArrayList
parameter_list|()
block|{
name|this
...
expr_stmt|;
block|}
comment|/**    * Constructs a new mutable {@code BooleanArrayList}    * containing the same elements as {@code other}.    */
specifier|private
name|BooleanArrayList
parameter_list|(
name|boolean
...
expr_stmt|;
block|}
comment|/**    * Like {@link #add(Boolean)} but more efficient in that it doesn't box the element.    */
annotation|@
name|Override
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**    * Like {@link #add(int, Boolean)} but more efficient in that it doesn't box the element.    */
specifier|private
name|void
name|addBoolean
parameter_list|(
...
throw|;
block|}
comment|// We specialize when adding another BooleanArrayList to avoid boxing elements.
if|if
condition|(
operator|!
operator|(
