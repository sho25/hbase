...
begin_comment
comment|/**  * An implementation of {@link IntList} on top of a primitive array.  *  * @author dweis@google.com (Daniel Weis)  */
end_comment
...
name|size
decl_stmt|;
comment|/**    * Constructs a new mutable {@code IntArrayList} with default capacity.    */
name|IntArrayList
parameter_list|()
block|{
name|this
...
expr_stmt|;
block|}
comment|/**    * Constructs a new mutable {@code IntArrayList}    * containing the same elements as {@code other}.    */
specifier|private
name|IntArrayList
parameter_list|(
name|int
...
expr_stmt|;
block|}
comment|/**    * Like {@link #add(Integer)} but more efficient in that it doesn't box the element.    */
annotation|@
name|Override
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**    * Like {@link #add(int, Integer)} but more efficient in that it doesn't box the element.    */
specifier|private
name|void
name|addInt
parameter_list|(
...
throw|;
block|}
comment|// We specialize when adding another IntArrayList to avoid boxing elements.
if|if
condition|(
operator|!
operator|(
