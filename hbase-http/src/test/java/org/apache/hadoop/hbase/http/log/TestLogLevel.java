...
expr_stmt|;
block|}
comment|/**    * Get the SSL configuration.    * This method is copied from KeyStoreTestUtil#getSslConfig() in Hadoop.    * @return {@link Configuration} instance with ssl configs loaded.    * @param conf to pull client/server SSL settings filename from    */
specifier|private
specifier|static
name|Configuration
name|getSslConfig
