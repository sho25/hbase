...
function_decl|;
block|}
comment|/**    * Notice that, closing the return {@link Writer} will not close the {@code writer} passed in, you    * still need to close the {@code writer} by yourself.    *<p/>    * This is because that, we can only finish the json after you call {@link Writer#close()}. So if    * we just close the {@code writer}, you can write nothing after finished the json.    */
specifier|public
name|Writer
name|open
parameter_list|(
...
block|}
block|}
comment|/**    * Dump out all registered mbeans as json on System.out.    */
specifier|public
specifier|static
name|void
name|dumpAllBeans
