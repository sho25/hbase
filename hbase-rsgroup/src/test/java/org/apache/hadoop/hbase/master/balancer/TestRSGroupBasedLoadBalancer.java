...
return|;
block|}
comment|/**    * Generate a list of regions evenly distributed between the tables.    *    * @param numRegions The number of regions to be generated.    * @return List of HRegionInfo.    */
specifier|private
name|List
argument_list|<
name|HRegionInfo
