...
argument_list|)
expr_stmt|;
comment|// Enable quota for testRSGroupsWithHBaseQuota()
name|TEST_UTIL
operator|.
name|getConfiguration
argument_list|()
...
argument_list|()
decl_stmt|;
comment|//4 meta,namespace, group, quota
name|assertEquals
argument_list|(
literal|4
argument_list|,
...
decl_stmt|;
name|boolean
name|preListRSGroupInfosCalled
init|=
literal|false
decl_stmt|;
name|boolean
name|postListRSGroupInfosCalled
init|=
literal|false
decl_stmt|;
name|boolean
...
specifier|public
name|void
name|testListRSGroupInfosCPHookCalled
parameter_list|()
throws|throws
name|Exception
block|{
