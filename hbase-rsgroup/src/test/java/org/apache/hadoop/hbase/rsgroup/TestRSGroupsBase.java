...
name|tablePrefix
operator|+
literal|"_testCreateMultiRegion"
argument_list|)
decl_stmt|;
name|byte
index|[]
...
name|info
argument_list|(
literal|"testSimpleRegionServerMove"
argument_list|)
expr_stmt|;
name|int
name|initNumGroups
