...
parameter_list|()
function_decl|;
comment|// repeated .hbase.pb.ServerName servers = 4;
comment|/**      *<code>repeated .hbase.pb.ServerName servers = 4;</code>      */
name|java
operator|.
name|util
operator|.
...
operator|.
name|ServerNameOrBuilder
name|getServersOrBuilder
parameter_list|(
name|int
name|index
parameter_list|)
function_decl|;
comment|// repeated .hbase.pb.TableName tables = 3;
comment|/**      *<code>repeated .hbase.pb.TableName tables = 3;</code>      */
name|java
operator|.
name|util
operator|.
...
function_decl|;
block|}
comment|/**    * Protobuf type {@code hbase.pb.RSGroupInfo}    */
specifier|public
specifier|static
specifier|final
class|class
...
name|RSGroupInfoOrBuilder
block|{
comment|// Use RSGroupInfo.newBuilder() to construct.
specifier|private
name|RSGroupInfo
parameter_list|(
name|com
...
name|RSGroupProtos
operator|.
name|internal_static_hbase_pb_RSGroupInfo_descriptor
return|;
block|}
specifier|protected
name|com
...
name|RSGroupProtos
operator|.
name|internal_static_hbase_pb_RSGroupInfo_fieldAccessorTable
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.protobuf.generated.RSGroupProtos.RSGroupInfo.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
condition|)
block|{
name|getServersFieldBuilder
argument_list|()
expr_stmt|;
name|getTablesFieldBuilder
argument_list|()
expr_stmt|;
block|}
block|}
...
return|;
block|}
comment|// @@protoc_insertion_point(builder_scope:hbase.pb.RSGroupInfo)
block|}
static|static
block|{
name|defaultInstance
...
expr_stmt|;
block|}
comment|// @@protoc_insertion_point(class_scope:hbase.pb.RSGroupInfo)
block|}
specifier|private
specifier|static
name|com
...
operator|+
literal|"(\0132\023.hbase.pb.TableNameBC\n*org.apache.ha"
operator|+
literal|"doop.hbase.protobuf.generatedB\rRSGroupPr"
operator|+
