...
block|}
block|}
comment|// Called by DefaultServerUpdater. Presume it has lock on this manager when it runs.
specifier|private
name|SortedSet
argument_list|<
name|Address
...
return|;
block|}
comment|// Called by DefaultServerUpdater. Synchronize on this because redoing
...
parameter_list|)
block|{
comment|// #serverChanged is internally synchronized
name|defaultServerUpdater
operator|.
name|serverChanged
argument_list|()
