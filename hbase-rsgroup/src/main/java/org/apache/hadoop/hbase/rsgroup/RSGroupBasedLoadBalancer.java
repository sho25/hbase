...
parameter_list|)
block|{
comment|/**      * servers is actually a TreeSet (see {@link org.apache.hadoop.hbase.rsgroup.RSGroupInfo}),      * having its contains()'s time complexity as O(logn), which is good enough.      * TODO: consider using HashSet to pursue O(1) for contains() throughout the calling chain      * if needed. */
name|ArrayList
argument_list|<
name|ServerName
argument_list|>
...
name|debug
argument_list|(
literal|"There is no assigned server for {}"
argument_list|,
name|region
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Couldn't obtain rs group information for {} on {}"
argument_list|,
name|region
argument_list|,
name|assignedServer
...
argument_list|(
literal|"Could not find server for region "
operator|+
name|region
operator|.
