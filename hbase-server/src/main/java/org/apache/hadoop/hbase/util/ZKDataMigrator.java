...
begin_comment
comment|/**  * Utlity method to migrate zookeeper data across HBase versions.  * Used by Master mirroring table state to zk for hbase-1 clients.  * @deprecated Since 2.0.0. To be removed in hbase-3.0.0.  */
end_comment
