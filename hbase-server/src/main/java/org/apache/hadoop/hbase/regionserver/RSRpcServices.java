...
block|}
comment|// HBASE-17924
comment|// Sort to improve lock efficiency for non-atomic batch of operations. If atomic (mostly
comment|// called from mutateRows()), order is preserved as its expected from the client
if|if
condition|(
operator|!
name|atomic
...
condition|)
block|{
comment|// Old style bulk load. This will not be supported in future releases
name|List
argument_list|<
name|Pair
argument_list|<
