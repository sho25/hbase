...
return|;
block|}
comment|/**    * Loads all of the permission grants stored in a region of the {@code _acl_}    * table.    *    * @param aclRegion the acl region    * @return a map of the permissions for this table.    * @throws IOException if an error occurs    */
specifier|static
name|Map
argument_list|<
name|byte
...
return|;
block|}
comment|/**    * Reads user permission assignments stored in the<code>l:</code> column family of the first    * table row in<code>_acl_</code>.    *<p>    * See {@link PermissionStorage class documentation} for the key structure used for storage.    *</p>    */
specifier|static
name|ListMultimap
argument_list|<
name|String
