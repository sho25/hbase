...
parameter_list|)
function_decl|;
comment|/**    * Removes the given Region from the list of onlineRegions.    * @param r Region to remove.    * @param destination Destination, if any, null otherwise.    * @return True if we removed a region from online list.    */
name|boolean
name|removeRegion
parameter_list|(
specifier|final
