...
parameter_list|()
block|{
comment|// If we have already requested a roll, do nothing
if|if
condition|(
...
name|warn
argument_list|(
literal|"Requesting log roll because of low replication, current pipeline: "
operator|+
name|Arrays
operator|.
name|toString
...
if|if
condition|(
name|doCheckSlowSync
argument_list|()
condition|)
block|{
comment|// We log this already in checkSlowSync
name|requestLogRoll
argument_list|(
name|SLOW_SYNC
argument_list|)
