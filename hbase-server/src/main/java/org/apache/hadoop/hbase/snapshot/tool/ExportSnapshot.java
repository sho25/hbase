...
name|error
argument_list|(
literal|"Error closing output FileSystem"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Error closing input FileSystem"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|/**      * Returns the location where the inputPath will be copied.      *  - hfiles are encoded as hfile links hfile-region-table      *  - logs are encoded as serverName/logName      */
specifier|private
name|Path
name|getOutputPath
parameter_list|(
...
try|try
block|{
comment|// Verify if the input file exists
name|FileStatus
name|inputStat
init|=
name|getFileStatus
...
block|}
block|}
comment|/**      * Preserve the files attribute selected by the user copying them from the source file      */
specifier|private
name|boolean
name|preserveAttributes
parameter_list|(
...
return|;
block|}
comment|/**      * HLog files are encoded as serverName/logName      * and since all the other files should be in /hbase/table/..path..      * we can rely on the depth, for now.      */
specifier|private
specifier|static
name|boolean
name|isHLogLinkPath
...
name|IOException
block|{
comment|// copied with the snapshot referenecs
block|}
specifier|public
name|void
name|logFile
