...
expr_stmt|;
block|}
comment|/**    * Turns a snapshot of memstore into a set of store files.    * @param snapshot Memstore snapshot.    * @param cacheFlushSeqNum Log cache flush sequence number.    * @param status Task that represents the flush operation and may be updated with status.    * @return List of files written. Can be empty; must not be null.    */
specifier|public
specifier|abstract
name|List
argument_list|<
...
return|;
block|}
comment|/**    * Performs memstore flush, writing data from scanner into sink.    * @param scanner Scanner to get data from.    * @param sink Sink to write data to. Could be StoreFile.Writer.    * @param smallestReadPoint Smallest read point used for the flush.    */
specifier|protected
name|void
name|performFlush
parameter_list|(
