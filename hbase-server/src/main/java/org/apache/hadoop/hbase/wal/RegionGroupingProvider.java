...
begin_comment
comment|/** A group-provider mapping, recommended to make sure one-one rather than many-one mapping */
end_comment
...
begin_comment
comment|/** Stores delegation providers (no duplicated) used by this RegionGroupingProvider */
end_comment
