...
expr_stmt|;
block|}
comment|/**    * Used to set original seq Id for HLogKey during wal replay    * @param seqId    */
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**    * Return a positive long if current HLogKey is created from a replay edit    * @return original sequence number of the WALEdit    */
specifier|public
name|long
