...
block|}
block|}
comment|/**    * iff the given WALFactory is using the BoundedRegionGroupingProvider for meta and/or non-meta,    * count the number of files (rolled and active). if either of them isn't, count 0    * for that provider.    * @param walFactory may not be null.    */
specifier|public
specifier|static
name|long
name|getNumLogFiles
...
return|;
block|}
comment|/**    * iff the given WALFactory is using the BoundedRegionGroupingProvider for meta and/or non-meta,    * count the size of files (rolled and active). if either of them isn't, count 0    * for that provider.    * @param walFactory may not be null.    */
specifier|public
specifier|static
name|long
name|getLogFileSize
