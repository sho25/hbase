...
literal|false
decl_stmt|;
comment|/**    * Creates a half file reader for a hfile referred to by an hfilelink.    * @param context Reader context info    * @param fileInfo HFile info    * @param cacheConf CacheConfig    * @param r original reference file (contains top or bottom)    * @param refCount reference count    * @param conf Configuration    */
specifier|public
name|HalfStoreFileReader
parameter_list|(
specifier|final
