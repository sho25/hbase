...
block|}
block|}
comment|/**    * Remove specified regions by removing them from file-system and .META.    * (The regions must be offline).    *    * @param fs {@link FileSystem} on which to delete the region directory    * @param catalogTracker the catalog tracker    * @param regions list of {@link HRegionInfo} to delete.    */
specifier|public
specifier|static
name|void
name|deleteRegions
...
block|}
block|}
comment|/**    * Remove region from file-system and .META.    * (The region must be offline).    *    * @param fs {@link FileSystem} on which to delete the region directory    * @param catalogTracker the catalog tracker    * @param regionInfo {@link HRegionInfo} to delete.    */
specifier|public
specifier|static
name|void
name|deleteRegion
