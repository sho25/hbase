...
parameter_list|()
function_decl|;
comment|// required .RpcResponse.Status status = 2;
name|boolean
name|hasStatus
parameter_list|()
function_decl|;
...
expr_stmt|;
block|}
comment|// @@protoc_insertion_point(enum_scope:RpcResponse.Status)
block|}
specifier|private
name|int
name|bitField0_
...
operator|+
literal|"llId\030\001 \002(\005\022#\n\006status\030\002 \002(\0162\023.RpcResponse"
operator|+
literal|".Status\022\020\n\010response\030\003 \001(\014\022 \n\texception\030\004"
block|,
literal|" \001(\0132\r.RpcException\"+\n\006Status\022\013\n\007SUCCESS"
operator|+
