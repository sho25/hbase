...
argument_list|()
decl_stmt|;
comment|// 3. Forces all the RegionStates to be offline
comment|//
...
argument_list|)
expr_stmt|;
comment|// 4.1 Removes the current set of regions from META
comment|//
...
argument_list|)
expr_stmt|;
comment|// 4.2 Add the new set of regions to META
comment|//
