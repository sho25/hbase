...
control|)
block|{
comment|// Do not use the elements other than the default replica as they may be null. We will fail
comment|// earlier if the location for default replica is null.
specifier|final
name|RegionInfo
name|replica
init|=
...
name|HBaseIOException
argument_list|(
literal|"No location found for default replica of table="
operator|+
name|tableDesc
operator|.
name|getTableName
