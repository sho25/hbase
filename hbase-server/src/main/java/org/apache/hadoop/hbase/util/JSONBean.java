...
return|;
block|}
comment|/**    * @param mBeanServer    * @param qry    * @param attribute    * @param description    * @return Return non-zero if failed to find bean. 0    * @throws IOException    */
specifier|private
specifier|static
name|int
name|write
...
block|}
block|}
comment|/**    * Dump out a subset of regionserver mbeans only, not all of them, as json on System.out.    * @throws MalformedObjectNameException    * @throws IOException    */
specifier|public
specifier|static
name|String
