...
return|;
block|}
comment|/**    * Get Servernames which are currently splitting; paths have a '-splitting' suffix.    * @return ServerName    * @throws IOException IOException    */
specifier|public
name|Set
argument_list|<
name|ServerName
...
block|{
return|return
name|getServerNamesFromWALDirPath
argument_list|(
name|p
lambda|->
name|p
...
return|;
block|}
comment|/**    * Get Servernames that COULD BE 'alive'; excludes those that have a '-splitting' suffix as these    * are already being split -- they cannot be 'alive'.    * @return ServerName    * @throws IOException IOException    */
specifier|public
name|Set
argument_list|<
name|ServerName
...
return|;
block|}
comment|/**    * @return List of all RegionServer WAL dirs; i.e. this.rootDir/HConstants.HREGION_LOGDIR_NAME.    */
specifier|public
name|FileStatus
index|[]
name|getWALDirPaths
...
name|warn
argument_list|(
literal|"Unable to delete log dir. Ignoring. "
operator|+
name|splitDir
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Failed archiving meta log for server "
operator|+
name|serverName
argument_list|,
name|ie
