...
return|;
block|}
comment|/**    * Mark regions in recovering state when distributedLogReplay are set true    * @param serverName Failed region server whose wals to be replayed    * @param regions Set of regions to be recovered    */
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**    * Wrapper function on {@link SplitLogManager#removeStaleRecoveringRegions(Set)}    * @param failedServers A set of known failed servers    */
name|void
...
block|}
block|}
comment|/**    * The function is used in SSH to set recovery mode based on configuration after all outstanding    * log split tasks drained.    */
specifier|public
name|void
