...
return|;
block|}
comment|/**    * Get table descriptor    * @param tableName is the table backed up    * @return {@link HTableDescriptor} saved in backup image of the table    */
name|HTableDescriptor
name|getTableDesc
parameter_list|(
name|TableName
...
block|}
block|}
comment|// we do not recovered edits
block|}
catch|catch
parameter_list|(
name|Exception
