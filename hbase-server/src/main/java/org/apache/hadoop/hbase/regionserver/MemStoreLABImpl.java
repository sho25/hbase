...
parameter_list|)
block|{
comment|// See head of copyBBECellInto for how it differs from copyCellInto
return|return
operator|(
name|cell
operator|instanceof
...
argument_list|)
expr_stmt|;
comment|// Callers should satisfy large allocations from JVM heap so limit fragmentation.
if|if
condition|(
name|size
operator|>
...
return|;
block|}
comment|/**    * @see #copyBBECellInto(ByteBufferExtendedCell, int)    */
specifier|private
name|Cell
name|copyCellInto
parameter_list|(
...
return|;
block|}
comment|/**    * Clone the passed cell by copying its data into the passed buf and create a cell with a chunkid    * out of it    * @see #copyBBECToChunkCell(ByteBufferExtendedCell, ByteBuffer, int, int)    */
specifier|private
specifier|static
name|Cell
name|copyToChunkCell
...
return|;
block|}
comment|/**    * Clone the passed cell by copying its data into the passed buf and create a cell with a chunkid    * out of it    * @see #copyToChunkCell(Cell, ByteBuffer, int, int)    */
specifier|private
specifier|static
name|Cell
name|copyBBECToChunkCell
