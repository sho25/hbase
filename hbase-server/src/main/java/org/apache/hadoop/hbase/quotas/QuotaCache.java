...
literal|false
decl_stmt|;
comment|// factors used to divide cluster scope quota into machine scope quota
specifier|private
specifier|volatile
name|double
name|machineQuotaFactor
init|=
literal|1
decl_stmt|;
specifier|private
...
block|}
block|}
comment|/**      * Update quota factors which is used to divide cluster scope quota into machine scope quota      *      * For user/namespace/user over namespace quota, use [1 / RSNum] as machine factor.      * For table/user over table quota, use [1 / TotalTableRegionNum * MachineTableRegionNum]      * as machine factor.      */
specifier|private
name|void
name|updateQuotaFactors
parameter_list|()
block|{
comment|// Update machine quota factor
try|try
block|{
name|int
name|rsSize
...
condition|)
block|{
comment|// TODO if use rs group, the cluster limit should be shared by the rs group
name|machineQuotaFactor
operator|=
literal|1.0
operator|/
...
name|warn
argument_list|(
literal|"Get live region servers failed"
argument_list|,
name|e
argument_list|)
expr_stmt|;
block|}
comment|// Update table machine quota factors
for|for
control|(
name|TableName
name|tableName
...
name|warn
argument_list|(
literal|"Get table regions failed: {}"
argument_list|,
name|tableName
argument_list|,
name|e
