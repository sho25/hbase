...
comment|// ============================================================================
comment|/**    * Suspend the procedure if the specified namespace is already locked.    * @see #wakeNamespaceExclusiveLock(Procedure,String)    * @param procedure the procedure trying to acquire the lock    * @param nsName Namespace to lock    * @return true if the procedure has to wait for the namespace to be available    */
specifier|public
name|boolean
...
block|}
block|}
comment|/**    * Wake the procedures waiting for the specified namespace    * @see #waitNamespaceExclusiveLock(Procedure,String)    * @param procedure the procedure releasing the lock    * @param nsName the namespace that has the exclusive lock    */
specifier|public
name|void
...
comment|// Write up the concurrency expectations. St.Ack 01/19/2017
specifier|private
specifier|static
specifier|abstract
class|class
