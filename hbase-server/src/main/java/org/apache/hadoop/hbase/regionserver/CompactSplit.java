...
block|}
block|}
comment|// A compaction life cycle tracker to trace the execution of all the compactions triggered by one
comment|// request and delegate to the source CompactionLifeCycleTracker. It will call completed method if
comment|// all the compactions are finished.
specifier|private
specifier|static
specifier|final
class|class
name|AggregatingCompactionLifeCycleTracker
implements|implements
name|CompactionLifeCycleTracker
block|{
specifier|private
