...
specifier|final
name|String
name|COMPACTION_POLICY_CLASS_FOR_TIERED_WINDOWS_KEY
init|=
...
specifier|final
name|String
name|SINGLE_OUTPUT_FOR_MINOR_COMPACTION_KEY
init|=
...
argument_list|>
name|DEFAULT_TIER_COMPACTION_POLICY_CLASS
init|=
...
specifier|final
name|int
name|incomingWindowMin
decl_stmt|;
specifier|private
specifier|final
name|String
name|compactionPolicyForTieredWindow
decl_stmt|;
specifier|private
specifier|final
name|boolean
name|singleOutputForMinorCompaction
decl_stmt|;
name|CompactionConfiguration
parameter_list|(
name|Configuration
...
operator|+
literal|" tiered compaction: max_age %d, base window in milliseconds %d, windows per tier %d,"
operator|+
literal|"incoming window min %d"
argument_list|,
name|minCompactSize
argument_list|,
name|maxCompactSize
