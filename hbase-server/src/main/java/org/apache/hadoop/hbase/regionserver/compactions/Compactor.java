...
return|;
block|}
comment|/**    * Performs the compaction.    * @param fd File details    * @param scanner Where to read from.    * @param writer Where to write to.    * @param smallestReadPoint Smallest read point.    * @param cleanSeqId When true, remove seqId(used to be mvcc) value which is<= smallestReadPoint    * @param major Is a major compaction.    * @return Whether compaction ended; false if it was interrupted for some reason.    */
specifier|protected
name|boolean
...
return|;
block|}
comment|/**    * Resets the sequence id.    * @param smallestReadPoint The smallest mvcc readPoint across all the scanners in this region.    * @param cleanSeqId Should clean the sequence id.    * @param kv The current KeyValue.    */
specifier|protected
name|void
name|resetSeqId
parameter_list|(
...
block|}
block|}
comment|/**    * Appends the metadata and closes the writer.    * @param writer The current store writer.    * @param fd The file details.    * @param isMajor Is a major compaction.    * @throws IOException    */
specifier|protected
name|void
