...
name|error
argument_list|(
literal|"fail to close table in cleanup"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"fail to close connection in cleanup"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|//in case we've been run before, restore all parameters to their initial states
comment|//Otherwise, if our previous run included a parameter not in args this time,
comment|//we might hold on to the old value.
