...
condition|)
block|{
comment|// Entry is no longer Writable, maintain compatible serialization.
comment|// Writables write their exact runtime class
name|Class
argument_list|<
name|?
argument_list|>
...
name|instanceObj
decl_stmt|;
comment|// We only support legacy HLogKey
name|WALKey
name|key
init|=
name|entry
...
name|IOException
argument_list|(
literal|"Can't write Entry '"
operator|+
name|instanceObj
operator|+
literal|"' due to key class '"
operator|+
name|key
operator|.
name|getClass
...
if|if
condition|(
literal|"org.apache.hadoop.hbase.regionserver.wal.HLog$Entry"
operator|.
name|equals
argument_list|(
name|className
...
condition|)
block|{
comment|// Entry stopped being Writable; maintain serialization support.
specifier|final
name|HLogKey
name|key
init|=
