...
literal|1
decl_stmt|;
comment|// Configuration keys for merge threads
specifier|public
specifier|final
specifier|static
name|String
...
name|justification
operator|=
literal|"Contrived use of compareTo"
argument_list|)
specifier|private
class|class
name|CompactionRunner
...
name|error
argument_list|(
literal|"Encountered exception while compacting"
argument_list|,
name|ioe
argument_list|)
expr_stmt|;
