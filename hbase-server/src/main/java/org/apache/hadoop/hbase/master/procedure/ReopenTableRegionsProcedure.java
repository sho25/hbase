...
begin_comment
comment|/**  * Used for reopening the regions for a table.  *<p/>  * Currently we use {@link MoveRegionProcedure} to reopen regions.  */
end_comment
...
parameter_list|)
block|{
comment|// we skip the checks so this should not happen
throw|throw
operator|new
name|AssertionError
argument_list|(
