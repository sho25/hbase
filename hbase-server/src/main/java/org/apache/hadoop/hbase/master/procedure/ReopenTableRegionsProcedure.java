...
name|tableName
decl_stmt|;
comment|// Specify specific regions of a table to reopen.
comment|// if specified null, all regions of the table will be reopened.
specifier|private
specifier|final
name|List
argument_list|<
...
name|regions
operator|=
name|getRegionLocationsForReopen
argument_list|(
name|tableRegions
argument_list|)
expr_stmt|;
