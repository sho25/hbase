...
return|;
block|}
comment|/**      * Get FileStatus with filter.      * @param function a filter function      * @return filtered FileStatus or empty list if dir doesn't exist      * @throws IOException if there's an error other than dir not existing      */
specifier|private
name|List
argument_list|<
name|FileStatus
