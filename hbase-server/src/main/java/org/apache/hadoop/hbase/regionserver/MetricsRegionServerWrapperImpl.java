...
decl_stmt|;
name|long
name|currentReadRequestsCount
init|=
literal|0
decl_stmt|;
name|long
name|currentWriteRequestsCount
init|=
literal|0
decl_stmt|;
name|long
...
decl_stmt|;
name|long
name|readRequestsDelta
init|=
literal|0
decl_stmt|;
name|long
name|writeRequestsDelta
init|=
literal|0
decl_stmt|;
name|long
name|totalReadRequestsDelta
init|=
literal|0
decl_stmt|;
name|long
name|totalWriteRequestsDelta
init|=
literal|0
decl_stmt|;
name|String
...
name|writeRequestsDelta
expr_stmt|;
comment|//Update cache for our next comparision
name|requestsCountCache
operator|.
name|get
argument_list|(
...
block|{
comment|// List[0] -> readRequestCount
comment|// List[1] -> writeRequestCount
name|ArrayList
argument_list|<
name|Long
argument_list|>
