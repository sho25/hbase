...
decl_stmt|;
comment|// lists of super users and super groups, used to route rpc calls made by
comment|// superusers through high-priority (ADMIN_QOS) thread pool.
comment|// made protected for tests
specifier|protected
specifier|final
name|HashSet
argument_list|<
...
try|try
block|{
comment|// TODO Usage of VisibilityUtils API to be avoided with HBASE-13755
name|Pair
argument_list|<
name|List
argument_list|<
...
expr_stmt|;
block|}
comment|/**    * @param user user running request    * @return true if user is super user, false otherwise    */
specifier|private
name|boolean
name|isExecutedBySuperUser
parameter_list|(
