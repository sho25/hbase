...
block|}
block|}
comment|/*      * If it is not a major mob compaction with del files, and the file number in Partition is 1,      * remove the partition from filesToCompact list to avoid re-compacting files which has been      * compacted with del files.      */
if|if
condition|(
operator|!
name|allFiles
