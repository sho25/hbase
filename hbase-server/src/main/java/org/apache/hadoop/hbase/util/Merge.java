...
expr_stmt|;
block|}
comment|/**    * Parse given arguments and assign table name and regions names.    * (generic args are handled by ToolRunner.)    *    * @param args the arguments to parse    *    * @throws IOException    */
specifier|private
name|int
name|parseArgs
parameter_list|(
