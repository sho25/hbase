...
name|warn
argument_list|(
literal|"Failed to get worker to replay wals {} for peer id={}, sleep {} secs and retry"
argument_list|,
name|wals
argument_list|,
name|peerId
...
name|info
argument_list|(
literal|"No worker to replay wals {} for peer id={}, sleep {} secs and retry"
argument_list|,
name|wals
argument_list|,
name|peerId
...
name|warn
argument_list|(
literal|"Failed to remove worker {} for peer id={}, sleep {} secs and retry"
argument_list|,
name|worker
argument_list|,
name|peerId
