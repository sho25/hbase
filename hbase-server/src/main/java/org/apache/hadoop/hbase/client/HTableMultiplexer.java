...
expr_stmt|;
block|}
comment|/**    * The put request will be buffered by its corresponding buffer queue. Return false if the queue    * is already full.    * @param table    * @param put    * @return true if the request can be accepted by its corresponding buffer queue.    * @throws IOException    */
specifier|public
name|boolean
name|put
parameter_list|(
...
return|;
block|}
comment|/**    * The puts request will be buffered by their corresponding buffer queue.     * Return the list of puts which could not be queued.    * @param table    * @param puts    * @return the list of puts which could not be queued    * @throws IOException    */
specifier|public
name|List
argument_list|<
name|Put
