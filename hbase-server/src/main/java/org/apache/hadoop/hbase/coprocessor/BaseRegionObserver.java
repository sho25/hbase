...
name|IOException
block|{
comment|// By default we are executing the deprecated preGet to support legacy RegionObservers
comment|// We may use the results coming in and we may return the results going out.
name|List
argument_list|<
name|KeyValue
argument_list|>
...
expr_stmt|;
block|}
comment|/**    * WARNING: please override preGetOp instead of this method.  This is to maintain some    * compatibility and to ease the transition from 0.94 -> 0.96.  It is super inefficient!    */
annotation|@
name|Deprecated
annotation|@
name|Override
...
expr_stmt|;
block|}
comment|/**    * WARNING: please override postGetOp instead of this method.  This is to maintain some    * compatibility and to ease the transition from 0.94 -> 0.96.  It is super inefficient!    */
annotation|@
name|Deprecated
annotation|@
name|Override
