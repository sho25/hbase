...
name|bypassable
decl_stmt|;
comment|/**    * Is this operation completable?    */
specifier|private
name|boolean
name|complete
decl_stmt|;
...
name|UnsupportedOperationException
argument_list|(
literal|"This method does not support 'complete'."
argument_list|)
throw|;
block|}
name|complete
...
return|;
block|}
comment|/**    * @return {@code true}, if {@link ObserverContext#complete()} was called by one of the loaded    * coprocessors, {@code false} otherwise.    */
specifier|public
name|boolean
name|shouldComplete
parameter_list|()
