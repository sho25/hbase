...
name|warn
argument_list|(
literal|"Error trying to modify the namespace"
operator|+
name|newNsDescriptor
operator|.
name|getName
...
expr_stmt|;
block|}
comment|/**    * rollback the row into namespace table    * @param env MasterProcedureEnv    * @throws IOException    */
specifier|private
name|void
name|rollbackUpdateInNSTable
parameter_list|(
