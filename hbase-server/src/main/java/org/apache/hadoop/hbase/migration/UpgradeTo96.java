...
block|}
return|return
name|upgradeNamespaceAndZnodes
argument_list|()
return|;
block|}
return|return
...
argument_list|()
return|;
comment|//upgrade znodes only if we succeed in first step.
else|else
block|{
name|LOG
operator|.
name|warn
argument_list|(
literal|"Namespace upgrade returned: "
operator|+
name|res
operator|+
literal|", expected 0. Aborting the upgrade"
argument_list|)
expr_stmt|;
throw|throw
operator|new
name|Exception
argument_list|(
literal|"Unexpected return code from Namespace upgrade"
argument_list|)
throw|;
block|}
block|}
...
name|info
argument_list|(
literal|"Successfully Upgraded NameSpace."
argument_list|)
expr_stmt|;
return|return
name|res
...
name|error
argument_list|(
literal|"Got exception while upgrading Namespace"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Succesfully upgraded znodes."
argument_list|)
expr_stmt|;
return|return
name|res
...
name|error
argument_list|(
literal|"Got exception while upgrading Znodes"
argument_list|,
name|e
argument_list|)
expr_stmt|;
