...
parameter_list|()
function_decl|;
comment|/**      * To close only the stream's socket. HBASE-9393      */
name|void
name|unbufferStream
parameter_list|()
function_decl|;
...
condition|)
block|{
comment|// Enclosing unbuffer() in try-catch just to be on defensive side.
try|try
block|{
name|stream
operator|.
...
name|error
argument_list|(
literal|"Failed to unbuffer the stream so possibly there may be a TCP socket connection "
operator|+
