...
parameter_list|)
block|{
comment|// delegate to the internal constructor after checking basic preconditions
name|this
argument_list|(
name|Preconditions
operator|.
...
expr_stmt|;
block|}
comment|/**      * Set the files (and, implicitly, the size of the compaction based on those files)      * @param files files that should be included in the compaction      */
specifier|public
name|void
name|setSelection
parameter_list|(
