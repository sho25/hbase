...
name|closeRegionDetails
decl_stmt|;
comment|/**    * This method used internally by the RegionServer to close out regions.    * @param server    * @param rsServices    * @param regionInfo    * @param abort If the regionserver is aborting.    * @param closeRegionCoordination consensus for closing regions    * @param crd object carrying details about region close task.    */
specifier|public
name|CloseRegionHandler
parameter_list|(
specifier|final
