...
name|IOException
argument_list|(
literal|"Failed creating PENDING_MERGE znode on "
operator|+
name|this
operator|.
name|mergedRegionInfo
...
name|IOException
block|{
comment|// Wait for the master to process the pending_merge.
try|try
block|{
name|int
name|spins
