...
specifier|public
name|boolean
name|isReplicaAvailableForRegion
parameter_list|(
specifier|final
name|RegionInfo
name|info
parameter_list|)
block|{
comment|// if the region info itself is a replica return true.
if|if
condition|(
operator|!
name|RegionReplicaUtil
...
return|;
block|}
comment|// iterate the regionsMap for the given region name. If there are replicas it should
comment|// list them in order.
for|for
control|(
name|RegionStateNode
name|node
...
condition|)
block|{
comment|// we have replicas
return|return
literal|true
return|;
block|}
block|}
comment|// we don have replicas
return|return
literal|false
return|;
block|}
