...
comment|/**    * RegionName -- i.e. HRegionInfo.getRegionName() -- as bytes to {@link RegionStateNode}    */
specifier|private
specifier|final
name|ConcurrentSkipListMap
argument_list|<
...
block|}
name|RegionStateNode
name|getRegionNodeFromEncodedName
parameter_list|(
specifier|final
name|String
...
return|;
block|}
comment|/**    * Returns the set of regions hosted by the specified server    * @param serverName the server we are interested in    * @return set of HRegionInfo hosted by the specified server    */
specifier|public
name|List
argument_list|<
name|HRegionInfo
