...
condition|)
block|{
comment|// replicate all user tables, but filter by exclude namespaces config
name|Set
argument_list|<
name|String
argument_list|>
...
argument_list|()
decl_stmt|;
comment|// return null(prevent replicating) if logKey's table is in this peer's
comment|// exclude namespaces list
if|if
condition|(
name|excludeNamespaces
operator|!=
...
comment|// replicable tables list
if|if
condition|(
name|tableCFs
operator|==
