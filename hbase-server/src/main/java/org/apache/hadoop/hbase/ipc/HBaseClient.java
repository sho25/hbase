...
block|}
block|}
comment|/**    * Construct an IPC client whose values are of the {@link Message}    * class.    * @param valueClass value class    * @param conf configuration    * @param factory socket factory    */
specifier|public
name|HBaseClient
parameter_list|(
name|Configuration
