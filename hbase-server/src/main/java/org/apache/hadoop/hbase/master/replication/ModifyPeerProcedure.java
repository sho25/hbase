...
specifier|final
name|int
name|SET_LAST_SEQ_ID_BATCH_SIZE
init|=
literal|1000
decl_stmt|;
specifier|protected
...
expr_stmt|;
block|}
comment|/**    * Implementation class can override this method. The default return value is false which means we    * will jump to POST_PEER_MODIFICATION and finish the procedure. If returns true, we will jump to    * SERIAL_PEER_REOPEN_REGIONS.    */
specifier|protected
name|boolean
...
specifier|private
name|void
name|setLastSequenceIdForSerialPeer
parameter_list|(
name|MasterProcedureEnv
name|env
parameter_list|)
...
name|warn
argument_list|(
literal|"{} reopen regions for peer {} failed, retry"
argument_list|,
name|getClass
argument_list|()
operator|.
...
name|warn
argument_list|(
literal|"{} set last sequence id for peer {} failed, retry"
argument_list|,
name|getClass
argument_list|()
operator|.
...
name|warn
argument_list|(
literal|"{} enable peer before finish for peer {} failed, retry"
argument_list|,
name|getClass
argument_list|()
operator|.
