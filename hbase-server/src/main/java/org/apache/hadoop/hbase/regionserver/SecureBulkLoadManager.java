...
name|trace
argument_list|(
literal|"Cleaned up {} successfully."
argument_list|,
name|path
argument_list|)
expr_stmt|;
...
try|try
block|{
comment|/*              * This is creating and caching a new FileSystem instance. Other code called              * "beneath" this method will rely on this FileSystem instance being in the              * cache. This is important as those methods make _no_ attempt to close this              * FileSystem instance. It is critical that here, in SecureBulkLoadManager,              * we are tracking the lifecycle and closing the FS when safe to do so.              */
name|fs
operator|=
name|FileSystem
operator|.
