...
argument_list|)
expr_stmt|;
comment|// This can be set while the write is created itself because
comment|// in both cases useHBaseChecksum is going to be true
name|hFileContext
operator|.
...
argument_list|(
literal|"KV tags are supported only from HFile V3"
argument_list|)
throw|;
block|}
specifier|protected
