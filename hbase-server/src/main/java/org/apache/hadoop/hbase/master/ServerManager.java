...
name|warn
argument_list|(
literal|"Expiration called on {} but already in DeadServer"
argument_list|,
name|serverName
argument_list|)
expr_stmt|;
...
block|{
comment|// If not online, that is odd but may happen if 'Unknown Servers' -- where meta
comment|// has references to servers not online nor in dead servers list. If
comment|// 'Unknown Server', don't add to DeadServers else will be there for ever.
name|LOG
operator|.
name|trace
argument_list|(
...
name|UNKNOWN
block|}
comment|/**    * @return whether the server is online, dead, or unknown.    */
specifier|public
specifier|synchronized
name|ServerLiveState
