...
return|;
block|}
comment|/**    * It "atomically" copies all the hlogs queues from another region server and returns them all    * sorted per peer cluster (appended with the dead server's znode).    * @param znode    * @return HLog queues sorted per peer cluster    */
specifier|public
name|SortedMap
argument_list|<
name|String
