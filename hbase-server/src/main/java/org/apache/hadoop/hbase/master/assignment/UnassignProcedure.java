...
comment|// failure processing sets state back to REGION_TRANSITION_QUEUE so we come back in here again
comment|// to probably go into the clause after waitOnServerCrashProcedure;
