...
return|;
block|}
comment|/**    *  We intend to use the local version for service call shortcut(s), so we use an interface    *  compatible with a typical service call, with 2 args, return type, and an exception type.    */
specifier|public
interface|interface
...
name|E
block|{
comment|// Note: just as RpcServer.CurCall, this will only apply on the current thread.
name|NonCallVersion
operator|.
name|set
argument_list|(
...
return|;
block|}
comment|/**    * Returns the version components    * Examples: "1.4.3" returns [1, 4, 3], "4.5.6-SNAPSHOT" returns [4, 5, 6, "SNAPSHOT"]    * @return the components of the version string    */
specifier|private
specifier|static
name|String
index|[]
