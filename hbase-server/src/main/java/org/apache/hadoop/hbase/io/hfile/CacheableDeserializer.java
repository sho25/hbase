...
name|IOException
function_decl|;
comment|/**    * Get the identifier of this deserialiser. Identifier is unique for each    * deserializer and generated by {@link CacheableDeserializerIdManager}    * @return identifier number of this cacheable deserializer    */
specifier|public
name|int
