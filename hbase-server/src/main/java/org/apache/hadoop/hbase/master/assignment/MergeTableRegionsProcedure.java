...
expr_stmt|;
block|}
comment|/**    * Rollback the region state change    * Not used for now, since rollbackCloseRegionsForMerge() will mark regions as OPEN    * @param env MasterProcedureEnv    * @throws IOException    */
specifier|private
name|void
name|setRegionStateBackToOpen
parameter_list|(
specifier|final
name|MasterProcedureEnv
name|env
...
name|IOException
block|{
comment|// revert region state to Open
name|RegionStates
name|regionStates
init|=
name|env
