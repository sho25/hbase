...
return|;
block|}
comment|/**    * check the closed regions    * @param env the master env    * @throws IOException IOException    */
specifier|private
name|void
name|checkClosedRegions
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Check whether there is recovered.edits in the closed region    * If any, that means this region is not closed property, we need    * to abort region merge to prevent data loss    * @param env master env    * @param regionInfo regioninfo    * @throws IOException IOException    */
specifier|private
name|void
name|checkClosedRegion
parameter_list|(
...
name|regionInfo
operator|+
literal|", abort merge to prevent data loss"
argument_list|)
throw|;
block|}
block|}
