...
name|restoreDir
expr_stmt|;
name|openWithoutRestoringSnapshot
argument_list|()
expr_stmt|;
block|}
else|else
...
argument_list|)
expr_stmt|;
name|openWithRestoringSnapshot
argument_list|()
expr_stmt|;
block|}
...
argument_list|(
literal|"Snapshot seems empty, snapshotName: "
operator|+
name|snapshotName
argument_list|)
throw|;
...
parameter_list|)
block|{
comment|// An offline split parent region should be excluded.
if|if
condition|(
name|hri
operator|.
...
name|warn
argument_list|(
literal|"Delete restore directory for the snapshot failed. restoreDir: "
operator|+
name|this
operator|.
name|restoreDir
...
name|warn
argument_list|(
literal|"Could not delete restore directory for the snapshot. restoreDir: "
operator|+
name|this
operator|.
name|restoreDir
...
expr_stmt|;
block|}
comment|// if snapshotAlreadyRestored is true, then we should invoke cleanup() method by hand.
if|if
condition|(
operator|!
name|this
