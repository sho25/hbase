...
name|filename
operator|+
literal|" hit ZooKeeper issue, resigning"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|// initialize a new connection for splitlogworker configuration
name|HConnectionManager
operator|.
name|getConnection
argument_list|(
...
return|;
block|}
comment|/**    * Submit a log split task to executor service    * @param curTask    * @param curTaskZKVersion    */
name|void
name|submitTask
parameter_list|(
specifier|final
