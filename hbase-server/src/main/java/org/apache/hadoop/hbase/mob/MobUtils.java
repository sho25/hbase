...
return|;
block|}
comment|/**    * Creates the encyption context.    * @param conf The current configuration.    * @param family The current column descriptor.    * @return The encryption context.    * @throws IOException    */
specifier|public
specifier|static
name|Encryption
operator|.
...
name|IOException
block|{
comment|// TODO the code is repeated, and needs to be unified.
name|Encryption
operator|.
name|Context
name|cryptoContext
...
block|}
block|}
comment|/**    * Archives mob store files    * @param conf The current configuration.    * @param fs The current file system.    * @param mobRegionInfo The mob family region info.    * @param mobFamilyDir The mob family directory.    * @param family The name of the column family.    * @throws IOException    */
specifier|public
specifier|static
name|void
