...
specifier|final
name|String
name|COMPACTION_WORKING_DIR_NAME
init|=
literal|"working"
decl_stmt|;
specifier|private
...
expr_stmt|;
block|}
comment|/**    * Gets the znode name of column family.    * @param tableName The current table name.    * @param familyName The name of the current column family.    * @return The znode name of column family.    */
specifier|public
specifier|static
name|String
...
return|;
block|}
comment|/**    * Commits the mob file.    * @param @param conf The current configuration.    * @param fs The current file system.    * @param path The path where the mob file is saved.    * @param targetPath The directory path where the source file is renamed to.    * @param cacheConfig The current cache config.    * @throws IOException    */
specifier|public
specifier|static
name|void
name|commitFile
