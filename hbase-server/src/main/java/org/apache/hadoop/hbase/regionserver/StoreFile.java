...
expr_stmt|;
block|}
comment|/**      * Record the earlest Put timestamp.      *      * If the timeRangeTracker is not set,      * update TimeRangeTracker to include the timestamp of this key      * @param cell      */
specifier|public
name|void
...
block|{
comment|// TODO : Convert key to Cell so that we could use compare(Cell, Cell)
name|keyIsAfterLast
operator|=
operator|(
name|CellComparator
...
argument_list|)
decl_stmt|;
comment|// TODO this is in hot path? Optimize and avoid 2 extra object creations.
name|KeyValue
operator|.
name|KeyOnlyKeyValue
name|firstKeyKV
