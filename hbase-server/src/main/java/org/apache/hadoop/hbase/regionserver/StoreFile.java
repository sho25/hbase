...
argument_list|)
decl_stmt|;
comment|/** Min Flush time in FileInfo */
specifier|public
specifier|static
specifier|final
name|byte
...
literal|1024
decl_stmt|;
comment|/** Default value for files without minFlushTime in metadata */
specifier|public
specifier|static
specifier|final
name|long
...
literal|1
decl_stmt|;
comment|// default value is -1, remains -1 if file written without minFlushTime
specifier|private
name|long
name|minFlushTime
init|=
...
parameter_list|()
block|{
comment|// BulkLoad files are assumed to contain very old data, return 0
if|if
condition|(
...
condition|)
block|{
comment|// File written without minFlushTime field assume recent data
return|return
name|EnvironmentEdgeManager
operator|.
