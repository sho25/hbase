...
name|String
argument_list|,
name|ReplicationSourceWorkerThread
argument_list|>
name|workerThreads
init|=
operator|new
...
name|peerId
operator|+
literal|" inited, replicationQueueSizeCapacity="
operator|+
name|replicationQueueSizeCapacity
operator|+
literal|", replicationQueueNbCapacity="
operator|+
name|replicationQueueNbCapacity
operator|+
literal|", curerntBandwidth="
operator|+
name|this
operator|.
name|currentBandwidth
...
literal|true
decl_stmt|;
comment|// Current number of hfiles that we need to replicate
specifier|private
name|long
...
comment|// FIXME check the relationship between single wal group and overall
if|if
condition|(
name|totalBufferTooLarge
operator|||
...
condition|)
block|{
comment|// For recovered queue: must use peerClusterZnode since peerId is a parsed value
name|manager
operator|.
name|cleanOldLogs
argument_list|(
...
parameter_list|()
block|{
comment|// We presume this means the file we're reading is closed.
if|if
condition|(
name|this
operator|.
...
argument_list|()
operator|+
literal|". Restarting WAL reading (see HBASE-15983 for details). stats: "
operator|+
name|getStats
argument_list|()
argument_list|)
