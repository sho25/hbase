...
decl_stmt|;
comment|// whether the replication endpoint has been initialized
specifier|private
specifier|volatile
name|boolean
name|endpointInitialized
init|=
literal|false
decl_stmt|;
...
name|warn
argument_list|(
literal|"Error starting ReplicationEndpoint, retrying"
argument_list|,
name|e
argument_list|)
expr_stmt|;
