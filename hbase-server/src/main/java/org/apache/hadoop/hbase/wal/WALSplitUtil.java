...
return|;
block|}
comment|/**    * Path to a file under recovered.hfiles directory of the region's column family: e.g.    * /hbase/some_table/2323432434/cf/recovered.hfiles/2332-wal. This method also ensures existence    * of recovered.hfiles directory under the region's column family, creating it if necessary.    *    * @param tableName          the table name    * @param encodedRegionName  the encoded region name    * @param familyName         the column family name    * @param seqId              the sequence id which used to generate file name    * @param fileNameBeingSplit the file being split currently. Used to generate tmp file name    * @param conf               configuration    * @param rootFS             the root file system    * @return Path to file into which to dump split log edits.    */
specifier|static
name|Path
...
name|dir
init|=
name|getStoreDirRecoveredHFilesDir
argument_list|(
name|regionDir
argument_list|,
name|familyName
...
name|warn
argument_list|(
literal|"mkdir failed on {}, region {}, column family {}"
argument_list|,
name|dir
argument_list|,
name|encodedRegionName
...
return|;
block|}
comment|/**    * @param regionDir  This regions directory in the filesystem    * @param familyName The column family name    * @return The directory that holds recovered hfiles for the region's column family    */
specifier|private
specifier|static
name|Path
name|getStoreDirRecoveredHFilesDir
