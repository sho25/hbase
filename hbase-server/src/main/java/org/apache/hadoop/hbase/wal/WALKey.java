...
name|this
operator|.
name|preAssignedWriteEntry
operator|!=
literal|null
condition|)
block|{
comment|// don't wait for seqNumAssignedLatch if writeEntry is preassigned
return|return
name|this
operator|.
name|preAssignedWriteEntry
...
block|}
block|}
comment|/**    * @return The preassigned writeEntry, if any    */
annotation|@
name|InterfaceAudience
operator|.
name|Private
...
return|;
block|}
comment|/**    * Preassign writeEntry    * @param writeEntry the entry to assign    */
annotation|@
name|InterfaceAudience
operator|.
name|Private
