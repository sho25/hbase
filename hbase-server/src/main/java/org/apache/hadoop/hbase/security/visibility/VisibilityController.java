...
condition|)
block|{
comment|// TODO : Cells without visibility tags would be handled in follow up issue
name|Delete
name|d
init|=
operator|(
...
name|IOException
argument_list|(
literal|"Invalid cell visibility expression "
operator|+
name|labelsExp
argument_list|,
name|e
...
literal|null
decl_stmt|;
comment|// If a super user issues a scan, he should be able to scan the cells
comment|// irrespective of the Visibility labels
if|if
condition|(
name|checkIfScanOrGetFromSuperUser
argument_list|()
condition|)
block|{
return|return
...
literal|null
decl_stmt|;
comment|// If a super user issues a get, he should be able to scan the cells
comment|// irrespective of the Visibility labels
if|if
condition|(
name|checkIfScanOrGetFromSuperUser
