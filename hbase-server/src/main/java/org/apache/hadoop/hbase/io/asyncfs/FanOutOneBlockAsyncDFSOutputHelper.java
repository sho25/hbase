...
decl_stmt|;
comment|// StorageType enum is placed under o.a.h.hdfs in hadoop 2.6 and o.a.h.fs in hadoop 2.7. So here
comment|// we need to use reflection to set it.See createStorageTypeSetter for more details.
specifier|private
interface|interface
...
decl_stmt|;
comment|// helper class for calling add block method on namenode. There is a addBlockFlags parameter for
comment|// hadoop 2.8 or later. See createBlockAdder for more details.
specifier|private
interface|interface
name|BlockAdder
block|{
...
name|PB_HELPER
decl_stmt|;
comment|// helper class for creating data checksum.
specifier|private
interface|interface
...
specifier|static
name|PipelineAckStatusGetter
name|createPipelineAckStatusGetter27
parameter_list|()
throws|throws
name|NoSuchMethodException
block|{
...
name|msg
init|=
literal|"Couldn't properly initialize the PipelineAck.ECN class. Please "
operator|+
...
specifier|static
name|PipelineAckStatusGetter
name|createPipelineAckStatusGetter26
parameter_list|()
throws|throws
name|NoSuchMethodException
block|{
...
name|NoSuchMethodException
argument_list|(
literal|"Can not find addBlock method in ClientProtocol"
argument_list|)
throw|;
block|}
specifier|private
...
name|NoSuchMethodException
argument_list|(
literal|"Can not find createChecksum method in DfsClientConf"
argument_list|)
throw|;
block|}
specifier|private
...
name|forName
argument_list|(
literal|"org.apache.hadoop.hdfs.client.impl.DfsClientConf"
argument_list|)
argument_list|)
return|;
block|}
...
name|debug
argument_list|(
literal|"No DfsClientConf class found, should be hadoop 2.7-"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|forName
argument_list|(
literal|"org.apache.hadoop.hdfs.DFSClient$Conf"
argument_list|)
argument_list|)
return|;
block|}
