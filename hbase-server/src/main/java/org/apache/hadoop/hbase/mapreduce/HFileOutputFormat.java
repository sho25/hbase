...
specifier|final
name|String
name|DATABLOCK_ENCODING_CONF_KEY
init|=
...
argument_list|(
literal|"Invalid data block encoding type configured for the param "
operator|+
name|DATABLOCK_ENCODING_CONF_KEY
operator|+
literal|" : "
...
expr_stmt|;
block|}
comment|/**    * Serialize column family to bloom type map to configuration.    * Invoked while configuring the MR job for incremental load.    *    * @throws IOException    *           on failure to read column family descriptors    */
specifier|static
name|void
name|configureBloomType
parameter_list|(
