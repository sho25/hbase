...
return|;
block|}
comment|/**    * @return undeletedHFileRefsQueue replicator with its undeleted queueIds for removed peers in    *         hfile-refs queue    */
specifier|public
name|Set
argument_list|<
name|String
...
expr_stmt|;
block|}
comment|/**      * @param replicator The regionserver which has undeleted queue      * @param queueId The undeleted queue id      */
name|void
name|removeQueue
parameter_list|(
specifier|final
