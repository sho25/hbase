...
return|;
block|}
comment|/**    * It removes recovering regions under /hbase/recovering-regions/[encoded region name] so that the    * region server hosting the region can allow reads to the recovered region    * @param serverNames servers which are just recovered    */
specifier|private
name|void
name|removeRecoveringRegionsFromZK
parameter_list|(
...
name|ServerName
argument_list|>
name|previouslyFailedDeletoins
init|=
literal|null
decl_stmt|;
if|if
