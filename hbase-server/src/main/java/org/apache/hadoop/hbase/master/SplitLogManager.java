...
return|;
block|}
comment|/**    * This function is to set recovery mode from outstanding split log tasks from before or    * current configuration setting    * @param isForInitialization    * @throws KeeperException    * @throws InterruptedIOException    */
specifier|public
name|void
name|setRecoveryMode
parameter_list|(
