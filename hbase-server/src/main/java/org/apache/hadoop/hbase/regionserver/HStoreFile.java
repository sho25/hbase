...
return|;
block|}
comment|/**    * Opens reader on this store file. Called by Constructor.    * @throws IOException    * @see #closeStoreFile(boolean)    */
specifier|private
name|void
name|open
parameter_list|()
...
argument_list|)
decl_stmt|;
comment|//Add reader once the scanner is created
name|streamReaders
operator|.
name|add
argument_list|(
...
control|)
block|{
comment|//closing the reader will remove itself from streamReaders thanks to the Listener
name|entry
operator|.
name|close
argument_list|(
...
literal|0
argument_list|,
literal|"There are still streamReaders post close: "
operator|+
name|size
argument_list|)
expr_stmt|;
