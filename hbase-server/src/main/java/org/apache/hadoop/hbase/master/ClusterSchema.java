...
literal|1000
decl_stmt|;
comment|/**    * Utility method that will wait {@link #HBASE_MASTER_CLUSTER_SCHEMA_OPERATION_TIMEOUT_KEY}    * timeout and if exceptions, THROWs the exception doing conversion so palatable outside Master:    * i.e. {@link InterruptedException} becomes {@link InterruptedIOException} and so on.    *    *<<Utility>>    *    * @param future Future to wait on.    * @return On completion, info on the procedure that ran.    * @throws IOException    */
comment|// TODO: Where to put this utility? It goes away?
name|ProcedureInfo
name|get
parameter_list|(
specifier|final
...
name|IOException
function_decl|;
comment|/**    * Get all Namespaces    * @return All Namespace descriptors    * @throws IOException    */
name|List
argument_list|<
name|NamespaceDescriptor
argument_list|>
