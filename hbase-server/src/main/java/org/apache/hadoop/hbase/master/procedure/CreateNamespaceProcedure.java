...
return|;
block|}
comment|/**    * Action before any real action of creating namespace.    * @param env MasterProcedureEnv    */
specifier|private
name|boolean
name|prepareCreate
parameter_list|(
...
return|;
block|}
comment|/**    * Set quota for the namespace    * @param env MasterProcedureEnv    * @param nsDescriptor NamespaceDescriptor    **/
specifier|private
specifier|static
name|void
name|setNamespaceQuota
