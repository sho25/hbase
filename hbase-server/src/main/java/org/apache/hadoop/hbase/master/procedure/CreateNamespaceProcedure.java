...
name|warn
argument_list|(
literal|"Error trying to create the namespace"
operator|+
name|nsDescriptor
operator|.
name|getName
...
name|CREATE_NAMESPACE_INSERT_INTO_NS_TABLE
case|:
name|rollbackInsertIntoNSTable
argument_list|(
name|env
argument_list|)
expr_stmt|;
...
name|state
operator|+
literal|" for creating the namespace "
operator|+
name|nsDescriptor
operator|.
name|getName
...
expr_stmt|;
block|}
comment|/**    * undo create directory    * @param env MasterProcedureEnv    * @throws IOException    */
specifier|private
name|void
name|rollbackCreateDirectory
parameter_list|(
...
name|debug
argument_list|(
literal|"Rollback of createDirectory throws exception: "
operator|+
name|e
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|/**    * Undo the insert.    * @param env MasterProcedureEnv    * @throws IOException    */
specifier|private
name|void
name|rollbackInsertIntoNSTable
parameter_list|(
...
name|debug
argument_list|(
literal|"Rollback of insertIntoNSTable throws exception: "
operator|+
name|e
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"Rollback of updateZKNamespaceManager throws exception: "
operator|+
name|e
argument_list|)
expr_stmt|;
