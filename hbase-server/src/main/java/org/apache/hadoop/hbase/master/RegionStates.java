...
return|;
block|}
comment|/**    * Add a region to RegionStates with the specified state.    * If the region is already in RegionStates, this call has    * no effect, and the original state is returned.    */
specifier|public
specifier|synchronized
name|RegionState
name|createRegionState
