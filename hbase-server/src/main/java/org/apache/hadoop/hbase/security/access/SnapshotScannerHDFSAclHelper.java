...
init|=
literal|"hbase.user.scan.snapshot.enable"
decl_stmt|;
specifier|public
specifier|static
specifier|final
name|String
name|USER_SCAN_SNAPSHOT_THREAD_NUMBER
init|=
literal|"hbase.user.scan.snapshot.thread.number"
decl_stmt|;
...
init|=
literal|"hbase.user.scan.snapshot.common.directory.permission"
decl_stmt|;
...
init|=
literal|"hbase.user.scan.snapshot.restore.directory.permission"
decl_stmt|;
...
block|}
block|}
comment|/**    * Reset acl when truncate table    * @param tableName the specific table    * @return false if an error occurred, otherwise true    */
specifier|public
name|boolean
name|resetTableAcl
parameter_list|(
...
argument_list|()
decl_stmt|;
comment|// global and namespace user permission can be inherited from default acl automatically
name|setTableAcl
argument_list|(
name|tableName
argument_list|,
...
name|info
argument_list|(
literal|"Set HDFS acl when truncate {}, cost {} ms"
argument_list|,
name|tableName
argument_list|,
name|System
...
name|error
argument_list|(
literal|"Set HDFS acl error when truncate {}"
argument_list|,
name|tableName
argument_list|,
name|e
...
argument_list|)
decl_stmt|;
comment|// If table has no snapshots, then remove archive ns HDFS acl, otherwise reserve the archive
comment|// ns acl to make the snapshots can be scanned, in the second case, need to remove the archive
comment|// ns acl when all snapshots of the deleted table are deleted (will do it in later work).
if|if
condition|(
...
name|error
argument_list|(
literal|"Set HDFS acl error when delete table {}"
argument_list|,
name|tableName
argument_list|,
name|e
...
block|}
block|}
comment|/**    * Set table owner acl when create table    * @param tableName the table    * @param user the table owner    * @return false if an error occurred, otherwise true    */
specifier|public
name|boolean
name|addTableAcl
parameter_list|(
...
name|info
argument_list|(
literal|"Set HDFS acl when create table {}, cost {} ms"
argument_list|,
name|tableName
argument_list|,
name|System
...
name|error
argument_list|(
literal|"Set HDFS acl error when create table {}"
argument_list|,
name|tableName
argument_list|,
name|e
...
return|;
block|}
comment|/**    * return paths that user will namespace permission will visit    * @param namespace the namespace    * @return the path list    * @throws IOException if an error occurred    */
name|List
argument_list|<
name|Path
argument_list|>
...
return|;
block|}
comment|/**    * Return users with namespace read permission    * @param namespace the namespace    * @return users with namespace read permission    * @throws IOException if an error occurred    */
specifier|private
name|Set
argument_list|<
name|String
...
return|;
block|}
comment|/**    * Return users with table read permission    * @param tableName the table    * @return users with table read permission    * @throws IOException if an error occurred    */
specifier|private
name|Set
argument_list|<
name|String
