...
throw|;
block|}
comment|/**    * Gets incremental restore service    * @param conf - configuration    * @return incremental backup service instance    */
specifier|public
specifier|static
...
return|;
block|}
comment|/**    * Gets backup copy service    * @param conf - configuration    * @return backup copy service    */
specifier|public
specifier|static
