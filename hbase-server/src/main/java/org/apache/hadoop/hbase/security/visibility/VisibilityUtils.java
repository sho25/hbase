...
return|;
block|}
comment|/**    * Get the super users and groups defined in the configuration.    * The user running the hbase server is always included.    * @param conf    * @return Pair of super user list and super group list.    * @throws IOException    */
specifier|public
specifier|static
name|Pair
argument_list|<
