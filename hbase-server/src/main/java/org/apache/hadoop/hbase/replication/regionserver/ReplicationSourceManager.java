...
block|}
block|}
name|AdoptAbandonedQueuesWorker
name|adoptionWorker
init|=
operator|new
name|AdoptAbandonedQueuesWorker
...
name|info
argument_list|(
literal|"Cancelling the adoption of abandoned queues because of "
operator|+
name|ex
operator|.
name|getMessage
...
block|}
block|}
comment|/**    * Add sources for the given peer cluster on this region server. For the newly added peer, we only    * need to enqueue the latest log of each wal group and do replication    * @param id the id of the peer cluster    * @return the source that was created    * @throws IOException    */
specifier|protected
name|ReplicationSourceInterface
name|addSource
parameter_list|(
