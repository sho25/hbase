...
name|warn
argument_list|(
literal|"pid={}, split is disabled for the table! Skipping split of {}"
argument_list|,
name|getProcId
argument_list|()
argument_list|,
...
argument_list|()
operator|+
literal|" failed as region split is disabled for the table"
argument_list|)
argument_list|)
expr_stmt|;
return|return
