...
condition|)
block|{
comment|// Wait till at least another regionserver is up besides the active master
comment|// so that we don't assign all regions to the active master.
comment|// This is best of efforts, because newly joined regionserver
comment|// could crash right after that.
name|Thread
operator|.
name|sleep
argument_list|(
