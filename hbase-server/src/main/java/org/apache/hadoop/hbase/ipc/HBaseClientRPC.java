...
begin_comment
comment|/**  * An RPC implementation. This class provides the client side implementation.  */
end_comment
...
return|;
block|}
comment|/**    * @param protocol      protocol interface    * @param clientVersion which client version we expect    * @param addr          address of remote service    * @param conf          configuration    * @param maxAttempts   max attempts    * @param rpcTimeout    timeout for each RPC    * @param timeout       timeout in milliseconds    * @return proxy    * @throws java.io.IOException e    */
annotation|@
...
return|;
block|}
comment|/**    * Construct a client-side proxy object with the default SocketFactory    *    * @param protocol      interface    * @param clientVersion version we are expecting    * @param addr          remote address    * @param conf          configuration    * @param rpcTimeout    timeout for each RPC    * @return a proxy instance    * @throws java.io.IOException e    */
specifier|public
specifier|static
name|VersionedProtocol
name|getProxy
