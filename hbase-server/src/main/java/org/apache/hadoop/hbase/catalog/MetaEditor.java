...
expr_stmt|;
block|}
comment|/**    * Delete the passed<code>deletes</code> from the<code>.META.</code> table.    * @param ct CatalogTracker on whose back we will ride the edit.    * @param deletes Deletes to add to .META.    * @throws IOException    */
specifier|static
name|void
name|deleteFromMetaTable
parameter_list|(
