...
return|;
block|}
comment|/**    * Returns the daughter regions by reading from the corresponding columns of the .META. table    * Result. If the region is not a split parent region, it returns PairOfSameType(null, null).    */
specifier|public
specifier|static
name|PairOfSameType
argument_list|<
