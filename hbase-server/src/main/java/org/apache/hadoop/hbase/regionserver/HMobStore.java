...
name|tableLockName
argument_list|,
literal|"Major compaction in HMobStore"
argument_list|)
expr_stmt|;
block|}
name|boolean
...
name|info
argument_list|(
literal|"Start to acquire a read lock for the table["
operator|+
name|tableName
operator|+
...
name|error
argument_list|(
literal|"Fail to lock the table "
operator|+
name|tableName
argument_list|,
name|e
...
block|{
comment|// If the tableLockManager is null, mark the tableLocked as true.
name|tableLocked
operator|=
literal|true
expr_stmt|;
...
name|warn
argument_list|(
literal|"Cannot obtain the table lock, maybe a sweep tool is running on this table["
operator|+
name|tableName
operator|+
