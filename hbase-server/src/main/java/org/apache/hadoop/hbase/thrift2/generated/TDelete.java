...
argument_list|,
operator|new
name|TDeleteStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|TDeleteTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field deleteType is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetDeleteType
parameter_list|()
