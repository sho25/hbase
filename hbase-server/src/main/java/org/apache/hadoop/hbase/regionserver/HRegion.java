...
return|;
block|}
comment|/**    * Only for the purpose of testing    * @param clock    */
annotation|@
name|VisibleForTesting
specifier|public
name|void
...
return|;
block|}
comment|/*    * Clients use physical timestamps when setting time ranges. Tables that use HLCs must map the    * physical timestamp to HLC time    */
specifier|private
name|void
name|mapTimeRangesWithRespectToClock
parameter_list|(
name|Scan
name|scan
parameter_list|)
...
argument_list|()
decl_stmt|;
comment|// Clip time range max to prevent overflow when converting from epoch time to timestamp time
name|long
name|trMaxClipped
init|=
name|Math
