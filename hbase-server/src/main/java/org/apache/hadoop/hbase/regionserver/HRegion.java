...
argument_list|()
argument_list|,
name|getWALRegionDirOfDefaultReplica
argument_list|()
argument_list|)
decl_stmt|;
name|nextSeqId
...
return|;
block|}
comment|/**    * @return the Region directory under WALRootDirectory; in case of secondary replica return the    *         region directory corresponding to its default replica    * @throws IOException if there is an error getting WALRootDir    */
specifier|private
name|Path
name|getWALRegionDirOfDefaultReplica
parameter_list|()
...
name|error
argument_list|(
literal|"Failed delete of {} from under the root directory."
argument_list|,
name|file
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"Deleted recovered.edits under root directory. file="
operator|+
name|file
argument_list|)
expr_stmt|;
