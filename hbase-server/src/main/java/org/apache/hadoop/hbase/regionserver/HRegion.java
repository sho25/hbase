...
comment|// StoreFiles per family and there will be no reference store
name|Map
argument_list|<
name|byte
index|[]
...
argument_list|()
decl_stmt|;
comment|// Move StoreFiles under new region directory
name|regionFs
operator|.
...
expr_stmt|;
block|}
comment|// Create HRegion and update the metrics
name|HRegion
name|dstRegion
init|=
name|HRegion
