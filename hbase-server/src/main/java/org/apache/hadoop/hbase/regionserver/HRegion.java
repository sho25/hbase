...
expr_stmt|;
block|}
comment|/**    * @param op The operation is about to be taken on the region    * @throws NotServingRegionException    * @throws RegionTooBusyException    * @throws InterruptedIOException    */
specifier|protected
name|void
name|startRegionOperation
parameter_list|(
...
block|}
block|}
comment|/**    * This function is used to construct replay mutations from WALEdits    * @param entries    * @param cells    * @param clusterId    * @param logEntries List of Pair<HLogKey, WALEdit> contructed from its PB version - WALEntry    *          instances    * @return list of Pair<MutationType, Mutation> to be replayed    * @throws IOException    */
name|List
argument_list|<
name|Pair
argument_list|<
