...
block|{
comment|// repeated .Mutate mutatationRequest = 1;
name|java
operator|.
name|util
operator|.
...
function_decl|;
name|int
name|getMutatationRequestCount
parameter_list|()
function_decl|;
name|java
operator|.
...
argument_list|>
name|getMutatationRequestOrBuilderList
parameter_list|()
function_decl|;
name|org
operator|.
...
operator|.
name|MutateOrBuilder
name|getMutatationRequestOrBuilder
parameter_list|(
name|int
name|index
parameter_list|)
...
specifier|final
name|int
name|MUTATATIONREQUEST_FIELD_NUMBER
init|=
literal|1
decl_stmt|;
specifier|private
...
condition|)
block|{
name|getMutatationRequestFieldBuilder
argument_list|()
expr_stmt|;
block|}
block|}
...
if|if
condition|(
name|mutatationRequestBuilder_
operator|==
literal|null
condition|)
block|{
...
block|{
name|ensureMutatationRequestIsMutable
argument_list|()
expr_stmt|;
name|mutatationRequest_
operator|.
...
operator|.
name|Builder
name|getMutatationRequestBuilder
parameter_list|(
name|int
name|index
parameter_list|)
...
operator|.
name|Builder
name|addMutatationRequestBuilder
parameter_list|()
block|{
return|return
name|getMutatationRequestFieldBuilder
...
name|Builder
argument_list|>
name|getMutatationRequestBuilderList
parameter_list|()
block|{
return|return
name|getMutatationRequestFieldBuilder
...
operator|+
literal|"t\030\001 \003(\0132\007.Mutate\"\025\n\023MultiMutateResponse2"
operator|+
literal|"R\n\027MultiRowMutationService\0227\n\nmutateRows"
operator|+
literal|"\022\023.MultiMutateRequest\032\024.MultiMutateRespo"
operator|+
literal|"nseBF\n*org.apache.hadoop.hbase.protobuf."
operator|+
literal|"generatedB\020MultiRowMutationH\001\210\001\001\240\001\001"
block|}
decl_stmt|;
name|com
operator|.
