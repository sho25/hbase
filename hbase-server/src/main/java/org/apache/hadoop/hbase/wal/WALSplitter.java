...
if|if
condition|(
name|isTableDisabledOrDisabling
argument_list|(
name|buffer
operator|.
name|tableName
...
condition|)
block|{
comment|// skip the whole WAL entry
name|this
operator|.
name|skippedEdits
operator|.
...
argument_list|)
expr_stmt|;
comment|// We should already have control of the monitor; ensure this is the case.
synchronized|synchronized
init|(
name|controller
operator|.
...
literal|false
return|;
comment|// we can't get state without CoordinatedStateManager
if|if
condition|(
name|tableName
operator|.
...
literal|false
return|;
comment|// assume that system tables never can be disabled
name|TableState
name|tableState
init|=
name|tableStatesCache
...
name|warn
argument_list|(
literal|"State is not accessible for table "
operator|+
name|tableName
argument_list|,
name|e
