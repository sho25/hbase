...
return|;
block|}
comment|/**    * @param table the table to load into    * @param pool the ExecutorService    * @param queue the queue for LoadQueueItem    * @param startEndKeys start and end keys    * @return A map that groups LQI by likely bulk load region targets and List of missing hfiles.    */
specifier|private
name|Pair
argument_list|<
name|Multimap
