...
argument_list|)
expr_stmt|;
comment|// TODO :change here after Bufferbackedcells come
name|keyOnlyKv
operator|.
name|setKey
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// TODO : change here after BufferBacked cells come
return|return
name|ByteBuffer
operator|.
name|wrap
...
name|IllegalStateException
argument_list|(
literal|"Scanner works only on data "
operator|+
literal|"blocks, got "
operator|+
name|block
...
argument_list|)
expr_stmt|;
comment|// Create a KeyOnlyKv now.
comment|// TODO : Will change when Buffer backed cells come
return|return
operator|new
name|KeyValue
operator|.
