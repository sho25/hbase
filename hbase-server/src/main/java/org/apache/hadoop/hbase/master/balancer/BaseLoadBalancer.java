...
argument_list|()
expr_stmt|;
comment|// We want to find server with non zero regions having lowest locality.
name|int
name|i
init|=
literal|0
...
name|warn
argument_list|(
literal|"Region location finder found null, skipping locality calculations."
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|slop
decl_stmt|;
comment|// overallSlop to controll simpleLoadBalancer's cluster level threshold
specifier|protected
name|float
name|overallSlop
decl_stmt|;
...
return|;
block|}
comment|/**    * Assign the regions that should be on master regionserver.    */
specifier|protected
name|Map
argument_list|<
name|ServerName
