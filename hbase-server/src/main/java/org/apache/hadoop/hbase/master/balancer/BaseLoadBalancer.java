...
decl_stmt|;
comment|// tableIndex -> number of regions that table has
name|int
index|[]
...
block|}
block|}
comment|/**      * Returns the minimum number of regions of a table T each server would store if T were      * perfectly distributed (i.e. round-robin-ed) across the cluster      */
specifier|public
name|int
...
return|;
block|}
comment|/**      * Returns the maximum number of regions of a table T each server would store if T were      * perfectly distributed (i.e. round-robin-ed) across the cluster      */
specifier|public
name|int
...
return|;
block|}
comment|/**      * Returns the number of servers that should hold maxRegionsIfEvenlyDistributed for a given      * table. A special case here is if maxRegionsIfEvenlyDistributed == minRegionsIfEvenlyDistributed,      * in which case all servers should hold the max      */
specifier|public
name|int
...
block|}
block|}
comment|/**      * Returns true iff at least one server in the cluster stores either more than the min/max load      * per server when all regions are evenly distributed across the cluster      */
specifier|public
name|boolean
...
return|;
block|}
comment|/**      * Returns a pair where the first server is that with the least number of regions across the      * cluster and the second server is that with the most number of regions across the cluster      */
specifier|public
name|Pair
argument_list|<
name|Integer
...
operator|++
expr_stmt|;
comment|// if old server had max num regions, assume (for now)
comment|// max num regions went down since we moved the region
if|if
condition|(
name|oldServer
operator|>=
...
expr_stmt|;
block|}
comment|// Now check if new server sets new max
name|numMaxRegionsPerTable
index|[
name|tableIndex
index|]
