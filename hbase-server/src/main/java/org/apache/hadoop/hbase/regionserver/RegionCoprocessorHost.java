...
parameter_list|()
block|{
comment|// do not allow seqId update.
...
expr_stmt|;
block|}
comment|/**    * @param familyPaths pairs of { CF, file path } submitted for bulk load    * @param map Map of CF to List of file paths for the final loaded files    * @param result whether load was successful or not    * @return the possibly modified value of hasLoaded    * @throws IOException    */
specifier|public
name|boolean
