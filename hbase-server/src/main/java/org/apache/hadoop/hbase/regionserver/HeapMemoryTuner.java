...
begin_comment
comment|/**  * Makes the decision regarding proper sizing of the heap memory. Decides what percentage of heap  * memory should be allocated for global memstore and BlockCache.  */
end_comment
