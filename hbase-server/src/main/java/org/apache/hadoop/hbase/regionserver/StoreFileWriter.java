...
expr_stmt|;
block|}
comment|/**    * Writes meta data.    * Call before {@link #close()} since its written as meta data to this file.    * @param maxSequenceId Maximum sequence id.    * @param majorCompaction True if this file is product of a major compaction    * @param storeFiles The compacted store files to generate this new file    * @throws IOException problem writing to FS    */
specifier|public
name|void
name|appendMetadata
parameter_list|(
...
name|String
argument_list|>
name|notArchivedCompactedStoreFiles
init|=
name|this
operator|.
name|compactedFilesSupplier
...
expr_stmt|;
block|}
comment|/**    * Appends MOB - specific metadata (even if it is empty)    * @param mobRefSet - set of MOB file names    * @throws IOException problem writing to FS    */
specifier|public
name|void
