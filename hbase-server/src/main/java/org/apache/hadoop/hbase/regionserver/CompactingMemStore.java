...
argument_list|()
expr_stmt|;
comment|// for all segments in the pipeline
name|order
operator|+=
name|snapshot
operator|.
...
argument_list|()
expr_stmt|;
comment|// for all segments in the snapshot
comment|// TODO: check alternatives to using this order
comment|// The list of elements in pipeline + the active element + the snapshot segments
