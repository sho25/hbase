...
condition|)
block|{
comment|// if the new metric is swept off by lossyCounting then don't add in the map
name|metersToBeRemoved
operator|.
name|remove
argument_list|(
...
block|{
comment|// else register the new metric and add in the map
name|registry
operator|.
name|meter
argument_list|(
...
control|)
block|{
comment|//cleanup requestsMap according to the swept data from lossy count;
name|requestsMap
operator|.
name|remove
argument_list|(
...
argument_list|)
decl_stmt|;
name|registerAndMarkMeterIfNotPresent
argument_list|(
name|tableRequestMeter
argument_list|)
expr_stmt|;
