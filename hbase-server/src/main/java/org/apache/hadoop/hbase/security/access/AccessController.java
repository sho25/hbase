...
literal|null
argument_list|,
literal|"ZKPermissionWatcher is null"
argument_list|)
expr_stmt|;
name|Preconditions
operator|.
...
name|IOException
block|{
comment|/* always allow namespace listing */
block|}
annotation|@
name|Override
specifier|public
...
name|format
argument_list|(
literal|"This method can only execute at the table specified in "
operator|+
literal|"TablePermission. Table of the region:%s , requested table:%s"
argument_list|,
name|tableName
argument_list|,
name|tperm
...
argument_list|)
expr_stmt|;
comment|//todo: should add check for table existence
block|}
annotation|@
name|Override
specifier|public
...
argument_list|)
argument_list|,
literal|"getConfiguredNamespacesAndTablesInRSGroup"
argument_list|,
literal|null
argument_list|,
name|Permission
