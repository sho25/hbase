...
return|;
block|}
comment|/**    * Authorizes that the current user has "admin" privileges for the given table.    * that means he/she can edit/modify/delete the table.    * If current user is the table owner, and has CREATE permission,    * then he/she has table admin permission. otherwise ADMIN rights are checked.    * @param e Coprocessor environment    * @param tableName Table requested    * @throws IOException if obtaining the current user fails    * @throws AccessDeniedException if authorization is denied    */
specifier|private
name|void
name|requireTableAdminPermission
parameter_list|(
name|CoprocessorEnvironment
name|e
parameter_list|,
...
literal|null
decl_stmt|;
comment|// Table admins are allowed to perform DDL
if|if
condition|(
name|authManager
operator|.
...
condition|)
block|{
comment|// Table owners with Create permission are allowed to perform DDL
if|if
condition|(
name|authManager
operator|.
...
name|allow
argument_list|(
literal|"Owner has table permission"
argument_list|,
name|user
argument_list|,
name|TablePermission
...
block|{
comment|// Table owners without Create permission cannot perform DDL
name|result
operator|=
name|AuthResult
operator|.
