...
specifier|final
name|String
name|REST_SPNEGO_PRINCIPAL_KEY
init|=
literal|"hbase.rest.kerberos.spnego.principal"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|String
name|REST_PRINCIPAL_KEY
init|=
...
name|REST_SPNEGO_PRINCIPAL_KEY
operator|+
literal|" should be set if authentication is enabled"
argument_list|)
expr_stmt|;
name|params
operator|.
