...
condition|)
block|{
comment|// Assumes now and timestamp should be of same type. It should be the case.
comment|// Else there is something wrong. if it happens in tests, tests should be rewritten.
if|if
condition|(
name|TimestampType
operator|.
