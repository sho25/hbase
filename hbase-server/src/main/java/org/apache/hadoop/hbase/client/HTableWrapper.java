...
condition|)
block|{
comment|// We don't support his combination.  In HTable, the implementation is this:
comment|//
comment|// this.clearBufferOnFail = autoFlush || clearBufferOnFail
comment|//
comment|// So if autoFlush == false and clearBufferOnFail is false, that is not supported in
comment|// the new Table Interface so just throwing UnsupportedOperationException here.
throw|throw
operator|new
name|UnsupportedOperationException
argument_list|(
literal|"Can't do this via wrapper"
argument_list|)
throw|;
block|}
block|}
