...
argument_list|(
literal|"Can not find suitable getInstance method in CryptoCodec"
argument_list|)
throw|;
block|}
name|CREATE_CODEC
...
specifier|static
name|TransparentCryptoHelper
name|createTransparentCryptoHelper25
parameter_list|()
block|{
return|return
operator|new
...
specifier|final
name|Method
name|getFileEncryptionInfoMethod
init|=
name|HdfsFileStatus
operator|.
name|class
...
name|?
argument_list|>
name|keyVersionClass
init|=
name|Class
operator|.
name|forName
argument_list|(
literal|"org.apache.hadoop.crypto.key.KeyProvider$KeyVersion"
argument_list|)
decl_stmt|;
specifier|final
name|Method
name|getMaterialMethod
init|=
name|keyVersionClass
operator|.
name|getMethod
...
name|forName
argument_list|(
literal|"org.apache.hadoop.fs.FileEncryptionInfo"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|debug
argument_list|(
literal|"No FileEncryptionInfo class found, should be hadoop 2.5-"
argument_list|,
name|e
argument_list|)
expr_stmt|;
