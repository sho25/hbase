...
specifier|static
name|TransparentCryptoHelper
name|createTransparentCryptoHelperWithoutHDFS12396
parameter_list|()
throws|throws
name|NoSuchMethodException
block|{
...
specifier|static
name|TransparentCryptoHelper
name|createTransparentCryptoHelperWithHDFS12396
parameter_list|()
throws|throws
...
name|debug
argument_list|(
literal|"No decryptEncryptedDataEncryptionKey method in DFSClient,"
operator|+
literal|" should be hadoop version with HDFS-12396"
argument_list|,
name|e
argument_list|)
expr_stmt|;
