...
block|}
block|}
comment|/**    * Delete the master znode if its content (ServerName string) is the same    *  as the one in the znode file. (env: HBASE_ZNODE_FILE).    * @return true on successful deletion, false otherwise.    */
specifier|public
specifier|static
name|boolean
name|clear
