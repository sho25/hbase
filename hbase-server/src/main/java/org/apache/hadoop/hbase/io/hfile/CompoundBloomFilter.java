...
argument_list|)
decl_stmt|;
comment|// This copy will be needed. Because blooms work on the key part only.
comment|// Atleast we now avoid multiple copies until it comes here. If we want to make this to work
comment|// with BBs then the Hash.java APIs should also be changed to work with BBs.
if|if
condition|(
name|keyCell
operator|instanceof
