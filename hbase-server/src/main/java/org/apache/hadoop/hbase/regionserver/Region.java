...
name|IOException
function_decl|;
comment|/**    * Atomically checks if a row matches the filter and if it does, it performs the mutation. See    * checkAndRowMutate to do many checkAndPuts at a time on a single row.    * @param row to check    * @param filter the filter    * @param mutation data to put if check succeeds    * @return true if mutation was applied, false otherwise    */
specifier|default
name|boolean
name|checkAndMutate
parameter_list|(
...
return|;
block|}
comment|/**    * Atomically checks if a row value matches the filter and if it does, it performs the mutation.    * See checkAndRowMutate to do many checkAndPuts at a time on a single row.    * @param row to check    * @param filter the filter    * @param mutation data to put if check succeeds    * @param timeRange time range to check    * @return true if mutation was applied, false otherwise    */
name|boolean
name|checkAndMutate
parameter_list|(
name|byte
...
name|IOException
function_decl|;
comment|/**    * Atomically checks if a row matches the filter and if it does, it performs the row mutations.    * Use to do many mutations on a single row. Use checkAndMutate to do one checkAndMutate at a    * time.    * @param row to check    * @param filter the filter    * @param mutations data to put if check succeeds    * @return true if mutations were applied, false otherwise    */
specifier|default
name|boolean
name|checkAndRowMutate
parameter_list|(
...
return|;
block|}
comment|/**    * Atomically checks if a row matches the filter and if it does, it performs the row mutations.    * Use to do many mutations on a single row. Use checkAndMutate to do one checkAndMutate at a    * time.    * @param row to check    * @param filter the filter    * @param mutations data to put if check succeeds    * @param timeRange time range to check    * @return true if mutations were applied, false otherwise    */
name|boolean
name|checkAndRowMutate
parameter_list|(
name|byte
