...
argument_list|>
block|{
comment|/**    *  Changes prior to version 3 were not recorded here.    *  Version 3 adds metadata as a map where keys and values are byte[].    *  Version 4 adds indexes    *  Version 5 removed transactional pollution -- e.g. indexes    *  Version 6 changed metadata to BytesBytesPair in PB    */
specifier|private
specifier|static
specifier|final
name|byte
