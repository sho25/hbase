...
name|Cacheable
block|{
comment|/** Minor versions starting with this number have hbase checksums */
specifier|static
specifier|final
name|int
...
literal|1
decl_stmt|;
comment|/** minor version that does not support checksums */
specifier|static
specifier|final
name|int
...
argument_list|)
decl_stmt|;
comment|// minorVersion+offset+nextBlockOnDiskSizeWithHeader
specifier|public
specifier|static
specifier|final
name|int
...
decl_stmt|;
comment|/** The Type of checksum, better to store the byte than an object */
specifier|private
specifier|final
name|byte
name|checksumType
decl_stmt|;
comment|/** The number of bytes for which a checksum is computed */
specifier|private
specifier|final
name|int
...
decl_stmt|;
comment|/** The minor version of the hfile. */
specifier|private
specifier|final
name|int
name|minorVersion
...
name|buf
decl_stmt|;
comment|/** Whether there is a memstore timestamp after every key/value */
specifier|private
name|boolean
...
comment|// bytePerChecksum,  onDiskDataSize and minorVersion
literal|6
operator|*
name|Bytes
operator|.
...
name|SIZEOF_LONG
operator|+
comment|// "Include memstore timestamp" flag
name|Bytes
operator|.
name|SIZEOF_BOOLEAN
argument_list|)
...
name|fileSize
decl_stmt|;
comment|/** The minor version of this reader */
specifier|private
name|int
name|minorVersion
decl_stmt|;
