...
return|;
block|}
comment|/**    * Returns a new encoding context given the inCache encoding scheme provided in the constructor.    * This used to be kept around but HFileBlockDefaultEncodingContext isn't thread-safe.    * See HBASE-8732    * @return a new in cache encoding context    */
specifier|private
name|HFileBlockEncodingContext
name|createInCacheEncodingContext
parameter_list|(
