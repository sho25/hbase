...
name|debug
argument_list|(
literal|"Exception while closing the writer :"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|// Skip the unit tests which create a splitter that reads and writes
comment|// the
comment|// data without touching disk. TestHLogSplit#testThreading is an
comment|// example.
if|if
condition|(
name|fs
...
block|}
comment|// Skip the unit tests which create a splitter that reads and writes
comment|// the data without touching disk. TestHLogSplit#testThreading is an
comment|// example.
if|if
condition|(
name|fs
