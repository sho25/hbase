...
condition|)
block|{
comment|// During distributed log splitting the output by each
comment|// SplitLogWorker is written to a temporary area.
name|editsfile
operator|=
...
literal|0
decl_stmt|;
comment|/* To check whether a close has already been tried on the      * writer      */
name|boolean
name|writerClosed
init|=
literal|false
