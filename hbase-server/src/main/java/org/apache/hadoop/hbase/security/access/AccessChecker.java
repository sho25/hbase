...
return|;
block|}
comment|/**    * Constructor with existing configuration    *    * @param conf Existing configuration to use    * @param zkw reference to the {@link ZKWatcher}    * @return the AccessChecker instance    */
specifier|public
name|AccessChecker
parameter_list|(
specifier|final
