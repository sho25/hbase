...
name|warn
argument_list|(
literal|"Found table without state "
operator|+
name|table
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Found table with state in descriptor, using that state"
argument_list|)
expr_stmt|;
name|MetaTableAccessor
operator|.
...
name|warn
argument_list|(
literal|"Updating table descriptor"
argument_list|)
expr_stmt|;
name|td
operator|.
...
name|warn
argument_list|(
literal|"Found table with no state in descriptor, assuming ENABLED"
argument_list|)
expr_stmt|;
name|MetaTableAccessor
operator|.
