...
block|}
block|}
comment|/**    * Set table state to provided but only if table in specified states Caller should lock table on    * write.    * @param tableName table to change state for    * @param newState new state    * @param states states to check against    * @return null if succeed or table state if failed    */
specifier|public
name|TableState
...
block|}
block|}
comment|/**    * Set table state to provided but only if table not in specified states Caller should lock table    * on write.    * @param tableName table to change state for    * @param newState new state    * @param states states to check against    */
specifier|public
name|boolean
