...
specifier|final
name|String
name|WAL_PROVIDER_CLASS
init|=
literal|"hbase.wal.provider.class"
decl_stmt|;
end_decl_stmt
...
name|WALProvider
argument_list|>
name|DEFAULT_WAL_PROVIDER_CLASS
init|=
name|AsyncFSWALProvider
operator|.
name|class
...
specifier|final
name|String
name|META_WAL_PROVIDER_CLASS
init|=
literal|"hbase.wal.meta_provider.class"
decl_stmt|;
end_decl_stmt
...
annotation|@
name|VisibleForTesting
comment|/*    * @param clsKey config key for provider classname    * @param key config key for provider enum    * @param defaultValue default value for provider enum    * @return Class which extends WALProvider    */
specifier|public
name|Class
argument_list|<
name|?
...
parameter_list|)
block|{
comment|// try with enum key next
block|}
block|}
try|try
block|{
