...
literal|false
decl_stmt|;
comment|/*    * Some implementations of HBaseInterClusterReplicationEndpoint may require instantiate different    * Connection implementations, or initialize it in a different way, so defining createConnection    * as protected for possible overridings.    */
specifier|protected
name|AsyncClusterConnection
...
return|;
block|}
comment|/*    * Some implementations of HBaseInterClusterReplicationEndpoint may require instantiate different    * ReplicationSinkManager implementations, or initialize it in a different way,    * so defining createReplicationSinkManager as protected for possible overridings.    */
specifier|protected
name|ReplicationSinkManager
name|createReplicationSinkManager
parameter_list|(
name|AsyncClusterConnection
name|conn
parameter_list|)
