...
expr_stmt|;
block|}
comment|/**    * Canary entry point for specified table.    * Keeping this method backward compatibility    * @throws Exception    */
specifier|public
specifier|static
name|void
name|sniff
...
block|}
block|}
comment|/**    * Canary entry point for specified table with task type(read/write)    * Keeping this method backward compatible    * @throws Exception    */
specifier|public
specifier|static
name|void
name|sniff
