...
expr_stmt|;
block|}
comment|/**    * Obtain the list of logs that need to be copied out for this incremental backup. The list is set    * in BackupInfo.    * @param conn the Connection    * @param backupInfo backup info    * @return The new HashMap of RS log timestamps after the log roll for this incremental backup.    * @throws IOException exception    */
specifier|public
name|HashMap
argument_list|<
name|String
...
argument_list|)
decl_stmt|;
name|addLogsFromBackupSystemToContext
argument_list|(
name|logFromSystemTable
argument_list|)
expr_stmt|;
