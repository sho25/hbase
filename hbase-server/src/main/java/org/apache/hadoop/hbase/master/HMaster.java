...
name|assignmentManager
decl_stmt|;
comment|/**    * Cache for the meta region replica's locations. Also tracks their changes to avoid stale    * cache entries.    */
specifier|private
specifier|final
...
block|}
block|}
comment|/**    * Protected to have custom implementations in tests override the default ActiveMaster    * implementation.    */
specifier|protected
name|ActiveMasterManager
name|createActiveMasterManager
parameter_list|(
...
argument_list|()
expr_stmt|;
comment|// This is for backwards compatible. We do not need the CP for rs group now but if user want to
comment|// load it, we need to enable rs group.
name|String
index|[]
name|cpClasses
init|=
...
return|;
block|}
comment|/**    * Checks master state before initiating action over region topology.    * @param action the name of the action under consideration, for logging.    * @return {@code true} when the caller should exit early, {@code false} otherwise.    */
specifier|private
name|boolean
name|skipRegionManagementAction
parameter_list|(
specifier|final
name|String
name|action
...
name|debug
argument_list|(
literal|"Master has not been initialized, don't run {}."
argument_list|,
name|action
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Cluster is shutting down, don't run {}."
argument_list|,
name|action
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Master is in maintenance mode, don't run {}."
argument_list|,
name|action
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|// make one last check that the cluster isn't shutting down before proceeding.
return|return
literal|false
return|;
block|}
