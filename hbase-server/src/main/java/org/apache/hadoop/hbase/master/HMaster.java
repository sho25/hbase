...
argument_list|)
expr_stmt|;
comment|// create the snapshot monitor
comment|// TODO should this be config based?
name|this
operator|.
name|snapshotManager
operator|=
...
argument_list|(
literal|"Enabled table snapshots are not yet supported"
argument_list|)
argument_list|)
throw|;
block|}
...
argument_list|)
decl_stmt|;
comment|// look through all the completed snapshots
for|for
control|(
name|FileStatus
name|snapshot
...
name|e
throw|;
comment|// get the current snapshot and compare it against the requested
name|SnapshotDescription
name|snapshot
init|=
name|sentinel
...
name|debug
argument_list|(
literal|"Have a snapshot to compare:"
operator|+
name|snapshot
argument_list|)
expr_stmt|;
...
begin_comment
comment|/**    * Check to see if the snapshot is one of the currently completed snapshots    * @param expected snapshot to check    * @return<tt>true</tt> if the snapshot is stored on the {@link FileSystem},<tt>false</tt> if is    *         not stored    * @throws IOException if the filesystem throws an unexpected exception    */
end_comment
...
name|UnsupportedOperationException
argument_list|(
literal|"Snapshots restore is not implemented yet."
argument_list|)
argument_list|)
throw|;
block|}
