...
argument_list|)
expr_stmt|;
comment|// check that namespace exists
return|return
name|Lists
operator|.
name|newArrayList
...
return|;
block|}
comment|/**    * Returns the list of table descriptors that match the specified request    *    * @param regex The regular expression to match against, or null if querying for all    * @param tableNameList the list of table names, or null if querying for all    * @param includeSysTables False to match only against userspace tables    * @return the list of table descriptors    */
specifier|public
name|List
argument_list|<
name|HTableDescriptor
...
return|;
block|}
comment|/**    * Returns the list of table names that match the specified request    * @param regex The regular expression to match against, or null if querying for all    * @param includeSysTables False to match only against userspace tables    * @return the list of table names    */
specifier|public
name|List
argument_list|<
name|TableName
