...
expr_stmt|;
block|}
comment|// Start replication zk node cleaner
if|if
condition|(
name|conf
operator|.
...
name|error
argument_list|(
literal|"start replicationZKNodeCleanerChore failed"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
argument_list|)
decl_stmt|;
comment|// TODO: No cleaner currently!
specifier|final
name|Path
name|walArchiveDir
init|=
...
argument_list|()
operator|+
literal|" Dispatch merge regions "
operator|+
name|regionsToMerge
index|[
literal|0
...
block|{
return|return
literal|"DispatchMergingRegionsProcedure"
return|;
block|}
block|}
argument_list|)
...
block|{
return|return
literal|"AddColumnFamilyProcedure"
return|;
block|}
block|}
argument_list|)
...
block|{
return|return
literal|"ModifyColumnFamilyProcedure"
return|;
block|}
block|}
argument_list|)
...
block|{
return|return
literal|"DeleteColumnFamilyProcedure"
return|;
block|}
block|}
argument_list|)
...
name|prefix
argument_list|(
literal|"Unable to add drain for '"
operator|+
name|server
operator|.
name|getServerName
...
name|prefix
argument_list|(
literal|"Unable to list draining servers."
argument_list|)
argument_list|,
name|ke
argument_list|)
expr_stmt|;
block|}
comment|// No nodes is empty draining list or ZK connectivity issues.
if|if
condition|(
name|serverStrs
operator|==
...
return|;
block|}
comment|// Skip invalid ServerNames in result
for|for
control|(
name|String
name|serverStr
...
name|warn
argument_list|(
literal|"Unable to cast '"
operator|+
name|serverStr
operator|+
literal|"' to ServerName."
argument_list|,
name|iae
argument_list|)
expr_stmt|;
...
name|prefix
argument_list|(
literal|"Unable to remove drain for '"
operator|+
name|server
operator|.
name|getServerName
