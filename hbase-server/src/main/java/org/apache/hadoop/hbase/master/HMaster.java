...
name|mobFileCompactChore
decl_stmt|;
name|MasterMobFileCompactionThread
name|mobFileCompactThread
decl_stmt|;
comment|// used to synchronize the mobFileCompactionStates
specifier|private
specifier|final
name|IdLock
name|mobFileCompactionLock
init|=
operator|new
name|IdLock
argument_list|()
decl_stmt|;
comment|// save the information of mob file compactions in tables.
