...
name|memStoreLAB
argument_list|,
comment|// initial size of segment metadata (the data per cell is added in createCellArrayMapSet)
...
name|memStoreLAB
argument_list|,
comment|// initial size of segment metadata (the data per cell is added in internalAdd)
name|CompactingMemStore
operator|.
...
argument_list|()
decl_stmt|;
comment|// each Cell is now represented in CellArrayMap
