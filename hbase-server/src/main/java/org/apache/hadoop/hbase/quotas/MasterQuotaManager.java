...
argument_list|)
expr_stmt|;
comment|// Copy the user request into the Quotas object
name|Quotas
operator|.
name|Builder
name|builder
...
block|}
block|}
comment|/**    * Adds the information from the provided {@link SpaceLimitRequest} to the {@link Quotas} builder.    *    * @param quotas The builder to update.    * @param req The request to extract space quota information from.    */
name|void
name|applySpaceLimit
parameter_list|(
specifier|final
...
parameter_list|)
block|{
comment|// Create a builder for Quotas
name|SpaceQuota
operator|.
name|Builder
name|builder
...
argument_list|()
decl_stmt|;
comment|// Update the values from the provided quota into the new one and set it on Quotas.
name|quotas
operator|.
name|setSpace
argument_list|(
