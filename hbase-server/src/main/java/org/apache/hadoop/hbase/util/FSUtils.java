...
name|debug
argument_list|(
literal|"Create cluster ID file [{}] with ID: {}"
argument_list|,
name|idFile
argument_list|,
name|clusterId
...
name|debug
argument_list|(
literal|"Write the cluster ID file to a temporary location: {}"
argument_list|,
name|tempIdFile
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"Move the temporary cluster ID file to its target location [{}]:[{}]"
argument_list|,
name|tempIdFile
argument_list|,
name|idFile
...
name|IOException
argument_list|(
literal|"Unable to move temp cluster ID file to "
operator|+
name|idFile
argument_list|)
argument_list|)
...
name|warn
argument_list|(
literal|"Unable to create cluster ID file in {}, retrying in {}ms"
argument_list|,
name|rootdir
argument_list|,
name|wait
