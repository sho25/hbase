...
condition|)
block|{
comment|// A return type of FAMILY_DELETED will cause skip for all remaining cells from this
comment|// family. We would like to match visibility expression on every put cells after
comment|// this and only remove those matching with the family delete visibility. So we are
