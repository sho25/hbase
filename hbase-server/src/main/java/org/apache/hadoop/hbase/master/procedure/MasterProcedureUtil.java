...
return|;
block|}
comment|/**    * This is a version of unwrapRemoteIOException that can do DoNotRetryIOE.    * We need to throw DNRIOE to clients if a failed Procedure else they will    * keep trying. The default proc.getException().unwrapRemoteException    * doesn't have access to DNRIOE from the procedure2 module.    */
specifier|public
specifier|static
name|IOException
...
argument_list|()
decl_stmt|;
comment|// Do not retry ProcedureExceptions!
return|return
operator|(
name|e
operator|instanceof
...
return|;
block|}
comment|/**    * Do not allow creating new tables/namespaces which has an empty rs group, expect the default rs    * group. Notice that we do not check for online servers, as this is not stable because region    * servers can die at any time.    */
specifier|public
specifier|static
name|void
