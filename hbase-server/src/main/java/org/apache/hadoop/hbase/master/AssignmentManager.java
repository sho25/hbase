...
argument_list|)
expr_stmt|;
comment|/*          * This can be removed once HBASE-16119 (Procedure v2 Merge) is implemented and AM force          * assigns the merged region on the same region server. FavoredNodes for the region would          * be passed along with OpenRegionRequest and hence the following would become redundant.          */
name|List
argument_list|<
name|ServerName
argument_list|>
