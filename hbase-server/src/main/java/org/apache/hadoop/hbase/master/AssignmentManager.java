...
name|error
argument_list|(
literal|"Dropped merge! ServerName="
operator|+
name|sn
operator|+
literal|" unknown."
...
break|break;
block|}
comment|// Get merged and merging regions.
name|byte
index|[]
name|payloadOfMerge
init|=
...
name|error
argument_list|(
literal|"Dropped merge! Failed reading merge payload for "
operator|+
name|prettyPrintedRegionName
argument_list|)
expr_stmt|;
...
condition|)
return|return;
comment|//remove system tables because they would have been assigned earlier
for|for
control|(
name|Iterator
argument_list|<
...
block|}
block|}
comment|/**    * Update inmemory structures.    * @param sn Server that reported the merge    * @param merged regioninfo of merged    * @param a region a    * @param b region b    */
specifier|public
name|void
