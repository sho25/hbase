...
argument_list|()
decl_stmt|;
comment|/**    * Used for assignment only.  TODO: revisit the assign lock scheme    */
specifier|final
specifier|private
name|KeyLocker
argument_list|<
...
argument_list|)
decl_stmt|;
comment|// TODO: we can't synchronized on state any more since it could
comment|// be an new instance.  We need to reconsider how to avoid
comment|// double/multiple assignments.
comment|// This is to prevent double assignments? Does it work?
name|String
name|encodedName
init|=
name|region
...
condition|)
block|{
comment|// Failed opening this region, reassign it
name|assign
argument_list|(
name|regions
operator|.
...
argument_list|)
expr_stmt|;
comment|// TODO: do we need synchronization here?
comment|// could not synchronized on regionState since it can be
comment|// an new instance
name|String
name|encodedName
init|=
name|regionState
