...
block|}
block|}
comment|/**    * Processes list of dead servers from result of hbase:meta scan and regions in RIT    *    * @param deadServers    *          The list of dead servers which failed while there was no active    *          master. Can be null.    */
specifier|private
name|void
name|processDeadServers
parameter_list|(
