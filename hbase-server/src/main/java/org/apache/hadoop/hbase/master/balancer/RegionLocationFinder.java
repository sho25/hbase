...
return|;
block|}
comment|/**    * return TableDescriptor for a given tableName    *    * @param tableName the table name    * @return TableDescriptor    * @throws IOException if table descriptor cannot be loaded    */
specifier|protected
name|TableDescriptor
name|getTableDescriptor
parameter_list|(
...
name|debug
argument_list|(
literal|"FileNotFoundException during getTableDescriptors. Current table name =  {}"
argument_list|,
name|tableName
argument_list|,
name|fnfe
