...
expr_stmt|;
block|}
comment|// Populate the master address host ports in the config. This is needed if a master based
comment|// registry is configured for client metadata services (HBASE-18095)
name|List
argument_list|<
name|String
argument_list|>
