...
begin_comment
comment|/**  * Implementation of RSGroupAdminService defined in RSGroupAdmin.proto. This class calls  * {@link RSGroupInfoManagerImpl} for actual work, converts result to protocol buffer response,  * handles exceptions if any occurred and then calls the {@code RpcCallback} with the response.  *  * @deprecated Keep it here only for compatibility with {@link RSGroupAdminClient},  *     using {@link org.apache.hadoop.hbase.master.MasterRpcServices} instead.  */
end_comment
