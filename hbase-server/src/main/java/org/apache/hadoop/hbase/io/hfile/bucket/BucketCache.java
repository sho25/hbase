...
decl_stmt|;
comment|/** Use strong reference for offsetLock or not */
specifier|private
specifier|static
specifier|final
name|String
name|STRONG_REF_KEY
init|=
literal|"hbase.bucketcache.offsetlock.usestrongref"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|boolean
name|STRONG_REF_DEFAULT
init|=
literal|false
decl_stmt|;
...
literal|1
decl_stmt|;
comment|/**    * A ReentrantReadWriteLock to lock on a particular block identified by offset.    * The purpose of this is to avoid freeing the block which is being read.    *<p>    */
annotation|@
name|VisibleForTesting
specifier|transient
specifier|final
