...
expr_stmt|;
block|}
comment|/**    * Copy constructor that takes in an existing WALKeyImpl plus some extended attributes.    * Intended for coprocessors to add annotations to a system-generated WALKey    * for persistence to the WAL.    * @param key Key to be copied into this new key    * @param extendedAttributes Extra attributes to copy into the new key    */
specifier|public
name|WALKeyImpl
parameter_list|(
name|WALKeyImpl
...
expr_stmt|;
block|}
comment|/**    * Copy constructor that takes in an existing WALKey, the extra WALKeyImpl fields that the    * parent interface is missing, plus some extended attributes. Intended    * for coprocessors to add annotations to a system-generated WALKey for    * persistence to the WAL.    */
specifier|public
name|WALKeyImpl
parameter_list|(
name|WALKey
...
name|walKey
operator|.
name|getExtendedAttributesCount
argument_list|()
operator|>
literal|0
condition|)
...
name|walKey
operator|.
name|getExtendedAttributesList
argument_list|()
control|)
block|{
name|byte
