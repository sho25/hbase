...
expr_stmt|;
block|}
comment|/**    * Handle RIT of meta region against crashed server    * Only used when ServerCrashProcedure is not enabled.    *    * @param serverName Server that has already crashed    */
specifier|public
name|void
...
name|info
argument_list|(
literal|"Meta has been assigned to crashed server: "
operator|+
name|serverName
operator|+
literal|"; will do re-assign"
argument_list|)
expr_stmt|;
...
argument_list|)
decl_stmt|;
comment|// Not need to consider for REGION_TRANSITION_QUEUE step
if|if
condition|(
name|rtp
operator|!=
