...
return|;
block|}
comment|/**    * Found the potentially problematic opened regions. There are three case:    * case 1. Master thought this region opened, but no regionserver reported it.    * case 2. Master thought this region opened on Server1, but regionserver reported Server2    * case 3. More than one regionservers reported opened this region    *    * @return the map of potentially problematic opened regions. Key is the region name. Value is    *         a pair of location in meta and the regionservers which reported opened this region.    */
specifier|public
name|Map
argument_list|<
name|String
...
control|)
block|{
comment|// Only consider the opened region and not in transition
if|if
condition|(
operator|!
name|rits
