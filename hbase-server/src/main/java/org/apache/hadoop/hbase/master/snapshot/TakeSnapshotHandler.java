...
name|IOException
block|{
comment|// 2 copy the regionInfo files to the snapshot
name|HRegionFileSystem
name|regionFs
init|=
name|HRegionFileSystem
...
argument_list|()
expr_stmt|;
comment|// 2 for each region, copy over its recovered.edits directory
name|Path
name|regionDir
init|=
name|HRegion
...
argument_list|)
expr_stmt|;
comment|// 2 reference all the files in the region
operator|new
name|ReferenceRegionHFilesTask
argument_list|(
name|snapshot
