...
specifier|private
name|LongStream
name|getStoreFileCreatedTimestampStream
parameter_list|()
block|{
return|return
name|this
...
block|}
block|}
comment|/**    * Archives and removes the compacted files    * @param compactedfiles The compacted files in this store that are not active in reads    * @throws IOException    */
specifier|private
name|void
name|removeCompactedfiles
parameter_list|(
