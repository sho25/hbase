...
specifier|private
name|ThreadPoolExecutor
name|compactionCleanerthreadPoolExecutor
init|=
literal|null
decl_stmt|;
specifier|private
...
name|r
argument_list|,
literal|"CompactedfilesArchiver-"
operator|+
name|count
operator|++
argument_list|)
...
name|debug
argument_list|(
literal|"Removing the compacted store files "
operator|+
name|compactedfiles
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Interrupted exception while closing the compacted files"
argument_list|,
name|ie
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Exception occured while closing the compacted files"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
condition|)
block|{
name|archiveAndRemoveCompactedFiles
argument_list|(
name|filesToRemove
argument_list|)
expr_stmt|;
