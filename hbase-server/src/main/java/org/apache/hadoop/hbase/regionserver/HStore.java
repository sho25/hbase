...
parameter_list|()
function_decl|;
comment|/**    * @param priority priority to check against. When priority is {@link HStore#PRIORITY_USER},    *          {@link HStore#PRIORITY_USER} is returned.    * @return The priority that this store has in the compaction queue.    */
specifier|public
name|int
name|getCompactPriority
parameter_list|(
...
parameter_list|()
function_decl|;
comment|/**    * @return the parent region hosting this store    */
specifier|public
name|HRegion
name|getHRegion
parameter_list|()
