...
argument_list|)
decl_stmt|;
comment|/** Parameter name for what compaction manager to use. */
specifier|private
specifier|static
specifier|final
name|String
name|COMPACTION_MANAGER_CLASS
init|=
literal|"hbase.compactionmanager.class"
decl_stmt|;
comment|/** Default compaction manager class name. */
specifier|private
specifier|static
specifier|final
name|String
name|DEFAULT_COMPACTION_MANAGER_CLASS
init|=
name|CompactionManager
operator|.
name|class
...
expr_stmt|;
block|}
comment|/**    * This setter is used for unit testing    * TODO: Fix this for online configuration updating    */
name|void
name|setCompactionPolicy
parameter_list|(
name|String
...
name|UnsupportedOperationException
argument_list|(
literal|"Unable to invoke specified target class constructor "
operator|+
name|managerClassName
argument_list|,
name|e
...
return|;
block|}
comment|/**    * Refreshes compaction manager class configuration.     * Used for tests only - not plumbed thru any layers.    * TODO: replace when HBASE-3909 is in.    */
name|void
