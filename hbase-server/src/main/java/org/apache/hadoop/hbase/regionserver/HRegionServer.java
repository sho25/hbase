...
name|walRoller
decl_stmt|;
comment|// Lazily initialized if this RegionServer hosts a meta table.
specifier|final
name|AtomicReference
argument_list|<
name|LogRoller
...
block|{
comment|// Another thread won starting the roller
name|Threads
operator|.
name|shutdown
argument_list|(
...
name|stop
argument_list|(
literal|"Meta WAL roller thread is no longer alive -- stop"
argument_list|)
expr_stmt|;
return|return
literal|false
...
name|error
argument_list|(
literal|"Could not retrieve WAL information for region "
operator|+
name|r
operator|.
name|getRegionInfo
argument_list|()
operator|+
literal|"; not adding to moved regions."
argument_list|)
expr_stmt|;
name|LOG
operator|.
name|debug
argument_list|(
literal|"Exception details for failure to get wal"
argument_list|,
name|exception
argument_list|)
expr_stmt|;
