...
block|}
block|}
comment|/**    * Return the last failed RS name under /hbase/recovering-regions/encodedRegionName    * @param encodedRegionName    * @throws IOException    * @throws KeeperException    */
specifier|private
name|String
name|getLastFailedRSFromZK
parameter_list|(
