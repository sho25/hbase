...
name|conf
expr_stmt|;
comment|// initialize netty event loop group at the very beginning as we may use it to start rpc server,
comment|// rpc client and WAL.
name|this
operator|.
name|eventLoopGroupConfig
operator|=
...
return|;
block|}
comment|/**    * Converts a pair of {@link HRegionInfo} and {@code long} into a {@link RegionSpaceUse}    * protobuf message.    *    * @param regionInfo The HRegionInfo    * @param sizeInBytes The size in bytes of the Region    * @return The protocol buffer    */
name|RegionSpaceUse
name|convertRegionSize
parameter_list|(
name|HRegionInfo
