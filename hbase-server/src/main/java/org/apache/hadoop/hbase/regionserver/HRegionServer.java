...
expr_stmt|;
block|}
comment|/**    * Starts a HRegionServer at the default location    * @param conf    * @param consensusProvider implementation of ConsensusProvider to be used    * @throws IOException    * @throws InterruptedException    */
specifier|public
name|HRegionServer
parameter_list|(
name|Configuration
