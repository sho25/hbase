...
operator|.
name|Builder
name|regionMutationResultBuilder
init|=
literal|null
decl_stmt|;
name|HRegion
...
expr_stmt|;
block|}
comment|// Have one regionmutationresult per regionmutation even if it is empty so we keep results
comment|// aligned w/ how the requests came in.
name|responseBuilder
operator|.
name|addRegionMutationResult
argument_list|(
name|regionMutationResultBuilder
operator|==
literal|null
