...
block|}
block|}
comment|/**    * Execute a list of Put/Delete mutations.    * @param region    * @param mutations    * @param isReplay    * @return an array of OperationStatus which internally contains the    *         OperationStatusCode and the exceptionMessage if any    * @throws IOException    */
specifier|protected
name|OperationStatus
index|[]
name|doBatchOp
