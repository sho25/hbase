...
return|;
block|}
comment|/**    * Are there enough available resources to allow execution?    * @param amount the number of required resources    * @return true if there are enough available resources, otherwise false    */
specifier|public
specifier|synchronized
name|boolean
name|canExecute
