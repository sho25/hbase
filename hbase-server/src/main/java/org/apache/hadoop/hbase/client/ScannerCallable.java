...
return|return;
block|}
comment|/*      * broken by protobufs     for (Result rr : rrs) {       if (rr.getBytes() != null) {         this.scanMetrics.countOfBytesInResults.inc(rr.getBytes().getLength());         if (isRegionServerRemote) {           this.scanMetrics.countOfBytesInRemoteResults.inc(             rr.getBytes().getLength());         }       }     }     */
block|}
specifier|private
name|void
name|close
