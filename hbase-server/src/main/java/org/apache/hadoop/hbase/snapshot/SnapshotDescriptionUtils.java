...
literal|0
decl_stmt|;
comment|// Default value if no ttl is specified for Snapshot
specifier|private
specifier|static
specifier|final
name|long
name|NO_SNAPSHOT_TTL_SPECIFIED
init|=
literal|0
decl_stmt|;
specifier|public
...
argument_list|()
decl_stmt|;
comment|// set default ttl(sec) if it is not set already or the value is out of the range
if|if
condition|(
name|ttl
operator|==
...
name|debug
argument_list|(
literal|"Snapshot current TTL value: {} resetting it to default value: {}"
argument_list|,
name|ttl
argument_list|,
name|defaultSnapshotTtl
