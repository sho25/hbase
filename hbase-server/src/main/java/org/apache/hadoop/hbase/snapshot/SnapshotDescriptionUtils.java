...
specifier|final
name|String
name|MASTER_WAIT_TIME_GLOBAL_SNAPSHOT
init|=
literal|"hbase.snapshot.global.master.timeout"
decl_stmt|;
specifier|public
specifier|static
specifier|final
name|String
name|REGION_WAIT_TIME_GLOBAL_SNAPSHOT
init|=
literal|"hbase.snapshot.global.region.timeout"
decl_stmt|;
specifier|public
specifier|static
specifier|final
name|String
name|MASTER_WAIT_TIME_TIMESTAMP_SNAPSHOT
init|=
literal|"hbase.snapshot.timestamp.master.timeout"
decl_stmt|;
specifier|public
specifier|static
specifier|final
name|String
name|REGION_WAIT_TIME_TIMESTAMP_SNAPSHOT
init|=
literal|"hbase.snapshot.timestamp.region.timeout"
decl_stmt|;
specifier|public
specifier|static
specifier|final
...
init|=
literal|"hbase.snapshot.disabled.master.timeout"
decl_stmt|;
comment|/** Default timeout of 60 sec for a snapshot timeout on a region */
specifier|public
specifier|static
specifier|final
name|long
name|DEFAULT_REGION_SNAPSHOT_TIMEOUT
init|=
literal|60000
decl_stmt|;
...
literal|60000
decl_stmt|;
comment|/**    * Conf key for amount of time the in the future a timestamp snapshot should be taken (ms).    * Defaults to {@value SnapshotDescriptionUtils#DEFAULT_TIMESTAMP_SNAPSHOT_SPLIT_IN_FUTURE}    */
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"hbase.snapshot.timestamp.master.splittime"
decl_stmt|;
comment|/** Start 2 seconds in the future, if no start time given */
specifier|public
specifier|static
specifier|final
name|long
name|DEFAULT_TIMESTAMP_SNAPSHOT_SPLIT_IN_FUTURE
init|=
literal|2000
decl_stmt|;
specifier|private
...
return|;
block|}
comment|/**    * @param conf {@link Configuration} from which to check for the timeout    * @param type type of snapshot being taken    * @param defaultMaxWaitTime Default amount of time to wait, if none is in the configuration    * @return the max amount of time the region should wait for a snapshot to complete    */
specifier|public
specifier|static
name|long
name|getMaxRegionTimeout
parameter_list|(
name|Configuration
name|conf
parameter_list|,
