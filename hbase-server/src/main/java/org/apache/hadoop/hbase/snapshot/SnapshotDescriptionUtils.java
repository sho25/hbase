...
name|warn
argument_list|(
literal|"security feature is not available, skip saving .aclinfo file."
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|debug
argument_list|(
literal|"write .aclinfo into file, .aclinfo path: "
operator|+
name|aclInfo
operator|+
...
name|error
argument_list|(
literal|"write table acl info file failed: "
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|msg
init|=
literal|"Couldn't delete table acl info file: "
operator|+
name|aclInfo
decl_stmt|;
name|LOG
...
name|IOException
argument_list|(
literal|"read .aclinfo error, length does not match. file size: "
operator|+
name|status
operator|.
name|getLen
...
name|IOException
argument_list|(
literal|"deserialize .aclinfo bytes to object failed: "
argument_list|,
name|e
argument_list|)
throw|;
...
name|IOException
argument_list|(
literal|"grant .aclinfo permissions into table failed: "
argument_list|,
name|throwable
argument_list|)
throw|;
