...
expr_stmt|;
block|}
comment|/**    * @param rootDir Path to the root directory where hbase files are stored    * @param archiveDir Path to the hbase archive directory    * @param mobDir path to the hbase mob directory    * @param path The path of the HFile Link.    */
specifier|public
name|HFileLink
parameter_list|(
specifier|final
...
return|;
block|}
comment|/**    * Returns true if the HFileLink exists    */
specifier|public
name|boolean
name|exists
parameter_list|(
