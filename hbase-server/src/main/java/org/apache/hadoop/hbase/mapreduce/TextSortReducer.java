...
begin_comment
comment|/**  * Emits Sorted KeyValues. Reads the text passed, parses it and creates the Key Values then Sorts  * them and emits Keyalues in sorted order.   * @see HFileOutputFormat  * @see KeyValueSortReducer  * @see PutSortReducer  */
end_comment
...
block|{
comment|// Should ensure that VisibilityController is present
name|kv
operator|=
name|labelExpander
operator|.
