...
block|}
block|}
comment|/**    * Setup response for the RPC Call.    * @param response buffer to serialize the response into    * @param call {@link ServerCall} to which we are setting up the response    * @param error error message, if the call failed    * @throws IOException    */
specifier|protected
name|void
name|setupResponse
parameter_list|(
