...
literal|null
decl_stmt|;
comment|/** replication related queue; */
specifier|protected
name|BlockingQueue
argument_list|<
name|Call
...
name|IPCUtil
operator|.
name|getRequestShortTextFormat
argument_list|(
name|this
operator|.
name|param
...
block|}
block|}
comment|/**    * Minimal setup.  Used by tests mostly.    * @param service    * @param isa    * @param conf    * @throws IOException    */
specifier|public
name|RpcServer
parameter_list|(
specifier|final
