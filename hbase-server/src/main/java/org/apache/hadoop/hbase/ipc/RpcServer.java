...
parameter_list|()
function_decl|;
comment|/** Called for each call.    * @param method Method to invoke.    * @param param parameter    * @param receiveTime time    * @param status    * @return Message Protobuf response Message and optionally the Cells that make up the response.    * @throws java.io.IOException e    */
name|Pair
argument_list|<
name|Message
argument_list|,
