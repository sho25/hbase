...
condition|)
block|{
comment|// This is not an actual case. So the Prefix tree block is not loaded in case of Prefix_tree
comment|// Just copy only the key part to form a keyBuffer
name|byte
index|[]
name|serializedKey
init|=
