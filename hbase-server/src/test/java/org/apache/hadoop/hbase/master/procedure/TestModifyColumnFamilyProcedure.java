...
specifier|public
class|class
name|TestModifyColumnFamilyProcedure
extends|extends
...
argument_list|)
expr_stmt|;
comment|// Test 1: modify the column family online
name|columnDescriptor
operator|.
name|setBlocksize
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Test 2: modify the column family offline
name|UTIL
operator|.
name|getAdmin
argument_list|()
...
name|valueOf
argument_list|(
literal|"testModifyExistingColumnFamily"
argument_list|)
decl_stmt|;
specifier|final
name|String
...
argument_list|)
expr_stmt|;
comment|// Modify the column family that does not exist
name|columnDescriptor
operator|.
name|setBlocksize
argument_list|(
...
name|debug
argument_list|(
literal|"Modify failed with exception: "
operator|+
name|result
operator|.
