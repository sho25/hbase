...
argument_list|()
expr_stmt|;
comment|//Try getting the row with an empty row key and make sure the other base cases work as well
name|Result
name|res
init|=
name|table
...
argument_list|)
expr_stmt|;
comment|//Now actually put in a row with an empty row key
name|put
operator|=
operator|new
name|Put
