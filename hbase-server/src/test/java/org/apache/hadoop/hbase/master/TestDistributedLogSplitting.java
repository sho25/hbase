...
specifier|public
name|void
name|testSameVersionUpdatesRecovery
parameter_list|()
throws|throws
name|Exception
block|{
...
name|info
argument_list|(
literal|"testSameVersionUpdatesRecovery"
argument_list|)
expr_stmt|;
name|conf
operator|.
...
argument_list|)
decl_stmt|;
comment|// use last 5 bytes because HBaseTestingUtility.createMultiRegions use 5 bytes key
name|row
operator|=
name|Arrays
operator|.
...
argument_list|)
expr_stmt|;
comment|// verify we got the last value
name|LOG
operator|.
name|info
argument_list|(
literal|"Verification Starts..."
argument_list|)
expr_stmt|;
name|Get
name|g
...
name|info
argument_list|(
literal|"Verification after flush..."
argument_list|)
expr_stmt|;
name|TEST_UTIL
operator|.
...
specifier|public
name|void
name|testSameVersionUpdatesRecoveryWithCompaction
parameter_list|()
throws|throws
name|Exception
block|{
...
name|info
argument_list|(
literal|"testSameVersionUpdatesRecoveryWithWrites"
argument_list|)
expr_stmt|;
name|conf
operator|.
...
argument_list|)
expr_stmt|;
comment|// after flush& compaction
name|LOG
operator|.
name|info
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// wait for compaction completes
name|TEST_UTIL
operator|.
name|waitFor
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// current SeqId file has seqid=1001
name|HLogUtil
operator|.
name|writeRegionOpenSequenceIdFile
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// current SeqId file has seqid=2001
name|assertEquals
argument_list|(
literal|3001
argument_list|,
