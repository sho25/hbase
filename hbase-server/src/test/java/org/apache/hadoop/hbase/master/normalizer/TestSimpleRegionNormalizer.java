...
specifier|private
name|void
name|noNormalizationOnTransitioningRegions
parameter_list|(
specifier|final
name|RegionState
operator|.
...
name|format
argument_list|(
literal|"Unexpected plans for RegionState %s"
argument_list|,
name|state
argument_list|)
argument_list|,
...
specifier|public
name|void
name|testNoNormalizationOnMergingNewRegions
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testNoNormalizationOnMergingRegions
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testNoNormalizationOnMergedRegions
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testNoNormalizationOnSplittingNewRegions
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testNoNormalizationOnSplittingRegions
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testNoNormalizationOnSplitRegions
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testSplitWithTargetRegionCount
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// test when target region size is 20
name|when
argument_list|(
name|masterServices
operator|.
...
expr_stmt|;
block|}
comment|// test when target region size is 200
name|when
argument_list|(
name|masterServices
operator|.
...
specifier|public
name|void
name|testSplitWithTargetRegionSize
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// test when target region count is 8
name|when
argument_list|(
name|masterServices
operator|.
...
expr_stmt|;
block|}
comment|// test when target region count is 3
name|when
argument_list|(
name|masterServices
operator|.
