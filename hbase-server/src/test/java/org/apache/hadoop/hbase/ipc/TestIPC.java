...
argument_list|)
expr_stmt|;
comment|// Another test for the async client
name|doAsyncSimpleTest
argument_list|(
operator|new
name|AsyncRpcClient
argument_list|(
...
specifier|public
name|void
name|testRTEDuringAsyncBlockingConnectionSetup
parameter_list|()
throws|throws
name|Exception
block|{
