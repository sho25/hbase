...
argument_list|)
expr_stmt|;
comment|// windows fix: tgz file has hbase:meta directory renamed as -META- since the original
comment|// is an illegal name under windows. So we rename it back.
comment|// See src/test/data//TestMetaMigrationConvertingToPB.README and
