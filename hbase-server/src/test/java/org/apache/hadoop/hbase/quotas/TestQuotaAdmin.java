...
specifier|public
name|void
name|testSetAndRemoveRegionServerQuota
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testRpcThrottleWhenStartup
parameter_list|()
throws|throws
name|IOException
throws|,
...
name|fail
argument_list|(
literal|"should not come here, because can't enable exceed throttle quota "
operator|+
literal|"if there is no region server quota"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
literal|"should not come here, because can't enable exceed throttle quota "
operator|+
literal|"if there is no read region server quota"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
literal|"should not come here, because can't enable exceed throttle quota "
operator|+
literal|"because not all region server quota are in seconds time unit"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
argument_list|()
decl_stmt|;
comment|// set CLUSTER quota scope for namespace
name|admin
operator|.
name|setQuota
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// set CLUSTER quota scope for table
name|admin
operator|.
name|setQuota
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// set CLUSTER quota scope for user
name|admin
operator|.
name|setQuota
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// set CLUSTER quota scope for user and table
name|admin
operator|.
name|setQuota
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// set CLUSTER quota scope for user and namespace
name|admin
operator|.
name|setQuota
argument_list|(
