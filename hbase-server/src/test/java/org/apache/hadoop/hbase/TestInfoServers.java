...
expr_stmt|;
block|}
comment|/**    * Test for checking master info port of cluster whether same with the port of    * TestHBaseTestingUtility's getConfiguration .    *     * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
name|testMasterInfoServerPort
parameter_list|()
throws|throws
name|Exception
block|{
