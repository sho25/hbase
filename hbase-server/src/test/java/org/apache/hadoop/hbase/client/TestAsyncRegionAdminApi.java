...
name|valueOf
argument_list|(
literal|"testGetRegionByStateOfTable"
argument_list|)
decl_stmt|;
try|try
block|{
...
name|valueOf
argument_list|(
literal|"testCompactRegionServer"
argument_list|)
decl_stmt|;
name|byte
index|[]
