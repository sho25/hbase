...
expr_stmt|;
block|}
comment|/**    * Test for HBASE-23044.    */
annotation|@
name|Test
specifier|public
name|void
name|testGetMergeRegions
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Delete merge qualifiers for mergedRegion0, then cannot getMergeRegions again
name|MetaTableAccessor
operator|.
...
specifier|public
name|void
name|testIsMetaWhenMetaGoesOffline
parameter_list|()
throws|throws
name|InterruptedException
block|{
...
specifier|public
name|void
name|testMetaLocationForRegionReplicasIsRemovedAtTableDeletion
parameter_list|()
throws|throws
name|IOException
block|{
...
specifier|public
name|void
name|testScanByRegionEncodedNameExistingRegion
parameter_list|()
throws|throws
name|Exception
block|{
...
name|valueOf
argument_list|(
literal|"testScanByRegionEncodedNameExistingRegion"
argument_list|)
decl_stmt|;
name|UTIL
operator|.
...
specifier|public
name|void
name|testScanByRegionEncodedNameNonExistingRegion
parameter_list|()
throws|throws
name|Exception
block|{
