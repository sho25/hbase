...
begin_comment
comment|/**  * Test CoreCoprocessor Annotation works giving access to facility not usually available.  * Test RegionServerCoprocessor.  */
end_comment
...
specifier|public
class|class
name|TestCoreRegionServerCoprocessor
block|{
annotation|@
name|ClassRule
specifier|public
...
specifier|static
class|class
name|NotCoreRegionServerCoprocessor
...
specifier|static
class|class
name|CoreRegionServerCoprocessor
implements|implements
name|RegionServerCoprocessor
block|{
specifier|public
...
block|{}
block|}
comment|/**    * Assert that when a Coprocessor is annotated with CoreCoprocessor, then it is possible to    * access a RegionServerServices instance. Assert the opposite too.    * Do it to RegionServerCoprocessors.    * @throws IOException    */
annotation|@
name|Test
specifier|public
name|void
