...
specifier|private
name|boolean
name|preListLocksCalled
decl_stmt|;
specifier|private
name|boolean
name|postListLocksCalled
decl_stmt|;
specifier|private
name|boolean
name|preMoveCalled
...
specifier|public
name|boolean
name|wasPreListLocksCalledOnly
parameter_list|()
block|{
return|return
name|preListLocksCalled
...
name|assertTrue
argument_list|(
literal|"Coprocessor should be called on list locks request"
argument_list|,
name|cp
operator|.
name|wasListLocksCalled
