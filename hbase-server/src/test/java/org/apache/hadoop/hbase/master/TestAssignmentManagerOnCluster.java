...
argument_list|)
expr_stmt|;
comment|// reset the value for other tests
name|TEST_UTIL
operator|.
name|getMiniHBaseCluster
argument_list|()
...
block|}
block|}
comment|/**    * This tests round-robin assignment failed due to no bulkplan    */
annotation|@
name|Test
argument_list|(
name|timeout
...
specifier|public
name|void
name|testRoundRobinAssignmentFailed
parameter_list|()
throws|throws
name|Exception
block|{
...
name|valueOf
argument_list|(
literal|"testRoundRobinAssignmentFailed"
argument_list|)
decl_stmt|;
try|try
block|{
...
argument_list|()
decl_stmt|;
comment|// round-robin assignment but balancer cannot find a plan
comment|// assignment should fail
name|MyLoadBalancer
operator|.
name|controledRegion
operator|=
name|hri
expr_stmt|;
comment|// if bulk assignment cannot update region state to online
comment|// or failed_open this waits until timeout
name|assertFalse
argument_list|(
name|TEST_UTIL
operator|.
...
argument_list|)
expr_stmt|;
comment|// try again with valid plan
name|MyLoadBalancer
operator|.
name|controledRegion
operator|=
...
block|}
block|}
comment|/**    * This tests retain assignment failed due to no bulkplan    */
annotation|@
name|Test
argument_list|(
name|timeout
...
specifier|public
name|void
name|testRetainAssignmentFailed
parameter_list|()
throws|throws
name|Exception
block|{
...
name|valueOf
argument_list|(
literal|"testRetainAssignmentFailed"
argument_list|)
decl_stmt|;
try|try
block|{
...
argument_list|)
expr_stmt|;
comment|// retainAssignment but balancer cannot find a plan
comment|// assignment should fail
name|am
operator|.
name|assign
...
argument_list|)
expr_stmt|;
comment|// if retain assignment cannot update region state to online
comment|// or failed_open this waits until timeout
name|assertFalse
argument_list|(
name|am
...
argument_list|)
expr_stmt|;
comment|// try retainAssigment again with valid plan
name|MyLoadBalancer
operator|.
name|controledRegion
operator|=
...
argument_list|)
expr_stmt|;
comment|// it retains on same server as specified
name|assertEquals
argument_list|(
name|serverName
argument_list|,
...
block|}
block|}
comment|/**    * Test SSH waiting for extra region server for assignment    */
annotation|@
name|Test
argument_list|(
name|timeout
...
specifier|public
name|void
name|testSSHWaitForServerToAssignRegion
parameter_list|()
throws|throws
name|Exception
block|{
...
name|valueOf
argument_list|(
literal|"testSSHWaitForServerToAssignRegion"
argument_list|)
decl_stmt|;
name|MiniHBaseCluster
name|cluster
...
name|assertNotNull
argument_list|(
literal|"First region should be assigned"
argument_list|,
name|rs
argument_list|)
expr_stmt|;
...
argument_list|()
decl_stmt|;
comment|// Wait till SSH tried to assign regions a several times
name|int
name|counter
init|=
name|MyLoadBalancer
...
literal|false
expr_stmt|;
comment|// Wait till the dead server is processed by SSH
name|TEST_UTIL
operator|.
name|waitFor
argument_list|(
...
name|assertTrue
argument_list|(
literal|"First region should be re-assigned to a different server"
argument_list|,
name|rs
operator|!=
literal|null
...
condition|)
block|{
comment|// Let's wait till more region servers join in.
comment|// Before that, fail region assignments.
name|counter
operator|.
