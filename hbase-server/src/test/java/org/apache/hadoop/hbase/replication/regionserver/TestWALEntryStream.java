...
argument_list|)
expr_stmt|;
comment|//equals() only checks region name, sequence id and write time
name|Assert
operator|.
name|assertEquals
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//can't use Map.equals() because byte arrays use reference equality
name|Assert
operator|.
name|assertEquals
argument_list|(
