...
block|}
block|}
comment|/**    * Test the openregionhandler can deal with perceived failure of transitioning to OPENED state    * due to intermittent zookeeper malfunctioning.    * @see<a href="https://issues.apache.org/jira/browse/HBASE-9387">HBASE-9387</a>    * @throws IOException    * @throws NodeExistsException    * @throws KeeperException    */
annotation|@
name|Test
specifier|public
name|void
name|testRegionServerAbortionDueToFailureTransitioningToOpened
parameter_list|()
throws|throws
name|IOException
throws|,
...
name|IOException
block|{
comment|// remove znode simulating intermittent zookeeper connection issue
name|ZooKeeperWatcher
name|zkw
init|=
name|this
...
throw|;
block|}
comment|// then try to transition to OPENED
return|return
name|super
operator|.
name|transitionToOpened
...
expr_stmt|;
block|}
comment|// Region server is expected to abort due to OpenRegionHandler perceiving transitioning
comment|// to OPENED as failed
comment|// This was corresponding to the second handler.process() call above.
name|assertTrue
argument_list|(
literal|"region server should have aborted"
argument_list|,
name|rss
operator|.
name|isAborted
...
specifier|public
name|void
name|testTransitionToFailedOpenFromOffline
parameter_list|()
throws|throws
name|Exception
block|{
