...
block|}
decl_stmt|;
comment|// The mnior version for pre-checksum files
specifier|private
specifier|static
name|int
name|MINOR_VERSION
...
name|prevOffset
decl_stmt|;
comment|/** Whether we are including memstore timestamp after every key/value */
specifier|private
name|boolean
name|includesMemstoreTS
decl_stmt|;
comment|/**      * @param compressionAlgorithm compression algorithm to use      * @param dataBlockEncoderAlgo data block encoding algorithm to use      */
specifier|public
name|Writer
parameter_list|(
name|Compression
