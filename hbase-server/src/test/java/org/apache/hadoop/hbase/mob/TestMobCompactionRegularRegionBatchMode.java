...
specifier|public
class|class
name|TestMobCompactionRegularRegionBatchMode
extends|extends
...
name|info
argument_list|(
literal|"MOB compaction chore regular batch mode started"
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"MOB compaction chore regular batch mode finished OK"
argument_list|)
expr_stmt|;
block|}
annotation|@
