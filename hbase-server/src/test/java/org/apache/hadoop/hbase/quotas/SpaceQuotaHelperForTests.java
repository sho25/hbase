...
block|}
block|}
comment|/**    * Writes the given mutation into a table until it violates the given policy.    * Verifies that the policy has been violated& then returns the name of    * the table created& written into.    */
name|TableName
...
return|;
block|}
comment|/**    * Writes the given mutation into a table until it violates the given policy.    * Returns the name of the table created& written into.    */
name|TableName
name|writeUntilViolation
parameter_list|(
name|SpaceViolationPolicy
...
return|;
block|}
comment|/**    * Verifies that the given policy on the given table has been violated    */
name|void
name|verifyViolation
parameter_list|(
name|SpaceViolationPolicy
...
expr_stmt|;
block|}
comment|/**    * Verifies that no policy has been violated on the given table    */
name|void
...
expr_stmt|;
block|}
comment|/**    * Sets the given quota (policy& limit) on the passed table.    */
name|void
name|setQuotaLimit
parameter_list|(
specifier|final
...
expr_stmt|;
block|}
comment|/**    * Removes the space quota from the given table    */
name|void
