...
do|;
block|}
comment|/**    * Load a table with a single region and compact the files.    * @param tableName name of the table to load    * @return the number of archived store files    * @throws Exception on failure    */
specifier|private
name|int
name|loadAndCompact
parameter_list|(
...
name|debug
argument_list|(
literal|"Not compacting store with just one store file!"
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|assertTrue
argument_list|(
literal|"Only one store file, need more for compaction!"
argument_list|,
name|store
operator|.
name|getStorefilesCount
