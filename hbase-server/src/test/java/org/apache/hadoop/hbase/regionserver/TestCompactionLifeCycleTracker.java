...
expr_stmt|;
block|}
comment|// This test assumes that compaction wouldn't happen with null user.
comment|// But null user means system generated compaction so compaction should happen
comment|// even if the space quota is violated. So this test should be removed/ignored.
annotation|@
name|Ignore
annotation|@
name|Test
