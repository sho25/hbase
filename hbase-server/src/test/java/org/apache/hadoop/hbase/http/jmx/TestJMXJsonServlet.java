...
argument_list|)
expr_stmt|;
comment|// test to get XSS JSONP result
name|result
operator|=
name|readOutput
argument_list|(
...
name|baseUrl
argument_list|,
literal|"/jmx?qry=java.lang:type=Memory&callback=<script>alert('hello')</script>"
argument_list|)
argument_list|)
expr_stmt|;
name|LOG
...
name|info
argument_list|(
literal|"/jmx?qry=java.lang:type=Memory&callback=<script>alert('hello')</script> RESULT: "
operator|+
name|result
argument_list|)
expr_stmt|;
