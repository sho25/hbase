...
specifier|public
name|void
name|testTableSkewCostProperlyDecreases
parameter_list|()
block|{
name|int
name|replication
...
argument_list|()
decl_stmt|;
comment|// Start out with 100 regions on one server and 0 regions on the other
name|int
name|numNodes
init|=
literal|2
...
specifier|public
name|void
name|testTableSkewCandidateGeneratorConvergesToZero
parameter_list|()
block|{
name|int
name|replication
...
argument_list|)
decl_stmt|;
comment|// num regions between max(numTables, numNodes) - numTables*100
name|int
name|numRegionsPerServer
init|=
name|rand
...
literal|1
decl_stmt|;
comment|// num regions per server (except one) between 1 and numRegions / numNodes
name|Map
argument_list|<
name|ServerName
argument_list|,
