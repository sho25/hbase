...
specifier|public
name|void
name|testImpactOfBalanceClusterOverallWithClusterLoadPerTable
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testBalanceClusterOverallStrictly
parameter_list|()
throws|throws
name|Exception
block|{
name|int
index|[]
name|regionNumOfTable1PerServer
init|=
block|{
literal|3
block|,
...
name|int
index|[]
name|regionNumOfTable2PerServer
init|=
block|{
literal|2
block|,
