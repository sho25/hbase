...
name|warn
argument_list|(
literal|"Starting namenodes on mini cluster is not supported"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|warn
argument_list|(
literal|"Aborting namenodes on mini cluster is not supported"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|warn
argument_list|(
literal|"Stopping namenodes on mini cluster is not supported"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|warn
argument_list|(
literal|"Waiting for namenodes to start on mini cluster is not supported"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|warn
argument_list|(
literal|"Waiting for namenodes to stop on mini cluster is not supported"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
return|;
block|}
comment|/**    * Suspend the specified region server    * @param serverNumber Used as index into a list.    * @return    */
specifier|public
name|JVMClusterUtil
operator|.
name|RegionServerThread
...
return|;
block|}
comment|/**    * Resume the specified region server    * @param serverNumber Used as index into a list.    * @return    */
specifier|public
name|JVMClusterUtil
operator|.
name|RegionServerThread
