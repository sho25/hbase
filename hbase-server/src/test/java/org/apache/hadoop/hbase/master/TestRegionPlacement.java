...
comment|// correctly update the new assignment plan to META and Region Server.
...
argument_list|)
decl_stmt|;
comment|// Let the region placement update the META and Region Servers
name|rp
operator|.
...
name|IOException
block|{
comment|// Verify the assignment plan in META is consistent with the expected plan.
