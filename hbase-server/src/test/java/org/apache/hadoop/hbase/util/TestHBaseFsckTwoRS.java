...
annotation|@
name|Ignore
comment|// Until after HBASE-14614 goes in.
annotation|@
name|Category
argument_list|(
block|{
...
block|}
block|}
comment|/**    * Test fixing lingering HFileLinks.    */
annotation|@
name|Test
argument_list|(
name|timeout
...
argument_list|)
expr_stmt|;
comment|// should report no error
name|HBaseFsck
name|hbck
init|=
name|doFsck
...
argument_list|)
expr_stmt|;
comment|// Check without fix should show the error
name|hbck
operator|=
name|doFsck
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Fix should sideline these files, thus preventing the error
name|hbck
operator|=
name|doFsck
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// creating a directory with file instead of the HFileLink file
name|fs
operator|.
name|mkdirs
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// If a tableName has no CF's it doesn't get checked
name|createTable
argument_list|(
name|TEST_UTIL
argument_list|,
...
block|}
block|}
comment|/**    * Creates and fixes a bad table with a successful split that have a deployed    * start and end keys    */
annotation|@
name|Test
argument_list|(
name|timeout
...
name|valueOf
argument_list|(
literal|"testSplitAndDupeRegion"
argument_list|)
decl_stmt|;
name|Table
name|meta
