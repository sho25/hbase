...
block|{
comment|/**    * Throws an assertion if we find a test class without category (small/medium/large).    * List all the test classes without category in the assertion message.    */
annotation|@
name|Test
specifier|public
name|void
