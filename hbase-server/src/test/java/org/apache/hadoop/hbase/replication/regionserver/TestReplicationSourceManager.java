...
expr_stmt|;
block|}
comment|/**    * Test whether calling removePeer() on a ReplicationSourceManager that failed on initializing the    * corresponding ReplicationSourceInterface correctly cleans up the corresponding    * replication queue and ReplicationPeer.    * See HBASE-16096.    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
...
literal|"replication.replicationsource.implementation"
argument_list|,
literal|"fakeReplicationSourceImpl"
argument_list|)
expr_stmt|;
name|ReplicationPeers
name|rp
...
argument_list|)
expr_stmt|;
comment|// Have ReplicationSourceManager add the fake peer. It should fail to initialize a
comment|// ReplicationSourceInterface.
name|List
argument_list|<
name|String
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// Removing the peer should remove both the replication queue and the ReplicationPeer
name|manager
operator|.
name|removePeer
argument_list|(
