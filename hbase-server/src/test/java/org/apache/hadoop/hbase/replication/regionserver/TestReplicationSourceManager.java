...
block|}
block|}
comment|/**    * Add a peer and wait for it to initialize    * @param peerId    * @param peerConfig    * @param waitForSource Whether to wait for replication source to initialize    * @throws Exception    */
specifier|private
name|void
name|addPeerAndWait
parameter_list|(
