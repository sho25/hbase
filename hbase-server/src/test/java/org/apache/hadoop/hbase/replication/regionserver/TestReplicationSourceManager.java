...
argument_list|()
decl_stmt|;
comment|// cversion should increased by 1 since a child node is deleted
name|assertEquals
argument_list|(
name|v0
operator|+
...
argument_list|()
decl_stmt|;
comment|// 2. Get the bulk load wal edit event
name|WALEdit
name|logEdit
init|=
...
name|assertNull
argument_list|(
literal|"No bulk load entries scope should be added if bulk load replication is diabled."
argument_list|,
name|logKey
operator|.
name|getScopes
