...
specifier|final
name|String
name|OPT_USAGE_USETAG
init|=
literal|"Adds tags with every KV.  This option would be used"
operator|+
literal|" only if the HFileV3 version is used"
decl_stmt|;
specifier|public
specifier|static
specifier|final
...
specifier|final
name|String
name|OPT_USAGE_NUM_TAGS
init|=
literal|"Specifies the minimum and number of tags to be"
operator|+
literal|" added per KV"
decl_stmt|;
specifier|protected
specifier|static
specifier|final
...
name|println
argument_list|(
literal|"Using tags, number of tags per KV: min="
operator|+
name|minNumTags
operator|+
literal|", max="
