...
comment|// NOTE: the 5 (number of MODIFY_TABLE_DELETE_FS_LAYOUT + 1 step) is hardcoded,
...
argument_list|)
expr_stmt|;
comment|// "cf2" should be added and "cf1" should be removed
name|MasterProcedureTestingUtility
operator|.
name|validateTableCreation
argument_list|(
