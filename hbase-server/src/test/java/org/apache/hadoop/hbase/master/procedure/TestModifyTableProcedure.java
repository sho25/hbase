...
specifier|public
name|void
name|testConcurrentAddColumnFamily
parameter_list|()
throws|throws
name|IOException
throws|,
...
expr_stmt|;
class|class
name|ConcurrentAddColumnFamily
extends|extends
name|Thread
block|{
name|TableName
...
name|assertTrue
argument_list|(
literal|"Expected ConcurrentTableModificationException."
argument_list|,
operator|(
operator|(
name|t1
...
specifier|public
name|void
name|testConcurrentDeleteColumnFamily
parameter_list|()
throws|throws
name|IOException
throws|,
...
expr_stmt|;
class|class
name|ConcurrentCreateDeleteTable
extends|extends
name|Thread
block|{
name|TableName
...
specifier|public
name|void
name|testConcurrentModifyColumnFamily
parameter_list|()
throws|throws
name|IOException
throws|,
...
expr_stmt|;
class|class
name|ConcurrentModifyColumnFamily
extends|extends
name|Thread
block|{
name|TableName
...
specifier|public
name|void
name|testConcurrentModifyTable
parameter_list|()
throws|throws
name|IOException
throws|,
