...
name|DEEP_OVERHEAD
operator|+
literal|" DEEP_OVERHEAD_PER_PIPELINE_SKIPLIST_ITEM="
operator|+
name|CompactingMemStore
operator|.
...
name|DEEP_OVERHEAD
operator|+
literal|", CompactingMemStore DEEP_OVERHEAD_PER_PIPELINE_SKIPLIST_ITEM is:"
operator|+
name|CompactingMemStore
operator|.
name|DEEP_OVERHEAD_PER_PIPELINE_SKIPLIST_ITEM
...
specifier|public
name|void
name|testSelectiveFlushWhenEnabledNoFlattening
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// set memstore segment flattening to false and compact to skip-list
name|conf
operator|.
name|setBoolean
argument_list|(
