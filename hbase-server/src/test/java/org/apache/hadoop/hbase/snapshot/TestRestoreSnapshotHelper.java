...
specifier|public
name|void
name|testSkipReplayAndUpdateSeqId
parameter_list|()
throws|throws
name|Exception
block|{
...
name|valueOf
argument_list|(
literal|"testSkipReplayAndUpdateSeqId"
argument_list|)
decl_stmt|;
name|String
name|snapshotName
...
name|Path
argument_list|(
literal|"/hbase/.tmp-restore/testScannerWithRestoreScanner2"
argument_list|)
decl_stmt|;
...
argument_list|)
decl_stmt|;
comment|// open restored region without set restored flag
name|HRegion
name|region2
init|=
name|HRegion
