...
specifier|public
name|void
name|testBackupMastersExcluded
parameter_list|()
throws|throws
name|HBaseIOException
block|{
...
argument_list|)
expr_stmt|;
comment|// Round robin assignment
name|List
argument_list|<
name|HRegionInfo
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// Filter backup masters for balance cluster
name|Map
argument_list|<
name|ServerName
argument_list|,
