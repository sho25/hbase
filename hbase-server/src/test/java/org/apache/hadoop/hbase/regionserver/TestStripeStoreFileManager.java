...
argument_list|)
expr_stmt|;
comment|// Try to rebalance two stripes, but don't take all files from them - no effect.
name|StoreFile
name|sf_B2D_4
init|=
name|createFile
...
argument_list|)
expr_stmt|;
comment|// Rebalance two stripes correctly.
name|manager
operator|.
name|addCompactionResults
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Try various range mismatch cases in replaced and new data - no effect.
name|ArrayList
argument_list|<
name|StoreFile
argument_list|>
