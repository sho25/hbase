...
argument_list|)
decl_stmt|;
comment|// We need to add two cells, three times, in order to guarantee a merge
name|List
argument_list|<
name|String
index|[]
...
comment|// The in-memory flush size is bigger than the size of a single cell,
comment|// but smaller than the size of two cells.
comment|// Therefore, the two created cells are flattened in a seperate segment.
name|totalHeapSize
operator|+=
literal|2
operator|*
...
condition|)
block|{
comment|// Four out of the five segments are merged into one
name|totalHeapSize
operator|-=
operator|(
literal|4
