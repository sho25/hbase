...
expr_stmt|;
block|}
comment|/**    * Small scans should not return partial results because it would prevent small scans from    * retrieving all of the necessary results in a single RPC request which is what makese small    * scans useful. Thus, ensure that even when {@link Scan#getAllowPartialResults()} is true, small    * scans do not return partial results    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
name|testSmallScansDoNotAllowPartials
parameter_list|()
throws|throws
name|Exception
block|{
...
name|valueOf
argument_list|(
literal|"testReadPointAndPartialResults"
argument_list|)
decl_stmt|;
name|int
name|numRows
...
name|valueOf
argument_list|(
literal|"testPartialResultWhenRegionMove"
argument_list|)
argument_list|,
name|ROWS
argument_list|,
...
name|valueOf
argument_list|(
literal|"testReversedPartialResultWhenRegionMove"
argument_list|)
argument_list|,
name|ROWS
argument_list|,
...
name|valueOf
argument_list|(
literal|"testCompleteResultWhenRegionMove"
argument_list|)
argument_list|,
name|ROWS
argument_list|,
...
name|valueOf
argument_list|(
literal|"testReversedCompleteResultWhenRegionMove"
argument_list|)
argument_list|,
name|ROWS
argument_list|,
...
name|valueOf
argument_list|(
literal|"testBatchingResultWhenRegionMove"
argument_list|)
argument_list|,
name|ROWS
argument_list|,
...
name|valueOf
argument_list|(
literal|"testDontThrowUnknowScannerException"
argument_list|)
argument_list|,
name|ROWS
argument_list|,
