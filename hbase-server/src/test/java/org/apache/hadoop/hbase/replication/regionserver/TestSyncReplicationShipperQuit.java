...
begin_comment
comment|/**  * Testcase for HBASE-20456.  */
end_comment
...
specifier|public
class|class
name|TestSyncReplicationShipperQuit
extends|extends
name|SyncReplicationTestBase
block|{
annotation|@
...
specifier|public
name|void
name|testShipperQuitWhenDA
parameter_list|()
throws|throws
name|Exception
block|{
comment|// set to serial replication
name|UTIL1
operator|.
name|getAdmin
argument_list|()
...
argument_list|)
decl_stmt|;
comment|// the peer is serial so here we can make sure that the previous wals have already been
comment|// replicated, and finally the shipper should be removed from the worker pool
name|UTIL1
operator|.
name|waitFor
argument_list|(
