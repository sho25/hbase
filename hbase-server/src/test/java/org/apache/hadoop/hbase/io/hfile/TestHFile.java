...
specifier|public
name|void
name|testCorruptOutOfOrderHFileWrite
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|()
decl_stmt|;
comment|//second Cell will sort "higher" than the first because later timestamps should come first
name|writer
operator|.
name|append
argument_list|(
...
name|fail
argument_list|(
literal|"Exception wasn't thrown even though Cells were appended in the wrong order!"
argument_list|)
expr_stmt|;
block|}
specifier|public
...
argument_list|()
expr_stmt|;
comment|// pollute first cell's backing ByteBuffer
name|ByteBufferUtils
operator|.
...
argument_list|)
expr_stmt|;
comment|// write another cell, if DBE not Shipped, test will fail
name|writer
operator|.
name|append
argument_list|(
