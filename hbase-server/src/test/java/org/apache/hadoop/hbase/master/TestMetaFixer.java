...
argument_list|)
expr_stmt|;
comment|// wait for RITs to settle -- those are the fixed regions being assigned -- or until the
comment|// watchdog TestRule terminates the test.
name|await
argument_list|(
literal|50
argument_list|,
...
expr_stmt|;
block|}
comment|/**    * Await the successful return of {@code condition}, sleeping {@code sleepMillis} between    * invocations.    */
specifier|private
specifier|static
name|void
name|await
