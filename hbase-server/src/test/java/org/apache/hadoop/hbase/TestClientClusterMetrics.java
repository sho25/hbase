...
argument_list|)
expr_stmt|;
name|waitForUsersMetrics
argument_list|(
literal|0
argument_list|)
expr_stmt|;
name|long
name|writeMetaMetricBeforeNextuser
init|=
name|getMetaMetrics
argument_list|()
operator|.
...
expr_stmt|;
name|long
name|writeMetaMetricForUserFoo
init|=
name|getMetaMetrics
argument_list|()
operator|.
...
decl_stmt|;
name|long
name|readMetaMetricBeforeNextuser
init|=
name|getMetaMetrics
argument_list|()
operator|.
...
name|fail
argument_list|(
literal|"Should have filtered all rows"
argument_list|)
expr_stmt|;
block|}
block|}
...
expr_stmt|;
name|long
name|filteredMetaReqeustForTestUser
init|=
name|getMetaMetrics
argument_list|()
operator|.
...
argument_list|)
expr_stmt|;
comment|//Read/write count because of Meta operations
name|Assert
operator|.
name|assertTrue
argument_list|(
...
name|fail
argument_list|(
literal|"Should have find meta metrics"
argument_list|)
expr_stmt|;
return|return
literal|null
...
name|Exception
block|{
comment|//Sleep for metrics to get updated on master
name|Thread
operator|.
name|sleep
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//including current user + noOfUsers
return|return
name|metrics
operator|.
name|keySet
