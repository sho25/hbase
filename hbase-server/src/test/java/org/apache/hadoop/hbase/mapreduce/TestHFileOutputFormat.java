...
name|context
operator|=
name|getTestTaskAttemptContext
argument_list|(
name|job
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|/**    * @return True if the available mapreduce is post-0.20.    */
specifier|private
specifier|static
name|boolean
name|isPost020MapReduce
parameter_list|()
block|{
comment|// Here is a coarse test for post 0.20 hadoop; TAC became an interface.
return|return
name|TaskAttemptContext
operator|.
name|class
