...
return|;
block|}
comment|/**    * @deprecated Use {@link #generateData(java.util.Random, int)} instead.    * @return Generated random value to insert into a table cell.    */
annotation|@
name|Deprecated
specifier|public
specifier|static
...
operator|+
literal|"'valueSize': Default: Not set."
argument_list|)
expr_stmt|;
name|System
operator|.
...
throw|;
block|}
comment|// Calculate how many rows per gig.  If random value size presume that that half the max
comment|// is average row size.
name|int
name|rowsPerGB
init|=
name|ONE_GB
