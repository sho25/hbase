...
specifier|public
name|void
name|testLoadRegionFromMetaAfterRegionManuallyAdded
parameter_list|()
throws|throws
name|Exception
block|{
...
name|valueOf
argument_list|(
literal|"testLoadRegionFromMetaAfterRegionManuallyAdded"
argument_list|)
decl_stmt|;
name|this
operator|.
...
name|assertNull
argument_list|(
literal|"RegionInfo was just instantiated by the test, but "
operator|+
literal|"shouldn't be in AM regionStates yet."
argument_list|,
name|am
operator|.
name|getRegionStates
...
name|assertNull
argument_list|(
literal|"RegionInfo was manually added in META, but "
operator|+
literal|"shouldn't be in AM regionStates yet."
argument_list|,
name|am
...
specifier|public
name|void
name|testLoadRegionFromMetaRegionNotInMeta
parameter_list|()
throws|throws
name|Exception
block|{
...
name|valueOf
argument_list|(
literal|"testLoadRegionFromMetaRegionNotInMeta"
argument_list|)
decl_stmt|;
name|this
operator|.
...
name|assertNull
argument_list|(
literal|"RegionInfo was never added in META, should had returned null."
argument_list|,
name|am
operator|.
name|loadRegionFromMeta
