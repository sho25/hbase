...
specifier|static
class|class
name|FilterSomeCellsWALCellFilter
...
specifier|static
class|class
name|FilterAllCellsWALCellFilter
implements|implements
name|WALEntryFilter
implements|,
name|WALCellFilter
...
specifier|public
name|void
name|testChainWALEntryWithCellFilter
parameter_list|()
block|{
name|Entry
name|userEntry
...
argument_list|)
decl_stmt|;
comment|// since WALCellFilter filter cells with rowkey 'a'
name|assertEquals
argument_list|(
name|createEntry
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// since there is no cell to get filtered, nothing should get filtered
name|assertEquals
argument_list|(
name|userEntry2
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// since we filter all the cells, we should get empty entry
name|ChainWALEntryFilter
name|filterAllCells
init|=
operator|new
...
specifier|public
name|void
name|testChainWALEmptyEntryWithCellFilter
parameter_list|()
block|{
name|Entry
name|userEntry
...
argument_list|)
expr_stmt|;
comment|// let's set the filter empty entry flag to true now for the above case
name|filterAllCells
operator|.
...
argument_list|)
expr_stmt|;
comment|// since WALCellFilter filter all cells, whole entry should be filtered
name|assertEquals
argument_list|(
literal|null
argument_list|,
