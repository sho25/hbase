...
argument_list|)
decl_stmt|;
comment|// 1. replicate all user tables
name|when
argument_list|(
name|peerConfig
operator|.
...
argument_list|)
expr_stmt|;
comment|// 2. not replicate all user tables, no namespaces and table-cfs config
name|when
argument_list|(
name|peerConfig
operator|.
...
argument_list|)
expr_stmt|;
comment|// 3. Only config table-cfs in peer
comment|// empty map
name|userEntry
operator|=
name|createEntry
...
argument_list|)
expr_stmt|;
comment|// 3. Only config namespaces in peer
name|when
argument_list|(
name|peer
operator|.
...
argument_list|)
expr_stmt|;
comment|// 4. Config namespaces and table-cfs both
