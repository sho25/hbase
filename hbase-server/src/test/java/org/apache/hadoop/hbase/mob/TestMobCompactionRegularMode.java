...
specifier|public
class|class
name|TestMobCompactionRegularMode
extends|extends
...
name|info
argument_list|(
literal|"MOB compaction regular mode started"
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"MOB compaction regular mode finished OK"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|InterruptedException
block|{
comment|// Major compact MOB table
name|admin
operator|.
name|majorCompact
argument_list|(
