...
comment|// ROWPREFIX_DELIMITED: Row does not contain delimiter
...
condition|)
block|{
comment|// startRow does not contain delimiter
name|String
name|prefixStartRow
init|=
name|String
...
argument_list|)
expr_stmt|;
comment|// startRow contains delimiter, but stopRow does not have the same prefix as startRow.
name|prefixStartRow
operator|=
name|String
operator|.
