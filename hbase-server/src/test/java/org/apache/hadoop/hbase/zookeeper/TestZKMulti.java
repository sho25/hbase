...
expr_stmt|;
block|}
comment|/**    * Verifies that for the given root node, it should delete all the child nodes    * recursively using normal sequential way.    */
annotation|@
name|Test
argument_list|(
name|timeout
...
specifier|public
name|void
name|testdeleteChildrenRecursivelySequential
parameter_list|()
throws|throws
name|Exception
block|{
...
try|try
block|{
comment|// disables the multi-update api execution
name|ZKUtil
operator|.
name|deleteChildrenRecursivelyMultiOrSequential
argument_list|(
...
block|{
comment|// sets back the multi-update api execution
name|zkw
operator|.
name|getConfiguration
argument_list|()
...
expr_stmt|;
block|}
comment|/**    * Verifies that for the given root node, it should delete all the nodes recursively using    * normal sequential way.    */
annotation|@
name|Test
argument_list|(
name|timeout
...
specifier|public
name|void
name|testDeleteNodeRecursivelySequential
parameter_list|()
throws|throws
name|Exception
block|{
...
name|parentZNode
init|=
literal|"/testdeleteNodeRecursivelySequential"
decl_stmt|;
name|createZNodeTree
argument_list|(
name|parentZNode
