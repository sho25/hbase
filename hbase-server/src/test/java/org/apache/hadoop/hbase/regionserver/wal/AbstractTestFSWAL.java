...
specifier|public
name|void
name|testRollWriterForClosedWAL
parameter_list|()
throws|throws
name|IOException
block|{
...
specifier|public
name|void
name|testUnflushedSeqIdTrackingWithAsyncWal
parameter_list|()
throws|throws
name|IOException
throws|,
...
name|assertEquals
argument_list|(
literal|"Found seqId for the region which is already closed"
argument_list|,
name|HConstants
operator|.
name|NO_SEQNUM
