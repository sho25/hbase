...
expr_stmt|;
block|}
comment|/*    * Test that invalid draining server names (invalid start code) don't get added to drain list.    */
annotation|@
name|Test
argument_list|(
name|timeout
