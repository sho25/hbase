...
name|method
init|=
literal|"testSkipRecoveredEditsReplayTheLastFileIgnored"
decl_stmt|;
name|TableName
name|tableName
init|=
...
comment|// expected
block|}
comment|// The WAL is hosed. It has failed an append and a sync. It has an exception stuck in it
comment|// which it will keep returning until we roll the WAL to prevent any further appends going
comment|// in or syncs succeeding on top of failed appends, a no-no.
name|wal
operator|.
name|rollWriter
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// Roll WAL to clean out any exceptions stuck in it. See note above where we roll WAL.
name|wal
operator|.
name|rollWriter
argument_list|(
...
name|info
argument_list|(
literal|"...waiting for put thread to sync 1st time"
argument_list|)
expr_stmt|;
name|waitForCounter
argument_list|(
...
name|info
argument_list|(
literal|"...waiting for put thread to sync 2nd time"
argument_list|)
expr_stmt|;
name|waitForCounter
argument_list|(
...
name|info
argument_list|(
literal|"...releasing row lock 2, which should let put thread continue"
argument_list|)
expr_stmt|;
name|rowLock2
operator|.
...
name|info
argument_list|(
literal|"...waiting for put thread to sync 3rd time"
argument_list|)
expr_stmt|;
name|waitForCounter
argument_list|(
...
name|info
argument_list|(
literal|"...releasing row lock 3, which should let put thread continue"
argument_list|)
expr_stmt|;
name|rowLock3
operator|.
...
name|info
argument_list|(
literal|"...waiting for put thread to sync 4th time"
argument_list|)
expr_stmt|;
name|waitForCounter
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Split point should be the force split row
name|assertTrue
argument_list|(
name|Bytes
operator|.
...
argument_list|)
expr_stmt|;
comment|// Add a store that has references.
name|HStore
name|storeMock
init|=
name|Mockito
...
argument_list|)
expr_stmt|;
comment|// Will not split since the store has references.
name|regions
operator|=
name|splitRegion
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Region force split should be cleared after the split try.
name|assertFalse
argument_list|(
name|region
operator|.
...
argument_list|)
expr_stmt|;
comment|// Remove the store that has references.
name|region
operator|.
name|stores
operator|.
...
name|dir
operator|+
literal|"testRegionReplicaSecondary"
argument_list|)
decl_stmt|;
name|FSUtils
operator|.
...
block|}
block|}
comment|/**    * Test that we get the expected flush results back    * @throws IOException    */
annotation|@
name|Test
specifier|public
name|void
...
return|;
block|}
comment|/**    * @param tableName    * @param callingMethod    * @param conf    * @param families    * @throws IOException    * @return A region on which you must call    *         {@link HBaseTestingUtility#closeRegionAndWAL(HRegion)} when done.    */
specifier|private
specifier|static
name|HRegion
name|initHRegion
...
return|;
block|}
comment|/**    * @param tableName    * @param callingMethod    * @param conf    * @param isReadOnly    * @param families    * @throws IOException    * @return A region on which you must call    *         {@link HBaseTestingUtility#closeRegionAndWAL(HRegion)} when done.    */
specifier|private
specifier|static
name|HRegion
name|initHRegion
...
specifier|public
name|void
name|testSplitRegionWithReverseScan
parameter_list|()
throws|throws
name|IOException
block|{
...
name|valueOf
argument_list|(
literal|"testSplitRegionWithReverseScan"
argument_list|)
decl_stmt|;
name|byte
index|[]
...
argument_list|)
expr_stmt|;
comment|//fire the reverse scan1:  top range, and larger than the last row
name|Scan
name|scan
init|=
operator|new
...
argument_list|()
expr_stmt|;
comment|//fire the reverse scan2:  top range, and equals to the last row
name|scan
operator|=
operator|new
name|Scan
...
argument_list|()
expr_stmt|;
comment|//fire the reverse scan3:  bottom range, and larger than the last row
name|scan
operator|=
operator|new
name|Scan
...
argument_list|()
expr_stmt|;
comment|//fire the reverse scan4:  bottom range, and equals to the last row
name|scan
operator|=
operator|new
name|Scan
...
name|valueOf
argument_list|(
literal|"testOpenRegionWrittenToWAL"
argument_list|,
literal|100
argument_list|,
literal|42
...
name|valueOf
argument_list|(
literal|"testOpenRegionWrittenToWALForLogReplay"
argument_list|,
literal|100
argument_list|,
literal|42
