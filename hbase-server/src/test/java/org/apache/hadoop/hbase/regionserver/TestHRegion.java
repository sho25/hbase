...
specifier|public
name|void
name|testArchiveRecoveredEditsReplay
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testCheckAndMutate_WithFilters
parameter_list|()
throws|throws
name|Throwable
block|{
...
block|}
block|}
comment|/**    * Utility method to setup a WAL mock.    *<p/>    * Needs to do the bit where we close latch on the WALKeyImpl on append else test hangs.    * @return a mock WAL    */
specifier|private
name|WAL
name|mockWAL
parameter_list|()
