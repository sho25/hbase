...
comment|// so we try 10 times;  with the reorder it will never last more than a few milli seconds
for|for
control|(
name|int
name|i
...
condition|)
do|;
comment|// Let's fix our own order
name|setOurOrder
argument_list|(
name|l
argument_list|)
...
argument_list|()
decl_stmt|;
comment|// Should be filtered, the name is different
name|lrb
operator|.
name|reorderBlocks
argument_list|(
...
argument_list|)
expr_stmt|;
name|checkOurFixedOrder
argument_list|(
name|l
argument_list|)
expr_stmt|;
comment|// And change again and check again
name|l
operator|.
name|get
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// nothing to do here, but let's check
name|l
operator|.
name|get
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// nothing to do here, check again
name|l
operator|.
name|get
argument_list|(
