...
specifier|public
class|class
name|TestSyncReplicationMoreLogsInLocalCopyToRemote
extends|extends
...
name|fail
argument_list|(
literal|"Should fail since the rs will crash and we will not retry"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
block|{
return|return
literal|"The row is still not available"
return|;
block|}
block|}
argument_list|)
...
argument_list|)
expr_stmt|;
comment|// We should have copied the local log to remote, so we should be able to get the value
try|try
init|(
name|Table
name|table
