...
condition|)
block|{
comment|// Set up HLog for encryption
name|Configuration
name|conf
init|=
name|getConf
...
return|;
block|}
comment|/**    * Verify the content of the WAL file.    * Verify that the file has expected number of edits.    * @param wal    * @return Count of edits.    * @throws IOException    */
specifier|private
name|long
name|verify
parameter_list|(
...
name|println
argument_list|(
literal|"  -syncInterval<N> Append N edits and then sync. Default=0, i.e. sync every edit."
argument_list|)
expr_stmt|;
name|System
operator|.
