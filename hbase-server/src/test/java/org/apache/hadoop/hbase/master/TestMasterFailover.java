...
expr_stmt|;
block|}
comment|/**    * return the index of the active master in the cluster    * @throws MasterNotRunningException if no active master found    */
specifier|private
name|int
...
throw|;
block|}
comment|/**    * Kill the master and wait for a new active master to show up    * @param cluster    * @return the new active master    * @throws InterruptedException    * @throws MasterNotRunningException    */
specifier|private
name|HMaster
