...
argument_list|()
expr_stmt|;
comment|// if the pool was created on demand it should be closed upon connectin close
name|assertTrue
argument_list|(
name|pool
operator|.
...
argument_list|)
expr_stmt|;
comment|// The test may fail here if the thread doing the gets is stuck. The wait to find
