...
name|fail
argument_list|(
literal|"Waited too long for table to be disabled + "
operator|+
name|tablename
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// Mess up ZKTable state, otherwise, can't open the region
name|ZKTable
name|zkTable
init|=
name|cluster
...
name|info
argument_list|(
literal|"Region was deployed but not in online "
operator|+
literal|"region list. This should be transient. Waiting longer"
argument_list|)
expr_stmt|;
block|}
else|else
block|{
comment|// Now, region is deployed, reset the table state back
name|zkTable
operator|.
...
argument_list|)
expr_stmt|;
comment|//SPLITS + 1 is # regions pre-split.
name|assertNoErrors
argument_list|(
name|doFsck
argument_list|(
