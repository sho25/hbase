...
parameter_list|)
block|{
comment|// ignore UnknownSnapshotException, this is possible as for AsyncAdmin, the method will
comment|// return immediately after sending out the request, no matter whether the master has
comment|// processed the request or not.
if|if
condition|(
operator|!
operator|(
...
name|TimeoutException
argument_list|(
literal|"Timeout waiting for snapshot "
operator|+
name|snapshot
operator|+
literal|" to complete"
