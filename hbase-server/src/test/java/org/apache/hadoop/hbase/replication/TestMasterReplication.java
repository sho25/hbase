...
argument_list|)
expr_stmt|;
comment|// we now have an edit that was replicated into cluster originating from cluster 1
name|putAndWait
argument_list|(
name|row3
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// now add a local edit to cluster 2
name|Put
name|put
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// reenable replication from cluster 2 to cluster 3
name|admin2
operator|.
name|enablePeer
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// without HBASE-9158 the edit for row4 would have been marked with cluster 1's id
comment|// and hence not replicated to cluster 1
name|wait
argument_list|(
name|row4
argument_list|,
