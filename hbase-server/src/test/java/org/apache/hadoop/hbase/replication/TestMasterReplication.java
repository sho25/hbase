...
block|}
block|}
comment|/*    * Test RSRpcServices#replicateWALEntry when replication is disabled. This is to simulate    * HBASE-14840    */
annotation|@
name|Test
argument_list|(
name|timeout
...
specifier|public
name|void
name|testReplicateWALEntryWhenReplicationIsDisabled
parameter_list|()
throws|throws
name|Exception
block|{
