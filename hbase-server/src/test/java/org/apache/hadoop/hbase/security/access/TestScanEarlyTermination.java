...
argument_list|)
expr_stmt|;
comment|// A scan of FAMILY1 and FAMILY2 will produce combined results. If we use
comment|// a cell first strategy then cell ACLs come into effect. In FAMILY2, that
comment|// cell ACL on Q1 now grants access and the empty permission set on Q2 now
comment|// denies access.
name|verifyAllowed
argument_list|(
operator|new
name|AccessTestAction
