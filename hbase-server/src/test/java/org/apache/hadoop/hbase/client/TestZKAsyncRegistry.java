...
block|}
block|}
comment|/**    * Test meta tablestate implementation.    * Test is a bit involved because meta has replicas... Replica assign lags so check    * between steps all assigned.    */
annotation|@
name|Test
specifier|public
name|void
name|testMetaTableState
parameter_list|()
throws|throws
name|IOException
throws|,
