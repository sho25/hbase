...
block|}
block|}
comment|/**    * @param proceduresAsJSON This is String returned by admin.getProcedures call... an array of    *          Procedures as JSON.    * @return The Procedure timeout value parsed from the TRSP.    */
specifier|private
name|long
name|getTimeout
parameter_list|(
