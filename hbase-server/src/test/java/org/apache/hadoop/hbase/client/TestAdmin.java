...
name|tableName
init|=
literal|"testDeleteEditUnknownColumnFamilyAndOrTable"
operator|+
name|System
operator|.
...
argument_list|)
expr_stmt|;
comment|// Reset the value for the other tests
name|TEST_UTIL
operator|.
name|getMiniHBaseCluster
argument_list|()
...
specifier|public
name|void
name|testOnlineChangeReplicationScope
parameter_list|()
throws|throws
name|Exception
block|{
...
name|valueOf
argument_list|(
literal|"changeReplicationTable"
argument_list|)
decl_stmt|;
name|TEST_UTIL
operator|.
...
name|assertEquals
argument_list|(
literal|"Replication is enabled by default, which should not be the case"
argument_list|,
literal|0
argument_list|,
name|hcd
...
argument_list|)
expr_stmt|;
comment|// verify that the replication scope is off (0) by default
name|HColumnDescriptor
index|[]
name|hcds
init|=
...
name|assertEquals
argument_list|(
literal|"Unexpected number of column families returned"
argument_list|,
literal|1
argument_list|,
name|hcds
...
name|assertEquals
argument_list|(
literal|"There is an owner by default, which should not be the case"
argument_list|,
literal|null
argument_list|,
name|htd
...
argument_list|)
expr_stmt|;
comment|// does this need to be a valid user
name|admin
operator|.
name|modifyTable
argument_list|(
...
name|index
operator|+
literal|" should be at least deltaForLargestFamily "
operator|+
name|deltaForLargestFamily
argument_list|,
literal|false
...
specifier|public
name|void
name|testEmptyHTableDescriptor
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// wait 2s so that at least some of the RSes have the
comment|// info
name|Set
argument_list|<
name|HColumnDescriptor
...
name|println
argument_list|(
literal|"FAIL: HColumnDescriptor definition did not settle. Here is the output:"
argument_list|)
expr_stmt|;
name|Iterator
argument_list|<
...
name|fail
argument_list|(
literal|"HColumnDescription did not settle as expected."
argument_list|)
expr_stmt|;
block|}
name|assertEquals
argument_list|(
literal|"The number of regions did not match. Expected "
operator|+
name|totalRegions
operator|+
...
specifier|static
name|void
name|verifyBloomFilterPropertyOnEachRS
parameter_list|(
name|MiniHBaseCluster
name|miniCluster
parameter_list|,
...
name|assertEquals
argument_list|(
literal|"The bloom filter did not match expected value "
operator|+
name|expectedType
operator|+
literal|" on RS "
