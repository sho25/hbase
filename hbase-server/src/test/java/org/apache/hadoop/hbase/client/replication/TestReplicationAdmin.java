...
specifier|public
name|void
name|testRemovePeerWithNonDAState
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Transit sync replication state to ACTIVE.
name|hbaseAdmin
operator|.
...
name|fail
argument_list|(
literal|"Can't remove a synchronous replication peer with state=ACTIVE"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
comment|// OK
block|}
comment|// Transit sync replication state to DA
name|hbaseAdmin
operator|.
name|transitReplicationPeerSyncReplicationState
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Transit sync replication state to STANDBY
name|hbaseAdmin
operator|.
name|transitReplicationPeerSyncReplicationState
argument_list|(
...
name|fail
argument_list|(
literal|"Can't remove a synchronous replication peer with state=STANDBY"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"Only support replicated table config for sync replication"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"Only support replicated table config for sync replication, and tables can't be empty"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"Change replicated table config on an existing synchronous peer is not allowed"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
argument_list|)
expr_stmt|;
comment|// Disable and enable peer don't affect SyncReplicationState
name|hbaseAdmin
operator|.
...
name|fail
argument_list|(
literal|"Can't transit cluster state from ACTIVE to STANDBY"
argument_list|)
expr_stmt|;
block|}
catch|catch
