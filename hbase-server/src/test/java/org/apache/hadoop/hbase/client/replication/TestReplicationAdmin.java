...
name|Exception
block|{
comment|// Default replicate all flag is true
name|ReplicationPeerConfig
name|rpc
init|=
operator|new
...
name|fail
argument_list|(
literal|"Should throw Exception. When replicate all flag is true, no need to config namespaces"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"Should throw Exception. When replicate all flag is true, no need to config table-cfs"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
operator|+
literal|" When replicate all flag is true, no need to config namespaces or table-cfs"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"Should throw ReplicationException, because table "
operator|+
name|tableName1
operator|+
...
name|fail
argument_list|(
literal|"Should throw ReplicationException, because namespace "
operator|+
name|ns2
operator|+
