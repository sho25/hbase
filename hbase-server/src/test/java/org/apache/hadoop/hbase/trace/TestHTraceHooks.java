...
name|Exception
block|{
comment|// Find out what the right value to use fo SPAN_ROOT_ID after HTRACE-111. We use HTRACE-32
comment|// to find out to detect if we are using HTrace 3.2 or not.
try|try
block|{
name|Method
name|m
...
literal|0x74aceL
expr_stmt|;
comment|// Span.SPAN_ROOT_ID pre HTrace-3.2
block|}
name|TEST_UTIL
operator|.
