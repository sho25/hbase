...
control|)
block|{
comment|// LOG.info("" + count++ + " " + rr.toString());
block|}
name|s
operator|.
name|close
...
name|println
argument_list|(
literal|"  [--option] [--option=value]<command><nclients>"
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|" host          String. Specify Stargate endpoint."
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|" token         String. API access token."
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|" rows          Integer. Rows each client runs. Default: One million"
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|" rowsPerPut    Integer. Rows each Stargate (multi)Put. Default: 100"
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|" nomapred      (Flag) Run multiple clients using threads "
operator|+
