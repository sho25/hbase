...
begin_comment
comment|/**  * Test class for {@link MasterSpaceQuotaObserver}.  */
end_comment
...
specifier|public
class|class
name|TestMasterSpaceQuotaObserver
block|{
specifier|private
specifier|static
specifier|final
...
argument_list|)
expr_stmt|;
comment|// Delete the table and observe the quota being automatically deleted as well
name|admin
operator|.
name|disableTable
argument_list|(
...
specifier|public
name|void
name|testNamespaceQuotaRemoved
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertTrue
argument_list|(
literal|"Did not find MasterSpaceQuotaObserver in list of CPs: "
operator|+
name|coprocessorNames
argument_list|,
name|coprocessorNames
