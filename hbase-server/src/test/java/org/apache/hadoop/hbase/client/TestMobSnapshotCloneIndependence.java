...
expr_stmt|;
block|}
comment|/**    * Verify the mob cells still exist after the table to be cloned is deleted.    */
annotation|@
name|Test
argument_list|(
name|timeout
...
specifier|public
name|void
name|testDeleteTableToBeCloned
parameter_list|()
throws|throws
name|Exception
block|{
...
name|valueOf
argument_list|(
literal|"testDeleteTableToBeCloned"
argument_list|)
decl_stmt|;
name|byte
index|[]
...
argument_list|()
expr_stmt|;
comment|// make sure the mob cell exists
name|Scan
name|scan
init|=
operator|new
