...
specifier|public
name|void
name|testArchiveStoreFilesDifferentFileSystemsWallWithSchemaPlainRoot
parameter_list|()
throws|throws
name|Exception
block|{
...
name|walDir
init|=
literal|"mockFS://mockFSAuthority:9876/mockDir/wals/"
decl_stmt|;
name|String
name|baseDir
init|=
...
literal|"/"
decl_stmt|;
name|testArchiveStoreFilesDifferentFileSystems
argument_list|(
name|walDir
argument_list|,
name|baseDir
...
specifier|public
name|void
name|testArchiveStoreFilesDifferentFileSystemsWallNullPlainRoot
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testArchiveStoreFilesDifferentFileSystemsWallAndRootSame
parameter_list|()
throws|throws
name|Exception
block|{
...
name|thenReturn
argument_list|(
literal|"mocked-region-encoded-name"
argument_list|)
expr_stmt|;
name|Path
name|tableDir
...
name|Path
argument_list|(
literal|"mockFS://mockDir/tabledir"
argument_list|)
decl_stmt|;
name|byte
index|[]
...
name|expectedBase
operator|+
literal|"archive/data/default/mockTable/mocked-region-encoded-name/testfamily/mockFile"
decl_stmt|;
name|assertTrue
argument_list|(
name|pathCaptor
...
specifier|public
name|void
name|testArchiveRecoveredEditsWalDirNull
parameter_list|()
throws|throws
name|Exception
block|{
name|testArchiveRecoveredEditsWalDirNullOrSame
argument_list|(
literal|null
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|testArchiveRecoveredEditsWalDirSameFsStoreFiles
parameter_list|()
throws|throws
name|Exception
block|{
...
name|baseDir
init|=
literal|"mockFS://mockFSAuthority:9876/hbase/"
decl_stmt|;
name|UTIL
operator|.
name|getConfiguration
...
specifier|public
name|void
name|testArchiveRecoveredEditsWrongFS
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"/"
decl_stmt|;
comment|//Internally, testArchiveStoreFilesDifferentFileSystems will pass a "mockedFS"
comment|// to HFileArchiver.archiveRecoveredEdits, but since wal-dir is supposedly on same FS
comment|// as root dir it would lead to conflicting FSes and an IOException is expected.
name|testArchiveStoreFilesDifferentFileSystems
argument_list|(
literal|"/wal-dir"
argument_list|,
...
specifier|public
name|void
name|testArchiveRecoveredEditsWalDirDifferentFS
parameter_list|()
throws|throws
name|Exception
block|{
