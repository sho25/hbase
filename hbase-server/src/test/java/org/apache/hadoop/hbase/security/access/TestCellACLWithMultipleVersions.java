...
comment|// Setting of future timestamps is not allowed with System Monotonic and HLC.
comment|// So need not run this test against these two clocks.
if|if
condition|(
name|clockType
operator|==
...
name|Exception
block|{
comment|// This test relies is dependent on non monotonic timestamp updates which doesn't happen with
comment|// HLC and System Monotonic Clocks.
if|if
condition|(
name|clockType
operator|==
