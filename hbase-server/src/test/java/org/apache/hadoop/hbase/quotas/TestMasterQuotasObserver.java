...
argument_list|)
expr_stmt|;
comment|// Delete the table and observe the quotas being automatically deleted as well
name|dropTable
argument_list|(
name|admin
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Delete the namespace and observe the quotas being automatically deleted as well
name|admin
operator|.
name|deleteNamespace
argument_list|(
