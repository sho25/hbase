...
specifier|public
name|void
name|testTableSpaceAndRPCQuotaRemoved
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Set back the space quota
name|settings
operator|=
name|QuotaSettingsFactory
operator|.
...
argument_list|)
expr_stmt|;
comment|// Remove the throttle quota
name|settings
operator|=
name|QuotaSettingsFactory
operator|.
...
argument_list|)
expr_stmt|;
comment|// Set back the throttle quota
name|settings
operator|=
name|QuotaSettingsFactory
operator|.
...
argument_list|)
expr_stmt|;
comment|// Drop the table and check that both the quotas have been dropped as well
name|dropTable
argument_list|(
name|admin
argument_list|,
...
specifier|public
name|void
name|testNamespaceSpaceAndRPCQuotaRemoved
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Delete the namespace and check that both the quotas have been dropped as well
name|admin
operator|.
name|deleteNamespace
argument_list|(
