...
expr_stmt|;
block|}
comment|/**    * Runs an import job with the specified command line args    * @param args    * @return true if job completed successfully    * @throws Exception    */
name|boolean
name|runImport
parameter_list|(
name|String
...
return|;
block|}
comment|/**    * Test the writer's options.    * @throws IOException    */
annotation|@
name|Test
specifier|public
name|void
name|testOutputFileFormat
parameter_list|()
throws|throws
name|IOException
throws|,
...
argument_list|)
decl_stmt|;
comment|//need to make a copy of the configuration because to make sure the Exporter has set the "io.serializations"
name|copy
operator|.
name|setStrings
argument_list|(
...
argument_list|()
decl_stmt|;
comment|//skips the MR meta output
if|if
condition|(
name|path
operator|.
...
block|}
block|}
comment|/**    * Test simple replication case with column mapping    * @throws IOException    */
annotation|@
name|Test
specifier|public
name|void
...
block|}
block|}
comment|/**    * Test simple replication case with column mapping.    */
specifier|public
name|void
name|testSimpleCase
parameter_list|(
...
block|}
block|}
comment|/**    * Test export hbase:meta table    *    * @throws IOException    */
annotation|@
name|Test
specifier|public
name|void
...
block|}
block|}
comment|/**    * Test export scanner batching      * @throws java.lang.IOException    */
annotation|@
name|Test
specifier|public
name|void
...
name|assertEquals
argument_list|(
literal|"Unexpected row count between export("
operator|+
name|exporter
operator|.
name|toString
