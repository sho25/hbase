...
argument_list|)
decl_stmt|;
comment|// Register the hlog listener for the import table
...
expr_stmt|;
block|}
comment|/**    * This listens to the {@link #visitLogEntryBeforeWrite(HTableDescriptor, HLogKey, WALEdit)} to    * identify that an entry is written to the Write Ahead Log for the given table.    */
specifier|private
specifier|static
class|class
name|TableWALActionListener
...
name|IOException
block|{
comment|// Not interested in this method.
block|}
annotation|@
name|Override
specifier|public
