...
name|USER_NSP_WRITE
decl_stmt|;
comment|// user with admin permission on namespace.
specifier|private
specifier|static
name|User
name|USER_NSP_ADMIN
...
block|}
decl_stmt|;
comment|// verify that only superuser can create namespaces.
name|verifyAllowed
argument_list|(
name|createNamespace
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// verify that superuser or hbase admin can delete namespaces.
name|verifyAllowed
argument_list|(
name|deleteNamespace
argument_list|,
...
block|}
decl_stmt|;
comment|// verify that superuser or hbase admin can get the namespace descriptor.
name|verifyAllowed
argument_list|(
name|getNamespaceAction
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Only an admin should be able to get the user permission
name|verifyAllowed
argument_list|(
name|revokeAction
argument_list|,
