...
specifier|public
name|void
name|testDeleteRowForDeletedRegionNoPeers
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// There are no peers, and no catalog family for this region either, so we should remove the
comment|// barriers. And since there is no catalog family, after we delete the barrier family, the whole
