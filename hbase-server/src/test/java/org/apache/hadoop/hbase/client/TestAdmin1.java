...
name|valueOf
argument_list|(
literal|"testCompactionTimestampsTable"
argument_list|)
decl_stmt|;
name|HTableDescriptor
name|htd
...
name|valueOf
argument_list|(
literal|"testSplitAndMergeWithReplicaTable"
argument_list|)
decl_stmt|;
name|HTableDescriptor
name|desc
...
literal|false
expr_stmt|;
comment|// Try going to the regionservers directly
comment|// first move the region to the same regionserver
if|if
condition|(
operator|!
name|regions
...
name|valueOf
argument_list|(
literal|"testEnableDisableAddColumnDeleteColumn"
argument_list|)
decl_stmt|;
name|TEST_UTIL
operator|.
...
name|valueOf
argument_list|(
literal|"testDeleteLastColumnFamily"
argument_list|)
decl_stmt|;
name|TEST_UTIL
operator|.
...
name|valueOf
argument_list|(
literal|"testMergeWithFullRegionName"
argument_list|)
decl_stmt|;
name|HColumnDescriptor
name|cd
