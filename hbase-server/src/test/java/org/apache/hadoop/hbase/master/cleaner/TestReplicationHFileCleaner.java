...
expr_stmt|;
block|}
comment|/*    * Test for HBASE-14621. This test will not assert directly anything. Without the fix the test    * will end up in a infinite loop, so it will timeout.    */
annotation|@
name|Test
argument_list|(
name|timeout
...
specifier|public
name|void
name|testForDifferntHFileRefsZnodeVersion
parameter_list|()
throws|throws
name|Exception
block|{
...
name|root
argument_list|,
literal|"testForDifferntHFileRefsZnodeVersion"
argument_list|)
decl_stmt|;
name|fs
operator|.
...
argument_list|)
decl_stmt|;
comment|//Return different znode version for each call
name|Mockito
operator|.
name|when
argument_list|(
