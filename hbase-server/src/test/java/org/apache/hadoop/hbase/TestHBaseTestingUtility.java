...
argument_list|()
decl_stmt|;
comment|/**    * Basic sanity test that spins up multiple HDFS and HBase clusters that share    * the same ZK ensemble. We then create the same table in both and make sure    * that what we insert in one place doesn't end up in the other.    * @throws Exception on error    */
annotation|@
name|Test
specifier|public
name|void
