...
argument_list|)
decl_stmt|;
comment|/**    * Context used by our wal dictionary compressor.  Null if we're not to do    * our custom dictionary compression.  This custom WAL compression is distinct    * from sequencefile native compression.    */
specifier|private
...
name|IOException
block|{
comment|// Should we do our custom WAL compression?
name|boolean
name|compress
init|=
name|conf
