...
argument_list|)
decl_stmt|;
comment|// TODO let uncomment the GZ algorithm in HBASE-21937, because no support BB unpack yet.
specifier|static
specifier|final
name|Compression
operator|.
...
argument_list|()
decl_stmt|;
comment|// Generate boolean triples from 000 to 111
for|for
control|(
name|int
name|i
