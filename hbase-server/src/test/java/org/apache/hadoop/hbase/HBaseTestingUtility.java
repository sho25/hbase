...
return|;
block|}
comment|/**    * Same as {@link #startMiniCluster(int, int, String[], Class, Class)}, but with custom    * number of datanodes.    * @param numDataNodes Number of data nodes.    * @param create Set this flag to create a new    * root or data directory path or not (will overwrite if exists already).    */
specifier|public
name|MiniHBaseCluster
name|startMiniCluster
parameter_list|(
