...
expr_stmt|;
block|}
comment|/*    * This is the test for : HBASE-20940 This test will split the region and try to open an reference    * over store file. Once store file has any reference, it makes sure that region can't be split    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
...
name|assertEquals
argument_list|(
literal|"Compaction did not complete in 30 secs"
argument_list|,
name|CompactionState
operator|.
name|NONE
