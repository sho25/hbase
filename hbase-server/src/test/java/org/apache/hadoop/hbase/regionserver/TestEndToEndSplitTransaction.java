...
specifier|private
name|void
name|runTestFromClientSideWhileSplitting
parameter_list|(
name|boolean
...
operator|=
operator|new
name|RegionSplitterWithSchemaChange
argument_list|(
name|table
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|testFromClientSideOnlineSchemaChangeWhileSplitting
parameter_list|()
throws|throws
name|Throwable
block|{
