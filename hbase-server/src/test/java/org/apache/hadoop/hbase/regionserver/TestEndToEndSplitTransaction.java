...
block|}
block|}
comment|/** bloks until the region split is complete in META and region server opens the daughters */
name|void
name|blockUntilRegionSplit
parameter_list|(
name|long
...
operator|)
expr_stmt|;
name|blockUntilRegionIsOpenedByRS
argument_list|(
name|rem
argument_list|,
name|daughterA
...
name|log
argument_list|(
literal|"blocking until region is opened by region server: "
operator|+
name|Bytes
operator|.
name|toStringBinary
...
name|log
argument_list|(
literal|"found region open in RS: "
operator|+
name|Bytes
operator|.
name|toStringBinary
