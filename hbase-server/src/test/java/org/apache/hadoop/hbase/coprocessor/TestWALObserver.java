...
specifier|public
name|void
name|testLegacyWALObserverWriteToWAL
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testNonLegacyWALKeysDoNotExplode
parameter_list|()
throws|throws
name|Exception
block|{
...
name|debug
argument_list|(
literal|"ensuring wal entries haven't happened before we start"
argument_list|)
expr_stmt|;
name|assertFalse
argument_list|(
...
name|debug
argument_list|(
literal|"writing to WAL with non-legacy keys."
argument_list|)
expr_stmt|;
name|NavigableMap
argument_list|<
...
name|debug
argument_list|(
literal|"Verify that only the non-legacy CP saw edits."
argument_list|)
expr_stmt|;
name|assertTrue
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// wish we could test that the log message happened :/
name|assertFalse
argument_list|(
name|oldApi
operator|.
...
name|debug
argument_list|(
literal|"write a log edit that supports legacy cps."
argument_list|)
expr_stmt|;
specifier|final
name|long
...
name|debug
argument_list|(
literal|"Make sure legacy cps can see supported edits after having been skipped."
argument_list|)
expr_stmt|;
name|assertTrue
argument_list|(
literal|"non-legacy WALObserver didn't see pre-write."
argument_list|,
name|newApi
operator|.
name|isPreWALWriteCalled
...
name|assertTrue
argument_list|(
literal|"non-legacy WALObserver didn't see post-write."
argument_list|,
name|newApi
operator|.
name|isPostWALWriteCalled
...
name|assertFalse
argument_list|(
literal|"non-legacy WALObserver shouldn't have seen legacy pre-write."
argument_list|,
name|newApi
operator|.
name|isPreWALWriteDeprecatedCalled
...
name|assertFalse
argument_list|(
literal|"non-legacy WALObserver shouldn't have seen legacy post-write."
argument_list|,
name|newApi
operator|.
name|isPostWALWriteDeprecatedCalled
...
name|assertTrue
argument_list|(
literal|"legacy WALObserver didn't see pre-write."
argument_list|,
name|oldApi
operator|.
name|isPreWALWriteCalled
...
name|assertTrue
argument_list|(
literal|"legacy WALObserver didn't see post-write."
argument_list|,
name|oldApi
operator|.
name|isPostWALWriteCalled
...
name|assertTrue
argument_list|(
literal|"legacy WALObserver didn't see legacy pre-write."
argument_list|,
name|oldApi
operator|.
name|isPreWALWriteDeprecatedCalled
...
name|assertTrue
argument_list|(
literal|"legacy WALObserver didn't see legacy post-write."
argument_list|,
name|oldApi
operator|.
name|isPostWALWriteDeprecatedCalled
