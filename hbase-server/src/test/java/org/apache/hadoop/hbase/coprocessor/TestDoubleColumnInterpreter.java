...
begin_comment
comment|/**  * A test class to test DoubleColumnInterpreter for AggregateProtocol  */
end_comment
...
specifier|public
class|class
name|TestDoubleColumnInterpreter
block|{
specifier|protected
specifier|static
name|Log
...
expr_stmt|;
comment|// CP will throw an IOException about the
comment|// null column family, and min will be set to 0
block|}
annotation|@
name|Test
argument_list|(
