...
argument_list|)
decl_stmt|;
comment|// Tag this increment with an ACL that denies write permissions to USER_OTHER
name|i
operator|.
name|setACL
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// We should be able to increment Q2 twice, the previous ACL will be
...
specifier|public
name|void
name|testCellStrategy
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Set up our test actions
name|AccessTestAction
name|readQ1Default
init|=
operator|new
...
name|p
decl_stmt|;
comment|// The empty permission set on Q1
name|p
operator|=
operator|new
name|Put
...
argument_list|)
expr_stmt|;
comment|// Read permissions on Q2
name|p
operator|=
operator|new
name|Put
...
argument_list|)
expr_stmt|;
comment|// A read by USER_OTHER will be denied with the default cell strategy as
comment|// there is no visibility without a grant and a cell ACL giving
comment|// explicit permission
name|verifyDenied
argument_list|(
name|readQ1Default
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// A read will be allowed by the default cell strategy if there is a cell
comment|// ACL giving explicit permission.
name|verifyAllowed
argument_list|(
name|readQ2Default
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// A read by USER_OTHER will now be allowed with the default cell strategy
comment|// because we have a CF level grant and we take the union of permissions.
name|verifyAllowed
argument_list|(
name|readQ1Default
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// A read by USER_OTHER will be denied with the cell first strategy
comment|// because the empty perm set for USER_OTHER in the cell ACL there
comment|// revokes access.
name|verifyDenied
argument_list|(
name|readQ1CellFirst
argument_list|,
