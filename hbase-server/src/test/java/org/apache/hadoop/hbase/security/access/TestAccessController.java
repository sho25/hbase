...
argument_list|)
decl_stmt|;
comment|// Tag this increment with an ACL that denies write permissions to userOther
name|i
operator|.
name|setACL
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Grant namespace READ to USER_NONE, this should supercede any table permissions
name|HTable
name|acl
init|=
operator|new
