...
name|USER_RO
decl_stmt|;
comment|// user with table admin permissions
specifier|private
specifier|static
name|User
name|USER_TBLADM
...
block|}
decl_stmt|;
comment|// verify that superuser and admin only can split
name|verifyAllowed
argument_list|(
name|action
argument_list|,
...
block|}
decl_stmt|;
comment|// verify that superuser and admin only can flush
name|verifyAllowed
argument_list|(
name|action
argument_list|,
...
block|}
decl_stmt|;
comment|// verify that superuser and admin only can compact
name|verifyAllowed
argument_list|(
name|action
argument_list|,
