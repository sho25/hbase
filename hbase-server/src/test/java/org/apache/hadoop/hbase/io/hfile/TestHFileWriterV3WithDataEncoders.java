...
begin_comment
comment|/**  * Testing writing a version 3 {@link HFile} for all encoded blocks  */
end_comment
...
specifier|public
class|class
name|TestHFileWriterV3WithDataEncoders
block|{
annotation|@
name|ClassRule
specifier|public
...
name|info
argument_list|(
literal|"Current offset: {}, scanning until {}"
argument_list|,
name|fsdis
operator|.
name|getPos
...
name|info
argument_list|(
literal|"Finished reading: entries={}, blocksRead = {}"
argument_list|,
name|entriesRead
argument_list|,
name|blocksRead
