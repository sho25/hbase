...
argument_list|)
expr_stmt|;
comment|// Set up an appender to catch the "Too many delayed calls" that we expect.
name|ListAppender
name|listAppender
init|=
operator|new
...
literal|null
argument_list|,
literal|"testTooManyDelayedRpcs"
argument_list|,
name|Lists
operator|.
name|newArrayList
...
argument_list|)
decl_stmt|;
name|FaultyTestDelayedImplementation
name|instance
init|=
operator|new
name|FaultyTestDelayedImplementation
...
name|warn
argument_list|(
literal|"Caught exception, expected="
operator|+
name|caughtException
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"In faulty test, delaying"
argument_list|)
expr_stmt|;
try|try
block|{
