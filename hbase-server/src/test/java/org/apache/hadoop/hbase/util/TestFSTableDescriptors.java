...
name|name
init|=
literal|"testReadingOldHTDFromFS"
decl_stmt|;
name|FileSystem
name|fs
init|=
...
specifier|public
name|void
name|testHTableDescriptorsNoCache
parameter_list|()
throws|throws
name|IOException
throws|,
...
name|name
init|=
literal|"testHTableDescriptorsNoCache"
decl_stmt|;
name|FileSystem
name|fs
init|=
...
operator|)
operator|+
literal|" HTableDescriptor.get() on "
operator|+
name|tablename
operator|+
literal|", cachehits="
