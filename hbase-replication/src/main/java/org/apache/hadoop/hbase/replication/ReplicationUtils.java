...
specifier|final
name|String
name|REMOTE_WAL_SNAPSHOT_SUFFIX
init|=
literal|"-snapshot"
decl_stmt|;
comment|// This is used for copying sync replication log from local to remote and overwrite the old one
comment|// since some FileSystem implementation may not support atomic rename.
specifier|public
specifier|static
specifier|final
name|String
...
return|;
block|}
comment|/**    * Returns whether we should replicate the given table.    */
specifier|public
specifier|static
name|boolean
name|contains
...
return|;
block|}
comment|/**    * Do the sleeping logic    * @param msg Why we sleep    * @param sleepForRetries the base sleep time.    * @param sleepMultiplier by how many times the default sleeping time is augmented    * @param maxRetriesMultiplier the max retry multiplier    * @return True if<code>sleepMultiplier</code> is&lt;<code>maxRetriesMultiplier</code>    */
specifier|public
specifier|static
name|boolean
...
return|;
block|}
comment|/**    * Get the adaptive timeout value when performing a retry    */
specifier|public
specifier|static
name|int
name|getAdaptiveTimeout
parameter_list|(
specifier|final
name|int
name|initialValue
