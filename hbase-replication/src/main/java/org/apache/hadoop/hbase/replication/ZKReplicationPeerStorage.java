...
specifier|final
name|String
name|SYNCHRONOUS_REPLICATION_STATE_ZNODE
init|=
...
name|ReplicationException
argument_list|(
literal|"Unable to change the cluster state for the synchronous replication peer with id="
operator|+
name|peerId
argument_list|,
name|e
...
name|ReplicationException
argument_list|(
literal|"Error getting cluster state for the synchronous replication peer with id="
operator|+
name|peerId
argument_list|,
name|e
