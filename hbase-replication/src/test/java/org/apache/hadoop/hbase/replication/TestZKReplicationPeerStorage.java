...
name|fail
argument_list|(
literal|"Should throw a ReplicationException when getting peer config of a removed peer"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
specifier|public
name|void
name|testNoSyncReplicationState
parameter_list|()
throws|throws
name|ReplicationException
throws|,
...
name|IOException
block|{
comment|// This could happen for a peer created before we introduce sync replication.
name|String
name|peerId
init|=
literal|"testNoSyncReplicationState"
decl_stmt|;
try|try
block|{
name|STORAGE
...
name|fail
argument_list|(
literal|"Should throw a ReplicationException when getting state of inexist peer"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
argument_list|)
expr_stmt|;
comment|// delete the sync replication state node to simulate
name|ZKUtil
operator|.
name|deleteNode
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// should not throw exception as the peer exists
name|assertEquals
argument_list|(
name|SyncReplicationState
operator|.
...
argument_list|)
expr_stmt|;
comment|// make sure we create the node for the old format peer
name|assertNotEquals
argument_list|(
operator|-
literal|1
