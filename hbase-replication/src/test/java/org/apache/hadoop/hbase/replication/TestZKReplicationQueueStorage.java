...
specifier|private
name|ZKReplicationQueueStorage
name|createWithUnstableVersion
parameter_list|()
throws|throws
name|IOException
block|{
...
name|Integer
argument_list|>
name|getLastSequenceIdWithVersion
parameter_list|(
name|String
...
condition|)
block|{
comment|// Let the ZNode version increase.
name|String
name|path
init|=
...
expr_stmt|;
block|}
comment|// For HBASE-20138
annotation|@
name|Test
specifier|public
name|void
name|testSetWALPositionBadVersion
parameter_list|()
throws|throws
name|IOException
throws|,
...
name|encodedRegionName
init|=
literal|"31d9792f4435b99d9fb1016f6fbc8dc6"
decl_stmt|;
name|storage
operator|.
name|addWAL
...
argument_list|)
expr_stmt|;
comment|// This should return eventually when data version stabilizes
name|storage
operator|.
name|setWALPosition
argument_list|(
...
specifier|public
name|void
name|testRemoveAllLastPushedSeqIdsForPeer
parameter_list|()
throws|throws
name|Exception
block|{
