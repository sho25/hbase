...
begin_comment
comment|// import org.apache.hadoop.hbase.MiniZooKeeperCluster;
end_comment
...
begin_comment
comment|// import org.apache.hadoop.hbase.zookeeper.ZooKeeperWrapper;
end_comment
...
argument_list|()
expr_stmt|;
comment|/* REENALBE     MiniZooKeeperCluster miniZK = utility1.getZkCluster();     zkw1 = ZooKeeperWrapper.createInstance(conf1, "cluster1");     zkw1.writeZNode("/1", "replication", "");     zkw1.writeZNode("/1/replication", "master",         conf1.get(HConstants.ZOOKEEPER_QUORUM)+":" +             conf1.get("hbase.zookeeper.property.clientPort")+":/1");     setIsReplication(true); */
name|LOG
operator|.
name|info
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* REENALBE     utility2 = new HBaseTestingUtility(conf2);     utility2.setZkCluster(miniZK);     zkw2 = ZooKeeperWrapper.createInstance(conf2, "cluster2");     zkw2.writeZNode("/2", "replication", "");     zkw2.writeZNode("/2/replication", "master",         conf1.get(HConstants.ZOOKEEPER_QUORUM)+":" +             conf1.get("hbase.zookeeper.property.clientPort")+":/1");      zkw1.writeZNode("/1/replication/peers", "1",         conf2.get(HConstants.ZOOKEEPER_QUORUM)+":" +             conf2.get("hbase.zookeeper.property.clientPort")+":/2"); */
name|LOG
operator|.
name|info
argument_list|(
