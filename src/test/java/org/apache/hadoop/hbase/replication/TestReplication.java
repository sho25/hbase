...
name|conf2
decl_stmt|;
comment|/*   private static ZooKeeperWrapper zkw1;   private static ZooKeeperWrapper zkw2;   */
specifier|private
specifier|static
name|HTable
name|htable1
...
argument_list|)
expr_stmt|;
comment|// REENALBE  zkw1.writeZNode("/1/replication", "state", Boolean.toString(rep));
