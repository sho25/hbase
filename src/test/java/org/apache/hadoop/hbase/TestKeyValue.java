...
decl_stmt|;
comment|// empty value
comment|// verify key with a non-empty value works
name|KeyValue
name|kv1
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// verify key with an already-empty value works
name|KeyValue
name|kv2
init|=
operator|new
...
argument_list|()
expr_stmt|;
comment|// they should still be equal
name|assertTrue
argument_list|(
name|kv2
operator|.
...
argument_list|)
expr_stmt|;
comment|// but they should have different underlying byte arrays
name|assertFalse
argument_list|(
name|kv2
operator|.
...
argument_list|)
expr_stmt|;
comment|// both with 0 length values
name|assertTrue
argument_list|(
name|kv2
operator|.
