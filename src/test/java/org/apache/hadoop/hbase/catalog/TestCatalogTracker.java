...
argument_list|)
decl_stmt|;
comment|// Make it so our implementation is returned when we do a connection.
comment|// Need to fake out the location lookup stuff first.
name|ServerName
name|sn
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// Have implementation returned which ever way getHRegionConnection is called.
name|Mockito
operator|.
name|when
argument_list|(
