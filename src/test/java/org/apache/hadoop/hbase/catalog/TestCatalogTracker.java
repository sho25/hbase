...
name|KeeperException
block|{
comment|// Mock an HRegionInterface.
specifier|final
name|HRegionInterface
name|implementation
init|=
...
try|try
block|{
comment|// If a 'getRegionInfo' is called on mocked HRegionInterface, throw IOE
...
block|}
block|}
comment|/**    * Test we survive a connection refused {@link ConnectException}    * @throws IOException    * @throws InterruptedException    * @throws KeeperException    */
annotation|@
name|Test
specifier|public
name|void
