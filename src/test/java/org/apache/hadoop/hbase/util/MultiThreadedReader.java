...
argument_list|)
expr_stmt|;
comment|// if we got no data report error
if|if
condition|(
name|result
operator|.
...
name|error
argument_list|(
literal|"No data returned, tried to get actions for key = "
operator|+
name|rowKey
operator|+
operator|(
...
literal|", keys inserted by writer: "
operator|+
name|writer
operator|.
name|numKeys
...
condition|)
block|{
comment|// increment number of columns read
name|numCols
operator|.
name|addAndGet
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// if something does not look right report it
if|if
condition|(
operator|!
name|LoadTestKVGenerator
