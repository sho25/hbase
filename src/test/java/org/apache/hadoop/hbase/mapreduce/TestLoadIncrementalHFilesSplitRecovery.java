...
specifier|public
name|void
name|testBulkLoadPhaseRecovery
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Now let's cause trouble
specifier|final
name|AtomicInteger
name|attmptedCalls
init|=
