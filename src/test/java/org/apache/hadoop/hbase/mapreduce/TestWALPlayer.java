...
expr_stmt|;
block|}
comment|/**    * Simple test for data parsing    * @throws Exception    */
annotation|@
name|Test
specifier|public
name|void
...
argument_list|)
expr_stmt|;
comment|// make sure if nothing is specified nothing is set
name|assertNull
argument_list|(
name|conf
operator|.
...
argument_list|)
expr_stmt|;
comment|// test a textual data (including ms)
name|conf
operator|.
name|set
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// test with mss as a long
name|conf
operator|.
name|set
argument_list|(
