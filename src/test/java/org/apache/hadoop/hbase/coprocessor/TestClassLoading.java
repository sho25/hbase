...
begin_comment
comment|/**    * return the subset of all regionservers    * (actually returns set of HServerLoads)    * which host some region in a given table.    * used by assertAllRegionServers() below to    * test reporting of loaded coprocessors.    * @param tableName : given table.    * @return subset of all servers.    */
end_comment
