...
argument_list|)
decl_stmt|;
comment|// delete was first, row should exist
name|assertEquals
argument_list|(
literal|0
argument_list|,
...
expr_stmt|;
block|}
comment|/**    * Test HConnection can be recovered after this connection has been    * aborted.    * @throws IOException    */
annotation|@
name|Test
specifier|public
name|void
name|testConnectionResetAfterAbort
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// At this time, abort the connection.
name|HConnection
name|conn
init|=
name|table
...
literal|true
decl_stmt|;
comment|// This put will success, for the connection has been recovered.
try|try
block|{
name|Put
name|put02
