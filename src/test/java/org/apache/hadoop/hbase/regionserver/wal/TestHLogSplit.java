...
comment|// Not available in 0.20 hdfs
comment|// TEST_UTIL.getDFSCluster().getNamesystem().leaseManager.
comment|//  setLeasePeriod(100, 50000);
comment|// Use reflection to get at the 0.20 version of above.
name|MiniDFSCluster
name|dfsCluster
init|=
name|TEST_UTIL
...
block|}
block|}
comment|//TODO: check the edits order is respected (scenarios)
annotation|@
name|Test
specifier|public
name|void
