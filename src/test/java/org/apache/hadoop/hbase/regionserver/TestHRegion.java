...
return|;
block|}
comment|/**    * @param tableName    * @param startKey    * @param stopKey    * @param callingMethod    * @param conf    * @param families    * @throws IOException    * @return A region on which you must call {@link HRegion#closeHRegion(HRegion)} when done.    */
specifier|private
specifier|static
name|HRegion
name|initHRegion
