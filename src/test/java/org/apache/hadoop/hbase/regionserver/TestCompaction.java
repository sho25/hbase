...
expr_stmt|;
block|}
comment|/**    * Test major compaction with block cache.    * @throws Exception    */
specifier|public
name|void
name|testDataBlockEncodingWithNormalSeek
parameter_list|()
throws|throws
name|Exception
block|{
comment|// block cache only
...
expr_stmt|;
block|}
comment|/**    * Test major compaction with block cache and in memory encoding.    * @throws Exception    */
specifier|public
name|void
name|testDataBlockEncodingWithEncodedSeek
parameter_list|()
throws|throws
name|Exception
block|{
