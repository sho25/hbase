...
argument_list|)
expr_stmt|;
comment|// sort first so you don't include huge file the tail end
comment|// happens with HFileOutputFormat bulk migration
name|compactEquals
argument_list|(
name|sfCreate
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// unless one of those files is too big
name|compactEquals
argument_list|(
name|sfCreate
argument_list|(
