...
comment|/*     // the below config caused IllegalArgumentException in our production cluster     // however, the resulting byteSize is< MAX_INT, so this should work properly     writer = new StoreFile.Writer(fs, f,         StoreFile.DEFAULT_BLOCKSIZE_SMALL, HFile.DEFAULT_COMPRESSION_ALGORITHM,         conf, KeyValue.COMPARATOR, StoreFile.BloomType.ROW, 272446963);     assertTrue(writer.hasBloom());     bloomWriteRead(writer, fs);     */
...
comment|//scan.setTimeRange(27, 50);
comment|//assertTrue(!scanner.shouldSeek(scan, columns));
block|}
specifier|public
name|void
