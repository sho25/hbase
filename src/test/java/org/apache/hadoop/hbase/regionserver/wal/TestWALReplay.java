...
argument_list|)
expr_stmt|;
comment|// Now close the region, split the log, reopen the region and assert that
comment|// replay of log has no effect, that our seqids are calculated correctly so
...
argument_list|(
literal|"Called when it should not have been!"
argument_list|)
throw|;
block|}
block|}
...
comment|// out from under it and assert that replay of the log addes the edits back
