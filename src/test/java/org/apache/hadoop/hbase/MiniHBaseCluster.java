...
expr_stmt|;
block|}
comment|/**      * This implementation is special, exceptions will be treated first and      * message won't be sent back to the region servers even if some are      * specified.      * @param hsi the rs      * @param msgs Messages to add to      * @return      * @throws IOException will be throw if any added for this region server      */
annotation|@
name|Override
specifier|protected
name|HMsg
...
return|;
block|}
comment|/**    * @return Returns the rpc address actually used by the currently active    * master server, because the supplied port is not necessarily the actual port    * used.    */
specifier|public
name|HServerAddress
...
return|;
block|}
comment|/**    * Add an exception to send when a region server checks back in    * @param serverNumber Which server to send it to    * @param ex The exception that will be sent    * @throws IOException    */
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**    * Add an exception to send when a region server checks back in    * @param hrs Which server to send it to    * @param ex The exception that will be sent    * @throws IOException    */
specifier|public
name|void
name|addExceptionToSendRegionServer
parameter_list|(
