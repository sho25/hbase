...
specifier|public
name|void
name|testBalanceAndShutdownServerAtSameTime
parameter_list|()
throws|throws
name|IOException
throws|,
...
decl_stmt|;
comment|// Amend ServerManager mock so that when we do send close of our region on
comment|// RANDOM_SERVERNAME, it will return true rather than default null.
name|Mockito
operator|.
name|when
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// Call the balance function
name|RegionPlan
name|plan
init|=
operator|new
