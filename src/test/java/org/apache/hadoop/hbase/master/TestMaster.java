...
argument_list|)
expr_stmt|;
comment|/**        * TODO: these methods return null when the regions are not deployed.        * These tests should be uncommented after HBASE-2656.       assertNotNull(pair);       m.getTableRegionFromName(pair.getFirst().getRegionName());       */
block|}
finally|finally
block|{
name|proceed
