...
name|fail
argument_list|(
literal|"NotServingRegionException should not be thrown after enabling the table.  Hence failing"
operator|+
literal|"the test case"
argument_list|)
expr_stmt|;
block|}
name|regions
...
name|assertEquals
argument_list|(
literal|"All the regions are not onlined."
argument_list|,
name|expectedNumRS
argument_list|,
name|cluster
