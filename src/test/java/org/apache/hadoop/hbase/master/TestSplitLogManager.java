...
expr_stmt|;
block|}
comment|// since all the nodes in the system are not unassigned the
comment|// unassigned_timeout must not have kicked in
name|assertEquals
argument_list|(
literal|0
argument_list|,
