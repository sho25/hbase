...
condition|)
continue|continue;
comment|// Try ten times in case random chances upon original order more than
comment|// one or two times in a row.
name|boolean
name|same
init|=
literal|true
