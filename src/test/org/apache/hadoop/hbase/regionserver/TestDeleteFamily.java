...
name|miniHdfs
decl_stmt|;
comment|//for family regex deletion test
specifier|protected
specifier|static
specifier|final
name|String
name|COLFAMILY_REGEX
init|=
literal|"col[a-zA-Z]*1"
decl_stmt|;
annotation|@
name|Override
specifier|protected
...
argument_list|)
expr_stmt|;
comment|// family regex test memcache
name|makeSureRegexWorks
argument_list|(
name|region
argument_list|,
name|region_incommon
...
argument_list|)
expr_stmt|;
comment|// family regex test hstore
name|makeSureRegexWorks
argument_list|(
name|region
argument_list|,
