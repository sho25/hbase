...
expr_stmt|;
block|}
comment|/**    * Same as above but for a negative number    * @throws IOException    */
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**    * When there is no mathing key already, adding a new.    * @throws IOException    */
specifier|public
name|void
...
argument_list|()
expr_stmt|;
comment|// incrment during the snapshot...
name|Store
operator|.
name|ICVResult
name|vas
...
argument_list|)
expr_stmt|;
comment|// only one, because Store.ICV doesnt add to memcache.
name|assertEquals
argument_list|(
literal|1
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// but the timestamps should be different...
name|long
name|icvTs
init|=
name|vas
