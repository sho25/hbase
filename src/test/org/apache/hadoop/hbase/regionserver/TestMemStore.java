...
expr_stmt|;
comment|// Row count is same as column count.
comment|// TODO PUTBACK assertEquals("count=" + count + ", result=" + result,
comment|//  rowCount, result.size());
name|count
operator|++
expr_stmt|;
if|if
...
argument_list|)
expr_stmt|;
comment|// Added more rows into kvset.
name|addRows
argument_list|(
name|this
operator|.
...
name|info
argument_list|(
literal|"Snapshotted, cleared it and then added values"
argument_list|)
expr_stmt|;
block|}
name|result
