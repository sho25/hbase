...
comment|// continue
block|}
comment|/*    * Create dir and set its value into configuration.    * @param key Create dir under test for this key.  Set its fully-qualified    * value into the conf.    * @throws IOException    */
specifier|private
name|void
name|setupDFSConfig
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// Delete if exists.  May contain data from old tests.
if|if
condition|(
name|fs
operator|.
...
condition|)
block|{
comment|/*         setupDFSConfig("dfs.namenode.name.dir");         setupDFSConfig("dfs.datanode.data.dir");         */
name|this
operator|.
name|dfsCluster
operator|=
