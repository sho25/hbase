...
argument_list|)
expr_stmt|;
comment|// Previous test had an assertFalse that I don't understand
comment|//    assertFalse(KeyValue.COMPARATOR.
comment|//    compareColumns(aaa, column1, 0, column1.length, 4) == 0);
block|}
specifier|public
name|void
name|testBasics
