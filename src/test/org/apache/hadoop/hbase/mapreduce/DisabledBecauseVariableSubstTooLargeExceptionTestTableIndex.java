...
block|}
block|}
comment|/**    * Collector that retrieves the count of the documents.    *     * @author Kay Kay    *    */
specifier|public
specifier|static
class|class
name|CountCollector
...
parameter_list|()
block|{
comment|//Make this accept docs out of order as some collectors can be efficient that way.
return|return
literal|true
return|;
block|}
...
name|IOException
block|{
comment|//Nothing to do with scorer.
block|}
block|}
