...
block|}
block|}
comment|/**     * @param maxAttempts the number of times that getProxy() should be called before     * giving up.  If a negative number is passed, it will retry indefinitely.    */
specifier|public
specifier|static
name|VersionedProtocol
name|waitForProxy
