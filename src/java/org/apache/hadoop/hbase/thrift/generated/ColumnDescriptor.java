...
specifier|final
name|TField
name|MAX_VALUE_LENGTH_FIELD_DESC
init|=
operator|new
name|TField
argument_list|(
literal|"maxValueLength"
argument_list|,
name|TType
operator|.
name|I32
...
expr_stmt|;
block|}
comment|// Returns true if field maxValueLength is set (has been asigned a value) and false otherwise
specifier|public
name|boolean
name|isSetMaxValueLength
parameter_list|()
block|{
return|return
name|this
...
block|}
name|boolean
name|this_present_maxValueLength
init|=
literal|true
decl_stmt|;
name|boolean
name|that_present_maxValueLength
init|=
literal|true
decl_stmt|;
if|if
