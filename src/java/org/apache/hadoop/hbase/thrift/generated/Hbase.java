...
name|TException
function_decl|;
comment|/**      * Get all the data for the specified table and row at the latest      * timestamp.      *       * @param tableName name of table      * @param row row key      * @return TRowResult containing the row and map of columns to TCells      * @throws NotFound if the row does not exist      */
specifier|public
name|TRowResult
name|getRow
parameter_list|(
...
name|TException
function_decl|;
comment|/**      * Get the specified columns for the specified table and row at the latest      * timestamp.      *       * @param tableName name of table      * @param row row key      * @param columns List of columns to return, null for all columns      * @return TRowResult containing the row and map of columns to TCells      * @throws NotFound if the row does not exist      */
specifier|public
name|TRowResult
...
name|TException
function_decl|;
comment|/**      * Get all the data for the specified table and row at the specified      * timestamp.      *       * @param tableName of table      * @param row row key      * @param timestamp timestamp      * @return TRowResult containing the row and map of columns to TCells      * @throws NotFound if the row does not exist      */
specifier|public
name|TRowResult
name|getRowTs
parameter_list|(
