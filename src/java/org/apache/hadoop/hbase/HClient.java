...
return|;
block|}
comment|/**      * Change the value for the specified column      *       * @param lockid lock id returned from startUpdate      * @param column column whose value is being set      * @param value new value for column      */
specifier|public
specifier|synchronized
name|void
name|put
...
expr_stmt|;
block|}
comment|/**       * Finalize a batch mutation      *      * @param timestamp time to associate with all the changes      * @throws IOException      */
specifier|public
specifier|synchronized
name|void
name|commit
...
block|}
block|}
comment|/** encapsulates finding the servers for a table */
specifier|protected
class|class
name|TableServers
block|{
...
expr_stmt|;
block|}
comment|/**      * Gets the servers of the given table out of cache, or calls      * findServersForTable if there is nothing in the cache.      *       * @param tableName - the table to be located      * @return map of startRow -> RegionLocation      * @throws IOException - if the table can not be located after retrying      */
specifier|public
specifier|synchronized
name|SortedMap
argument_list|<
...
name|tableServers
decl_stmt|;
comment|// For the "current" table: Map startRow -> RegionLocation
name|SortedMap
argument_list|<
name|Text
argument_list|,
...
return|;
block|}
comment|/**    * Reloads the cached server information for the current table    *     * @param info RegionInfo for a region that is a part of the table    * @throws IOException    */
specifier|protected
specifier|synchronized
name|void
name|reloadCurrentTable
parameter_list|(
name|RegionLocation
name|info
parameter_list|)
...
return|;
block|}
comment|/**     * Start a batch of row insertions/updates.    *     * No changes are committed until the call to commitBatchUpdate returns.    * A call to abortBatchUpdate will abandon the entire batch.    *     * Note that in batch mode, calls to commit or abort are ignored.    */
specifier|public
specifier|synchronized
name|void
...
block|}
block|}
comment|/**     * Abort a batch mutation    */
specifier|public
specifier|synchronized
name|void
name|abortBatch
...
expr_stmt|;
block|}
comment|/**     * Finalize a batch mutation    *    * @throws IOException    */
specifier|public
specifier|synchronized
name|void
name|commitBatch
...
return|;
block|}
comment|/**    * Determine the region server interface to use from configuration properties.    *    */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
