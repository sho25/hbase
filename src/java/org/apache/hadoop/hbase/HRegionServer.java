...
argument_list|)
decl_stmt|;
comment|/**    * Interface used by the {@link org.apache.hadoop.io.retry} mechanism.    */
specifier|public
interface|interface
name|UpdateMetaInterface
block|{
comment|/**      * @return True if succeeded.      * @throws IOException      */
specifier|public
name|boolean
name|update
parameter_list|()
...
name|error
argument_list|(
literal|"What happens if this fails? Are we toast?"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|// Wrap the update of META region with an org.apache.hadoop.io.retry.
name|UpdateMetaInterface
name|implementation
init|=
operator|new
...
argument_list|()
block|{
comment|/* (non-Javadoc)          * @see org.apache.hadoop.hbase.HRegionServer.UpdateMetaInterface#update()          */
specifier|public
name|boolean
name|update
parameter_list|()
...
argument_list|()
decl_stmt|;
comment|// Keep getting rows until we find one that has at least one non-deleted column value
name|HStoreKey
name|key
init|=
operator|new
...
block|}
block|}
comment|/* (non-Javadoc)    * @see org.apache.hadoop.hbase.HRegionInterface#openScanner(org.apache.hadoop.io.Text, org.apache.hadoop.io.Text[], org.apache.hadoop.io.Text)    */
specifier|public
name|long
name|openScanner
parameter_list|(
