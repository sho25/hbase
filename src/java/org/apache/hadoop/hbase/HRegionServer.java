...
argument_list|()
decl_stmt|;
comment|// Keep getting rows till we find one that has at least one non-deleted
...
condition|)
block|{
comment|// Row has something in it. Let it out. Else go get another row.
break|break;
block|}
comment|// Need to clear results before we go back up and call 'next' again.
name|results
operator|.
name|clear
argument_list|()
