...
name|debug
argument_list|(
literal|"starting root region scan"
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"bootstrap: creating root and meta regions"
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/** Call this to wait for everything to finish */
specifier|public
name|void
name|join
parameter_list|()
