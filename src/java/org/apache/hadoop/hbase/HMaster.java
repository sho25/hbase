...
name|assignAttempts
decl_stmt|;
comment|// 'killList' indicates regions that we hope to close and not reopen
comment|// (because we're merging them, or taking the table offline, for example).
specifier|private
name|SortedMap
argument_list|<
name|String
...
expr_stmt|;
block|}
comment|/* (non-Javadoc)    * @see org.apache.hadoop.hbase.HMasterInterface#mergeRegions(org.apache.hadoop.io.Text, org.apache.hadoop.io.Text)    */
specifier|public
name|void
name|mergeRegions
parameter_list|(
...
block|}
comment|// Cause regions being served to be take off-line and disabled
name|TreeMap
argument_list|<
name|Text
argument_list|,
