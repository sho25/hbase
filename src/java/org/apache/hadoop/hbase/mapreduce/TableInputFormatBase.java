...
argument_list|)
expr_stmt|;
comment|//          scan.setFilter(new RowFilterSet(RowFilterSet.Operator.MUST_PASS_ALL,
comment|//              rowFiltersSet));
name|this
operator|.
name|scanner
operator|=
...
condition|)
block|{
comment|// if timestamps are ungiven.
name|scan
operator|.
name|setTimeRange
argument_list|(
...
expr_stmt|;
block|}
comment|/**    * @param minStamp    * @param maxStam    */
specifier|protected
name|void
name|setTimeRange
parameter_list|(
