...
return|return;
block|}
comment|// 3. Load in the files to be deleted.
name|Vector
argument_list|<
name|HStoreFile
argument_list|>
...
expr_stmt|;
block|}
comment|// 4. Moving the new MapFile into place.
name|HStoreFile
name|compactedFile
init|=
operator|new
...
return|return;
block|}
comment|// 5. and 6. Unload all the replaced MapFiles, close and delete.
name|Vector
argument_list|<
name|Long
argument_list|>
...
expr_stmt|;
block|}
comment|// 7. Loading the new TreeMap.
name|Long
name|orderVal
init|=
name|Long
...
block|}
block|}
comment|/*    * @return Path to the compaction directory for this column family.    * Compaction dir is a subdirectory of the region.  Needs to have the    * same regiondir/storefamily path prefix; HStoreFile constructor presumes    * it (TODO: Fix).    */
specifier|private
name|Path
name|getCompactionDir
parameter_list|()
