...
block|}
block|}
comment|// If a bloom filter is enabled, try to read it in.
comment|// If it doesn't exist, create it.
...
return|;
block|}
comment|/**    * Get a MapFile writer    * This allows us to substitute a BloomFilterWriter if a bloom filter is enabled    */
name|MapFile
operator|.
name|Writer
