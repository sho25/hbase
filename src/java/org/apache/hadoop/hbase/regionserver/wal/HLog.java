...
return|;
block|}
comment|/**    * Get a reader for the WAL.    * @param fs    * @param path    * @param keyClass    * @param valueClass    * @return A WAL reader.  Close when done with it.    * @throws IOException    */
annotation|@
...
block|}
block|}
comment|/**    * Get a writer for the WAL.    * @param path    * @param keyClass    * @param valueClass    * @return A WAL writer.  Close when done with it.    * @throws IOException    */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
