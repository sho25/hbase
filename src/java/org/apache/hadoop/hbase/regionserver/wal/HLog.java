...
begin_comment
comment|/**    * Multiple threads will call sync() at the same time, only the winner    * will actually flush if there is any race or build up.    *    * @param force sync regardless (for meta updates) if there is data    * @throws IOException    */
end_comment
