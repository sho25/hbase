...
expr_stmt|;
block|}
comment|// We must do this in this loop because it could affect
comment|// the above get to find the next timestamp to remove.
comment|// This is the case when there are multiple deletes for the same column.
name|size
operator|=
name|this
operator|.
