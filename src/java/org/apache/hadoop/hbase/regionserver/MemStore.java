...
block|}
block|}
comment|/**    * Gets from either the memstore or the snapshop, and returns a code    * to let you know which is which.    *    * @param matcher    * @param result    * @return 1 == memstore, 2 == snapshot, 0 == none    */
name|int
name|getWithCode
parameter_list|(
name|QueryMatcher
...
block|}
block|}
comment|/**    * Small utility functions for use by Store.incrementColumnValue    * _only_ under the threat of pain and everlasting race conditions.    */
name|void
name|readLockLock
parameter_list|()
block|{
