...
expr_stmt|;
block|}
comment|/*    * @param msgs Current outboundMsgs array    * @return Messages to send or returns current outboundMsgs if it already had    * content to send.    */
specifier|private
name|HMsg
index|[]
name|getOutboundMsgs
...
parameter_list|)
block|{
comment|// If passed msgs are not null, means we haven't passed them to master yet.
if|if
condition|(
name|msgs
operator|!=
...
block|}
block|}
comment|/*    * @param msgs Messages we sent the master.    * @return Null    */
specifier|private
name|HMsg
index|[]
name|updateOutboundMsgs
