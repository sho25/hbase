...
decl_stmt|;
comment|/**    * Space is reserved in HRS constructor and then released when aborting    * to recover from an OOME. See HBASE-706.    */
specifier|private
specifier|final
name|LinkedList
argument_list|<
...
name|warn
argument_list|(
literal|"error getting store file index size for "
operator|+
name|store
operator|+
literal|": "
...
parameter_list|)
block|{
comment|// TODO: Should we even be returning an exception out of a close?
comment|// What can the client do with an exception in close?
name|checkOOME
argument_list|(
name|e
argument_list|)
