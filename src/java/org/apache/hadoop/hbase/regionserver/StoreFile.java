...
argument_list|()
decl_stmt|;
comment|/**    * Constructor.    * Loads up a Reader (and its indices, etc.).    * @param fs Filesystem.    * @param p qualified path    * @throws IOException    */
name|StoreFile
parameter_list|(
specifier|final
name|FileSystem
...
name|warn
argument_list|(
literal|"Failed toString first key"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Failed toString last key"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/**    * @param fs    * @param dir    * @param encodedRegionName    * @param family    * @return Path to a file that doesn't exist at time of this invocation.    * @throws IOException    */
specifier|static
name|Path
name|getRandomFilename
parameter_list|(
...
return|;
block|}
comment|/**    * @param fs    * @param dir    * @param encodedRegionName    * @param family    * @param suffix    * @return Path to a file that doesn't exist at time of this invocation.    * @throws IOException    */
specifier|static
name|Path
name|getRandomFilename
parameter_list|(
...
return|;
block|}
comment|/**    * Write file metadata.    * Call before you call close on the passed<code>w</code> since its written    * as metadata to that file.    *     * @param filesystem file system    * @param maxSequenceId Maximum sequence id.    * @throws IOException    */
specifier|static
name|void
name|appendMetadata
parameter_list|(
