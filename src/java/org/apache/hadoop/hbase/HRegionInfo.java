...
return|;
block|}
comment|/**    * Converts an encoded region name to its unencoded form    *     * @param encodedName     * @return unencoded region name    */
specifier|public
specifier|static
name|Text
...
name|IllegalArgumentException
argument_list|(
literal|"encoded region name does not contain '"
operator|+
name|DELIMITER
operator|+
literal|"': "
...
name|IllegalArgumentException
argument_list|(
literal|"improperly formatted encoded region name "
operator|+
name|encodedName
argument_list|)
throw|;
