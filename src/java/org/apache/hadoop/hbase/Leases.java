...
expr_stmt|;
block|}
comment|/**    * @param name Set name on the lease checking daemon thread.    */
specifier|public
name|void
name|setName
parameter_list|(
...
block|}
block|}
comment|/**    * LeaseMonitor is a thread that expires Leases that go on too long.    * Its a daemon thread.    */
class|class
name|LeaseMonitor
extends|extends
name|Chore
