...
argument_list|()
decl_stmt|;
comment|/**    * returns the next numResults Results from the Scaner mapped to Integer    * id. If the end of the table is reached, the scanner is closed and all    * succesfully retrieved rows are returned.    *     * @param id    *          id target scanner is mapped to.    * @param numRows    *          number of results to return.    * @return all successfully retrieved rows.    * @throws org.apache.hadoop.hbase.rest.exception.HBaseRestException    */
specifier|public
name|Result
index|[]
name|scannerGet
