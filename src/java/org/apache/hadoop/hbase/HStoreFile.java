...
expr_stmt|;
block|}
comment|/**    * Constructor that fully initializes the object    * @param conf Configuration object    * @param dir directory path    * @param regionName name of the region    * @param colFamily name of the column family    * @param fileId file identifier    * @param ref Reference to another HStoreFile.    */
name|HStoreFile
parameter_list|(
name|Configuration
name|conf
