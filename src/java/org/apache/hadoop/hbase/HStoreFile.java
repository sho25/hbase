...
return|;
block|}
comment|/**    * Get reader for the store file map file.    * Client is responsible for closing file when done.    * @param fs    * @param bloomFilter If null, no filtering is done.    * @param blockCacheEnabled If true, MapFile blocks should be cached.    * @return MapFile.Reader    * @throws IOException    */
specifier|public
specifier|synchronized
name|MapFile
operator|.
