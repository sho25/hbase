...
begin_comment
comment|/**  * Contains utility methods for manipulating HBase meta tables.  * Be sure to call {@link #shutdown()} when done with this class so it closes  * resources opened during meta processing (ROOT, META, etc.).  */
end_comment
...
expr_stmt|;
block|}
comment|/**    * @param tableName    * @param hcd Add this column to<code>tableName</code>    * @throws IOException     */
specifier|public
name|void
name|addColumn
parameter_list|(
...
block|}
block|}
comment|/**    * @param tableName    * @param columnFamily Name of column name to remove.    * @throws IOException    */
specifier|public
name|void
name|deleteColumn
parameter_list|(
...
block|}
block|}
comment|/**    * @return List of<code>.META.<code> {@link HRegionInfo} found in the    *<code>-ROOT-</code> table.    * @throws IOException    * @see #getMetaRegion(HRegionInfo)    */
specifier|public
name|List
argument_list|<
name|HRegionInfo
