...
block|}
block|}
comment|/**    * Verify and qualify rootdir in<code>conf</code>.  Does not test for    * existence of the rootdir.    * @param conf.    * @return Verified and qualified rootdir.    * @throws IOException    */
specifier|public
specifier|static
name|Path
name|verifyAndQualifyRootDir
parameter_list|(
specifier|final
name|HBaseConfiguration
name|conf
...
return|;
block|}
comment|/**    * @param c    * @return Path to hbase root directory: i.e.<code>hbase.rootdir</code> as a    * Path.    * @throws IOException     */
specifier|public
specifier|static
name|Path
name|getRootDir
...
return|;
block|}
comment|/**    * @param c    * @param test If true, test for presence and throw exception if not present.    * @return Path to hbase root directory: i.e.<code>hbase.rootdir</code> as a    * Path.    * @throws IOException     */
specifier|public
specifier|static
name|Path
name|getRootDir
