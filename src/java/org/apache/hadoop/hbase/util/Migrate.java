...
name|IOException
argument_list|(
literal|"Filesystem must be available for upgrade to run."
argument_list|)
throw|;
block|}
name|LOG
...
argument_list|(
literal|"HBase cluster must be off-line during upgrade."
argument_list|)
throw|;
block|}
block|}
...
name|name
operator|+
literal|" this file can be recovered by the master when it starts."
decl_stmt|;
name|extraFile
argument_list|(
name|logFiles
...
name|println
argument_list|(
literal|"    -logfiles={abort|ignore|delete|prompt}"
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|"                                   action to take when unrecovered region"
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|"                                   server log files are found.\n"
argument_list|)
expr_stmt|;
name|System
operator|.
