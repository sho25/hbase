...
return|;
block|}
comment|/**    * @param cell Cell object containing the serialized HRegionInfo    * @return A HRegionInfo instance built out of passed<code>cell</code>.    * @throws IOException    */
specifier|public
specifier|static
name|HRegionInfo
name|getHRegionInfo
...
return|;
block|}
comment|/**    * @param c    * @return Cell value as a UTF-8 String    */
specifier|public
specifier|static
name|String
name|cellToString
...
return|;
block|}
comment|/**    * @param c    * @return Cell as a long.    */
specifier|public
specifier|static
name|long
name|cellToLong
