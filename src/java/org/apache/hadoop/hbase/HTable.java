...
expr_stmt|;
block|}
comment|/**     * Start an atomic row insertion/update.  No changes are committed until the     * call to commit() returns.    *     * A call to abort() will abandon any updates in progress.    *    *     * @param row Name of row to start update against.    * @return Row lockid.    */
specifier|public
specifier|synchronized
name|long
name|startUpdate
