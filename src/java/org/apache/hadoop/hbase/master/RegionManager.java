...
return|;
block|}
comment|/*    * Get the set of regions that should be assignable in this pass.    *     * Note that no synchronization on regionsInTransition is needed because the    * only caller (assignRegions) whose caller owns the monitor for RegionManager    */
specifier|private
name|Set
argument_list|<
name|RegionState
...
expr_stmt|;
block|}
comment|/**    * Get metaregion that would host passed in row.    * @param row Row need to know all the meta regions for    * @return set of MetaRegion objects that contain the table    * @throws NotAllMetaRegionsOnlineException    */
specifier|public
name|MetaRegion
...
return|;
block|}
comment|/**    * @param hri    * @return True if the passed region is assignable: i.e. not assigned, not    * pending and not unassigned.    */
specifier|public
name|boolean
name|assignable
parameter_list|(
...
return|;
block|}
comment|/**    * @param regionName    * @return true if region has been assigned    */
specifier|public
name|boolean
name|isAssigned
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Mark a region as closing     * @param serverName    * @param regionInfo    * @param setOffline    * @param check False if we are to skip state transition check.    */
name|void
name|setClosing
parameter_list|(
specifier|final
...
argument_list|(
literal|"Cannot transition to closing from any other state. Region: "
operator|+
name|Bytes
operator|.
name|toString
