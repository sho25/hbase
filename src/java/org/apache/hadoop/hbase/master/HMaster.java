...
argument_list|)
expr_stmt|;
comment|// Set back into the configuration the qualified rootdir path.
name|this
operator|.
name|conf
operator|.
...
argument_list|)
expr_stmt|;
comment|// Set filesystem to be that of this.rootdir.
name|this
operator|.
name|conf
operator|.
...
expr_stmt|;
block|}
comment|/*    * Get the rootdir.  Make sure its wholesome before returning.    * @param conf    * @param fs    * @return Fully qualified path to wholesome hbase root dir.    * @throws IOException    */
specifier|private
name|Path
name|getAndCheckRootDir
parameter_list|(
