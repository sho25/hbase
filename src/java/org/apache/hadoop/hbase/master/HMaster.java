...
name|IOException
block|{
comment|// find out our address. If it's set in config, use that, otherwise look it
comment|// up in DNS.
name|String
name|addressStr
init|=
...
return|;
block|}
comment|/**    * Get row from meta table.    * @param row    * @param columns    * @return RowResult    * @throws IOException    */
specifier|protected
name|RowResult
name|getFromMETA
parameter_list|(
