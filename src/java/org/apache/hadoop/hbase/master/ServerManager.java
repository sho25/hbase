...
try|try
block|{
comment|// This method removes ROOT/META from the list and marks them to be reassigned
comment|// in addition to other housework.
if|if
condition|(
name|removeServerInfo
argument_list|(
...
name|debug
argument_list|(
literal|"Process all wells: "
operator|+
name|serverInfo
operator|+
literal|" openingCount: "
operator|+
name|openingCount
operator|+
literal|", nobalancingCount: "
operator|+
name|nobalancingCount
argument_list|)
expr_stmt|;
