...
return|;
block|}
comment|/**    * @param serverName    * @return True if this is a dead server and it has had its logs split.    */
specifier|public
name|boolean
name|isDeadServerLogsSplit
parameter_list|(
...
return|;
block|}
comment|/**    * Set that this deadserver has had its log split.    * @param serverName    */
specifier|public
name|void
