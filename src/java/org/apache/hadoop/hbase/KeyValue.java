...
expr_stmt|;
block|}
comment|/** Temporary constructors until 880/1249 is committed to remove deps */
comment|/**    * Temporary.    */
specifier|public
name|KeyValue
parameter_list|(
...
return|;
block|}
comment|/**    * @return True if Delete KeyValue type.    */
specifier|public
name|boolean
name|isDeleteType
parameter_list|()
...
return|;
block|}
comment|/**    * @return True if DeleteColumn KeyValue type.    */
specifier|public
name|boolean
name|isDeleteColumnType
parameter_list|()
block|{
return|return
name|getType
