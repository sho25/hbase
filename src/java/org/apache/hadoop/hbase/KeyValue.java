...
return|;
block|}
comment|/**    * @param column Column minus its delimiter    * @param familylength Length of family in passed<code>column</code>    * @return True if column matches.    * @see #matchingColumn(byte[])    */
specifier|public
name|boolean
