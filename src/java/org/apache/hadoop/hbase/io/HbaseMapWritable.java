...
begin_comment
comment|/**  * A Writable Map.  * Like {@link org.apache.hadoop.io.MapWritable} but dumb. It will fail  * if passed a Writable it has not already been told about. Its also been  * primed with hbase Writables.  */
end_comment
...
argument_list|()
operator|+
literal|" cannot be used as a key."
argument_list|)
throw|;
block|}
if|if
...
argument_list|()
operator|+
literal|" cannot be used as a value."
argument_list|)
throw|;
block|}
return|return
