...
expr_stmt|;
block|}
comment|/**    * Use this before submitting a TableReduce job. It will    * appropriately set up the JobConf.    *     * @param table    * @param reducer    * @param job    * @throws IOException     */
specifier|public
specifier|static
name|void
...
expr_stmt|;
block|}
comment|/**    * Use this before submitting a TableReduce job. It will    * appropriately set up the JobConf.    *     * @param table    * @param reducer    * @param job    * @param partitioner Partitioner to use. Pass null to use default    * partitioner.    * @throws IOException     */
specifier|public
specifier|static
name|void
name|initTableReduceJob
