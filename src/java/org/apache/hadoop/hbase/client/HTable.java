...
condition|)
block|{
comment|// The root region is always on-line
return|return
literal|true
return|;
block|}
...
return|;
block|}
comment|/**    * @param conf HBaseConfiguration object    * @param tableName name of table to check    * @return true if table is off-line    * @throws IOException    */
specifier|public
specifier|static
name|boolean
name|isTableOffline
...
condition|)
block|{
comment|// The root region is always online
return|return
literal|false
return|;
block|}
...
return|;
block|}
comment|/**    * TODO: Make the return read-only.    * @return table metadata     * @throws IOException    */
specifier|public
name|HTableDescriptor
name|getMetadata
parameter_list|()
