...
argument_list|)
expr_stmt|;
comment|// iterate through the scanner, accumulating unique region names
while|while
condition|(
literal|true
condition|)
...
name|IOException
block|{
comment|// TODO This code is a near exact copy of getStartKeys. To be refactored HBASE-626
name|HashMap
argument_list|<
name|HRegionInfo
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// iterate through the scanner, accumulating regions and their regionserver
while|while
condition|(
literal|true
condition|)
...
return|;
block|}
comment|/**     * Get selected columns for the specified row at the latest timestamp    *     * @param row row key    * @param columns Array of column names you want to retrieve.    * @return Map of columns to values.  Map is empty if row does not exist.    * @throws IOException    */
specifier|public
name|Map
argument_list|<
name|Text
...
return|;
block|}
comment|/**     * Get selected columns for the specified row at a specified timestamp    *     * @param row row key    * @param columns Array of column names you want to retrieve.       * @param ts timestamp    * @return Map of columns to values.  Map is empty if row does not exist.    * @throws IOException    */
specifier|public
name|Map
argument_list|<
name|Text
