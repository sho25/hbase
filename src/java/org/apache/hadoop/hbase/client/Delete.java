...
expr_stmt|;
block|}
comment|/**    * Create a Delete operation for the specified row and timestamp, using    * an optional row lock.    *<p>    * If no further operations are done, this will delete all columns in all    * families of the specified row with a timestamp less than or equal to the     * specified timestamp.    * @param row row key    * @param timestamp maximum version timestamp    * @param rowLock previously acquired row lock, or null    */
specifier|public
name|Delete
parameter_list|(
name|byte
