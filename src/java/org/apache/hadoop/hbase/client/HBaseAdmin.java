...
expr_stmt|;
block|}
comment|/**    * Modify an existing table    *     * @param tableName name of table    * @param op table modification operation    * @param args operation specific arguments    * @throws IOException    */
specifier|public
name|void
name|modifyTable
parameter_list|(
...
name|IllegalArgumentException
argument_list|(
literal|"SPLIT or COMPACT with arg "
operator|+
literal|"requires byte[] or ImmutableBytesWritable"
argument_list|)
throw|;
block|}
block|}
