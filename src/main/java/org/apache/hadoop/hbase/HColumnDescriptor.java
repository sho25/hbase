...
specifier|final
name|String
name|DATA_BLOCK_ENCODING_ON_DISK
init|=
literal|"DATA_BLOCK_ENCODING_ON_DISK"
decl_stmt|;
specifier|public
specifier|static
specifier|final
name|String
name|DATA_BLOCK_ENCODING_IN_CACHE
init|=
literal|"DATA_BLOCK_ENCODING_IN_CACHE"
decl_stmt|;
specifier|public
specifier|static
specifier|final
name|String
name|ENCODED_DATA_BLOCK_SEEK
init|=
...
argument_list|()
decl_stmt|;
comment|/**    * Default data block encoding algorithm on disk.    */
specifier|public
specifier|static
specifier|final
name|String
...
argument_list|()
decl_stmt|;
comment|/**    * Default data block encoding algorithm in cache.    */
specifier|public
specifier|static
specifier|final
name|String
...
argument_list|()
decl_stmt|;
comment|/**    * Do not use encoded seek by default.    */
specifier|public
specifier|static
specifier|final
name|boolean
...
expr_stmt|;
block|}
comment|/**    * Constructor    * @param familyName Column family name. Must be 'printable' -- digit or    * letter -- and may not contain a<code>:<code>    * @param minVersions Minimum number of versions to keep    * @param maxVersions Maximum number of versions to keep    * @param keepDeletedCells Whether to retain deleted cells until they expire    *        up to maxVersions versions.    * @param compression Compression type    * @param dataBlockEncodingOnDisk data block encoding used on disk    * @param dataBlockEncodingInCache data block encoding used in block cache    * @param encodedDataBlockSeek whether to use data block encoding while seeking    * @param inMemory If true, column data should be kept in an HRegionServer's    * cache    * @param blockCacheEnabled If true, MapFile blocks should be cached    * @param blocksize Block size to use when writing out storefiles.  Use    * smaller blocksizes for faster random-access at expense of larger indices    * (more memory consumption).  Default is usually 64k.    * @param timeToLive Time-to-live of cell contents, in seconds    * (use HConstants.FOREVER for unlimited TTL)    * @param bloomFilter Bloom filter type for this column    * @param scope The scope tag for this column    *    * @throws IllegalArgumentException if passed a family name that is made of    * other than 'word' characters: i.e.<code>[a-zA-Z_0-9]</code> or contains    * a<code>:</code>    * @throws IllegalArgumentException if the number of versions is&lt;= 0    */
specifier|public
name|HColumnDescriptor
parameter_list|(
specifier|final
...
specifier|final
name|String
name|dataBlockEncodingOnDisk
parameter_list|,
specifier|final
name|String
name|dataBlockEncodingInCache
parameter_list|,
specifier|final
name|boolean
name|encodedDataBlockSeek
parameter_list|,
specifier|final
name|boolean
name|inMemory
...
return|;
block|}
comment|/**    * Set data block encoding algorithm.    * @param type What kind of data block encoding will be used.    */
specifier|public
name|void
name|setDataBlockEncodingOnDisk
parameter_list|(
...
expr_stmt|;
block|}
comment|/** @return data block encoding in block cache algorithm */
specifier|public
name|DataBlockEncodings
operator|.
name|Algorithm
name|getDataBlockEncodingInCache
parameter_list|()
block|{
name|String
name|type
...
expr_stmt|;
block|}
comment|/** @return whether we are doing seek operations over encoded data blocks */
specifier|public
name|boolean
name|useEncodedDataBlockSeek
parameter_list|()
block|{
name|String
name|value
...
return|;
block|}
comment|/**    * Set whether we should seek over encoded data blocks (true) or decode    * blocks first and use normal seek operations (false).    */
specifier|public
name|void
name|setEncodedDataBlockSeek
parameter_list|(
