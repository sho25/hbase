...
name|info
argument_list|(
literal|"HBaseAdmin.getCatalogTracker()"
argument_list|)
expr_stmt|;
name|CatalogTracker
name|ct
...
name|info
argument_list|(
literal|"HBaseAdmin.getCatalogTracker()--11"
argument_list|)
expr_stmt|;
name|ct
operator|.
...
name|info
argument_list|(
literal|"HBaseAdmin.getCatalogTracker()-- CTracker started"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|info
argument_list|(
literal|"HBaseAdmin.disableTable"
argument_list|)
expr_stmt|;
name|disableTableAsync
argument_list|(
