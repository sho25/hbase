...
name|IOException
block|{
comment|// TODO: Replace w/ CatalogTracker-based tableExists test.
if|if
condition|(
operator|!
name|tableExists
...
name|error
argument_list|(
literal|"Unexpected ZooKeeper error attempting to read the root "
operator|+
literal|"region server address"
argument_list|)
expr_stmt|;
throw|throw
operator|new
