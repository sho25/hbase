...
return|;
block|}
comment|/**    * Returns a sorted array of KeyValues in this Result.    *<p>    * Since HBase 0.20.5 this is equivalent to {@link #raw}. Use    * {@link #raw} instead.    *    * @return sorted array of KeyValues    * @deprecated    */
specifier|public
name|KeyValue
index|[]
name|sorted
...
argument_list|()
return|;
comment|// side effect of loading this.kvs
block|}
...
return|;
block|}
comment|/**    * The KeyValue for the most recent for a given column. If the column does    * not exist in the result set - if it wasn't selected in the query (Get/Scan)    * or just does not exist in the row the return value is null.    *    * @param family    * @param qualifier    * @return KeyValue for the column or null    */
specifier|public
name|KeyValue
