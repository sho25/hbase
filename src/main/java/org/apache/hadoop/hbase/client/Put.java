...
argument_list|)
decl_stmt|;
comment|// a opaque blob that can be passed into a Put.
specifier|private
name|Map
argument_list|<
name|String
...
expr_stmt|;
block|}
comment|/**    * Sets arbitrary put's attribute.    * In case value = null attribute is removed from the attributes map.    * @param name attribute name    * @param value attribute value    */
specifier|public
name|void
name|setAttribute
parameter_list|(
...
literal|0
decl_stmt|;
comment|// iterate through all column families affected by this Put
for|for
control|(
name|Map
operator|.
