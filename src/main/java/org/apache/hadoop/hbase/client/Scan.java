...
return|;
block|}
comment|/**    * Sets arbitrary scan's attribute.    * In case value = null attribute is removed from the attributes map.    * @param name attribute name    * @param value attribute value    */
specifier|public
name|void
name|setAttribute
parameter_list|(
...
block|}
block|}
comment|/**    * Gets scan's attribute    * @param name attribute name    * @return attribute value if attribute is set,<tt>null</tt> otherwise    */
specifier|public
name|byte
index|[]
name|getAttribute
