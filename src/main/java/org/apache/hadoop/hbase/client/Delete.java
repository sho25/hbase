...
argument_list|)
decl_stmt|;
comment|// a opaque blob that can be passed into a Delete.
specifier|private
name|Map
argument_list|<
name|String
...
expr_stmt|;
block|}
comment|/**    * Sets arbitrary delete's attribute.    * In case value = null attribute is removed from the attributes map.    * @param name attribute name    * @param value attribute value    */
specifier|public
name|void
name|setAttribute
parameter_list|(
...
block|}
block|}
comment|/**    * Gets put's attribute    * @param name attribute name    * @return attribute value if attribute is set,<tt>null</tt> otherwise    */
specifier|public
name|byte
index|[]
name|getAttribute
...
literal|0
decl_stmt|;
comment|// iterate through all column families affected by this Delete
for|for
control|(
name|Map
operator|.
