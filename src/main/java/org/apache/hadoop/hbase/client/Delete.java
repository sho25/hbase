...
expr_stmt|;
block|}
comment|/**    * Advanced use only. Create a Delete object based on a KeyValue    * of type "delete".    * @param kv    * @throws IOException    */
specifier|public
name|Delete
parameter_list|(
name|KeyValue
...
throw|;
block|}
comment|// can't use singletonList, because this might be modified at the server by
