...
name|TException
function_decl|;
comment|/**      * Bulk commit a List of TDeletes to the table.      *       * This returns a list of TDeletes that were not      * executed. So if everything succeeds you'll      * receive an empty list.      *       * @param table the table to delete from      *       * @param deletes list of TDeletes to delete      */
specifier|public
name|List
argument_list|<
name|TDelete
