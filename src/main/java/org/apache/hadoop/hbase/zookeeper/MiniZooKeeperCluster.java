...
name|info
argument_list|(
literal|"Started MiniZK Server on client port: "
operator|+
name|clientPort
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Shutdown MiniZK Server on client port: "
operator|+
name|clientPort
argument_list|)
expr_stmt|;
block|}
comment|/**@return clientPort return clientPort if there is another ZooKeeper Candidate can run; return    *         -1, if there is no candidates.    * @throws IOException    * @throws InterruptedException     */
specifier|public
name|int
name|killCurrentZooKeeper
parameter_list|()
throws|throws
name|IOException
throws|,
...
return|;
block|}
comment|// Shutdown the current one
name|standaloneServerFactory
operator|.
name|shutdown
argument_list|()
...
name|info
argument_list|(
literal|"Kill the current MiniZK Server on client port: "
operator|+
name|clientPort
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|// Start another ZooKeeper Server
name|clientPort
operator|=
name|defaultClientPort
expr_stmt|;
...
name|info
argument_list|(
literal|"Started another candidate MiniZK Server on client port: "
operator|+
name|clientPort
argument_list|)
expr_stmt|;
