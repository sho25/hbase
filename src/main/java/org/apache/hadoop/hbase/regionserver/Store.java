...
block|}
block|}
comment|// For major compactions calculate the earliest put timestamp
comment|// of all involved storefiles. This is used to remove
comment|// family delete marker during the compaction.
if|if
condition|(
name|majorCompaction
condition|)
