...
argument_list|()
decl_stmt|;
comment|// TODO: HBASE-3532 - we can't use Set<HRegion> here because it doesn't
comment|// implement equals correctly. So, set of region names.
name|Set
argument_list|<
name|byte
index|[]
argument_list|>
name|excludedRegionNames
init|=
operator|new
name|TreeSet
argument_list|<
