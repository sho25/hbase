...
return|;
block|}
comment|/**    * Convert path to a file under RECOVERED_EDITS_DIR directory without    * RECOVERED_LOG_TMPFILE_SUFFIX    * @param srcPath    * @return dstPath without RECOVERED_LOG_TMPFILE_SUFFIX    */
specifier|static
name|Path
name|getCompletedRecoveredEditsFilePath
parameter_list|(
