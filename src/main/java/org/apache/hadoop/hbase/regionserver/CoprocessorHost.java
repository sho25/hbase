...
return|;
block|}
comment|/**      * @param key the key      * @return the value, or null if it does not exist      */
annotation|@
name|Override
specifier|public
name|Object
...
argument_list|)
decl_stmt|;
comment|/**    * Constructor    * @param server the regionServer    * @param region the region    * @param conf the configuration    */
specifier|public
name|CoprocessorHost
parameter_list|(
specifier|final
...
block|}
block|}
comment|/**    * @param row the row key    * @param family the family    * @param result the result set from the region    * @return the result set to return to the client    * @exception IOException Exception    */
specifier|public
name|Result
...
block|}
block|}
comment|/**    * @param get the Get request    * @return the possibly transformed Get object by coprocessor    * @exception IOException Exception    */
specifier|public
name|Get
name|preGet
parameter_list|(
...
block|}
block|}
comment|/**    * @param get the Get request    * @param exists the result returned by the region server    * @exception IOException Exception    */
specifier|public
name|Get
name|preExists
parameter_list|(
...
block|}
block|}
comment|/**    * @param familyMap map of family to edits for the given family.    * @return the possibly transformed map to actually use    * @exception IOException Exception    */
specifier|public
name|Map
argument_list|<
name|byte
...
block|}
block|}
comment|/**    * @param familyMap map of family to edits for the given family.    * @exception IOException Exception    */
specifier|public
name|void
name|postPut
parameter_list|(
...
block|}
block|}
comment|/**    * @param row row to check    * @param family column family    * @param qualifier column qualifier    * @param amount long amount to increment    * @param writeToWAL whether to write the increment to the WAL    * @return new amount to increment    * @throws IOException if an error occurred on the coprocessor    */
specifier|public
name|long
...
return|;
block|}
comment|/**    * @param increment increment object    * @param writeToWAL whether to write the increment to the WAL    * @return new amount to increment    * @throws IOException if an error occurred on the coprocessor    */
specifier|public
name|Increment
name|preIncrement
parameter_list|(
...
return|;
block|}
comment|/**    * @param increment increment object    * @param writeToWAL whether to write the increment to the WAL    * @param result the result returned by incrementColumnValue    * @return the result to return to the client    * @throws IOException if an error occurred on the coprocessor    */
specifier|public
name|Result
name|postIncrement
parameter_list|(
...
return|;
block|}
comment|/**    * @param scan the Scan specification    * @param scannerId the scanner id allocated by the region server    * @exception IOException Exception    */
specifier|public
name|void
...
block|}
block|}
comment|/**    * @param scannerId the scanner id    * @param results the result set returned by the region server    * @return the possibly transformed result set to actually return    * @exception IOException Exception    */
specifier|public
name|void
name|preScannerNext
parameter_list|(
...
block|}
block|}
comment|/**    * @param scannerId the scanner id    * @exception IOException Exception    */
specifier|public
name|void
