...
return|;
block|}
comment|/**    * @param increment increment object    * @param writeToWAL true if the change should be written to the WAL    * @return result to return to client if default operation should be    * bypassed, null otherwise    * @throws IOException if an error occurred on the coprocessor    */
specifier|public
name|Result
name|preIncrement
parameter_list|(
...
block|}
block|}
comment|/**    * @param increment increment object    * @param writeToWAL true if the change should be written to the WAL    * @param result the result returned by incrementColumnValue    * @throws IOException if an error occurred on the coprocessor    */
specifier|public
name|void
name|postIncrement
parameter_list|(
...
block|}
block|}
comment|/**    * @param scan the Scan specification    * @param scannerId the scanner id allocated by the region server    * @return the scanner instance to use    * @exception IOException Exception    */
specifier|public
name|InternalScanner
