...
name|info
argument_list|(
literal|"Spliting is done. Removing old log dir "
operator|+
name|srcDir
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Found existing old hlog file. It could be the result of a previous"
operator|+
literal|"failed split attempt. Deleting "
operator|+
name|logFile
operator|+
literal|", length="
