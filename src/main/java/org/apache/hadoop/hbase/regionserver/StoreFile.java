...
argument_list|)
decl_stmt|;
comment|/** Meta data block name for bloom filter meta-info (ie: bloom params/specs) */
specifier|static
specifier|final
name|String
...
decl_stmt|;
comment|/** Meta data block name for bloom filter data (ie: bloom bits) */
specifier|static
specifier|final
name|String
...
name|writer
decl_stmt|;
comment|/**      * Creates an HFile.Writer that also write helpful meta data.      * @param fs file system to write to      * @param path file name to create      * @param blocksize HDFS block size      * @param compress HDFS block compression      * @param conf user configuration      * @param comparator key comparator      * @param bloomType bloom filter setting      * @param maxKeys maximum amount of keys to add (for blooms)      * @param cacheOnWrite whether to cache blocks as we write file      * @throws IOException problem writing to FS      */
specifier|public
name|Writer
parameter_list|(
name|FileSystem
...
name|format
argument_list|(
literal|"Parse error while creating bloom for %s (%d, %f)"
argument_list|,
name|path
argument_list|,
name|maxKeys
