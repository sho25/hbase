...
expr_stmt|;
block|}
comment|/**    * Can only return INCLUDE or SKIP, since returning "NEXT" or    * "DONE" would imply we have finished with this row, when    * this class can't figure that out.    *    * @param bytes    * @param offset    * @param length    * @param timestamp    * @return The match code instance.    */
annotation|@
name|Override
specifier|public
name|MatchCode
