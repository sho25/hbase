...
name|machineName
decl_stmt|;
comment|// Replication-related attributes
specifier|private
name|Replication
name|replicationHandler
decl_stmt|;
comment|// End of replication
...
parameter_list|)
block|{
comment|// TODO: Can we recover? Should be throw RTE?
name|LOG
operator|.
name|error
argument_list|(
literal|"Failed to abort open region "
operator|+
name|regionInfo
operator|.
name|getRegionNameAsString
...
block|}
block|}
comment|/*    * @param regionInfo RegionInfo for the Region we're to instantiate and    * initialize.    * @param wal Set into here the regions' seqid.    * @return    * @throws IOException    */
specifier|protected
name|HRegion
name|instantiateRegion
parameter_list|(
...
name|println
argument_list|(
literal|"Usage: java org.apache.hbase.HRegionServer start|stop [-D<conf.param=value>]"
argument_list|)
expr_stmt|;
name|System
operator|.
