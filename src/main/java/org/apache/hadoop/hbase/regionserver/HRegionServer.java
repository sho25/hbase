...
argument_list|)
expr_stmt|;
comment|/* MajorCompactPriority is configurable.        * If not set, it will get the value of hbase.hstore.blockingStoreFiles,        * and the compaction will use default priority.        */
name|this
operator|.
name|majorCompactPriority
operator|=
