...
begin_comment
comment|/**    * Help function for metrics() that increments a map value if it exists.    *    * @param map    *          The map to work with    * @param key    *          the string key    * @param val    *          the value to add or set the map key to    */
end_comment
...
argument_list|()
expr_stmt|;
comment|// Note that there is only one store per CF so setting is safe
name|cfname
operator|=
literal|"cf."
operator|+
