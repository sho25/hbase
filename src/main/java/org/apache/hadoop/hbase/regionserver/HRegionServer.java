...
begin_comment
comment|/**    * Wait for mid-flight schema change requests. (if any)    * @param tableName    */
end_comment

begin_function
specifier|private
name|void
name|waitForSchemaChange
parameter_list|(
name|String
name|tableName
parameter_list|)
...
name|debug
argument_list|(
literal|"Schema alter is inprogress for table = "
operator|+
name|tableName
operator|+
literal|" Waiting for alter to complete before a split"
argument_list|)
expr_stmt|;
name|Thread
operator|.
...
begin_comment
comment|/**   * Refresh schema changes for given region.   * @param hRegion HRegion to refresh   * @throws IOException   */
end_comment
...
argument_list|()
expr_stmt|;
comment|// Remove from online regions
name|removeFromOnlineRegions
argument_list|(
name|regionInfo
operator|.
...
argument_list|)
decl_stmt|;
comment|// Add new region to the onlineRegions
name|addToOnlineRegions
argument_list|(
name|region
argument_list|)
