...
expr_stmt|;
block|}
comment|/**    * Add updates first to the hlog (if writeToWal) and then add values to memstore.    * Warning: Assumption is caller has lock on passed in row.    * @param put The Put command    * @param writeToWAL if true, then we should write to the log    * @throws IOException    */
specifier|private
name|void
name|internalPut
parameter_list|(
