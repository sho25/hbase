...
argument_list|()
decl_stmt|;
comment|// Check any loaded coprocessors
comment|/* TODO: we should catch any throws coprocessor exceptions here to allow the            rest of the batch to continue.  This means fixing HBASE-2898 */
if|if
condition|(
name|coprocessorHost
operator|!=
...
name|SUCCESS
expr_stmt|;
comment|// execute any coprocessor post-hooks
if|if
condition|(
name|coprocessorHost
operator|!=
...
expr_stmt|;
block|}
comment|// append get results to pre-get results
if|if
condition|(
name|results
operator|!=
