...
name|info
argument_list|(
literal|"replayRecoveredEditsIfAny"
argument_list|)
expr_stmt|;
name|long
name|seqid
...
operator|)
operator|+
comment|// memstoreFlushSize, lastFlushTime, blockingMemStoreSize, threadWakeFrequency
name|Bytes
operator|.
name|SIZEOF_BOOLEAN
operator|+
comment|// splitRequest
name|ClassSize
operator|.
name|ARRAY
operator|+
