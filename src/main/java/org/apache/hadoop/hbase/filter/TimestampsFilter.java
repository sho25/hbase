...
begin_comment
comment|/**  * Filter that returns only cells whose timestamp (version) is  * in the specified list of timestamps (versions).  *<p>  * Note: Use of this filter overrides any time range/time stamp  * options specified using {@link Get#setTimeRange(long, long)},  * {@link Scan#setTimeRange(long, long)}, {@link Get#setTimeStamp(long)},  * or {@link Scan#setTimeStamp(long)}.  */
end_comment
