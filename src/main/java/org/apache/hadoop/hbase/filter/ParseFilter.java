...
decl_stmt|;
comment|/**    * Constructor    *<p>    * Sets up the filterHashMap by registering all the filters    * Creates the operatorPrecedenceHashMap    */
specifier|public
name|ParseFilter
parameter_list|()
block|{
...
block|}
block|}
comment|/**    * Registers the filter    *<p>    * Inserts a key-value composed of a ByteBuffer containing the name of the filter    * and an object of the filter into the HashMap    *<p>    * @param filterName the name of the filter we wish to register in the filterHashMap    * @param filter an object of that filter    */
specifier|private
name|void
name|registerFilter
parameter_list|(
...
block|}
block|}
comment|/**  * Takes a quoted byte array and converts it into an unquoted byte array  * For example: given a byte array representing 'abc', it returns a  * byte array representing 'abc'  *<p>  * @param stringAsByteArray the quoted byte array  * @return  */
specifier|public
specifier|static
name|byte
index|[]
...
name|IllegalArgumentException
argument_list|(
literal|"convertByteArrayToString needs a quotes byte array"
argument_list|)
throw|;
block|}
else|else
