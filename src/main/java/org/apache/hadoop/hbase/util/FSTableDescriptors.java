...
block|}
block|}
comment|/**    * Width of the sequenceid that is suffix on tableinfo.    */
specifier|static
specifier|final
name|int
...
literal|10
decl_stmt|;
comment|/**    * Regex to eat up sequenceid suffix on a .tableinfo file.    */
specifier|private
specifier|static
specifier|final
name|Pattern
...
argument_list|)
decl_stmt|;
comment|/*    * @param number    * @return Returns zero-prefixed 5-byte wide decimal version of passed    * number (Does absolute in case number is negative).    */
specifier|static
name|String
...
return|;
block|}
comment|/**    * Update table descriptor    * @param fs    * @param conf    * @param hTableDescriptor    * @return New tableinfo    * @throws IOException    */
specifier|static
name|Path
name|updateHTableDescriptor
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Called when we are creating a table to write out the tables' descriptor.    * @param fs    * @param hTableDescriptor    * @param tableDir    * @param forceCreation True if we are to force creation    * @param status The status of the current tableinfo; can be null    * @throws IOException    */
specifier|private
specifier|static
name|Path
name|writeTableDescriptor
