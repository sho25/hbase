...
return|;
block|}
comment|/**      * Block until the master has come online, indicating it is ready      * to be used.      */
specifier|public
name|void
name|waitForServerOnline
parameter_list|()
block|{
comment|// The server is marked online after init begins but before race to become
comment|// the active master.
while|while
condition|(
operator|!
name|this
