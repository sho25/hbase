...
return|;
block|}
comment|/**    * Compute HDFS blocks distribution of a given file, or a portion of the file    * @param fs file system    * @param FileStatus file status of the file    * @param start start position of the portion    * @param length length of the portion     * @return The HDFS blocks distribution    */
specifier|static
specifier|public
name|HDFSBlocksDistribution
...
begin_comment
comment|/**    * Update table descriptor    * @param fs    * @param conf    * @param hTableDescriptor    * @throws IOException    */
end_comment
