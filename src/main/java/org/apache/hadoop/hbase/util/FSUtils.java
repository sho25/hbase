...
name|info
argument_list|(
literal|"Adding tabledescriptor for table = "
operator|+
name|tableName
argument_list|)
expr_stmt|;
...
begin_comment
comment|/**    * Get table info path for a table.    * @param tableName    * @return Table info path    */
end_comment
...
begin_comment
comment|/**    * Get HTD from HDFS.    * @param fs    * @param hbaseRootDir    * @param tableName    * @return    * @throws IOException    */
end_comment
...
name|info
argument_list|(
literal|"Reading table descriptor from .tableinfo. current path = "
operator|+
name|tableDir
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Reading table descriptor from .tableinfo current tablename is NULL "
argument_list|)
expr_stmt|;
return|return
literal|null
...
name|info
argument_list|(
literal|"Current tabledescriptor from .tableinfo is "
operator|+
name|hTableDescriptor
operator|.
name|toString
...
name|info
argument_list|(
literal|"Exception during getTableDescriptor "
argument_list|,
name|ioe
argument_list|)
expr_stmt|;
