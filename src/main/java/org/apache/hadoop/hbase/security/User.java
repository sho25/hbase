...
name|User
block|{
comment|/**    * Flag to differentiate between API-incompatible changes to    * {@link org.apache.hadoop.security.UserGroupInformation} between vanilla    * Hadoop 0.20.x and secure Hadoop 0.20+.    */
specifier|private
specifier|static
name|boolean
...
block|}
block|}
comment|/**    * Returns whether or not Kerberos authentication is configured.  For    * non-secure Hadoop, this always returns<code>false</code>.    * For secure Hadoop, it will return the value from    * {@code UserGroupInformation.isSecurityEnabled()}.    */
specifier|public
specifier|static
name|boolean
...
condition|)
block|{
comment|// Secure Hadoop UGI will perform an implicit login if the current
comment|// user is null.  Emulate the same behavior here for consistency
name|Configuration
name|conf
init|=
name|HBaseConfiguration
...
block|}
block|}
comment|/**      * No-op since we're running on a version of Hadoop that doesn't support      * logins.      * @see User#login(org.apache.hadoop.conf.Configuration, String, String, String)      */
specifier|public
specifier|static
name|void
name|login
