...
return|;
block|}
comment|/**    * Performs a full scan of<code>.META.</code>, skipping regions from any    * tables in the specified set of disabled tables.    *<p>    * Returns a map of every region to it's currently assigned server, according    * to META.  If the region does not have an assignment it will have a null    * value in the map.    *    * @param catalogTracker    * @param disabledTables set of disabled tables that will not be returned    * @return map of regions to their currently assigned server    * @throws IOException    */
specifier|public
specifier|static
name|Map
argument_list|<
...
return|;
block|}
comment|/**    * Performs a full scan of<code>.META.</code>.    *<p>    * Returns a map of every region to it's currently assigned server, according    * to META.  If the region does not have an assignment it will have a null    * value in the map.    * @param catalogTracker    * @param visitor    * @throws IOException    */
specifier|public
specifier|static
name|void
name|fullScan
...
return|return;
block|}
comment|/**    * Reads the location of META from ROOT.    * @param metaServer connection to server hosting ROOT    * @return location of META in ROOT where location, or null if not available    * @throws IOException    */
specifier|public
specifier|static
name|ServerName
...
return|;
block|}
comment|/**    * Reads the location of the specified region from META.    * @param catalogTracker    * @param regionName region to read location of    * @return location of META in ROOT where location is, or null if not available    * @throws IOException    */
specifier|public
specifier|static
name|ServerName
...
block|}
return|return
name|getServerNameFromResult
argument_list|(
name|r
argument_list|)
return|;
block|}
comment|/**    * Gets the region info and assignment for the specified region from META.    * @param catalogTracker    * @param regionName    * @return location of META in ROOT where location is    * a String of&lt;host> ':'&lt;port>, or null if not available    * @throws IOException    */
specifier|public
specifier|static
name|Pair
argument_list|<
...
return|;
block|}
comment|/**    * @param data A .META. table row.    * @return A pair of the regioninfo and the ServerName    * (or null for server address if no address set in .META.).    * @throws IOException    */
specifier|public
specifier|static
name|Pair
argument_list|<
...
argument_list|)
decl_stmt|;
comment|// sn can be null in case where no server inof.
return|return
operator|new
name|Pair
argument_list|<
...
return|;
block|}
comment|/**    * @param data Result to interrogate.    * @return A ServerName instance or null if necessary fields not found or empty.    */
specifier|private
specifier|static
name|ServerName
name|getServerNameFromResult
...
return|;
block|}
comment|/**    * Fully scan a given region, on a given server starting with given row.    * @param hRegionInterface region server    * @param visitor visitor    * @param regionName name of region    * @param startrow start row    * @throws IOException    */
specifier|public
specifier|static
name|void
name|fullScan
