...
return|;
block|}
comment|/**    * @param data A .META. table row.    * @return A pair of the regioninfo and the server address from<code>data</code>    * or null for server address if no address set in .META. or null for a result    * if no HRegionInfo found.    * @throws IOException    */
specifier|public
specifier|static
name|Pair
argument_list|<
...
block|}
block|}
comment|/**    * @param data A .META. table row.    * @return A pair of the regioninfo and the server info from<code>data</code>    * (or null for server address if no address set in .META.).    * @throws IOException    */
specifier|public
specifier|static
name|Pair
argument_list|<
