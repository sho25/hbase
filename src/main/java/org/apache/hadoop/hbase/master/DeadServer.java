...
argument_list|()
decl_stmt|;
comment|/** Linked list of dead servers used to bound size of dead server set */
specifier|private
specifier|final
name|List
argument_list|<
...
argument_list|()
decl_stmt|;
comment|/** Maximum number of dead servers to keep track of */
specifier|private
specifier|final
name|int
name|maxDeadServers
...
operator|++
expr_stmt|;
comment|// Check to see if we are at capacity for dead servers
if|if
condition|(
name|deadServerList
operator|.
