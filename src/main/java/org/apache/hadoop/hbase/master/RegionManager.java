...
argument_list|)
decl_stmt|;
comment|// regions in transition are also recorded in ZK using the zk wrapper
specifier|final
name|ZooKeeperWrapper
name|zkWrapper
decl_stmt|;
...
parameter_list|)
block|{
comment|// TODO: Review what we should do here.  If Writables work this
...
init|)
block|{
comment|// the root region has been assigned, remove it from transition in ZK
name|zkWrapper
operator|.
