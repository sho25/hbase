...
expr_stmt|;
block|}
comment|/**    * Handle failover.  Restore state from META and ZK.  Handle any regions in    * transition.    * @throws KeeperException    * @throws IOException    */
name|void
...
operator|+
literal|"long, resending close rpc"
argument_list|)
expr_stmt|;
name|unassign
argument_list|(
...
name|info
argument_list|(
literal|"Region not on a server: "
operator|+
name|hri
operator|.
name|getRegionNameAsString
...
block|}
block|}
comment|/*    * Caller must hold locks on servers Map.    * @param hsi    * @param hri    * @param expected    */
specifier|private
name|void
name|removeFromServers
parameter_list|(
