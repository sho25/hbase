...
argument_list|()
decl_stmt|;
comment|// If the UNASSIGNED ZNode exists and this is a fresh cluster start, then
comment|// delete it.
if|if
condition|(
name|master
...
name|info
argument_list|(
literal|"Cluster start, but found "
operator|+
name|unassignedZNode
operator|+
literal|", deleting it."
...
name|error
argument_list|(
literal|"Could not delete znode "
operator|+
name|unassignedZNode
argument_list|,
name|e
...
expr_stmt|;
block|}
comment|/**    * This is the processing loop that gets triggered from the ZooKeeperWrapper.    * This zookeeper events process function dies the following:    *   - WATCHES the following events: NodeCreated, NodeDataChanged, NodeChildrenChanged    *   - IGNORES the following events: None, NodeDeleted    */
annotation|@
name|Override
specifier|public
