...
return|;
block|}
comment|/**    * Get a HTableDescriptor of a table.    * @param tableName    * @return HTableDescriptor    */
specifier|public
name|HTableDescriptor
...
name|info
argument_list|(
literal|"Exception during readTableDecriptor "
argument_list|,
name|ioe
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|/**    * Update a table descriptor.    * @param htableDescriptor    * @return updated HTableDescriptor    * @throws IOException    */
specifier|public
name|HTableDescriptor
...
name|info
argument_list|(
literal|"Update Table Descriptor.  Current HTD = "
operator|+
name|htableDescriptor
argument_list|)
expr_stmt|;
