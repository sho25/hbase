...
begin_comment
comment|/**  * This Chore, everytime it runs, will clear the logs in the old logs folder  * that are deletable for each log cleaner in the chain, in order to limit the  * number of deletes it sends, will only delete maximum 20 in a single run.  */
end_comment
