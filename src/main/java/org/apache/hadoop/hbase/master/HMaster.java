...
expr_stmt|;
block|}
comment|/**    * Get a list of the regions for a given table. The pairs may have    * null for their second element in the case that they are not    * currently deployed.    * TODO: Redo so this method does not duplicate code with subsequent methods.    */
name|List
argument_list|<
name|Pair
argument_list|<
...
name|println
argument_list|(
literal|"   -D opt=<value>            Override HBase configuration settings."
argument_list|)
expr_stmt|;
name|System
operator|.
