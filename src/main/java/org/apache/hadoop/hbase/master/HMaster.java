...
name|conf
expr_stmt|;
comment|/*      * 1. Determine address and initialize RPC server (but do not start).      * The RPC server ports can be ephemeral. Create a ZKW instance.      */
name|HServerAddress
name|a
init|=
operator|new
...
argument_list|()
expr_stmt|;
comment|// Stop services started up in the constructor.
name|this
operator|.
name|activeMasterManager
operator|.
