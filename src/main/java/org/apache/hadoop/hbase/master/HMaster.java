...
argument_list|)
expr_stmt|;
comment|//fileSystemManager.createTableDescriptor(hTableDescriptor);
block|}
end_function
...
begin_comment
comment|/**    * Get all table descriptors    * @return HTableDescriptor[]    */
end_comment
...
begin_comment
comment|/**    * Get a HTD for a given table name    * @param tableName    * @return HTableDescriptor    */
end_comment

begin_comment
comment|/*   public HTableDescriptor getHTableDescriptor(byte[] tableName) {     if (tableName != null&& tableName.length> 0) {       return this.assignmentManager.getTableDescriptor(           Bytes.toString(tableName));     }     return null;   } */
end_comment
