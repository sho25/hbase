...
block|{
comment|// notify the waiting thread that we're done persisting the request
name|setPersist
argument_list|()
expr_stmt|;
block|}
...
return|;
block|}
comment|/**    * Table modifications are processed asynchronously, but provide an API for    * you to query their status.    *    * @throws IOException    */
specifier|public
