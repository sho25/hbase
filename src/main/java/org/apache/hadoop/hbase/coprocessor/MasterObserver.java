...
name|IOException
function_decl|;
comment|/**    * Called prior to modifying the flag used to enable/disable region balancing.    * @param env the coprocessor instance's environment    * @param newValue the new flag value submitted in the call    */
name|boolean
...
name|IOException
function_decl|;
comment|/**    * Called after the flag to enable/disable balancing has changed.    * @param env the coprocessor instance's environment    * @param oldValue the previously set balanceSwitch value    * @param newValue the newly set balanceSwitch value    */
name|void
