...
name|warn
argument_list|(
literal|"Cannot get peer's region server addresses"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
literal|false
return|;
comment|// TODO remove when we support it
block|}
elseif|else
if|if
condition|(
...
name|warn
argument_list|(
literal|"Multiple slaves feature not supported"
argument_list|)
expr_stmt|;
return|return
literal|false
...
argument_list|(
literal|"Multi-slave isn't supported yet"
argument_list|)
throw|;
block|}
name|ZKUtil
