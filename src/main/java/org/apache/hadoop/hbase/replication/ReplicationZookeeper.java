...
literal|"lock"
decl_stmt|;
comment|// Values of znode which stores state of a peer
specifier|public
specifier|static
enum|enum
name|PeerState
...
decl_stmt|;
comment|// Name of zk node which stores peer state
specifier|private
name|String
...
block|}
block|}
comment|/**    * Get state of the peer. This method checks the state by connecting to ZK.    *    * @param id peer's identifier    * @return current state of the peer    */
specifier|public
name|PeerState
name|getPeerState
parameter_list|(
