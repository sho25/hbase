...
block|}
block|}
comment|/** Constructor that uses all defaults for compression and block size. */
specifier|public
name|HFileWriterV1
parameter_list|(
name|Configuration
...
expr_stmt|;
block|}
comment|/**    * Constructor that takes a path, creates and closes the output stream. Takes    * compression algorithm name as string.    */
specifier|public
name|HFileWriterV1
parameter_list|(
name|Configuration
...
expr_stmt|;
block|}
comment|/** Constructor that takes a stream. */
specifier|public
name|HFileWriterV1
parameter_list|(
name|CacheConfig
