...
return|;
block|}
comment|/**    * Use this instead of {@link #toByteArray()} when writing to a stream and you want to use    * the pb mergeDelimitedFrom (w/o the delimiter, pb reads to EOF which may not be what ou want).    * @return This instance serialized as a delimited protobuf w/ a magic pb prefix.    * @throws IOException    * @see {@link #toByteArray()}    */
name|byte
index|[]
name|toByteArray
parameter_list|()
...
return|;
block|}
comment|/**    * Parses an {@link Reference} instance from the passed in stream.  Presumes the    * Reference was serialized to the stream with {@link #toDelimitedByteArray()}    * @param in    * @return An instance of Reference.    * @throws IOException    */
specifier|static
name|Reference
name|parseFrom
parameter_list|(
