...
begin_comment
comment|/**  * Provide access to all data block encoding algorithms.  */
end_comment
...
block|{
comment|/** Constructor. This class cannot be instantiated. */
specifier|private
name|DataBlockEncodings
parameter_list|()
block|{   }
comment|/**    * Algorithm type. All of the algorithms are required to have unique id which    * should _NEVER_ be changed. If you want to add a new algorithm/version,    * assign it a new id. Announce the new id in the HBase mailing list to    * prevent collisions.    */
specifier|public
specifier|static
enum|enum
name|Algorithm
...
name|HFileBlock
operator|.
name|DATA_BLOCK_ENCODER_ID_SIZE
condition|)
block|{
...
return|;
block|}
comment|/**      * Writes id in bytes.      * @param stream Where it should be written.      */
specifier|public
name|void
name|writeIdInBytes
parameter_list|(
...
block|}
block|}
comment|/**    * Maps encoding algorithm ids to algorithm instances for all algorithms in    * the {@link Algorithm} enum.    */
specifier|private
specifier|static
specifier|final
name|Map
...
argument_list|()
decl_stmt|;
comment|/** Size of a delta encoding algorithm id */
specifier|public
specifier|static
specifier|final
name|int
...
name|format
argument_list|(
literal|"Two data block encoder algorithms '%s' and '%s' has same id '%d"
argument_list|,
name|idToAlgorithm
operator|.
name|get
...
return|;
block|}
comment|/**    * Find and return name of data block encoder for given id.    * @param encoderId id of data block encoder    * @return name, same as used in options in column family    */
specifier|public
specifier|static
name|String
name|getNameFromId
