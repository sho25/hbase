...
name|encodingCxt
decl_stmt|;
comment|/**    * Create a buffer which will be encoded using dataBlockEncoder.    * @param dataBlockEncoder Algorithm used for compression.    * @param encoding encoding type used    */
specifier|public
name|EncodedDataBlock
parameter_list|(
name|DataBlockEncoder
...
return|;
block|}
comment|/**    * Do the encoding .    * @return encoded byte buffer.    */
specifier|public
name|byte
index|[]
name|encodeData
