...
block|}
block|}
comment|/**    * Implements the "basic block reader" API, used mainly by    * {@link HFileBlockIndex.BlockIndexReader} in    * {@link HFileBlockIndex.BlockIndexReader#seekToDataBlock(byte[], int, int,    * HFileBlock)} in a random-read access pattern.    */
annotation|@
name|Override
specifier|public
name|HFileBlock
...
throw|;
block|}
comment|// Assuming we are not doing a compaction.
return|return
name|readBlock
argument_list|(
name|offset
