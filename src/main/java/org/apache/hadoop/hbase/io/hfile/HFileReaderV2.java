...
argument_list|(
literal|"ScannerV2 works only on data blocks"
argument_list|)
throw|;
block|}
name|blockBuffer
...
argument_list|(
literal|"Error reading memstoreTS. "
operator|+
name|e
argument_list|)
throw|;
...
block|}
block|}
comment|/**    * ScannerV2 which operate on encoded data blocks.    */
specifier|protected
specifier|static
class|class
name|EncodedScannerV2
