...
decl_stmt|;
comment|/**      * The size of the data on disk that does not include the checksums.      * (header + data)      */
specifier|private
name|int
name|onDiskDataSizeWithHeader
decl_stmt|;
...
argument_list|(
literal|"Could not create compression stream "
operator|+
literal|"for algorithm "
operator|+
name|compressionAlgorithm
argument_list|,
name|e
...
expr_stmt|;
comment|// data size
comment|// reserve space for checksums in the output byte stream
name|ChecksumUtil
operator|.
...
argument_list|)
expr_stmt|;
comment|// generate checksums for header and data. The checksums are
comment|// part of onDiskBytesWithHeader itself.
name|ChecksumUtil
operator|.
...
argument_list|)
expr_stmt|;
comment|// Checksums are already part of onDiskBytesWithHeader
name|onDiskChecksum
operator|=
name|HConstants
operator|.
...
block|{
comment|// If we are not using any compression, then the
comment|// checksums are written to its own array onDiskChecksum.
name|onDiskBytesWithHeader
operator|=
name|uncompressedBytesWithHeader
expr_stmt|;
...
index|]
expr_stmt|;
comment|//set the header for the uncompressed bytes
name|putHeader
argument_list|(
name|uncompressedBytesWithHeader
argument_list|,
...
name|blockType
operator|+
literal|" without compression should have checksums "
operator|+
literal|" stored separately."
argument_list|)
throw|;
block|}
name|out
