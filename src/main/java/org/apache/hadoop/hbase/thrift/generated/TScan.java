...
expr_stmt|;
block|}
comment|/** Returns true if field caching is set (has been asigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetCaching
parameter_list|()
...
expr_stmt|;
block|}
comment|/** Returns true if field filterString is set (has been asigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetFilterString
parameter_list|()
