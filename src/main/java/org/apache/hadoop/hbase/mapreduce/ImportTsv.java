...
expr_stmt|;
block|}
comment|// Make sure one or more columns are specified excluding rowkey and timestamp key
if|if
condition|(
name|columns
operator|.
...
argument_list|)
decl_stmt|;
comment|// Set it back to replace invalid timestamp (non-numeric) with current system time
name|conf
operator|.
name|setLong
argument_list|(
