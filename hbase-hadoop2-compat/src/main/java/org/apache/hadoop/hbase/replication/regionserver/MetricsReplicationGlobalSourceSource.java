...
argument_list|)
expr_stmt|;
comment|// obtained value maybe smaller than 1024. We should make sure that KB count
comment|// eventually picks up even from multiple smaller updates.
...
parameter_list|)
block|{
comment|// Following code should be thread-safe.
name|long
name|delta
init|=
literal|0
