...
begin_comment
comment|/** Hadoop 2 implementation of BaseMetricsSource for */
end_comment
...
comment|//otherwise gaugeInt should contain the thing that was in before the put could be completed.
if|if
condition|(
name|gaugeInt
operator|==
