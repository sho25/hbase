...
name|warn
argument_list|(
literal|"No response from master on reportForDuty. Sleeping and "
operator|+
literal|"then trying again."
argument_list|)
expr_stmt|;
block|}
name|List
...
argument_list|)
decl_stmt|;
comment|// If we got something, add it to list of things to send.
if|if
condition|(
name|msg
operator|!=
...
argument_list|)
expr_stmt|;
comment|// Do some housekeeping before going back around
name|housekeeping
argument_list|()
expr_stmt|;
block|}
...
comment|//
comment|// HBASE-1215 migration; metautils scan of meta region was broken; wouldn't see first row
comment|// ------------------------------------------------------------------------
comment|// r796326 | stack | 2009-07-21 07:40:34 -0700 (Tue, 21 Jul 2009) | 38 lines
if|if
condition|(
name|hra
operator|!=
...
return|;
block|}
comment|/*    * Run some housekeeping tasks.    */
specifier|private
name|void
name|housekeeping
parameter_list|()
...
name|info
argument_list|(
literal|"Regionserver blocked by "
operator|+
name|HMsg
operator|.
name|Type
