...
expr_stmt|;
block|}
comment|/**    * Iterator that maps Iterator calls to return the value component of the    * passed-in Map.Entry Iterator.    */
specifier|static
class|class
