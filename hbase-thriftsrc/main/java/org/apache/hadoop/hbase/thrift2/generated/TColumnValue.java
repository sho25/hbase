...
block|}
argument_list|)
comment|/**  * Represents a single cell and its value.  */
annotation|@
name|Generated
argument_list|(
name|value
...
argument_list|,
operator|new
name|TColumnValueStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|TColumnValueTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field tags is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetTags
parameter_list|()
...
name|TProtocolException
argument_list|(
literal|"Required field 'value' was not present! Struct: "
operator|+
name|toString
argument_list|()
argument_list|)
...
block|{
specifier|public
name|TColumnValueStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
