...
block|}
argument_list|)
comment|/**  * A TIllegalArgument exception indicates an illegal or invalid  * argument was passed into a procedure.  */
annotation|@
name|Generated
argument_list|(
name|value
...
argument_list|,
operator|new
name|TIllegalArgumentStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|TIllegalArgumentTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|TIllegalArgumentStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|TIllegalArgumentTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
