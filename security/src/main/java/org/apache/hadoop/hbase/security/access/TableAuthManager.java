...
block|{
comment|/** Key for the user and group cache maps for globally assigned permissions */
specifier|private
specifier|static
specifier|final
name|String
name|GLOBAL_CACHE_KEY
init|=
literal|".access."
decl_stmt|;
specifier|private
...
name|instance
decl_stmt|;
comment|/** Cache of global user permissions */
specifier|private
name|ListMultimap
argument_list|<
name|String
...
argument_list|()
decl_stmt|;
comment|/** Cache of global group permissions */
specifier|private
name|ListMultimap
argument_list|<
name|String
...
parameter_list|)
block|{
comment|// split user from group assignments so we don't have to prepend the group
comment|// prefix every time we query for groups
name|ListMultimap
argument_list|<
name|String
argument_list|,
