...
argument_list|(
literal|"Only small scan is allowed"
argument_list|)
argument_list|)
return|;
block|}
...
name|IllegalArgumentException
argument_list|(
literal|"Batch and allowPartial is not allowed for small scan"
argument_list|)
argument_list|)
return|;
block|}
...
name|warn
argument_list|(
literal|"This is small scan "
operator|+
name|scan
operator|+
literal|", consider using smallScan directly?"
argument_list|)
expr_stmt|;
block|}
block|}
