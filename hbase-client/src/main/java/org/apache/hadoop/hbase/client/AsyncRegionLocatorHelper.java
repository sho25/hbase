...
name|debug
argument_list|(
literal|"Try updating {} , the old value is {}"
argument_list|,
name|loc
argument_list|,
name|oldLoc
...
block|}
block|}
comment|/**    * Create a new {@link RegionLocations} which is the merging result for the given two    * {@link RegionLocations}.    *<p/>    * All the {@link RegionLocations} in async locator related class are immutable because we want to    * access them concurrently, so here we need to create a new one, instead of calling    * {@link RegionLocations#mergeLocations(RegionLocations)} directly.    */
specifier|static
name|RegionLocations
