...
return|;
block|}
comment|/**    * Get the replicable table-cf config of the specified peer.    * @param id a short that identifies the cluster    */
specifier|public
name|String
...
return|;
block|}
comment|/**    * Set the replicable table-cf config of the specified peer    * @param id a short that identifies the cluster    */
specifier|public
name|void
