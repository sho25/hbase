...
throw|;
block|}
comment|/**    * Converts a list of Permission.Action shaded proto to an array of client Permission.Action    * objects.    * @param protoActions the list of shaded protobuf Actions    * @return the converted array of Actions    */
specifier|public
specifier|static
name|Permission
operator|.
