...
return|;
block|}
comment|/**    * Apply the specified server-side filter when performing the Query.    * Only {@link Filter#filterKeyValue(org.apache.hadoop.hbase.Cell)} is called AFTER all tests    * for ttl, column match, deletes and max versions have been run.    * @param filter filter to run on the server    * @return this for invocation chaining    */
specifier|public
name|Query
name|setFilter
parameter_list|(
...
return|;
block|}
comment|/**    * Sets the TimeRange to be used by this Query    * @param tr TimeRange    * @return Query    */
specifier|public
name|Query
name|setTimeRange
parameter_list|(
...
return|;
block|}
comment|/**    * Sets the TimeRange to be used by this Query    * [minStamp, maxStamp).    * @param minStamp minimum timestamp value, inclusive    * @param maxStamp maximum timestamp value, exclusive    * @throws IOException    * @return this for invocation chaining    */
specifier|public
name|Query
name|setTimeRange
parameter_list|(
