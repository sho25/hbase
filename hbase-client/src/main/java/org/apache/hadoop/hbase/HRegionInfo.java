...
literal|"(?:[a-f0-9]+)"
decl_stmt|;
comment|// to keep appended int's sorted in string format. Only allows 2 bytes to be
comment|// sorted for replicaId
specifier|public
specifier|static
specifier|final
name|String
...
return|;
block|}
comment|/**    * @return A deserialized {@link HRegionInfo}    * or null if we failed deserialize or passed bytes null    * @see #toByteArray()    */
specifier|public
specifier|static
name|HRegionInfo
...
return|;
block|}
comment|/**    * Get the descriptive name as {@link RegionState} does it but with hidden    * startkey optionally    * @param state    * @param conf    * @return descriptive string    */
specifier|public
specifier|static
name|String
...
return|;
block|}
comment|/**    * Get the region name for display. Optionally hide the start key.    * @param hri    * @param conf    * @return region name as String    */
specifier|public
specifier|static
name|String
name|getRegionNameAsStringForDisplay
...
return|;
block|}
comment|/**    * Get the region name for display. Optionally hide the start key.    * @param hri    * @param conf    * @return region name bytes    */
specifier|public
specifier|static
name|byte
index|[]
