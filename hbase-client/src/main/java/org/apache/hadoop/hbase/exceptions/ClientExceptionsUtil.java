...
return|return
operator|!
name|regionDefinitelyOnTheRegionServerException
argument_list|(
name|cur
argument_list|)
return|;
...
return|;
block|}
comment|/**    * This function is the alias of regionDefinitelyOnTheRegionServerException,    * whose name is confusing in the function findException().    */
specifier|private
specifier|static
name|boolean
name|matchExceptionWeCare
parameter_list|(
name|Throwable
name|t
parameter_list|)
...
comment|// For example, in SocketOutputStream a plain IOException is thrown at times when the channel is
comment|// closed.
specifier|private
specifier|static
specifier|final
...
argument_list|>
argument_list|>
name|CONNECTION_EXCEPTION_TYPES
init|=
name|ImmutableSet
operator|.
name|of
...
argument_list|)
decl_stmt|;
comment|/**    * For test only. Usually you should use the {@link #isConnectionException(Throwable)} method    * below.    */
annotation|@
name|VisibleForTesting
specifier|public
specifier|static
