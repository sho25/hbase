...
name|error
argument_list|(
literal|"ZK error trying to get hbase:meta from ZooKeeper"
argument_list|)
expr_stmt|;
return|return
literal|false
...
block|}
block|}
comment|/**    * Wait until the meta region is available.    * @param zkw zookeeper connection to use    * @param timeout maximum time to wait, in millis    * @return ServerName or null if we timed out.    * @throws InterruptedException    */
specifier|public
name|ServerName
name|blockUntilAvailable
parameter_list|(
