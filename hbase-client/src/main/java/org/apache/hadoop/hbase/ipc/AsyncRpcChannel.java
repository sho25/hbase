...
specifier|private
name|void
name|startConnectionWithEncryption
parameter_list|(
name|Channel
name|ch
parameter_list|)
block|{
comment|// for rpc encryption, the order of ChannelInboundHandler should be:
comment|// LengthFieldBasedFrameDecoder->SaslClientHandler->LengthFieldBasedFrameDecoder
comment|// Don't skip the first 4 bytes for length in beforeUnwrapDecoder,
comment|// SaslClientHandler will handler this
name|ch
operator|.
name|pipeline
argument_list|()
