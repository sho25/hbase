...
return|;
block|}
comment|/**    * Return the storage policy in use by this family    *<p/>    * Not using {@code enum} here because HDFS is not using {@code enum} for storage policy, see    * org.apache.hadoop.hdfs.server.blockmanagement.BlockStoragePolicySuite for more details    */
specifier|public
name|String
...
return|;
block|}
comment|/**    * Set the storage policy for use with this family    * @param policy the policy to set, valid setting includes:<i>"LAZY_PERSIST"</i>,    *<i>"ALL_SSD"</i>,<i>"ONE_SSD"</i>,<i>"HOT"</i>,<i>"WARM"</i>,<i>"COLD"</i>    */
specifier|public
name|HColumnDescriptor
