...
return|;
block|}
comment|/**    * Method for setting the Delete's familyMap    * @deprecated As of release 2.0.0, this will be removed in HBase 3.0.0.    *             Use {@link Delete#Delete(byte[], long, NavigableMap)} instead    */
annotation|@
name|Deprecated
annotation|@
name|Override
