...
return|;
block|}
comment|/**    * @param request    * @param t    * @return Return a response that has every action in request failed w/ the passed in    * exception<code>t</code> -- this will get them all retried after some backoff.    */
specifier|private
specifier|static
name|MultiResponse
name|createAllFailedResponse
