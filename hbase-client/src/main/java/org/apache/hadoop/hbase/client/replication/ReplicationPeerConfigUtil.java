...
specifier|static
name|ReplicationPeerConfig
name|appendExcludeTableCFsToReplicationPeerConfig
parameter_list|(
name|Map
argument_list|<
name|TableName
...
name|ReplicationException
argument_list|(
literal|"exclude tableCfs is null"
argument_list|)
throw|;
block|}
name|ReplicationPeerConfigBuilder
...
specifier|static
name|ReplicationPeerConfig
name|removeExcludeTableCFsFromReplicationPeerConfig
parameter_list|(
name|Map
argument_list|<
name|TableName
...
name|ReplicationException
argument_list|(
literal|"exclude-Table-Cfs for peer: "
operator|+
name|id
operator|+
literal|" is null"
...
name|table
operator|+
literal|" which doesn't specify cfs from exclude-table-cfs config in peer: "
operator|+
name|id
argument_list|)
throw|;
...
name|table
operator|+
literal|" which has specified cfs from exclude-table-cfs config in peer: "
operator|+
name|id
argument_list|)
throw|;
...
name|table
operator|+
literal|" in exclude-table-cfs config of peer: "
operator|+
name|id
argument_list|)
throw|;
