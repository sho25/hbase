...
return|;
block|}
comment|/**    * See {@link #add(byte[], byte[], byte[], Tag[] tag)}. This version expects    * that the underlying arrays won't change. It's intended    * for usage internal HBase to and for advanced client applications.    */
specifier|public
name|Put
name|addImmutable
parameter_list|(
...
return|;
block|}
comment|/**    * Forms a keyvalue with tags    */
annotation|@
...
return|;
block|}
comment|/**    * See {@link #add(byte[], byte[], long, byte[], Tag[] tag)}. This version expects    * that the underlying arrays won't change. It's intended    * for usage internal HBase to and for advanced client applications.    */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
...
return|;
block|}
comment|/**    * Add the specified column and value, with the specified timestamp as    * its version to this Put operation.    * @param family family name    * @param qualifier column qualifier    * @param ts version timestamp    * @param value column value    * @param tag the tags    * @return this    */
specifier|public
name|Put
name|add
parameter_list|(
...
return|;
block|}
comment|/**    * See {@link #add(byte[], ByteBuffer, long, ByteBuffer, Tag[] tag)}. This version expects    * that the underlying arrays won't change. It's intended    * for usage internal HBase to and for advanced client applications.    */
specifier|public
name|Put
name|addImmutable
parameter_list|(
