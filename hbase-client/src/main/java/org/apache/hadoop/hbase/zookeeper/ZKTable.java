...
return|;
block|}
comment|/**    * Gets a list of all the tables set as disabling in zookeeper.    * @return Set of disabling tables, empty Set if none    * @throws KeeperException    */
specifier|public
specifier|static
name|Set
argument_list|<
...
return|;
block|}
comment|/**    * Gets a list of all the tables set as enabling in zookeeper.    * @return Set of enabling tables, empty Set if none    * @throws KeeperException    */
specifier|public
specifier|static
name|Set
argument_list|<
