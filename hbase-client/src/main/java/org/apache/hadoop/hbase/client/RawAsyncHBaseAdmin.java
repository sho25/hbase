...
return|;
block|}
comment|/**    * {@link #listTables(boolean)}    */
annotation|@
name|Override
specifier|public
name|CompletableFuture
...
name|columnFamily
argument_list|,
literal|"columnFamily is null. If you don't specify a columnFamily, use compact(TableName) instead"
argument_list|)
expr_stmt|;
return|return
name|compact
...
literal|"columnFamily is null."
operator|+
literal|" If you don't specify a columnFamily, use majorCompact(TableName) instead"
argument_list|)
expr_stmt|;
return|return
name|compact
