...
name|RSGroupAdminProtos
operator|.
name|GetConfiguredNamespacesAndTablesInRSGroupRequest
import|;
end_import
...
name|RSGroupAdminProtos
operator|.
name|GetConfiguredNamespacesAndTablesInRSGroupResponse
import|;
end_import
...
name|RSGroupAdminProtos
operator|.
name|ListTablesInRSGroupRequest
import|;
end_import
...
name|RSGroupAdminProtos
operator|.
name|ListTablesInRSGroupResponse
import|;
end_import
...
name|warn
argument_list|(
literal|"Configured value of pauseForCQTBENs is {} ms, which is less than"
operator|+
literal|" the normal pause value {} ms, use the greater one instead"
argument_list|,
name|TimeUnit
operator|.
name|NANOSECONDS
...
begin_comment
comment|/**    * Utility for completing passed TableState {@link CompletableFuture}<code>future</code>    * using passed parameters. Sets error or boolean result ('true' if table matches    * the passed-in targetState).    */
end_comment
...
begin_comment
comment|/**    * This method is for internal use only, where we need the response of the flush.    *<p/>    * As it exposes the protobuf message, please do<strong>NOT</strong> try to expose it as a public    * API.    */
end_comment
...
condition|)
block|{
comment|// old format encodedName, should be meta region
name|future
operator|=
name|connection
operator|.
...
begin_comment
comment|/**    * Get the region info for the passed region name. The region name may be a full region name or    * encoded region name. If the region does not found, then it'll throw an UnknownRegionException    * wrapped by a {@link CompletableFuture}    * @return region info, wrapped by a {@link CompletableFuture}    */
end_comment
...
name|this
operator|.
block|<SwitchExceedThrottleQuotaRequest
argument_list|,
name|SwitchExceedThrottleQuotaResponse
argument_list|,
name|Boolean
...
name|this
operator|.
block|<AccessControlProtos.GetUserPermissionsRequest
argument_list|,
name|GetUserPermissionsResponse
argument_list|,
name|List
...
name|this
operator|.
block|<HasUserPermissionsRequest
argument_list|,
name|HasUserPermissionsResponse
argument_list|,
name|List
...
name|RequestConverter
operator|.
name|buildSetSnapshotCleanupRequest
argument_list|(
name|on
argument_list|,
name|sync
...
name|RequestConverter
operator|.
name|buildIsSnapshotCleanupEnabledRequest
argument_list|()
argument_list|,
name|MasterService
operator|.
...
parameter_list|)
lambda|->
name|getSlowLogResponseFromServer
argument_list|(
name|serverName
argument_list|,
name|slowLogQueryFilter
...
name|RequestConverter
operator|.
name|buildSlowLogResponseRequest
argument_list|(
name|slowLogQueryFilter
argument_list|)
argument_list|,
...
name|RequestConverter
operator|.
name|buildClearSlowLogResponseRequest
argument_list|()
argument_list|,
name|AdminService
operator|.
...
name|this
operator|.
block|<ListTablesInRSGroupRequest
argument_list|,
name|ListTablesInRSGroupResponse
argument_list|,
name|List
...
argument_list|>
argument_list|>
name|getConfiguredNamespacesAndTablesInRSGroup
parameter_list|(
name|String
name|groupName
parameter_list|)
...
name|this
operator|.
block|<GetConfiguredNamespacesAndTablesInRSGroupRequest
argument_list|,
name|GetConfiguredNamespacesAndTablesInRSGroupResponse
argument_list|,
name|Pair
...
name|this
operator|.
block|<GetRSGroupInfoOfServerRequest
operator|,
name|GetRSGroupInfoOfServerResponse
operator|,
name|RSGroupInfo
...
name|RequestConverter
operator|.
name|buildRemoveServersRequest
argument_list|(
name|servers
argument_list|)
argument_list|,
...
name|this
operator|.
block|<GetRSGroupInfoOfTableRequest
operator|,
name|GetRSGroupInfoOfTableResponse
operator|,
name|RSGroupInfo
