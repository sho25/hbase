...
return|;
block|}
comment|/**    * Is it the default meta replica's znode    * @param node    * @return true or false    */
specifier|public
name|boolean
...
name|DEFAULT_REPLICA_ID
return|;
comment|// the non-default replicas are of the pattern meta-region-server-<replicaId>
name|String
name|nonDefaultPattern
init|=
name|pattern
operator|+
literal|"-"
...
operator|+
literal|" recoverableZooKeeper is set"
argument_list|)
throw|;
block|}
if|if
