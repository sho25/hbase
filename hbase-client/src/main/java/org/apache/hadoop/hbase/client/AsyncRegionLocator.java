...
begin_comment
comment|/**    * Locate the previous region using the current regions start key. Used for reverse scan.    *<p>    * TODO: need to deal with region merge where the startRowOfCurrentRegion will not be the endRow    * of a region.    */
end_comment
