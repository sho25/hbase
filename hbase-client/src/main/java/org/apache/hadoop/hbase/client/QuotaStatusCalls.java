...
block|{
comment|/**    * See {@link #getMasterRegionSizes(Connection, RpcControllerFactory, RpcRetryingCallerFactory, int)}    */
specifier|public
specifier|static
name|GetSpaceQuotaRegionSizesResponse
...
block|}
block|}
comment|/**    * See {@link #getMasterQuotaStates(Connection, RpcControllerFactory, RpcRetryingCallerFactory, int)}    */
specifier|public
specifier|static
name|GetQuotaStatesResponse
...
return|;
block|}
comment|/**    * Executes an RPC tot he HBase master to fetch its view on space quotas.    */
specifier|public
specifier|static
name|GetQuotaStatesResponse
name|getMasterQuotaStates
...
block|}
block|}
comment|/**    * See {@link #getRegionServerQuotaSnapshot(ClusterConnection, RpcControllerFactory, int, ServerName)}    */
specifier|public
specifier|static
name|GetSpaceQuotaSnapshotsResponse
...
return|;
block|}
comment|/**    * See {@link #getRegionServerSpaceQuotaEnforcements(ClusterConnection, RpcControllerFactory, int, ServerName)}    */
specifier|public
specifier|static
name|GetSpaceQuotaEnforcementsResponse
