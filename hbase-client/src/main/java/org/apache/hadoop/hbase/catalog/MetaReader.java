...
block|}
block|}
comment|/**    * Gets the region info and assignment for the specified region.    * @param catalogTracker    * @param regionName Region to lookup.    * @return Location and HRegionInfo for<code>regionName</code>    * @throws IOException    * @deprecated use {@link #getRegionLocation(CatalogTracker, byte[])} instead    */
annotation|@
name|Deprecated
specifier|public
specifier|static
...
return|;
block|}
comment|/**    * Returns the HRegionLocation from meta for the given region    * @param catalogTracker    * @param regionName    * @return HRegionLocation for the given region    * @throws IOException    */
specifier|public
specifier|static
name|HRegionLocation
name|getRegionLocation
...
return|;
block|}
comment|/**    * Returns the HRegionLocation from meta for the given region    * @param catalogTracker    * @param regionInfo    * @return HRegionLocation for the given region    * @throws IOException    */
specifier|public
specifier|static
name|HRegionLocation
name|getRegionLocation
