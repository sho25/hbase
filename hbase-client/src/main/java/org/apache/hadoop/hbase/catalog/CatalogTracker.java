...
name|CatalogTracker
block|{
comment|// TODO JDC 11/30 We don't even have ROOT anymore, revisit
comment|// TODO: This class needs a rethink.  The original intent was that it would be
comment|// the one-stop-shop for meta locations and that it would get this
comment|// info from reading and watching zk state.  The class was to be used by
comment|// servers when they needed to know of meta movement but also by
comment|// client-side (inside in HTable) so rather than figure meta
...
name|IOException
argument_list|(
literal|"Attempt to start meta tracker failed."
argument_list|,
name|t
argument_list|)
throw|;
