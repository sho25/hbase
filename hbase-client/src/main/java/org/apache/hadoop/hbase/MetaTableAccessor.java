...
begin_comment
comment|/**    * Adds a hbase:meta row for the specified new region. Initial state of new region is CLOSED.    * @param connection connection we're using    * @param regionInfo region information    * @throws IOException if problem connecting or updating meta    */
end_comment
...
begin_comment
comment|/**    * Adds a hbase:meta row for each of the specified new regions. Initial state for new regions    * is CLOSED.    * @param connection connection we're using    * @param regionInfos region information list    * @param regionReplication    * @param ts desired timestamp    * @throws IOException if problem connecting or updating meta    */
end_comment
...
specifier|static
name|String
name|getSerialReplicationColumnValue
parameter_list|(
name|Connection
name|connection
parameter_list|,
...
begin_comment
comment|/**    * Get daughter region(s) for a region, only used in serial replication.    * @param connection connection we're using    * @param encodedName region's encoded name    */
end_comment
...
begin_comment
comment|/**    * Get parent region(s) for a region, only used in serial replication.    * @param connection connection we're using    * @param encodedName region's encoded name    */
end_comment
...
begin_comment
comment|/**    * Get the table name for a region, only used in serial replication.    * @param connection connection we're using    * @param encodedName region's encoded name    */
end_comment
