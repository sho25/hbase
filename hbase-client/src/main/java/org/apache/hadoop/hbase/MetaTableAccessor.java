...
begin_comment
comment|/**    * @return Return the {@link HConstants#CATALOG_FAMILY} row from hbase:meta.    */
end_comment
...
argument_list|(
literal|"Go to the Master to find hbase:meta table state, not here"
argument_list|)
throw|;
block|}
name|Table
...
begin_comment
comment|/**    * Updates state in META.    * Do not use. For internal use only.    * @param conn connection to use    * @param tableName table to look for    */
end_comment
