...
argument_list|)
decl_stmt|;
comment|// Save its daughter region(s) when split/merge
specifier|private
specifier|static
specifier|final
name|byte
index|[]
name|daughterNamePosCq
init|=
name|Bytes
operator|.
name|toBytes
...
begin_comment
comment|/**    * Get daughter region(s) for a region, only used in serial replication.    * @throws IOException    */
end_comment
...
begin_comment
comment|/**    * Get the table name for a region, only used in serial replication.    * @throws IOException    */
end_comment
