...
block|}
block|}
comment|/**    * A helper to close a region for split    * using admin protocol.    *    * @param controller RPC controller    * @param admin Admin service    * @param server the RS that hosts the target region    * @param parentRegionInfo the target region info    * @return true if the region is closed    * @throws IOException    */
specifier|public
specifier|static
name|boolean
...
name|ProtobufUtil
operator|.
name|buildCloseRegionForSplitRequest
argument_list|(
name|server
argument_list|,
name|parentRegionInfo
...
return|;
block|}
comment|/**    * Create a CloseRegionForSplitRequest for a given region    *    * @param server the RS server that hosts the region    * @param parentRegionInfo the info of the region to close    * @return a CloseRegionForSplitRequest    */
specifier|public
specifier|static
name|CloseRegionForSplitRequest
name|buildCloseRegionForSplitRequest
