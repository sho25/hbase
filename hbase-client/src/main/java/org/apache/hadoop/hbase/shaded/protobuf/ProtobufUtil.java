...
return|;
block|}
comment|/**    * Create a SplitRegionRequest for a given region name    * @param regionName the name of the region to split    * @param splitPoint the split point    * @return a SplitRegionRequest    * @deprecated Use {@link #buildSplitRegionRequest(byte[], Optional)} instead.    */
annotation|@
name|Deprecated
specifier|public
specifier|static
