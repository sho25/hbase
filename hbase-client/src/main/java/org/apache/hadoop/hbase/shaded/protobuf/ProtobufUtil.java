...
return|;
block|}
comment|/**    * Converts a TableSchema to HTableDescriptor    * @param ts A pb TableSchema instance.    * @return An {@link HTableDescriptor} made from the passed in pb<code>ts</code>.    */
specifier|public
specifier|static
name|HTableDescriptor
name|convertToHTableDesc
