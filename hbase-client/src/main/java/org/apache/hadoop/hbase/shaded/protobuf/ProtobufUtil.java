...
return|;
block|}
comment|/**    * Get NamespaceDescriptor[] from ListNamespaceDescriptorsResponse protobuf    * @param proto the ListNamespaceDescriptorsResponse    * @return NamespaceDescriptor[]    */
specifier|public
specifier|static
name|NamespaceDescriptor
index|[]
...
return|;
block|}
comment|/**    * Get HTableDescriptor[] from GetTableDescriptorsResponse protobuf    *    * @param proto the GetTableDescriptorsResponse    * @return a immutable HTableDescriptor array    * @deprecated Use {@link #getTableDescriptorArray} after removing the HTableDescriptor    */
annotation|@
name|Deprecated
specifier|public
specifier|static
...
return|;
block|}
comment|/**    * Get TableDescriptor[] from GetTableDescriptorsResponse protobuf    *    * @param proto the GetTableDescriptorsResponse    * @return TableDescriptor[]    */
specifier|public
specifier|static
name|TableDescriptor
index|[]
...
block|}
block|}
comment|/**    * A helper to close a region for split or merge    * using admin protocol.    *    * @param controller RPC controller    * @param admin Admin service    * @param server the RS that hosts the target region    * @param regionInfo the target region info    * @return true if the region is closed    * @throws IOException    */
specifier|public
specifier|static
name|boolean
...
block|{
name|CloseRegionForSplitOrMergeRequest
name|closeRegionForRequest
init|=
name|ProtobufUtil
operator|.
name|buildCloseRegionForSplitOrMergeRequest
argument_list|(
name|server
argument_list|,
name|regionInfo
...
return|;
block|}
comment|/**    * Create a CloseRegionForSplitOrMergeRequest for given regions    *    * @param server the RS server that hosts the region    * @param regionsToClose the info of the regions to close    * @return a CloseRegionForSplitRequest    */
specifier|public
specifier|static
name|CloseRegionForSplitOrMergeRequest
name|buildCloseRegionForSplitOrMergeRequest
