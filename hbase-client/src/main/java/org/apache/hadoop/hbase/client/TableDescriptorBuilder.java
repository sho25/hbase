...
argument_list|)
decl_stmt|;
comment|/**    * {@link ClockType} setting for the table.    */
annotation|@
name|InterfaceAudience
operator|.
name|Private
...
name|USE_DEFAULT
decl_stmt|;
comment|/**    * Default clock type for HTD is SYSTEM    */
specifier|public
specifier|static
specifier|final
name|ClockType
name|DEFAULT_CLOCK_TYPE
init|=
name|ClockType
operator|.
name|SYSTEM
...
return|;
block|}
comment|/**      * Sets the {@link ClockType} for the table. This defaults to DEFAULT_CLOCK_TYPE.      * @param clockType      * @return the modifyable TD      */
specifier|public
name|ModifyableTableDescriptor
name|setClockType
parameter_list|(
...
return|;
block|}
comment|/**      * Returns the clock type for the table.      * @return the clock type for the table.      */
annotation|@
name|Override
specifier|public
name|ClockType
...
return|;
block|}
comment|/**      * Remove a config setting represented by the key from the      * {@link #configuration} map      * @param key Config key.      * @return the modifyable TD      */
specifier|public
name|ModifyableTableDescriptor
name|removeConfiguration
parameter_list|(
