...
argument_list|)
decl_stmt|;
comment|/**    * Used by HBase Shell interface to access this metadata    * attribute which denotes if the table is split enabled.    */
annotation|@
name|InterfaceAudience
operator|.
name|Private
...
name|SPLIT_ENABLED
init|=
literal|"SPLIT_ENABLED"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|Bytes
name|SPLIT_ENABLED_KEY
init|=
operator|new
name|Bytes
argument_list|(
...
argument_list|)
decl_stmt|;
comment|/**    * Used by HBase Shell interface to access this metadata    * attribute which denotes if the table is merge enabled.    */
annotation|@
name|InterfaceAudience
operator|.
name|Private
...
name|MERGE_ENABLED
init|=
literal|"MERGE_ENABLED"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|Bytes
name|MERGE_ENABLED_KEY
init|=
operator|new
name|Bytes
argument_list|(
...
init|=
literal|"NORMALIZER_TARGET_REGION_COUNT"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|Bytes
name|NORMALIZER_TARGET_REGION_COUNT_KEY
init|=
operator|new
name|Bytes
argument_list|(
...
init|=
literal|"NORMALIZER_TARGET_REGION_SIZE"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|Bytes
name|NORMALIZER_TARGET_REGION_SIZE_KEY
init|=
operator|new
name|Bytes
argument_list|(
...
literal|true
decl_stmt|;
comment|/**    * Constant that denotes whether the table is split enabled by default    */
specifier|public
specifier|static
specifier|final
name|boolean
name|DEFAULT_SPLIT_ENABLED
init|=
literal|true
decl_stmt|;
comment|/**    * Constant that denotes whether the table is merge enabled by default    */
specifier|public
specifier|static
specifier|final
name|boolean
name|DEFAULT_MERGE_ENABLED
init|=
literal|true
decl_stmt|;
...
return|;
block|}
comment|/**      * Check if the split enable flag of the table is true. If flag is false then no split will be      * done.      *      * @return true if table region split enabled      */
annotation|@
name|Override
specifier|public
name|boolean
...
return|;
block|}
comment|/**      * Setting the table region split enable flag.      * @param isEnable True if enable region split.      *      * @return the modifyable TD      */
specifier|public
name|ModifyableTableDescriptor
name|setSplitEnabled
parameter_list|(
...
return|;
block|}
comment|/**      * Check if the region merge enable flag of the table is true. If flag is false then no merge      * will be done.      *      * @return true if table region merge enabled      */
annotation|@
name|Override
specifier|public
name|boolean
...
return|;
block|}
comment|/**      * Setting the table region merge enable flag.      * @param isEnable True if enable region merge.      *      * @return the modifyable TD      */
specifier|public
name|ModifyableTableDescriptor
name|setMergeEnabled
parameter_list|(
...
return|;
block|}
comment|/**      * Setting the target region count of table normalization .      * @param regionCount the target region count.      * @return the modifyable TD      */
specifier|public
name|ModifyableTableDescriptor
name|setNormalizerTargetRegionCount
parameter_list|(
...
return|;
block|}
comment|/**      * Setting the target region size of table normalization.      * @param regionSize the target region size.      * @return the modifyable TD      */
specifier|public
name|ModifyableTableDescriptor
name|setNormalizerTargetRegionSize
parameter_list|(
...
name|IOException
argument_list|(
literal|"Priority must be bigger than or equal with zero, current:"
operator|+
name|cp
operator|.
name|getPriority
...
block|}
block|}
comment|/**      * Add coprocessor to values Map      * @param specStr The Coprocessor specification all in in one String      * @return Returns<code>this</code>      */
specifier|private
name|ModifyableTableDescriptor
name|setCoprocessorToMap
parameter_list|(
