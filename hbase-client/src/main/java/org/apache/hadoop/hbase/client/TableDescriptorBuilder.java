...
return|;
block|}
comment|// TODO: remove this if the HTableDescriptor is removed
if|if
condition|(
name|desc
operator|instanceof
...
return|;
block|}
comment|/**    * Copy all configuration, values, families, and name from the input.    * @param desc The desciptor to copy    * @return A clone of input    */
specifier|public
specifier|static
name|TableDescriptorBuilder
name|newBuilder
...
return|;
block|}
comment|// TODO: replaced the HTableDescriptor by TableDescriptor
specifier|public
name|HTableDescriptor
name|build
parameter_list|()
...
return|;
block|}
comment|// TODO: remove this in HBase 3.0.0.
specifier|private
name|TableDescriptor
name|doBuild
parameter_list|()
...
expr_stmt|;
block|}
comment|/**      * Construct a table descriptor by cloning the descriptor passed as a      * parameter.      *<p>      * Makes a deep copy of the supplied descriptor.      * TODO: make this private after removing the HTableDescriptor      * @param desc The descriptor.      */
annotation|@
name|InterfaceAudience
operator|.
name|Private
...
block|}
block|}
comment|/**      * Remove metadata represented by the key from the {@link #values} map      *      * @param key Key whose key and value we're to remove from TableDescriptor      * parameters.      */
specifier|public
name|void
name|remove
parameter_list|(
...
name|ex
operator|+
literal|" because Durability value for TableDescriptor"
operator|+
...
return|;
block|}
comment|/**      * Adds a column family. For the updating purpose please use      * {@link #modifyFamily(HColumnDescriptor)} instead.      *      * @param family HColumnDescriptor of family to add.      * @return the modifyable TD      */
specifier|public
name|ModifyableTableDescriptor
name|addFamily
parameter_list|(
...
return|;
block|}
comment|// TODO: make this private after removing the UnmodifyableTableDescriptor
specifier|protected
name|ModifyableTableDescriptor
name|setFamily
parameter_list|(
...
return|;
block|}
comment|/**      * Setter for storing a configuration setting in {@link #configuration} map.      *      * @param key Config key. Same as XML config key e.g.      * hbase.something.or.other.      * @param value String value. If null, removes the setting.      * @return the modifyable TD      */
specifier|public
name|ModifyableTableDescriptor
name|setConfiguration
parameter_list|(
...
return|;
block|}
comment|/**      * Remove a config setting represented by the key from the      * {@link #configuration} map      * @param key Config key.      */
specifier|public
name|void
name|removeConfiguration
parameter_list|(
