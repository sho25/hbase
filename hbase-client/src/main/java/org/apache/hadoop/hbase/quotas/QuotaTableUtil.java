...
begin_comment
comment|/**  * Helper class to interact with the quota table.  *<pre>  *     ROW-KEY      FAM/QUAL        DATA  *   n.&lt;namespace&gt; q:s&lt;global-quotas&gt;  *   t.&lt;namespace&gt; u:p&lt;namespace-quota policy&gt;  *   t.&lt;table&gt;     q:s&lt;global-quotas&gt;  *   t.&lt;table&gt;     u:p&lt;table-quota policy&gt;  *   u.&lt;user&gt;      q:s&lt;global-quotas&gt;  *   u.&lt;user&gt;      q:s.&lt;table&gt;&lt;table-quotas&gt;  *   u.&lt;user&gt;      q:s.&lt;ns&gt;:&lt;namespace-quotas&gt;  *</pre>  */
end_comment
...
return|;
block|}
comment|/**    * Fetches the active {@link SpaceViolationPolicy}'s that are being enforced on the    * given RegionServer.    */
specifier|public
specifier|static
name|Map
argument_list|<
