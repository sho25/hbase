...
begin_comment
comment|/**  * Helper class to interact with the quota table.  *<pre>  *     ROW-KEY      FAM/QUAL        DATA  *   n.&lt;namespace&gt; q:s&lt;global-quotas&gt;  *   t.&lt;table&gt;     q:s&lt;global-quotas&gt;  *   t.&lt;table&gt;     u:v&lt;space violation policy&gt;  *   u.&lt;user&gt;      q:s&lt;global-quotas&gt;  *   u.&lt;user&gt;      q:s.&lt;table&gt;&lt;table-quotas&gt;  *   u.&lt;user&gt;      q:s.&lt;ns&gt;:&lt;namespace-quotas&gt;  *</pre>  */
end_comment
...
name|byte
index|[]
name|QUOTA_QUALIFIER_VIOLATION
init|=
name|Bytes
operator|.
name|toBytes
...
return|;
block|}
comment|/**    * Creates a {@link Delete} to remove a policy on the given<code>table</code>.    */
specifier|public
specifier|static
name|Delete
