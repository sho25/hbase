...
return|;
block|}
comment|/**    * Creates a {@link Get} which returns only {@link SpaceQuotaSnapshot} from the quota table for a    * specific table.    * @param tn table name to get from. Can't be null.    */
specifier|public
specifier|static
name|Get
name|makeQuotaSnapshotGetForTable
parameter_list|(
name|TableName
name|tn
parameter_list|)
...
return|;
block|}
comment|/**    * Returns a list of {@code Delete} to remove given table snapshot    * entries to remove from quota table    * @param snapshotEntriesToRemove the entries to remove    */
specifier|static
name|List
argument_list|<
name|Delete
...
return|;
block|}
comment|/**    * Returns a list of {@code Delete} to remove all table snapshot entries from quota table.    * @param connection connection to re-use    */
specifier|static
name|List
argument_list|<
name|Delete
...
block|{
return|return
name|createDeletesForExistingSnapshotsFromScan
argument_list|(
name|connection
argument_list|,
...
return|;
block|}
comment|/**    * Returns a list of {@code Delete} to remove given namespace snapshot    * entries to removefrom quota table    * @param snapshotEntriesToRemove the entries to remove    */
specifier|static
name|List
argument_list|<
name|Delete
...
return|;
block|}
comment|/**    * Returns a list of {@code Delete} to remove all namespace snapshot entries from quota table.    * @param connection connection to re-use    */
specifier|static
name|List
argument_list|<
name|Delete
...
name|connection
argument_list|,
name|createScanForNamespaceSnapshotSizes
argument_list|()
argument_list|)
return|;
block|}
comment|/**    * Returns a list of {@code Delete} to remove all entries returned by the passed scanner.    * @param connection connection to re-use    * @param scan the scanner to use to generate the list of deletes    */
specifier|static
name|List
argument_list|<
name|Delete
...
return|;
block|}
comment|/**    * Returns a scanner for all existing namespace snapshot entries.    */
specifier|static
name|Scan
name|createScanForNamespaceSnapshotSizes
parameter_list|()
...
return|;
block|}
comment|/**    * Returns a scanner for all namespace snapshot entries of the given namespace    * @param namespace name of the namespace whose snapshot entries are to be scanned    */
specifier|static
name|Scan
name|createScanForNamespaceSnapshotSizes
parameter_list|(
...
condition|)
block|{
comment|// Read all namespaces, just look at the row prefix
name|s
operator|.
name|setRowPrefixFilter
argument_list|(
...
block|}
block|}
comment|/**    * Returns a multimap for all existing table snapshot entries.    * @param conn connection to re-use    */
specifier|public
specifier|static
name|Multimap
argument_list|<
...
block|}
block|}
comment|/**    * Returns a set of the names of all namespaces containing snapshot entries.    * @param conn connection to re-use    */
specifier|public
specifier|static
name|Set
argument_list|<
...
block|}
block|}
comment|/**    * Returns the current space quota snapshot of the given {@code tableName} from    * {@code QuotaTableUtil.QUOTA_TABLE_NAME} or null if the no quota information is available for    * that tableName.    * @param conn connection to re-use    * @param tableName name of the table whose current snapshot is to be retreived    */
specifier|public
specifier|static
name|SpaceQuotaSnapshot
...
argument_list|)
decl_stmt|;
comment|// if we don't have any row corresponding to this get, return null
if|if
condition|(
name|result
operator|.
...
return|;
block|}
comment|// otherwise, extract quota snapshot in snapshots object
name|extractQuotaSnapshot
argument_list|(
name|result
argument_list|,
