...
expr_stmt|;
block|}
comment|/**    * Instantiate a Result with the specified array of KeyValues.    *<br><strong>Note:</strong> You must ensure that the keyvalues    * are already sorted    * @param cells array of KeyValues    */
specifier|public
name|Result
parameter_list|(
name|Cell
