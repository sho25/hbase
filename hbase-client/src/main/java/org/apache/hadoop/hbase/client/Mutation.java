...
begin_comment
comment|/**    * get a CellBuilder instance that already has relevant Type and Row set.    * @param cellBuilderType e.g CellBuilderType.SHALLOW_COPY    * @return CellBuilder which already has relevant Type and Row set.    */
end_comment
...
begin_comment
comment|/**    * get a CellBuilder instance that already has relevant Type and Row set.    * the default CellBuilderType is CellBuilderType.SHALLOW_COPY    * @return CellBuilder which already has relevant Type and Row set.    */
end_comment
...
begin_comment
comment|/**    * get a CellBuilder instance that already has relevant Type and Row set.    * @param cellBuilderType e.g CellBuilderType.SHALLOW_COPY    * @param cellType e.g Cell.Type.Put    * @return CellBuilder which already has relevant Type and Row set.      */
end_comment
...
argument_list|()
expr_stmt|;
comment|// reset the row and type
name|builder
operator|.
name|setRow
argument_list|(
