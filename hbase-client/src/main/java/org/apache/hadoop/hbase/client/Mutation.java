...
return|;
block|}
comment|/**    * @deprecated Use {@link #getDurability()} instead.    * @return true if edits should be applied to WAL, false if not    */
annotation|@
name|Deprecated
specifier|public
name|boolean
...
return|;
block|}
comment|/**    * Set whether this Delete should be written to the WAL or not.    * Not writing the WAL means you may lose edits on server crash.    * This method will reset any changes made via {@link #setDurability(Durability)}    * @param write true if edits should be written to WAL, false if not    * @deprecated Use {@link #setDurability(Durability)} instead.    */
annotation|@
name|Deprecated
specifier|public
name|void
