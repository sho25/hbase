...
block|}
block|}
comment|/**    * Create a new HConnection instance using the passed<code>conf</code> instance.    *<p>Note: This bypasses the usual HConnection life cycle management done by    * {@link #getConnection(Configuration)}. Use this with caution, the caller is responsible for    * calling {@link HConnection#close()} on the returned connection instance.    * @param conf configuration    * @return HConnection object for<code>conf</code>    * @throws ZooKeeperConnectionException    */
specifier|public
specifier|static
name|HConnection
name|createConnection
...
expr_stmt|;
block|}
comment|/**    * Cleanup a known stale connection.    * This will then close connection to the zookeeper ensemble and let go of all resources.    *    * @param connection    */
specifier|public
specifier|static
name|void
...
argument_list|()
decl_stmt|;
comment|/**      * Maintains current state of MasterService instance.      */
specifier|static
specifier|abstract
class|class
...
function_decl|;
block|}
comment|/**      * State of the MasterAdminService connection/setup.      */
specifier|static
class|class
name|MasterAdminServiceState
extends|extends
name|MasterServiceState
block|{
name|MasterAdminService
...
block|}
block|}
comment|/**      * State of the MasterMonitorService connection/setup.      */
specifier|static
class|class
name|MasterMonitorServiceState
extends|extends
name|MasterServiceState
block|{
name|MasterMonitorService
...
block|}
block|}
comment|/**      * Class to make a MasterMonitorService stub.      */
class|class
name|MasterMonitorServiceStubMaker
extends|extends
name|StubMaker
block|{
specifier|private
...
block|}
block|}
comment|/**      * Class to make a MasterAdminService stub.      */
class|class
name|MasterAdminServiceStubMaker
extends|extends
name|StubMaker
block|{
specifier|private
...
name|hci
operator|.
name|monitorMasterServiceState
argument_list|)
expr_stmt|;
block|}
block|}
...
expr_stmt|;
block|}
comment|// Ugly delegation just so can implement close
specifier|final
name|MasterMonitorService
operator|.
name|BlockingInterface
