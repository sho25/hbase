...
throw|;
block|}
comment|// Get the controller.  Often null.  Presume payload carrying controller.  Payload is optional.
comment|// It is cells/data that we do not want to protobuf.
