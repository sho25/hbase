...
literal|false
expr_stmt|;
comment|// used from tests, don't trust the connection is real
name|this
operator|.
name|mutator
operator|=
...
return|;
block|}
comment|/**    * @deprecated Use {@link RegionLocator#getRegionLocation(byte[])} instead.    */
annotation|@
name|Deprecated
specifier|public
name|HRegionLocation
...
return|;
block|}
comment|/**    * @deprecated Use {@link RegionLocator#getRegionLocation(byte[], boolean)} instead.    */
annotation|@
name|Deprecated
specifier|public
name|HRegionLocation
...
block|}
block|}
comment|/**    * @deprecated Use {@link RegionLocator#getStartEndKeys()} instead;    */
annotation|@
name|Deprecated
specifier|public
name|byte
...
return|;
block|}
comment|/**    * @deprecated Use {@link RegionLocator#getEndKeys()} instead;    */
annotation|@
name|Deprecated
specifier|public
name|byte
...
return|;
block|}
comment|/**    * Gets all the regions and their address for this table.    *<p>    * This is mainly useful for the MapReduce integration.    * @return A map of HRegionInfo with it's server address    * @throws IOException if a remote or network exception occurs    *    * @deprecated Use {@link RegionLocator#getAllRegionLocations()} instead;    */
annotation|@
name|Deprecated
specifier|public
name|List
...
name|IllegalArgumentException
argument_list|(
literal|"Small scan should not be used with batching"
argument_list|)
throw|;
block|}
if|if
