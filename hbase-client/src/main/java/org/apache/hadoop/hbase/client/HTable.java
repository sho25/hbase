...
return|;
block|}
comment|/**    * Creates an object to access a HBase table.    * Used by HBase internally.  DO NOT USE. See {@link ConnectionFactory} class comment for how to    * get a {@link Table} instance (use {@link Table} instead of {@link HTable}).    * @param tableName Name of the table.    * @param connection Connection to be used.    * @param pool ExecutorService to be used.    * @throws IOException if a remote or network exception occurs    */
annotation|@
name|InterfaceAudience
operator|.
name|Private
...
block|{
comment|// use default timeout in AP
name|ars
operator|=
name|multiAp
operator|.
...
name|IOException
argument_list|(
literal|"Invalid arguments to "
operator|+
name|mutation
operator|+
literal|", zero columns specified"
argument_list|)
throw|;
block|}
block|}
