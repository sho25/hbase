...
begin_comment
comment|/**  * Utility methods for obtaining authentication tokens, that do not require hbase-server.  */
end_comment
...
argument_list|)
decl_stmt|;
comment|// Set in TestClientTokenUtil via reflection
specifier|private
specifier|static
name|ServiceException
...
begin_comment
comment|/**    * Obtain and return an authentication token for the given user.    * @param conn The HBase cluster connection    * @param user The user to obtain a token for    * @return the authentication token instance    */
end_comment
