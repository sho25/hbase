...
name|operator
expr_stmt|;
name|initPrevListForMustPassOne
argument_list|(
name|rowFilters
operator|.
name|size
...
expr_stmt|;
block|}
comment|/**    * Constructor that takes a var arg number of {@link Filter}s. The default operator MUST_PASS_ALL    * is assumed.    * @param rowFilters    */
specifier|public
name|FilterList
parameter_list|(
specifier|final
...
specifier|private
name|ReturnCode
name|mergeReturnCodeForAndOperator
parameter_list|(
name|ReturnCode
name|rc
parameter_list|,
...
specifier|private
name|ReturnCode
name|mergeReturnCodeForOrOperator
parameter_list|(
name|ReturnCode
name|rc
parameter_list|,
