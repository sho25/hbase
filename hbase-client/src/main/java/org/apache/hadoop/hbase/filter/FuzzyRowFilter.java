...
condition|)
block|{
comment|// Should never happen for forward scanners; logic in filterKeyValue should return NO_NEXT.
comment|// Can happen in reversed scanner when currentKV is just before the next possible match; in
comment|// this case, fall back on scanner simply calling KeyValueHeap.next()
