...
block|}
block|}
comment|/**      * Create a stub against the master.  Retry if necessary.      * @return A stub to do<code>intf</code> against the master      * @throws org.apache.hadoop.hbase.MasterNotRunningException      */
name|Object
name|makeStub
parameter_list|()
throws|throws
...
expr_stmt|;
block|}
comment|/**    * @deprecated Use {@link org.apache.hadoop.hbase.client.Admin#listTables()} instead    */
annotation|@
name|Deprecated
annotation|@
name|Override
...
block|}
block|}
comment|/**    * @deprecated Use {@link org.apache.hadoop.hbase.client.Admin#listTableNames()} instead    */
annotation|@
name|Deprecated
annotation|@
name|Override
