...
block|{
comment|// update the stats about the region, if its a user table. We don't want to slow down
comment|// updates to meta tables, especially from internal updates (master, etc).
if|if
condition|(
name|AsyncProcess
operator|.
