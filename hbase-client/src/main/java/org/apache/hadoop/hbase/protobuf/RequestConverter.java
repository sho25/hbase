...
return|;
block|}
comment|/**    * Create a protocol buffer GetRequest for a client Get    *    * @param regionName the name of the region to get    * @param get the client Get    * @param existenceOnly indicate if check row existence only    * @return a protocol buffer GetRequest    */
specifier|public
specifier|static
name|GetRequest
name|buildGetRequest
...
return|;
block|}
comment|/**    * Create a protocol buffer MultiGetRequest for client Gets All gets are going to be run against    * the same region.    * @param regionName the name of the region to get from    * @param gets the client Gets    * @param existenceOnly indicate if check rows existence only    * @return a protocol buffer MultiGetRequest    */
specifier|public
specifier|static
name|MultiGetRequest
...
name|builder
init|=
name|getRegionMutationBuilderWithRegionAndAtomicSet
argument_list|(
name|regionName
argument_list|,
literal|true
...
return|;
block|}
comment|/**    * Create a protocol buffer MultiRequest for row mutations that does not hold data.  Data/Cells    * are carried outside of protobuf.  Return references to the Cells in<code>cells</code> param    *    * @param regionName    * @param rowMutations    * @param cells Return in here a list of Cells as CellIterable.    * @return a multi request minus data    * @throws IOException    */
specifier|public
specifier|static
name|MultiRequest
