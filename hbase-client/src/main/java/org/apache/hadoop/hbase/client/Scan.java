...
expr_stmt|;
block|}
comment|/**    * Set if pre-fetching is enabled. If enabled, the region    * server will try to read the next scan result ahead of time. This    * improves scan performance if we are doing large scans.    *    * @param enablePrefetching if pre-fetching is enabled or not    */
specifier|public
name|void
name|setPrefetching
parameter_list|(
