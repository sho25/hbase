...
comment|// then simply add all results to the list. Note allowPartial and setBatch are not same, we can
comment|// return here if allow partials and we will handle batching later.
if|if
condition|(
name|scan
operator|.
...
condition|)
block|{
comment|// We have a new row, complete the previous row.
name|resultsToAddToCache
operator|.
name|add
argument_list|(
