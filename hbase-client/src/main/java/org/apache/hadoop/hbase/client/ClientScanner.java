...
name|pool
decl_stmt|;
comment|/**      * Create a new ClientScanner for the specified table. A ClusterConnection will be      * retrieved using the passed Configuration.      * Note that the passed {@link Scan}'s start row maybe changed.      *      * @param conf The {@link Configuration} to use.      * @param scan {@link Scan} to use in this scanner      * @param tableName The table that we wish to scan      * @throws IOException      */
specifier|public
name|ClientScanner
parameter_list|(
specifier|final
...
expr_stmt|;
block|}
comment|/**      * @deprecated Use {@link #ClientScanner(Configuration, Scan, TableName)}      */
annotation|@
name|Deprecated
specifier|public
name|ClientScanner
...
expr_stmt|;
block|}
comment|/**    * @deprecated use    *             {@link #ClientScanner(Configuration, Scan, TableName, HConnection, RpcRetryingCallerFactory, RpcControllerFactory)}    */
annotation|@
name|Deprecated
specifier|public
name|ClientScanner
...
expr_stmt|;
block|}
comment|/**    * Create a new ClientScanner for the specified table.    * Note that the passed {@link Scan}'s start row maybe changed.    *    * @param conf    * @param scan    * @param tableName    * @param connection    * @param rpcFactory    * @throws IOException    */
specifier|public
name|ClientScanner
parameter_list|(
specifier|final
