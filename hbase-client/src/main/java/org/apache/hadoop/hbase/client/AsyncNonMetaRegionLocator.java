...
return|;
block|}
comment|// Used for reverse scan. See the comment of AsyncRegionLocator.getPreviousRegionLocation.
comment|// TODO: need to deal with region merge where the startRowOfCurrentRegion will not be the endRow
comment|// of a region.
name|CompletableFuture
argument_list|<
name|HRegionLocation
