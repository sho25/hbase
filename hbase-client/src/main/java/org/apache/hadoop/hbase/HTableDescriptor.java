...
return|;
block|}
comment|/**    * Set the name of the table.    *    * @param name name of table    * @throws IllegalArgumentException if passed a table name    * that is made of other than 'word' characters, underscore or period: i.e.    *<code>[a-zA-Z_0-9.].    * @see<a href="HADOOP-1581">HADOOP-1581 HBASE: Un-openable tablename bug</a>    */
specifier|public
name|void
name|setName
parameter_list|(
...
name|result
return|;
comment|// Compare that all column families
for|for
control|(
name|Iterator
argument_list|<
