...
argument_list|)
decl_stmt|;
comment|/**    *<em>INTERNAL</em> Used by shell/rest interface to access this metadata    * attribute which denotes the allowed types of action (split/merge) when the table is treated    * by region normalizer.    *    * @see #getDesiredNormalizationTypes()    */
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"NORMALIZATION_MODE"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|Bytes
name|NORMALIZATION_MODE_KEY
init|=
operator|new
name|Bytes
argument_list|(
...
expr_stmt|;
block|}
comment|/**    * Construct a table descriptor by cloning the descriptor passed as a parameter    * but using a different table name.    *<p>    * Makes a deep copy of the supplied descriptor.    * Can make a modifiable descriptor from an UnmodifyableHTableDescriptor.    * @param name Table name.    * @param desc The descriptor.    */
specifier|public
name|HTableDescriptor
parameter_list|(
specifier|final
...
return|;
block|}
comment|/**    * Check if normalization flag of the table. If flag is    * empty then region normalizer won't attempt to normalize this table.    *    * @return List of PlanType if region normalization is enabled for this table    *         null means region normalization is disabled    */
specifier|public
name|List
argument_list|<
name|PlanType
argument_list|>
name|getDesiredNormalizationTypes
parameter_list|()
block|{
name|byte
index|[]
...
return|;
block|}
comment|/**    * Setting the types of action for table normalization mode flag.    *    * @param types String containing desired types of action:    *        "M" for region merge    *        "S" for region split    *        "MS" for region merge / split    */
specifier|public
name|HTableDescriptor
