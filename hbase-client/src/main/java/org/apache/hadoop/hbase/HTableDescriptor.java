...
block|}
block|}
comment|/**    * Default constructor which constructs an empty object.    * For deserializing an HTableDescriptor instance only.    * @deprecated Used by Writables and Writables are going away.    */
annotation|@
name|Deprecated
specifier|public
name|HTableDescriptor
...
expr_stmt|;
block|}
comment|/**    * Check if deferred log edits are enabled on the table.    *    * @return true if that deferred log flush is enabled on the table    *    * @see #setDeferredLogFlush(boolean)    * @deprecated use {@link #getDurability()}    */
annotation|@
name|Deprecated
specifier|public
specifier|synchronized
