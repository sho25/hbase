...
return|;
block|}
comment|/**    * Sets the {@link ClockType} setting for the table.    * @param clockType enum value    */
specifier|public
name|HTableDescriptor
name|setClockType
parameter_list|(
...
return|;
block|}
comment|/**    * Returns the clock type for the table.    * @return clock type for the table.    */
annotation|@
name|Override
specifier|public
name|ClockType
