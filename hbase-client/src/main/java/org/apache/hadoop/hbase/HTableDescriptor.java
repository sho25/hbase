...
return|;
block|}
comment|/**    * Check if the region split enable flag of the table is true. If flag is    * false then no split will be done.    *    * @return true if table region split enabled    */
annotation|@
name|Override
specifier|public
name|boolean
...
return|;
block|}
comment|/**    * Setting the table region split enable flag.    *    * @param isEnable True if enable split.    */
specifier|public
name|HTableDescriptor
...
return|;
block|}
comment|/**    * Setting the table region merge enable flag.    *    * @param isEnable True if enable merge.    */
specifier|public
name|HTableDescriptor
