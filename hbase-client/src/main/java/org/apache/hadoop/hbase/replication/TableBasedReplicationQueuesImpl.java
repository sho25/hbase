...
decl_stmt|;
return|return
name|getLogsInQueueAndCheckOwnership
argument_list|(
name|rowKey
argument_list|)
return|;
...
return|;
block|}
comment|/**    * Get the QueueIds belonging to the named server from the ReplicationTableBase    *    * @param server name of the server    * @return a ResultScanner over the QueueIds belonging to the server    * @throws IOException    */
specifier|private
name|ResultScanner
name|getAllQueuesScanner
parameter_list|(
