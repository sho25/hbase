...
return|;
block|}
comment|// Connect the two futures, if the src future is done, then mark the dst future as done. And if
comment|// the dst future is done, then cancel the src future. This is used for timeline consistent read.
specifier|private
parameter_list|<
name|T
parameter_list|>
...
return|;
block|}
comment|// Timeline consistent read, where we will send requests to other region replicas
name|CompletableFuture
argument_list|<
name|Result
argument_list|>
...
name|warn
argument_list|(
literal|"Failed to locate all the replicas for table={}, row='{}',"
operator|+
...
name|warn
argument_list|(
literal|"There are no secondary replicas for region {},"
operator|+
literal|" give up timeline consistent read"
argument_list|,
name|locs
