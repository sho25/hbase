...
begin_comment
comment|/**  * Runs an rpc'ing {@link RetryingCallable}. Sets into rpc client  * threadlocal outstanding timeouts as so we don't persist too much.  * Dynamic rather than static so can set the generic appropriately.  */
end_comment
...
argument_list|)
decl_stmt|;
comment|/**    * Timeout for the call including retries    */
specifier|private
name|int
name|callTimeout
decl_stmt|;
...
return|;
block|}
comment|/**    * Retries if invocation fails.    * @param conf    * @param callTimeout Timeout for this call    * @param callable The {@link RetryingCallable} to run.    * @return an object of type T    * @throws IOException if a remote or network exception occurs    * @throws RuntimeException other unspecified error    */
specifier|synchronized
name|T
name|callWithRetries
parameter_list|(
