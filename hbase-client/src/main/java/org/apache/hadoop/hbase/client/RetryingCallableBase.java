...
begin_comment
comment|/**  * All generic methods for a Callable that can be retried. It is extended with Sync and  * Async versions.  */
end_comment
...
block|{
comment|/**    * Prepare by setting up any connections to servers, etc., ahead of call invocation.    * @param reload Set this to true if need to requery locations    * @throws IOException e    */
name|void
name|prepare
parameter_list|(
specifier|final
