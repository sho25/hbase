...
begin_comment
comment|/**  * Status information on the HBase cluster.  *<p>  *<tt>ClusterStatus</tt> provides clients with information such as:  *<ul>  *<li>The count and names of region servers in the cluster.</li>  *<li>The count and names of dead region servers in the cluster.</li>  *<li>The name of the active master for the cluster.</li>  *<li>The name(s) of the backup master(s) for the cluster, if they exist.</li>  *<li>The average cluster load.</li>  *<li>The number of regions deployed on the cluster.</li>  *<li>The number of requests since last report.</li>  *<li>Detailed region server loading and resource usage information,  *  per server and per region.</li>  *<li>Regions in transition at master</li>  *<li>The unique cluster ID</li>  *</ul>  *<tt>{@link Options}</tt> provides a way to filter out infos which unwanted.  * The following codes will retrieve all the cluster information.  *<pre>  * {@code  * // Original version still works  * Admin admin = connection.getAdmin();  * ClusterStatus status = admin.getClusterStatus();  * // or below, a new version which has the same effects  * ClusterStatus status = admin.getClusterStatus(Options.defaultOptions());  * }  *</pre>  * If information about dead servers and master coprocessors are unwanted,  * then codes in the following way:  *<pre>  * {@code  * Admin admin = connection.getAdmin();  * ClusterStatus status = admin.getClusterStatus(  *                                Options.defaultOptions()  *                                       .excludeDeadServers()  *                                       .excludeMasterCoprocessors());  * }  *</pre>  */
end_comment
...
block|}
block|}
comment|/**    * Options provides a way to filter out unwanted information.    * For compatibility, default options includes all the information about a ClusterStatus.    * To filter out unwanted information, use the specific excludeXXX() method.    */
specifier|public
specifier|static
class|class
name|Options
...
parameter_list|()
block|{}
comment|/**      * Include all information about a ClusterStatus.      */
specifier|public
specifier|static
name|Options
...
return|;
block|}
comment|/**      * Filter out hbase verision.      */
specifier|public
name|Options
...
return|;
block|}
comment|/**      * Filter out live servers.      */
specifier|public
name|Options
...
return|;
block|}
comment|/**      * Filter out dead servers info.      */
specifier|public
name|Options
...
return|;
block|}
comment|/**      * Filter out master info.      */
specifier|public
name|Options
name|excludeMaster
parameter_list|()
...
return|;
block|}
comment|/**      * Filter out backup masters info.      */
specifier|public
name|Options
...
return|;
block|}
comment|/**      * Filter out region state.      */
specifier|public
name|Options
...
return|;
block|}
comment|/**      * Filter out master's coprocessors info.      */
specifier|public
name|Options
...
return|;
block|}
comment|/**      * Filter out balancer on info.      */
specifier|public
name|Options
...
return|;
block|}
comment|/**      * Include hbase version info.      */
specifier|public
name|boolean
name|includeHBaseVersion
parameter_list|()
...
return|;
block|}
comment|/**      * Include live servers info.      */
specifier|public
name|boolean
name|includeLiveServers
parameter_list|()
...
return|;
block|}
comment|/**      * Include dead servers info.      */
specifier|public
name|boolean
name|includeDeadServers
parameter_list|()
...
return|;
block|}
comment|/**      * Include backup masters info.      */
specifier|public
name|boolean
name|includeBackupMasters
parameter_list|()
...
return|;
block|}
comment|/**      * Include region states info.      */
specifier|public
name|boolean
name|includeRegionState
parameter_list|()
...
return|;
block|}
comment|/**      * Include cluster id info.      */
specifier|public
name|boolean
name|includeClusterId
parameter_list|()
...
return|;
block|}
comment|/**      * Include master's coprocessors.      */
specifier|public
name|boolean
name|includeMasterCoprocessors
parameter_list|()
...
return|;
block|}
comment|/**      * Include balancer on info.      */
specifier|public
name|boolean
name|includeBalancerOn
parameter_list|()
...
return|;
block|}
comment|/**      * For an options reusable convenience, reset options to default.      */
specifier|public
name|Options
name|reset
parameter_list|()
...
name|append
argument_list|(
literal|"include backup masters info: "
operator|+
name|includeBackupMasters
operator|+
literal|", "
...
name|append
argument_list|(
literal|"include live servers info: "
operator|+
name|includeLiveServers
operator|+
literal|", "
...
name|append
argument_list|(
literal|"include dead servers info: "
operator|+
name|includeDeadServers
operator|+
literal|", "
...
name|append
argument_list|(
literal|"include masters coprocessors: "
operator|+
name|includeMasterCoprocessors
operator|+
literal|", "
