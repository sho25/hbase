...
specifier|private
specifier|final
name|BasicRetryAccountantFactory
...
return|;
block|}
comment|/**    * Factory to create {@link BasicRetryAccountant}s.  Saves having to have maxRetries and    * retryIntervalMillis available everywhere.    */
specifier|static
class|class
name|BasicRetryAccountantFactory
block|{
