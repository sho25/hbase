...
expr_stmt|;
block|}
comment|/**    * @return A new CatalogTracker instance; call {@link #cleanupCatalogTracker(CatalogTracker)}    * to cleanup the returned catalog tracker.    * @throws org.apache.hadoop.hbase.ZooKeeperConnectionException    * @throws IOException    * @see #cleanupCatalogTracker(CatalogTracker)    */
specifier|private
...
return|;
block|}
comment|/**    * List all of the names of userspace tables.    * @return String[] table names    * @throws IOException if a remote or network exception occurs    */
annotation|@
name|Deprecated
specifier|public
name|String
...
return|;
block|}
comment|/**    * List all of the names of userspace tables matching the given regular expression.    * @param pattern The regular expression to match against    * @return String[] table names    * @throws IOException if a remote or network exception occurs    */
annotation|@
name|Deprecated
specifier|public
name|String
...
return|;
block|}
comment|/**    * List all of the names of userspace tables matching the given regular expression.    * @param regex The regular expression to match against    * @return String[] table names    * @throws IOException if a remote or network exception occurs    */
annotation|@
name|Deprecated
specifier|public
name|String
...
return|;
block|}
comment|/**    * Check if table exists or not    * @param tableName Name of a table.    * @param ct A {@link CatalogTracker} instance (caller of this method usually has one).    * @return tableName instance    * @throws IOException if a remote or network exception occurs.    * @throws TableNotFoundException if table does not exist.    */
...
block|}
block|}
comment|/**    * @see {@link #executeCallable(org.apache.hadoop.hbase.client.HBaseAdmin.MasterCallable)}    */
specifier|abstract
specifier|static
class|class
name|MasterAdminCallable
