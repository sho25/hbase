...
expr_stmt|;
block|}
comment|/**    * @param sn    * @return List of {@link HRegionInfo}.    * @throws IOException    * @deprecated As of release 2.0.0, this will be removed in HBase 3.0.0    *             Use {@link #getRegions(ServerName)}.    */
annotation|@
name|Deprecated
annotation|@
name|Override
...
block|}
block|}
comment|/**    *    * @param tableName    * @return List of {@link HRegionInfo}.    * @throws IOException    * @deprecated As of release 2.0.0, this will be removed in HBase 3.0.0    *             Use {@link #getRegions(TableName)}.    */
annotation|@
name|Deprecated
annotation|@
name|Override
