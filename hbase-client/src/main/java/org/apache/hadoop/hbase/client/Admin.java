...
return|;
block|}
comment|/**    * Get {@link RegionLoad} of all regions hosted on a regionserver.    *    * @param serverName region server from which regionload is required.    * @return region load map of all regions hosted on a region server    * @throws IOException if a remote or network exception occurs    * @deprecated since 2.0 version and will be removed in 3.0 version.    *             use {@link #getRegionLoads(ServerName)}    */
annotation|@
name|Deprecated
specifier|default
name|Map
...
return|;
block|}
comment|/**    * Get {@link RegionLoad} of all regions hosted on a regionserver.    *    * @param serverName region server from which regionload is required.    * @return a region load list of all regions hosted on a region server    * @throws IOException if a remote or network exception occurs    */
specifier|default
name|List
argument_list|<
name|RegionLoad
...
name|FailedLogCloseException
function_decl|;
comment|/**    * Helper that delegates to getClusterStatus().getMasterCoprocessors().    * @return an array of master coprocessors    * @see org.apache.hadoop.hbase.ClusterStatus#getMasterCoprocessors()    */
name|String
index|[]
