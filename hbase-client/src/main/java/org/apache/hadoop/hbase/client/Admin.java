...
name|IOException
function_decl|;
comment|/**    * Creates a new RegionServer group with the given name    * @param groupName the name of the group    * @throws IOException if a remote or network exception occurs    */
name|void
name|addRSGroup
parameter_list|(
name|String
...
name|IOException
function_decl|;
comment|/**    * Get group info for the given group name    * @param groupName the group name    * @return group info    * @throws IOException if a remote or network exception occurs    */
name|RSGroupInfo
name|getRSGroup
parameter_list|(
name|String
...
name|IOException
function_decl|;
comment|/**    * Get group info for the given hostPort    * @param hostPort HostPort to get RSGroupInfo for    * @throws IOException if a remote or network exception occurs    */
name|RSGroupInfo
name|getRSGroup
parameter_list|(
name|Address
...
name|IOException
function_decl|;
comment|/**    * Get group info for the given table    * @param tableName table name to get RSGroupInfo for    * @throws IOException if a remote or network exception occurs    */
name|RSGroupInfo
name|getRSGroup
parameter_list|(
name|TableName
...
name|IOException
function_decl|;
comment|/**    * Lists current set of RegionServer groups    * @throws IOException if a remote or network exception occurs    */
name|List
argument_list|<
name|RSGroupInfo
argument_list|>
...
name|IOException
function_decl|;
comment|/**    * Get all tables in this RegionServer group.    * @param groupName the group name    * @throws IOException if a remote or network exception occurs    * @see #getConfiguredNamespacesAndTablesInRSGroup(String)    */
name|List
argument_list|<
name|TableName
argument_list|>
...
name|IOException
function_decl|;
comment|/**    * Remove RegionServer group associated with the given name    * @param groupName the group name    * @throws IOException if a remote or network exception occurs    */
name|void
name|removeRSGroup
parameter_list|(
name|String
...
name|IOException
function_decl|;
comment|/**    * Set the RegionServer group for tables    * @param tables tables to set group for    * @param groupName group name for tables    * @throws IOException if a remote or network exception occurs    */
name|void
name|setRSGroup
parameter_list|(
name|Set
...
name|IOException
function_decl|;
comment|/**    * Balance regions in the given RegionServer group    * @param groupName the group name    * @return boolean Whether balance ran or not    * @throws IOException if a remote or network exception occurs    */
name|boolean
name|balanceRSGroup
parameter_list|(
name|String
