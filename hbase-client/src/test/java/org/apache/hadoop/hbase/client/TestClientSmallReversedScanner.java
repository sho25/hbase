...
begin_comment
comment|/**  * Test the ClientSmallReversedScanner.  */
end_comment
...
specifier|public
class|class
name|TestClientSmallReversedScanner
block|{
name|Scan
name|scan
decl_stmt|;
...
argument_list|)
expr_stmt|;
comment|// getServerHasMoreResults shouldn't be called when hasMoreResultsContext returns false
name|Mockito
operator|.
name|when
argument_list|(
