...
name|fail
argument_list|(
literal|"Should not be able to merge a Table space quota with a namespace space quota."
argument_list|)
expr_stmt|;
block|}
catch|catch
