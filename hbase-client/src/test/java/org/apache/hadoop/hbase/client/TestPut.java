...
argument_list|)
expr_stmt|;
comment|// Verify the first cell in the list
name|Cell
name|cell0
init|=
name|put
...
argument_list|)
decl_stmt|;
comment|// Verify no local copy is made for family, qualifier and value
name|assertTrue
argument_list|(
name|cell0
operator|.
...
argument_list|)
expr_stmt|;
comment|// verify the second cell in the list
name|Cell
name|cell1
init|=
name|put
