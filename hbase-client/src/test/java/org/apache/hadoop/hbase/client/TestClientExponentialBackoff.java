...
name|assertTrue
argument_list|(
literal|"Heap occupancy at low watermark had no effect"
argument_list|,
name|backoffTime
operator|>
literal|0
...
name|assertTrue
argument_list|(
literal|"Increase above low watermark should have increased backoff"
argument_list|,
name|backoffTime
operator|>
name|previous
...
specifier|public
name|void
name|testCompactionPressurePolicy
parameter_list|()
block|{
name|Configuration
name|conf
...
name|assertTrue
argument_list|(
literal|"Compaction pressure has no effect"
argument_list|,
name|backoffTime
operator|==
literal|0
...
name|assertTrue
argument_list|(
literal|"Compaction pressure should be bigger"
argument_list|,
name|backoffTime
operator|>
name|previous
