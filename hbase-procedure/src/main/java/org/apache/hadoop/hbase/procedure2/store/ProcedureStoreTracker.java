...
parameter_list|)
block|{
comment|// See HBASE-20973, grow or merge can lead to ArrayIndexOutOfBoundsException
comment|// The root cause is not revealed yet, disable grow or merge for now
return|return
name|getOrCreateNodeNoGrowOrMerge
argument_list|(
name|procId
argument_list|)
return|;
...
specifier|private
name|BitSetNode
name|getOrCreateNodeWithGrowOrMerge
parameter_list|(
name|long
name|procId
parameter_list|)
