...
name|warn
argument_list|(
literal|"The BitSetNode for procId={} does not exist, maybe a double deletion?"
argument_list|,
name|procId
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/**    * Will be used when there are too many proc wal files. We will rewrite the states of the active    * procedures in the oldest proc wal file so that we can delete it.    * @return all the active procedure ids in this tracker.    */
specifier|public
name|long
index|[]
