...
function_decl|;
block|}
comment|/**    * Used by the DelayQueue to get the timeout interval of the procedure    */
specifier|private
specifier|static
class|class
...
return|;
block|}
comment|/**      * @throws NullPointerException {@inheritDoc}      * @throws ClassCastException {@inheritDoc}      */
annotation|@
name|Override
specifier|public
name|int
...
parameter_list|)
block|{
comment|// Just consume the interruption.
continue|continue;
block|}
if|if
condition|(
