...
argument_list|)
expr_stmt|;
comment|// Remove the first log, we have insert-txn and updates in the others so everything is fine.
name|fs
operator|.
name|delete
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Remove the second log, we have lost any root/parent references
name|fs
operator|.
name|delete
argument_list|(
