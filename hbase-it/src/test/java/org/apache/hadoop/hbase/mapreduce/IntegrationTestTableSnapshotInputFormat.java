...
specifier|final
name|String
name|MR_IMPLEMENTATION_KEY
init|=
literal|"IntegrationTestTableSnapshotInputFormat.API"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|String
name|MAPRED_IMPLEMENTATION
init|=
literal|"mapred"
decl_stmt|;
specifier|private
...
argument_list|)
decl_stmt|;
comment|// mapred API missing feature pairity with mapreduce. See comments in
comment|// mapred.TestTableSnapshotInputFormat
specifier|private
specifier|static
specifier|final
name|byte
index|[]
name|MAPRED_START_ROW
init|=
name|Bytes
operator|.
name|toBytes
...
name|debug
argument_list|(
literal|"Running job with mapreduce API."
argument_list|)
expr_stmt|;
name|int
...
condition|)
block|{
comment|/*        * Similar considerations to above. The difference is that mapred API does not support        * specifying start/end rows (or a scan object at all). Thus the omission of first and        * last regions are not performed. See comments in mapred.TestTableSnapshotInputFormat        * for details of how that test works around the problem. This feature should be added        * in follow-on work.        */
name|LOG
operator|.
name|debug
argument_list|(
literal|"Running job with mapred API."
argument_list|)
expr_stmt|;
name|int
name|expectedNumSplits
...
argument_list|(
literal|"Unrecognized mapreduce implementation: "
operator|+
name|mr
operator|+
literal|"."
