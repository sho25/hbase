...
name|info
argument_list|(
literal|"Verify.verify failed, let's stop CM and verify again"
argument_list|)
expr_stmt|;
name|it
operator|.
name|cleanUpMonkey
argument_list|(
literal|"Stop monkey before verify again after verify failed"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|info
argument_list|(
literal|"Verify.verify failed even without CM, verify one more"
argument_list|)
expr_stmt|;
name|runVerify
argument_list|(
