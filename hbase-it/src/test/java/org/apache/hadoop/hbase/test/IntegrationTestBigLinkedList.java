...
block|}
block|}
comment|/**      * Some ASCII art time:      * [ . . . ] represents one batch of random longs of length WIDTH      *      *                _________________________      *               |                  ______ |      *               |                 |      ||      *             __+_________________+_____ ||      *             v v                 v     |||      * first   = [ . . . . . . . . . . . ]   |||      *             ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^     |||      *             | | | | | | | | | | |     |||      * prev    = [ . . . . . . . . . . . ]   |||      *             ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^     |||      *             | | | | | | | | | | |     |||      * current = [ . . . . . . . . . . . ]   |||      *                                       |||      * ...                                   |||      *                                       |||      * last    = [ . . . . . . . . . . . ]   |||      *             | | | | | | | | | | |-----|||      *             |                 |--------||      *             |___________________________|      */
specifier|static
class|class
...
argument_list|()
operator|+
literal|"<num mappers><num nodes per map><tmp output dir>"
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|"   where<num nodes per map> should be a multiple of 25M"
argument_list|)
expr_stmt|;
return|return
literal|0
...
name|println
argument_list|(
literal|"Usage: Loop<num iterations><num mappers><num nodes per mapper><output dir><num reducers>"
argument_list|)
expr_stmt|;
return|return
literal|1
