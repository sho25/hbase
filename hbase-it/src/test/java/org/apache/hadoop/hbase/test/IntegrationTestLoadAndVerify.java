...
name|InterruptedException
block|{
comment|// Use disableTestAsync because disable can take a long time to complete
name|System
operator|.
name|out
operator|.
...
argument_list|()
decl_stmt|;
comment|// NOTE tables can be both admin.isTableEnabled=false and
comment|// isTableDisabled=false, when disabling must use isTableDisabled!
while|while
condition|(
operator|!
name|admin
