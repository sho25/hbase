...
begin_comment
comment|/**  * HTable interface to remote tables accessed via Stargate  */
end_comment
...
expr_stmt|;
block|}
comment|/**    * Constructor    * @param client    * @param name    * @param accessToken    */
specifier|public
name|RemoteHTable
parameter_list|(
name|Client
...
expr_stmt|;
block|}
comment|/**    * Constructor    * @param client    * @param conf    * @param name    * @param accessToken    */
specifier|public
name|RemoteHTable
parameter_list|(
name|Client
...
name|IOException
block|{
comment|// this is a trick: Stargate accepts multiple rows in a cell set and
...
name|error
argument_list|(
literal|"scanner.next failed with "
operator|+
name|response
operator|.
name|getCode
...
name|IOException
argument_list|(
literal|"lockRow not implemented"
argument_list|)
throw|;
block|}
annotation|@
...
name|IOException
argument_list|(
literal|"unlockRow not implemented"
argument_list|)
throw|;
block|}
annotation|@
...
name|IOException
argument_list|(
literal|"checkAndPut not supported"
argument_list|)
throw|;
block|}
annotation|@
