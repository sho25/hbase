...
expr_stmt|;
block|}
comment|/**Construct an index spec for a single column that has only unique values.    * @param indexId the name of the index    * @param indexedColumn the column to index    * @return the IndexSpecification    */
specifier|public
specifier|static
name|IndexSpecification
name|forUniqueIndex
