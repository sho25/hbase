...
init|=
literal|"hbase.rest.ssl.exclude.cipher.suites"
decl_stmt|;
name|String
name|REST_SSL_INCLUDE_CIPHER_SUITES
init|=
literal|"hbase.rest.ssl.include.cipher.suites"
decl_stmt|;
name|String
name|REST_SSL_EXCLUDE_PROTOCOLS
init|=
literal|"hbase.rest.ssl.exclude.protocols"
decl_stmt|;
name|String
name|REST_SSL_INCLUDE_PROTOCOLS
init|=
literal|"hbase.rest.ssl.include.protocols"
decl_stmt|;
name|String
...
init|=
literal|"hbase.rest.task.queue.size"
decl_stmt|;
name|String
name|REST_THREAD_POOL_THREAD_IDLE_TIMEOUT
init|=
literal|"hbase.rest.thread.idle.timeout"
decl_stmt|;
name|String
name|REST_CONNECTOR_ACCEPT_QUEUE_SIZE
init|=
literal|"hbase.rest.connector.accept.queue.size"
decl_stmt|;
name|String
