...
begin_comment
comment|// source: NamespacesMessage.proto
end_comment
...
block|{
comment|// repeated string namespace = 1;
comment|/**      *<code>repeated string namespace = 1;</code>      */
name|java
operator|.
name|util
operator|.
...
function_decl|;
block|}
comment|/**    * Protobuf type {@code org.apache.hadoop.hbase.rest.protobuf.generated.Namespaces}    */
specifier|public
specifier|static
specifier|final
class|class
...
name|NamespacesOrBuilder
block|{
comment|// Use Namespaces.newBuilder() to construct.
specifier|private
name|Namespaces
parameter_list|(
name|com
...
name|NamespacesMessage
operator|.
name|internal_static_org_apache_hadoop_hbase_rest_protobuf_generated_Namespaces_descriptor
return|;
block|}
specifier|protected
name|com
...
name|NamespacesMessage
operator|.
name|internal_static_org_apache_hadoop_hbase_rest_protobuf_generated_Namespaces_fieldAccessorTable
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.rest.protobuf.generated.NamespacesMessage.Namespaces.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
return|;
block|}
comment|// @@protoc_insertion_point(builder_scope:org.apache.hadoop.hbase.rest.protobuf.generated.Namespaces)
block|}
static|static
block|{
name|defaultInstance
...
expr_stmt|;
block|}
comment|// @@protoc_insertion_point(class_scope:org.apache.hadoop.hbase.rest.protobuf.generated.Namespaces)
block|}
specifier|private
specifier|static
name|com
...
operator|+
literal|"doop.hbase.rest.protobuf.generated\"\037\n\nNa"
operator|+
literal|"mespaces\022\021\n\tnamespace\030\001 \003(\t"
block|}
decl_stmt|;
name|com
operator|.
