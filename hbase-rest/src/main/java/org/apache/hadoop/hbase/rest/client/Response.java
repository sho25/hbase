...
expr_stmt|;
block|}
comment|/**    * Constructor. Note: this is not thread-safe    *    * @param code the HTTP response code    * @param headers headers the HTTP response headers    * @param resp the response    * @param in Inputstream if the response had one.    */
specifier|public
name|Response
parameter_list|(
name|int
