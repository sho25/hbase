...
specifier|public
name|void
name|testGetClusterId
parameter_list|()
block|{
name|String
name|actualClusterId
init|=
name|TEST_UTIL
operator|.
...
name|thriftConnection
argument_list|,
literal|"testThriftAdminNamespace"
argument_list|,
literal|"testThriftAdminTable"
argument_list|)
expr_stmt|;
name|testThriftAdmin
argument_list|(
name|thriftHttpConnection
argument_list|,
literal|"testThriftHttpAdminNamespace"
argument_list|,
literal|"testThriftHttpAdminTable"
argument_list|)
expr_stmt|;
block|}
annotation|@
