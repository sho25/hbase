...
expr_stmt|;
block|}
comment|/**    * Verify that thrift2 client calling thrift server can get the thrift server type correctly.    */
annotation|@
name|Test
specifier|public
name|void
...
name|info
argument_list|(
literal|"Starting HBase Thrift server One"
argument_list|)
expr_stmt|;
name|THRIFT_TEST_UTIL
operator|.
...
argument_list|)
decl_stmt|;
comment|// This is our thrift2 client.
name|THBaseService
operator|.
name|Iface
name|client
