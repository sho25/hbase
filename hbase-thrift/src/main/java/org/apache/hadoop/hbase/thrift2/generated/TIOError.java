...
block|}
argument_list|)
comment|/**  * A TIOError exception signals that an error occurred communicating  * to the HBase master or a HBase region server. Also used to return  * more general HBase error conditions.  */
annotation|@
name|javax
operator|.
name|annotation
...
init|=
operator|new
name|TIOErrorStandardSchemeFactory
argument_list|()
decl_stmt|;
specifier|private
specifier|static
...
init|=
operator|new
name|TIOErrorTupleSchemeFactory
argument_list|()
decl_stmt|;
specifier|public
annotation|@
