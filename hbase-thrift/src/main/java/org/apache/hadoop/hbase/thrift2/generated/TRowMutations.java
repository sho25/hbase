...
block|}
argument_list|)
comment|/**  * A TRowMutations object is used to apply a number of Mutations to a single row.  */
annotation|@
name|Generated
argument_list|(
name|value
...
argument_list|,
operator|new
name|TRowMutationsStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|TRowMutationsTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
name|TProtocolException
argument_list|(
literal|"Required field 'mutations' was not present! Struct: "
operator|+
name|toString
argument_list|()
argument_list|)
...
block|{
specifier|public
name|TRowMutationsStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
