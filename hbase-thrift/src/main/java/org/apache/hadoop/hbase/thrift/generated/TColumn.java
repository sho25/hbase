...
block|}
argument_list|)
comment|/**  * Holds column name and the cell.  */
annotation|@
name|Generated
argument_list|(
name|value
...
expr_stmt|;
block|}
comment|/** Returns true if field cell is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetCell
parameter_list|()
