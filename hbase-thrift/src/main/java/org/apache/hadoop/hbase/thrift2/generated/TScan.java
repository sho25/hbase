...
block|}
argument_list|)
comment|/**  * Any timestamps in the columns are ignored but the colFamTimeRangeMap included, use timeRange to select by timestamp.  * Max versions defaults to 1.  */
annotation|@
name|Generated
argument_list|(
name|value
...
operator|.
name|TField
name|COL_FAM_TIME_RANGE_MAP_FIELD_DESC
init|=
operator|new
name|org
operator|.
...
literal|13
case|:
comment|// COL_FAM_TIME_RANGE_MAP
return|return
name|COL_FAM_TIME_RANGE_MAP
return|;
case|case
...
name|TTimeRange
argument_list|>
name|__this__colFamTimeRangeMap
init|=
operator|new
name|HashMap
argument_list|<
...
decl_stmt|;
name|ByteBuffer
name|__this__colFamTimeRangeMap_copy_key
init|=
name|org
operator|.
name|apache
...
decl_stmt|;
name|TTimeRange
name|__this__colFamTimeRangeMap_copy_value
init|=
operator|new
name|TTimeRange
argument_list|(
...
specifier|public
name|int
name|getColFamTimeRangeMapSize
parameter_list|()
block|{
return|return
operator|(
...
expr_stmt|;
block|}
comment|/** Returns true if field colFamTimeRangeMap is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetColFamTimeRangeMap
parameter_list|()
...
specifier|public
name|void
name|setColFamTimeRangeMapIsSet
parameter_list|(
name|boolean
name|value
parameter_list|)
...
expr_stmt|;
block|}
comment|/** Returns true if field readType is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetReadType
parameter_list|()
...
block|}
name|boolean
name|this_present_colFamTimeRangeMap
init|=
literal|true
operator|&&
name|this
...
decl_stmt|;
name|boolean
name|that_present_colFamTimeRangeMap
init|=
literal|true
operator|&&
name|that
...
expr_stmt|;
name|boolean
name|present_colFamTimeRangeMap
init|=
literal|true
operator|&&
operator|(
