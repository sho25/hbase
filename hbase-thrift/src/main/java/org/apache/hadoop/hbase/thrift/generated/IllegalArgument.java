...
block|}
argument_list|)
comment|/**  * An IllegalArgument exception indicates an illegal or invalid  * argument was passed into a procedure.  */
annotation|@
name|javax
operator|.
name|annotation
...
init|=
operator|new
name|IllegalArgumentStandardSchemeFactory
argument_list|()
decl_stmt|;
specifier|private
specifier|static
...
init|=
operator|new
name|IllegalArgumentTupleSchemeFactory
argument_list|()
decl_stmt|;
specifier|public
annotation|@
...
block|{
specifier|public
name|IllegalArgumentStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|IllegalArgumentTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
