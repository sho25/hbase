...
literal|false
decl_stmt|;
comment|// TODO: We can rip out the ThriftClient piece of it rather than creating a new client every time.
...
parameter_list|)
block|{
comment|// Don't sleep for retrying the first time
if|if
condition|(
name|executionCount
operator|>
...
parameter_list|)
block|{
comment|//reset interrupt marker
name|Thread
operator|.
name|currentThread
argument_list|()
