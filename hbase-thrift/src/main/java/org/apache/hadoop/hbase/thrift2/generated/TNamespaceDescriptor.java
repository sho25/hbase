...
block|}
argument_list|)
comment|/**  * Thrift wrapper around  * org.apache.hadoop.hbase.NamespaceDescriptor  */
annotation|@
name|Generated
argument_list|(
name|value
...
argument_list|,
operator|new
name|TNamespaceDescriptorStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|TNamespaceDescriptorTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
block|{
specifier|public
name|TNamespaceDescriptorStandardScheme
name|getScheme
parameter_list|()
block|{
return|return
...
block|{
specifier|public
name|TNamespaceDescriptorTupleScheme
name|getScheme
parameter_list|()
block|{
return|return
