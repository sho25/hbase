...
argument_list|,
operator|new
name|MutationStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|MutationTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Returns true if field isDelete is set (has been assigned a value) and false otherwise */
specifier|public
name|boolean
name|isSetIsDelete
parameter_list|()
