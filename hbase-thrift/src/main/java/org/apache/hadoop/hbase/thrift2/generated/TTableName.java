...
block|}
argument_list|)
comment|/**  * Thrift wrapper around  * org.apache.hadoop.hbase.TableName  */
annotation|@
name|Generated
argument_list|(
name|value
...
argument_list|,
operator|new
name|TTableNameStandardSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
name|schemes
...
argument_list|,
operator|new
name|TTableNameTupleSchemeFactory
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
name|TProtocolException
argument_list|(
literal|"Required field 'ns' was not present! Struct: "
operator|+
name|toString
argument_list|()
argument_list|)
