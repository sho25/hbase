...
operator|+
literal|"[--batch=] [--verbose] [--sourceSnapshotName=P] [--sourceSnapshotTmpDir=Q] [--peerSnapshotName=R] "
operator|+
literal|"[--peerSnapshotTmpDir=S] [--peerFSAddress=T] [--peerHBaseRootAddress=U]<peerid><tablename>"
argument_list|)
expr_stmt|;
name|System
operator|.
