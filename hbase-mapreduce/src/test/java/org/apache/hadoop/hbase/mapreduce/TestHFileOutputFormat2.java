...
argument_list|)
expr_stmt|;
comment|//check output file num and size.
for|for
control|(
name|byte
index|[]
...
name|assertTrue
argument_list|(
literal|"Data size of each file should not be too large."
argument_list|,
name|perKVSize
operator|*
name|reader
...
name|assertEquals
argument_list|(
literal|"Should write expected data in output file."
argument_list|,
name|ROWSPERSPLIT
argument_list|,
name|kvCount
...
name|getDataTestDir
argument_list|(
literal|"TestConfigureCompression"
argument_list|)
decl_stmt|;
name|String
name|hfileoutputformatCompression
init|=
literal|"gz"
decl_stmt|;
try|try
