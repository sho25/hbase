...
specifier|public
name|void
name|testWithMockedMapReduceWithSplitsPerRegion
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// test scan with startRow and stopRow
name|Scan
name|scan
init|=
operator|new
...
specifier|public
name|void
name|testWithMockedMapReduceWithNoStartRowStopRow
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// test scan without startRow and stopRow
name|Scan
name|scan2
init|=
operator|new
...
name|assertTrue
argument_list|(
literal|"startRow should< stopRow"
argument_list|,
name|Bytes
operator|.
name|compareTo
