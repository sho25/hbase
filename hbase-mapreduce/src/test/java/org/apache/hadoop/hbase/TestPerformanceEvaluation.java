...
specifier|public
name|void
name|testDefaultInMemoryCompaction
parameter_list|()
block|{
name|PerformanceEvaluation
operator|.
...
expr_stmt|;
block|}
comment|/**    * Exercise the mr spec writing. Simple assertions to make sure it is basically working.    */
annotation|@
name|Test
specifier|public
name|void
