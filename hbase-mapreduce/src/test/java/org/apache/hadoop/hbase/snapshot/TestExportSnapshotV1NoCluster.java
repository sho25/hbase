...
expr_stmt|;
block|}
comment|/**    * Setup for test. Returns path to test data dir. Sets configuration into the passed    * hctu.getConfiguration.    */
specifier|static
name|Path
name|setup
parameter_list|(
...
name|info
argument_list|(
literal|"Export destination={}, fs={}, fsurl={}, fswd={}, testDir={}"
argument_list|,
name|path
argument_list|,
name|fs
