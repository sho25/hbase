...
name|fail
argument_list|(
literal|"RowCounter should had failed with invalid table."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|contains
argument_list|(
literal|"usage: hbase rowcounter "
operator|+
literal|"<tablename> [options] [<column1><column2>...]"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"--expectedCount=<arg>   expected number of rows to be count.\n"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"For performance, "
operator|+
literal|"consider the following configuration properties:\n"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
