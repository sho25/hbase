...
argument_list|)
decl_stmt|;
comment|// Delete all *data* files in dest
if|if
condition|(
operator|!
name|deleteData
...
block|}
block|}
comment|/**    * Deletes only data files and keeps all META    * @param fs file system instance    * @param dest destination location    * @return true, if success, false - otherwise    * @throws FileNotFoundException exception    * @throws IOException exception    */
specifier|private
name|boolean
name|deleteData
parameter_list|(
