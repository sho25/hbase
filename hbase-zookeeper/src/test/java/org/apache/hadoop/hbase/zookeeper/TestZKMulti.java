...
specifier|public
name|void
name|testBatchedDeletesOfWideZNodes
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Batch every 50bytes
specifier|final
name|int
name|batchSize
init|=
...
name|setInt
argument_list|(
literal|"zookeeper.multi.max.size"
argument_list|,
name|batchSize
argument_list|)
expr_stmt|;
...
init|)
block|{
comment|// With a parent znode like this, we'll get batches of 2-3 elements
specifier|final
name|String
name|parent1
init|=
literal|"/batchedDeletes1"
decl_stmt|;
specifier|final
name|String
name|parent2
init|=
literal|"/batchedDeletes2"
decl_stmt|;
specifier|final
name|byte
index|[]
...
argument_list|)
expr_stmt|;
comment|// Write into a second node
name|ops
operator|.
name|clear
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// These should return successfully
name|ZKUtil
operator|.
...
argument_list|)
decl_stmt|;
comment|// Simple, single element case
name|assertEquals
argument_list|(
name|Collections
operator|.
...
argument_list|)
expr_stmt|;
comment|// Simple case where we exceed the limit, but must make the list
name|assertEquals
argument_list|(
name|Collections
operator|.
...
argument_list|)
expr_stmt|;
comment|// Each gets its own bucket
name|assertEquals
argument_list|(
name|Arrays
operator|.
...
argument_list|)
expr_stmt|;
comment|// Test internal boundary
name|assertEquals
argument_list|(
name|Arrays
operator|.
