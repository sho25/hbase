...
block|}
block|}
comment|/**    * Set the balancer on/off.    *    * @param balancerOn true if the balancher should be on, false otherwise    * @throws KeeperException if a ZooKeeper operation fails    */
specifier|public
name|void
name|setBalancerOn
parameter_list|(
