...
decl_stmt|;
return|return
name|filterMetaReplicaNodes
argument_list|(
name|childrenOfBaseNode
argument_list|)
return|;
block|}
comment|/**    * Same as {@link #getMetaReplicaNodes()} except that this also registers a watcher on base znode    * for subsequent CREATE/DELETE operations on child nodes.    */
specifier|public
name|List
argument_list|<
name|String
...
return|;
block|}
comment|/**    * @param nodes Input list of znodes    * @return Filtered list of znodes from nodes that belong to meta replica(s).    */
specifier|private
name|List
argument_list|<
name|String
