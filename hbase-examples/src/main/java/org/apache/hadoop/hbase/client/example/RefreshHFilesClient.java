...
name|message
init|=
literal|"When there are multiple HBase clusters are sharing a common root dir, "
operator|+
literal|"especially for read replica cluster (see detail in HBASE-18477), please consider to "
operator|+
literal|"use this tool manually sync the flushed HFiles from the source cluster."
decl_stmt|;
name|message
operator|+=
literal|"\nUsage: "
...
name|error
argument_list|(
literal|"Refresh HFiles from table "
operator|+
name|tableName
operator|.
