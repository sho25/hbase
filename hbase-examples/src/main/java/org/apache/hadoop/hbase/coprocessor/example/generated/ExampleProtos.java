...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.coprocessor.example.generated.ExampleProtos.CountRequest.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
name|MessageOrBuilder
block|{
comment|// required int64 count = 1 [default = 0];
comment|/**      *<code>required int64 count = 1 [default = 0];</code>      */
name|boolean
name|hasCount
parameter_list|()
function_decl|;
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.coprocessor.example.generated.ExampleProtos.CountResponse.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
