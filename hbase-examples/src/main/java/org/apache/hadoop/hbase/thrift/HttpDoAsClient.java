...
name|println
argument_list|(
literal|"Usage: HttpDoAsClient host port doAsUserName [security=true] [principal] [keytab]"
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|printf
argument_list|(
literal|"ERROR: KeyTab File %s not found %n"
argument_list|,
name|keyTab
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|// To authenticate the HttpDoAsClient using principal and keyTab
name|Set
argument_list|<
name|Principal
argument_list|>
...
block|{
comment|/*        * To authenticate the HttpDoAsClient, kinit should be invoked ahead. Here we try to        * get the Kerberos credential from the ticket cache.        */
name|context
operator|=
operator|new
name|LoginContext
...
parameter_list|()
block|{
comment|// Empty constructor will have no principal or keyTab values
block|}
specifier|public
name|KerberosConfiguration
parameter_list|(
