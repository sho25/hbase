...
condition|)
block|{
comment|//readRequestPerSecond and writeRequestPerSecond will be zero
comment|// because there is no change or new metrics during refresh
case|case
literal|"FOO"
case|:
name|assertRecordInUserMode
argument_list|(
name|record
argument_list|,
literal|0L
