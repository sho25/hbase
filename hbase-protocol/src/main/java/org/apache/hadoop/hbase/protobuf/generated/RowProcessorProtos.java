...
begin_comment
comment|// source: RowProcessor.proto
end_comment
...
comment|/**      *<code>required string row_processor_class_name = 1;</code>      */
name|boolean
...
operator|.
name|ByteString
name|getRowProcessorClassNameBytes
parameter_list|()
function_decl|;
comment|// optional string row_processor_initializer_message_name = 2;
comment|/**      *<code>optional string row_processor_initializer_message_name = 2;</code>      */
name|boolean
...
operator|.
name|ByteString
name|getRowProcessorInitializerMessageNameBytes
parameter_list|()
function_decl|;
comment|// optional bytes row_processor_initializer_message = 3;
comment|/**      *<code>optional bytes row_processor_initializer_message = 3;</code>      */
name|boolean
...
parameter_list|()
function_decl|;
comment|// optional uint64 nonce = 5;
comment|/**      *<code>optional uint64 nonce = 5;</code>      */
name|boolean
name|hasNonce
parameter_list|()
function_decl|;
...
literal|0x00000002
expr_stmt|;
name|rowProcessorInitializerMessageName_
operator|=
name|input
operator|.
name|readBytes
...
literal|0x00000004
expr_stmt|;
name|rowProcessorInitializerMessage_
operator|=
name|input
operator|.
name|readBytes
...
specifier|public
name|Builder
name|clearRowProcessorClassName
parameter_list|()
block|{
name|bitField0_
operator|=
...
specifier|public
name|Builder
name|setRowProcessorClassNameBytes
parameter_list|(
name|com
operator|.
name|google
...
specifier|public
name|Builder
name|clearRowProcessorInitializerMessageName
parameter_list|()
block|{
name|bitField0_
operator|=
...
specifier|public
name|Builder
name|setRowProcessorInitializerMessageNameBytes
parameter_list|(
name|com
operator|.
name|google
...
specifier|public
name|Builder
name|clearRowProcessorInitializerMessage
parameter_list|()
block|{
name|bitField0_
operator|=
...
comment|/**      *<code>required bytes row_processor_result = 1;</code>      */
name|boolean
...
index|[]
block|{
literal|"RowProcessorClassName"
block|,
literal|"RowProcessorInitializerMessageName"
block|,
literal|"RowProcessorInitializerMessage"
block|,
literal|"NonceGroup"
block|,
literal|"Nonce"
