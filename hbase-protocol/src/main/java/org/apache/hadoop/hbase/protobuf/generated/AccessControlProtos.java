...
comment|/**      *<code>optional bytes namespace_name = 1;</code>      */
name|boolean
...
parameter_list|()
function_decl|;
comment|// optional bool merge_existing_permissions = 2 [default = false];
comment|/**      *<code>optional bool merge_existing_permissions = 2 [default = false];</code>      */
name|boolean
name|hasMergeExistingPermissions
parameter_list|()
function_decl|;
comment|/**      *<code>optional bool merge_existing_permissions = 2 [default = false];</code>      */
name|boolean
...
literal|0x00000002
expr_stmt|;
name|mergeExistingPermissions_
operator|=
name|input
operator|.
name|readBool
...
specifier|final
name|int
name|MERGE_EXISTING_PERMISSIONS_FIELD_NUMBER
init|=
literal|2
decl_stmt|;
specifier|private
...
specifier|public
name|Builder
name|clearMergeExistingPermissions
parameter_list|()
block|{
name|bitField0_
operator|=
...
comment|/**      *<code>optional bytes namespace_name = 3;</code>      */
name|boolean
name|hasNamespaceName
parameter_list|()
function_decl|;
...
operator|+
literal|"\001 \002(\0132\030.hbase.pb.UserPermission\022)\n\032merge"
operator|+
literal|"_existing_permissions\030\002 \001(\010:\005false\"\017\n\rGr"
operator|+
literal|"antResponse\"B\n\rRevokeRequest\0221\n\017user_per"
operator|+
literal|"mission\030\001 \002(\0132\030.hbase.pb.UserPermission\""
operator|+
literal|"\020\n\016RevokeResponse\"\205\001\n\031GetUserPermissions"
operator|+
literal|"Request\022\'\n\004type\030\001 \001(\0162\031.hbase.pb.Permiss"
block|,
literal|"ion.Type\022\'\n\ntable_name\030\002 \001(\0132\023.hbase.pb."
operator|+
literal|"TableName\022\026\n\016namespace_name\030\003 \001(\014\"O\n\032Get"
operator|+
literal|"UserPermissionsResponse\0221\n\017user_permissi"
operator|+
literal|"on\030\001 \003(\0132\030.hbase.pb.UserPermission\"C\n\027Ch"
operator|+
literal|"eckPermissionsRequest\022(\n\npermission\030\001 \003("
operator|+
literal|"\0132\024.hbase.pb.Permission\"\032\n\030CheckPermissi"
operator|+
literal|"onsResponse2\311\002\n\024AccessControlService\0228\n\005"
operator|+
literal|"Grant\022\026.hbase.pb.GrantRequest\032\027.hbase.pb"
operator|+
literal|".GrantResponse\022;\n\006Revoke\022\027.hbase.pb.Revo"
operator|+
literal|"keRequest\032\030.hbase.pb.RevokeResponse\022_\n\022G"
block|,
literal|"etUserPermissions\022#.hbase.pb.GetUserPerm"
operator|+
literal|"issionsRequest\032$.hbase.pb.GetUserPermiss"
operator|+
literal|"ionsResponse\022Y\n\020CheckPermissions\022!.hbase"
operator|+
literal|".pb.CheckPermissionsRequest\032\".hbase.pb.C"
operator|+
...
block|,
literal|"MergeExistingPermissions"
block|, }
argument_list|)
expr_stmt|;
name|internal_static_hbase_pb_GrantResponse_descriptor
