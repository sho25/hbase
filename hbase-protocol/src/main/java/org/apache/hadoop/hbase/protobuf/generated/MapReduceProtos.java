...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.protobuf.generated.MapReduceProtos.ScanMetrics.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
name|MessageOrBuilder
block|{
comment|// optional .TableSchema table = 1;
comment|/**      *<code>optional .TableSchema table = 1;</code>      */
name|boolean
name|hasTable
parameter_list|()
function_decl|;
...
parameter_list|()
function_decl|;
comment|// optional .RegionInfo region = 2;
comment|/**      *<code>optional .RegionInfo region = 2;</code>      */
name|boolean
name|hasRegion
parameter_list|()
function_decl|;
...
parameter_list|()
function_decl|;
comment|// repeated string locations = 3;
comment|/**      *<code>repeated string locations = 3;</code>      */
name|java
operator|.
name|util
operator|.
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.protobuf.generated.MapReduceProtos.TableSnapshotRegionSplit.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
