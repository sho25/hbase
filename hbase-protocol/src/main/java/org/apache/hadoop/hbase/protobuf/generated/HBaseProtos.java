...
block|{
comment|// required bytes namespace = 1;
name|boolean
name|hasNamespace
parameter_list|()
function_decl|;
...
name|TableNameOrBuilder
block|{
comment|// Use TableName.newBuilder() to construct.
specifier|private
name|TableName
parameter_list|(
name|Builder
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.protobuf.generated.HBaseProtos.TableName.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
name|FavoredNodesOrBuilder
block|{
comment|// Use FavoredNodes.newBuilder() to construct.
specifier|private
name|FavoredNodes
parameter_list|(
name|Builder
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.protobuf.generated.HBaseProtos.FavoredNodes.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
condition|)
block|{
name|getFavoredNodeFieldBuilder
argument_list|()
expr_stmt|;
block|}
block|}
...
block|{
name|ensureFavoredNodeIsMutable
argument_list|()
expr_stmt|;
name|favoredNode_
operator|.
...
name|Builder
argument_list|>
name|getFavoredNodeBuilderList
parameter_list|()
block|{
return|return
name|getFavoredNodeFieldBuilder
...
name|MessageOrBuilder
block|{
comment|// required bytes first = 1;
name|boolean
name|hasFirst
parameter_list|()
function_decl|;
...
parameter_list|()
function_decl|;
comment|// required bytes second = 2;
name|boolean
name|hasSecond
parameter_list|()
function_decl|;
...
name|BytesBytesPairOrBuilder
block|{
comment|// Use BytesBytesPair.newBuilder() to construct.
specifier|private
name|BytesBytesPair
parameter_list|(
name|Builder
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.protobuf.generated.HBaseProtos.BytesBytesPair.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
parameter_list|()
function_decl|;
comment|// optional int64 value = 2;
name|boolean
name|hasValue
parameter_list|()
function_decl|;
...
name|NameInt64PairOrBuilder
block|{
comment|// Use NameInt64Pair.newBuilder() to construct.
specifier|private
name|NameInt64Pair
parameter_list|(
name|Builder
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.protobuf.generated.HBaseProtos.NameInt64Pair.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
parameter_list|()
function_decl|;
comment|// optional string table = 2;
name|boolean
name|hasTable
parameter_list|()
function_decl|;
...
parameter_list|()
function_decl|;
comment|// optional int32 version = 5;
name|boolean
name|hasVersion
parameter_list|()
function_decl|;
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.protobuf.generated.HBaseProtos.SnapshotDescription.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
name|EmptyMsgOrBuilder
block|{
comment|// Use EmptyMsg.newBuilder() to construct.
specifier|private
name|EmptyMsg
parameter_list|(
name|Builder
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.protobuf.generated.HBaseProtos.EmptyMsg.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
name|LongMsgOrBuilder
block|{
comment|// Use LongMsg.newBuilder() to construct.
specifier|private
name|LongMsg
parameter_list|(
name|Builder
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.protobuf.generated.HBaseProtos.LongMsg.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
name|BigDecimalMsgOrBuilder
block|{
comment|// Use BigDecimalMsg.newBuilder() to construct.
specifier|private
name|BigDecimalMsg
parameter_list|(
name|Builder
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.protobuf.generated.HBaseProtos.BigDecimalMsg.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
name|UUIDOrBuilder
block|{
comment|// Use UUID.newBuilder() to construct.
specifier|private
name|UUID
parameter_list|(
name|Builder
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.protobuf.generated.HBaseProtos.UUID.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
name|NamespaceDescriptorOrBuilder
block|{
comment|// Use NamespaceDescriptor.newBuilder() to construct.
specifier|private
name|NamespaceDescriptor
parameter_list|(
name|Builder
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.protobuf.generated.HBaseProtos.NamespaceDescriptor.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
operator|+
literal|"eStringPair*r\n\013CompareType\022\010\n\004LESS\020\000\022\021\n\r"
operator|+
literal|"LESS_OR_EQUAL\020\001\022\t\n\005EQUAL\020\002\022\r\n\tNOT_EQUAL\020"
operator|+
literal|"\003\022\024\n\020GREATER_OR_EQUAL\020\004\022\013\n\007GREATER\020\005\022\t\n\005"
operator|+
literal|"NO_OP\020\006B>\n*org.apache.hadoop.hbase.proto"
operator|+
literal|"buf.generatedB\013HBaseProtosH\001\240\001\001"
block|}
decl_stmt|;
name|com
operator|.
