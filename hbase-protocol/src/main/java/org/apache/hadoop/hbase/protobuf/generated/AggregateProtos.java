...
comment|/**      *<code>optional bytes interpreter_specific_bytes = 3;</code>      */
name|boolean
...
comment|/**      *<code>repeated bytes first_part = 1;</code>      *      *<pre>      **      * The AggregateService methods all have a response that either is a Pair      * or a simple object. When it is a Pair both first_part and second_part      * have defined values (and the second_part is not present in the response      * when the response is not a pair). Refer to the AggregateImplementation       * class for an overview of the AggregateResponse object constructions.       *</pre>      */
name|java
operator|.
name|util
operator|.
...
comment|/**      *<code>optional bytes second_part = 2;</code>      */
name|boolean
name|hasSecondPart
parameter_list|()
function_decl|;
