...
comment|/**      *<code>required string interpreterClassName = 1;</code>      *      *<pre>      ** The argument passed to the AggregateService consists of three parts      *  (1) the (canonical) classname of the ColumnInterpreter implementation      *  (2) the Scan query      *  (3) any bytes required to construct the ColumnInterpreter object      *      properly      *</pre>      */
name|boolean
...
comment|/**      *<code>optional bytes interpreterSpecificBytes = 3;</code>      */
name|boolean
...
comment|/**      *<code>repeated bytes firstPart = 1;</code>      *      *<pre>      **      * The AggregateService methods all have a response that either is a Pair      * or a simple object. When it is a Pair both firstPart and secondPart      * have defined values (and the secondPart is not present in the response       * when the response is not a pair). Refer to the AggregateImplementation       * class for an overview of the AggregateResponse object constructions.       *</pre>      */
name|java
operator|.
name|util
operator|.
...
comment|/**      *<code>optional bytes secondPart = 2;</code>      */
name|boolean
name|hasSecondPart
parameter_list|()
function_decl|;
