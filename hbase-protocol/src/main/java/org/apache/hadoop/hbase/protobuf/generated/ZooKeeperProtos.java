...
parameter_list|()
function_decl|;
comment|// repeated bytes families = 2;
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.protobuf.generated.ZooKeeperProtos.TableCF.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
parameter_list|)
function_decl|;
comment|// repeated .hbase.pb.TableCF table_cfs = 5;
...
name|MessageOrBuilder
block|{
comment|// optional bool enabled = 1;
...
function_decl|;
block|}
comment|/**    * Protobuf type {@code hbase.pb.SwitchState}    *    *<pre>    **    * State of the switch.    *</pre>    */
specifier|public
specifier|static
specifier|final
class|class
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.protobuf.generated.ZooKeeperProtos.SwitchState.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
specifier|public
interface|interface
name|SplitAndMergeStateOrBuilder
extends|extends
name|com
operator|.
name|google
...
name|MessageOrBuilder
block|{
comment|// optional bool split_enabled = 1;
comment|/**      *<code>optional bool split_enabled = 1;</code>      */
name|boolean
...
comment|/**      *<code>optional bool split_enabled = 1;</code>      */
name|boolean
name|getSplitEnabled
parameter_list|()
function_decl|;
comment|// optional bool merge_enabled = 2;
comment|/**      *<code>optional bool merge_enabled = 2;</code>      */
name|boolean
...
comment|/**      *<code>optional bool merge_enabled = 2;</code>      */
name|boolean
name|getMergeEnabled
parameter_list|()
function_decl|;
block|}
comment|/**    * Protobuf type {@code hbase.pb.SplitAndMergeState}    *    *<pre>    **    * State for split and merge, used in hbck    *</pre>    */
specifier|public
specifier|static
specifier|final
class|class
...
name|SplitAndMergeStateOrBuilder
block|{
comment|// Use SplitAndMergeState.newBuilder() to construct.
specifier|private
name|SplitAndMergeState
parameter_list|(
name|com
...
name|ZooKeeperProtos
operator|.
name|internal_static_hbase_pb_SplitAndMergeState_descriptor
return|;
block|}
specifier|protected
name|com
...
name|ZooKeeperProtos
operator|.
name|internal_static_hbase_pb_SplitAndMergeState_fieldAccessorTable
operator|.
name|ensureFieldAccessorsInitialized
argument_list|(
name|org
...
specifier|final
name|int
name|SPLIT_ENABLED_FIELD_NUMBER
init|=
literal|1
decl_stmt|;
specifier|private
...
specifier|final
name|int
name|MERGE_ENABLED_FIELD_NUMBER
init|=
literal|2
decl_stmt|;
specifier|private
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.protobuf.generated.ZooKeeperProtos.SplitAndMergeState.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
return|;
block|}
comment|// @@protoc_insertion_point(builder_scope:hbase.pb.SplitAndMergeState)
block|}
static|static
block|{
name|defaultInstance
...
expr_stmt|;
block|}
comment|// @@protoc_insertion_point(class_scope:hbase.pb.SplitAndMergeState)
block|}
specifier|private
specifier|static
name|com
...
operator|+
literal|"\030\005 \003(\0132\021.hbase.pb.TableCF\"g\n\020Replication"
operator|+
literal|"State\022/\n\005state\030\001 \002(\0162 .hbase.pb.Replicat"
operator|+
literal|"ionState.State\"\"\n\005State\022\013\n\007ENABLED\020\000\022\014\n\010"
operator|+
literal|"DISABLED\020\001\"+\n\027ReplicationHLogPosition\022\020\n"
operator|+
literal|"\010position\030\001 \002(\003\"%\n\017ReplicationLock\022\022\n\nlo"
block|,
literal|"ck_owner\030\001 \002(\t\"\252\001\n\tTableLock\022\'\n\ntable_na"
operator|+
...
index|[]
block|{
literal|"SplitEnabled"
block|,
literal|"MergeEnabled"
block|, }
argument_list|)
expr_stmt|;
return|return
