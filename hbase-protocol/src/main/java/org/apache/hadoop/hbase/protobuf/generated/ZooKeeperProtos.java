...
comment|/**      *<code>required uint32 event_type_code = 1;</code>      *      *<pre>      * Code for EventType gotten by doing o.a.h.h.EventHandler.EventType.getCode()      *</pre>      */
name|boolean
...
comment|/**      *<code>required bytes region_name = 2;</code>      *      *<pre>      * Full regionname in bytes      *</pre>      */
name|boolean
name|hasRegionName
parameter_list|()
function_decl|;
...
comment|/**      *<code>required uint64 create_time = 3;</code>      */
name|boolean
name|hasCreateTime
parameter_list|()
function_decl|;
...
comment|/**      *<code>required .ServerName server_name = 4;</code>      *      *<pre>      * The region server where the transition will happen or is happening      *</pre>      */
name|boolean
name|hasServerName
parameter_list|()
function_decl|;
...
comment|/**      *<code>optional bytes payload = 5;</code>      */
name|boolean
name|hasPayload
parameter_list|()
function_decl|;
...
function_decl|;
block|}
comment|/**    * Protobuf type {@code RegionTransition}    *    *<pre>    **    * What we write under unassigned up in zookeeper as a region moves through    * open/close, etc., regions.  Details a region in transition.    *</pre>    */
specifier|public
specifier|static
specifier|final
class|class
...
operator|+
literal|"ayload\030\005 \001(\014\"\214\002\n\014SplitLogTask\022\"\n\005state\030\001"
operator|+
literal|" \002(\0162\023.SplitLogTask.State\022 \n\013server_name"
block|,
literal|"\030\002 \002(\0132\013.ServerName\0221\n\004mode\030\003 \001(\0162\032.Spli"
operator|+
...
operator|+
literal|"eplicationEndpointImpl\030\002 \001(\t\022\035\n\004data\030\003 \003"
block|,
literal|"(\0132\017.BytesBytesPair\022&\n\rconfiguration\030\004 \003"
operator|+
