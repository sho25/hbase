...
comment|/**      *<code>required string version = 1;</code>      */
name|boolean
name|hasVersion
parameter_list|()
function_decl|;
...
parameter_list|()
function_decl|;
comment|// required string url = 2;
comment|/**      *<code>required string url = 2;</code>      */
name|boolean
name|hasUrl
parameter_list|()
function_decl|;
...
parameter_list|()
function_decl|;
comment|// required string revision = 3;
comment|/**      *<code>required string revision = 3;</code>      */
name|boolean
name|hasRevision
parameter_list|()
function_decl|;
...
operator|.
name|ByteString
name|getRevisionBytes
parameter_list|()
function_decl|;
comment|// required string user = 4;
comment|/**      *<code>required string user = 4;</code>      */
name|boolean
name|hasUser
parameter_list|()
function_decl|;
...
parameter_list|()
function_decl|;
comment|// required string date = 5;
comment|/**      *<code>required string date = 5;</code>      */
name|boolean
name|hasDate
parameter_list|()
function_decl|;
...
parameter_list|()
function_decl|;
comment|// required string src_checksum = 6;
comment|/**      *<code>required string src_checksum = 6;</code>      */
name|boolean
name|hasSrcChecksum
parameter_list|()
function_decl|;
...
name|VersionInfoOrBuilder
block|{
comment|// Use VersionInfo.newBuilder() to construct.
specifier|private
name|VersionInfo
parameter_list|(
name|com
...
specifier|final
name|int
name|SRC_CHECKSUM_FIELD_NUMBER
init|=
literal|6
decl_stmt|;
specifier|private
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.protobuf.generated.RPCProtos.VersionInfo.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
comment|/**      *<code>optional string exception_class_name = 1;</code>      *      *<pre>      * Class name of the exception thrown from the server      *</pre>      */
name|boolean
...
comment|/**      *<code>optional string stack_trace = 2;</code>      *      *<pre>      * Exception stack trace from the server side      *</pre>      */
name|boolean
name|hasStackTrace
parameter_list|()
function_decl|;
...
comment|/**      *<code>optional bool do_not_retry = 5;</code>      *      *<pre>      * Set if we are NOT to retry on receipt of this exception      *</pre>      */
name|boolean
name|hasDoNotRetry
parameter_list|()
function_decl|;
...
comment|/**      *<code>optional uint32 call_id = 1;</code>      *      *<pre>      * Monotonically increasing call_id to keep track of RPC requests and their response      *</pre>      */
name|boolean
name|hasCallId
parameter_list|()
function_decl|;
...
comment|/**      *<code>optional bool request_param = 4;</code>      *      *<pre>      * If true, then a pb Message param follows.      *</pre>      */
name|boolean
