...
comment|/**      *<code>required string effectiveUser = 1;</code>      */
name|boolean
...
comment|/**      *<code>optional string realUser = 2;</code>      */
name|boolean
name|hasRealUser
parameter_list|()
function_decl|;
...
comment|/**      *<code>optional .UserInformation userInfo = 1;</code>      */
name|boolean
name|hasUserInfo
parameter_list|()
function_decl|;
...
comment|/**      *<code>optional string protocol = 2 [default = "org.apache.hadoop.hbase.client.ClientProtocol"];</code>      */
name|boolean
name|hasProtocol
parameter_list|()
function_decl|;
...
comment|/**      *<code>optional string cellBlockCodecClass = 3 [default = "org.apache.hadoop.hbase.codec.KeyValueCodec"];</code>      *      *<pre>      * Cell block codec we will use sending over optional cell blocks.  Server throws exception      * if cannot deal.      *</pre>      */
name|boolean
...
comment|/**      *<code>optional string cellBlockCompressorClass = 4;</code>      *      *<pre>      * Compressor we will use if cell block is compressed.  Server will throw exception if not supported.      * Class must implement hadoop's CompressionCodec Interface      *</pre>      */
name|boolean
...
comment|/**      *<code>optional uint32 length = 1;</code>      *      *<pre>      * Length of the following cell block.  Could calculate it but convenient having it too hand.      *</pre>      */
name|boolean
name|hasLength
parameter_list|()
function_decl|;
...
comment|/**      *<code>optional string exceptionClassName = 1;</code>      *      *<pre>      * Class name of the exception thrown from the server      *</pre>      */
name|boolean
...
comment|/**      *<code>optional string stackTrace = 2;</code>      *      *<pre>      * Exception stack trace from the server side      *</pre>      */
name|boolean
name|hasStackTrace
parameter_list|()
function_decl|;
...
comment|/**      *<code>optional string hostname = 3;</code>      *      *<pre>      * Optional hostname.  Filled in for some exceptions such as region moved      * where exception gives clue on where the region may have moved.      *</pre>      */
name|boolean
name|hasHostname
parameter_list|()
function_decl|;
...
comment|/**      *<code>optional bool doNotRetry = 5;</code>      *      *<pre>      * Set if we are NOT to retry on receipt of this exception      *</pre>      */
name|boolean
name|hasDoNotRetry
parameter_list|()
function_decl|;
...
comment|/**      *<code>optional uint32 callId = 1;</code>      *      *<pre>      * Monotonically increasing callId to keep track of RPC requests and their response      *</pre>      */
name|boolean
name|hasCallId
parameter_list|()
function_decl|;
...
comment|/**      *<code>optional .RPCTInfo traceInfo = 2;</code>      */
name|boolean
name|hasTraceInfo
parameter_list|()
function_decl|;
...
comment|/**      *<code>optional string methodName = 3;</code>      */
name|boolean
name|hasMethodName
parameter_list|()
function_decl|;
...
comment|/**      *<code>optional bool requestParam = 4;</code>      *      *<pre>      * If true, then a pb Message param follows.      *</pre>      */
name|boolean
...
comment|/**      *<code>optional .CellBlockMeta cellBlockMeta = 5;</code>      *      *<pre>      * If present, then an encoded data block follows.      *</pre>      */
name|boolean
...
block|{
comment|// optional uint32 callId = 1;
comment|/**      *<code>optional uint32 callId = 1;</code>      */
name|boolean
name|hasCallId
parameter_list|()
function_decl|;
...
comment|/**      *<code>optional .CellBlockMeta cellBlockMeta = 3;</code>      *      *<pre>      * If present, then an encoded data block follows.      *</pre>      */
name|boolean
name|hasCellBlockMeta
parameter_list|()
function_decl|;
