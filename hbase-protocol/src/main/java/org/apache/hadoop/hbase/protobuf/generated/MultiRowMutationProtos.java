...
specifier|public
interface|interface
name|MultiRowMutationProcessorRequestOrBuilder
extends|extends
name|com
operator|.
name|google
...
name|MultiRowMutationProcessorRequestOrBuilder
block|{
comment|// Use MultiRowMutationProcessorRequest.newBuilder() to construct.
specifier|private
name|MultiRowMutationProcessorRequest
parameter_list|(
name|com
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.protobuf.generated.MultiRowMutationProtos.MultiRowMutationProcessorRequest.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
specifier|public
interface|interface
name|MultiRowMutationProcessorResponseOrBuilder
extends|extends
name|com
operator|.
name|google
...
name|MultiRowMutationProcessorResponseOrBuilder
block|{
comment|// Use MultiRowMutationProcessorResponse.newBuilder() to construct.
specifier|private
name|MultiRowMutationProcessorResponse
parameter_list|(
name|com
...
return|;
block|}
comment|// Construct using org.apache.hadoop.hbase.protobuf.generated.MultiRowMutationProtos.MultiRowMutationProcessorResponse.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
parameter_list|)
function_decl|;
comment|// optional uint64 nonce_group = 2;
comment|/**      *<code>optional uint64 nonce_group = 2;</code>      */
name|boolean
name|hasNonceGroup
parameter_list|()
function_decl|;
...
parameter_list|()
function_decl|;
comment|// optional uint64 nonce = 3;
comment|/**      *<code>optional uint64 nonce = 3;</code>      */
name|boolean
name|hasNonce
parameter_list|()
function_decl|;
...
parameter_list|()
function_decl|;
comment|// optional .hbase.pb.RegionSpecifier region = 4;
comment|/**      *<code>optional .hbase.pb.RegionSpecifier region = 4;</code>      */
name|boolean
name|hasRegion
parameter_list|()
function_decl|;
...
operator|+
literal|"nt.proto\032\013HBase.proto\"\"\n MultiRowMutatio"
operator|+
literal|"nProcessorRequest\"#\n!MultiRowMutationPro"
operator|+
literal|"cessorResponse\"\225\001\n\021MutateRowsRequest\0221\n\020"
operator|+
literal|"mutation_request\030\001 \003(\0132\027.hbase.pb.Mutati"
operator|+
literal|"onProto\022\023\n\013nonce_group\030\002 \001(\004\022\r\n\005nonce\030\003 "
operator|+
literal|"\001(\004\022)\n\006region\030\004 \001(\0132\031.hbase.pb.RegionSpe"
operator|+
literal|"cifier\"\024\n\022MutateRowsResponse2b\n\027MultiRow"
operator|+
literal|"MutationService\022G\n\nMutateRows\022\033.hbase.pb"
operator|+
literal|".MutateRowsRequest\032\034.hbase.pb.MutateRows"
block|,
literal|"ResponseBL\n*org.apache.hadoop.hbase.prot"
operator|+
literal|"obuf.generatedB\026MultiRowMutationProtosH\001"
operator|+
