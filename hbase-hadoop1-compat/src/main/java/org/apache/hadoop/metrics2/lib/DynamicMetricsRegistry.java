...
return|;
block|}
comment|/**    * Create a new MutableQuantile(A more accurate histogram).    * @param name The name of the histogram    * @param desc Description of the data.    * @return a new MutableQuantile    */
specifier|public
name|MetricMutableQuantiles
name|newQuantile
parameter_list|(
...
name|name
operator|+
literal|"and not of type MetricMutableHistogram"
argument_list|)
throw|;
block|}
return|return
...
name|name
operator|+
literal|"and not of type MetricMutableQuantiles"
argument_list|)
throw|;
block|}
return|return
