...
return|;
block|}
comment|/**    * Null-safe length check.    * @param input    * @return true if null or length==0    */
specifier|public
specifier|static
name|boolean
name|isEmpty
...
return|;
block|}
comment|/**    * @param c repeat this character    * @param reapeatFor the length of the output String    * @return c, repeated repeatFor times    */
specifier|public
specifier|static
name|String
name|repeat
