...
return|;
block|}
comment|/**    * Calculate a hash using bytes from HashKey and the provided seed value.    * @param<T>    * @param hashKey key to extract the hash    * @param initval the seed value    * @return hash value    */
specifier|public
specifier|abstract
parameter_list|<
name|T
