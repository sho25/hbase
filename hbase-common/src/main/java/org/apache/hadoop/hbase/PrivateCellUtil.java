...
return|;
block|}
comment|/**    * Finds if the start of the qualifier part of the Cell matches<code>buf</code>    * @param left the cell with which we need to match the qualifier    * @param startsWith the serialized keyvalue format byte[]    * @return true if the qualifier have same staring characters, false otherwise    */
specifier|public
specifier|static
name|boolean
...
argument_list|(
literal|"Cannot pass an empty startsWith"
argument_list|)
throw|;
block|}
if|if
