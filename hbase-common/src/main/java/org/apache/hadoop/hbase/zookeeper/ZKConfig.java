...
index|]
operator|+
literal|" starts with '[' but has no matching ']:'"
argument_list|)
throw|;
block|}
if|if
...
index|]
operator|+
literal|" doesn't have a port after colon"
argument_list|)
throw|;
block|}
comment|//check the IPv6 address e.g. [2001:db8::1]
name|String
name|serverHostWithoutBracket
init|=
name|serverHosts
index|[
name|i
...
index|]
operator|+
literal|" is not a valid IPv6 address"
argument_list|)
throw|;
block|}
name|serverHost
