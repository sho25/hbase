...
function_decl|;
block|}
comment|// The actual contents of the LRUDictionary are of ByteArrayBackedNode type
specifier|private
specifier|static
class|class
name|ByteArrayBackedNode
...
block|}
block|}
comment|// Currently only used for finding the index and hence this node acts
comment|// as a temporary holder to look up in the indexToNode map
comment|// which is formed by ByteArrayBackedNode
specifier|private
specifier|static
class|class
name|ByteBufferBackedNode
...
parameter_list|()
block|{
comment|// This ideally should not be called
name|byte
index|[]
name|copy
init|=
...
return|;
block|}
comment|// This was done to avoid findbugs comment
name|Node
name|casted
init|=
operator|(
...
name|other
decl_stmt|;
comment|// The other side should be a byte array backed node only as we add only
comment|// ByteArrayBackedNode to the indexToNode map.
return|return
name|ByteBufferUtils
operator|.
name|equals
