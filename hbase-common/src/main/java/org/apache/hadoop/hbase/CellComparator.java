...
comment|// For internal use, see CellComparatorImpl utility methods.
specifier|static
name|CellComparator
name|getInstance
parameter_list|()
...
parameter_list|)
function_decl|;
comment|/**    * @param row ByteBuffer that wraps a row; will read from current position and will reading all    *            remaining; will not disturb the ByteBuffer internal state.    * @return greater than 0 if leftCell is bigger, less than 0 if rightCell is bigger, 0 if both    *         cells are equal    */
specifier|default
name|int
name|compareRows
parameter_list|(
