...
specifier|final
name|String
name|HBASE_CLIENT_FAILURE_MAP_CLEANUP_INTERVAL_MS
init|=
...
specifier|final
name|long
name|HBASE_CLIENT_FAILURE_MAP_CLEANUP_INTERVAL_MS_DEFAULT
init|=
literal|600000
decl_stmt|;
comment|/**    * @deprecated since 2.3.0, and in 3.0.0 the actually implementation will be removed so config    *             this value will have no effect. The constants itself will be removed in 4.0.0.    */
...
init|=
literal|"hbase.regionserver.slowlog.buffer.enabled"
decl_stmt|;
specifier|public
specifier|static
specifier|final
