...
name|IOException
function_decl|;
comment|/**    * Reads bytes from FileChannel into this ByteBuff    */
specifier|public
specifier|abstract
name|int
name|read
...
name|IOException
function_decl|;
comment|/**    * Write this ByteBuff's data into target file    */
specifier|public
specifier|abstract
name|int
name|write
...
name|IOException
function_decl|;
comment|/**    * function interface for Channel read    */
annotation|@
...
return|;
block|}
comment|/**    * Make this private because we don't want to expose the refCnt related wrap method to upstream.    */
specifier|private
specifier|static
name|ByteBuff
name|wrap
