...
condition|)
block|{
comment|// When tagsLen is 0, make a NoTagsKeyValue version of Cell. This is an optimized class which
comment|// directly return tagsLen as 0. So we avoid parsing many length components in reading the
comment|// tagLength stored in the backing buffer. The Memstore addition of every Cell call
comment|// getTagsLength().
name|newKv
operator|=
operator|new
name|NoTagsKeyValue
