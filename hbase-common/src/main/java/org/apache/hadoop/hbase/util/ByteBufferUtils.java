...
block|}
block|}
comment|/**    * Copy one buffer's whole data to another. Write starts at the current position of 'out' buffer.    * Note : This will advance the position marker of {@code out} but not change the position maker    * for {@code in}. The position and limit of the {@code in} buffer to be set properly by caller.    * @param in source buffer    * @param out destination buffer    */
specifier|public
specifier|static
name|void
name|copyFromBufferToBuffer
...
block|}
block|}
comment|/**    * Copy from one buffer to another from given offset. This will be absolute positional copying and    * won't affect the position of any of the buffers.    * @param out    * @param in    * @param sourceOffset    * @param destinationOffset    * @param length    */
specifier|public
specifier|static
name|void
name|copyFromBufferToBuffer
...
return|;
block|}
comment|/*    * Both values are passed as is read by Unsafe. When platform is Little Endian, have to convert    * to corresponding Big Endian value and then do compare. We do all writes in Big Endian format.    */
specifier|private
specifier|static
name|boolean
name|lessThanUnsignedLong
...
block|}
block|}
comment|/**    * Copies specified number of bytes from given offset of 'in' ByteBuffer to the array.    * @param out    * @param in    * @param sourceOffset    * @param destinationOffset    * @param length    */
specifier|public
specifier|static
name|void
