...
name|IOException
block|{
comment|// We have write which takes ByteBuffer in ByteBufferOutputStream so that it
comment|// can directly write
comment|// bytes from the src ByteBuffer to the destination ByteBuffer. This avoid
comment|// need for temp array
