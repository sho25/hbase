...
return|;
block|}
comment|/**    * Return the number of bytes that large input files should be optimally    * be split into to minimize i/o time.    *    * @param fs filesystem object    * @return the default block size for the path's filesystem    */
specifier|public
specifier|static
name|long
...
return|;
block|}
comment|/*    * Get the default replication.    *    * @param fs filesystem object    * @param f path of file    * @return default replication for the path's filesystem    */
specifier|public
specifier|static
name|short
...
specifier|static
name|Method
name|bufferSizeMethod
decl_stmt|;
specifier|static
name|Method
name|blockSizeMethod
decl_stmt|;
specifier|static
name|Method
...
name|dfsName
operator|+
literal|"$HdfsDataOutputStreamBuilder"
decl_stmt|;
name|Class
argument_list|<
name|?
...
name|debug
argument_list|(
literal|"{} not available, will not use builder API for file creation."
argument_list|,
name|dfsName
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"Using builder API via reflection for DFS file creation."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|debug
argument_list|(
literal|"Could not find method on builder; will use old DFS API for file creation {}"
argument_list|,
name|e
operator|.
name|getMessage
...
block|}
block|}
comment|/**      * Attempt to use builder API via reflection to create a file with the given parameters and      * replication enabled.      */
specifier|static
name|FSDataOutputStream
name|createHelper
parameter_list|(
...
parameter_list|)
block|{
comment|// Should have caught this failure during initialization, so log full trace here
name|LOG
operator|.
name|warn
argument_list|(
literal|"Couldn't use reflection with builder API"
argument_list|,
name|e
argument_list|)
expr_stmt|;
