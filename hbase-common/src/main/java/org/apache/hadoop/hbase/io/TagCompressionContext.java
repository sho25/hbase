...
begin_comment
comment|/**  * Context that holds the dictionary for Tag compression and doing the compress/uncompress. This  * will be used for compressing tags while writing into WALs.  */
end_comment
...
expr_stmt|;
block|}
comment|/**    * Compress tags one by one and writes the OutputStream.     * @param out Stream to which the compressed tags to be written    * @param in Source where tags are available    * @param offset Offset for the tags bytes    * @param length Length of all tag bytes    * @throws IOException    */
specifier|public
name|void
name|compressTags
parameter_list|(
