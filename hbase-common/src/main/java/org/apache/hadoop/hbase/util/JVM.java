...
name|warn
argument_list|(
literal|"Not able to load class or method for"
operator|+
literal|" com.sun.management.UnixOperatingSystemMXBean."
argument_list|,
name|e
...
name|warn
argument_list|(
literal|"Not able to close the BufferedReader"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Not able to close the InputStreamReader"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/**    * @see java.lang.management.OperatingSystemMXBean#getSystemLoadAverage    */
specifier|public
name|double
...
return|;
block|}
comment|/**    * @return the physical free memory (not the JVM one, as it's not very useful as it depends on    * the GC), but the one from the OS as it allows a little bit more to guess if the machine is    * overloaded or not).    */
specifier|public
name|long
name|getFreeMemory
parameter_list|()
...
literal|1
return|;
comment|//  -1 because there is a headline
block|}
catch|catch
parameter_list|(
name|IOException
