...
block|}
block|}
comment|/**        * Returns true if x1 is less than x2, when both values are treated as        * unsigned long.        * Both values are passed as is read by Unsafe. When platform is Little Endian, have to        * convert to corresponding Big Endian value and then do compare. We do all writes in        * Big Endian format.        */
specifier|static
name|boolean
name|lessThanUnsignedLong
parameter_list|(
name|long
name|x1
parameter_list|,
...
return|;
block|}
comment|/**        * Returns true if x1 is less than x2, when both values are treated as        * unsigned int.        * Both values are passed as is read by Unsafe. When platform is Little Endian, have to        * convert to corresponding Big Endian value and then do compare. We do all writes in        * Big Endian format.        */
specifier|static
name|boolean
name|lessThanUnsignedInt
parameter_list|(
name|int
name|x1
parameter_list|,
...
return|;
block|}
comment|/**        * Returns true if x1 is less than x2, when both values are treated as        * unsigned short.        * Both values are passed as is read by Unsafe. When platform is Little Endian, have to        * convert to corresponding Big Endian value and then do compare. We do all writes in        * Big Endian format.        */
specifier|static
name|boolean
name|lessThanUnsignedShort
parameter_list|(
name|short
name|x1
parameter_list|,
