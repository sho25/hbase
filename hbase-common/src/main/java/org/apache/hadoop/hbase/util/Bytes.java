...
argument_list|)
decl_stmt|;
comment|/**        * Returns true if x1 is less than x2, when both values are treated as        * unsigned long.        */
specifier|static
name|boolean
...
return|;
block|}
comment|/**        * Returns true if x1 is less than x2, when both values are treated as        * unsigned int.        */
specifier|static
name|boolean
...
return|;
block|}
comment|/**        * Returns true if x1 is less than x2, when both values are treated as        * unsigned short.        */
specifier|static
name|boolean
