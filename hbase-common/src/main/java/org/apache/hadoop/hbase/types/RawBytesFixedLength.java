...
argument_list|>
block|{
comment|/**    * Create a {@code RawBytesFixedLength} using the specified {@code order}    * and {@code length}.    */
specifier|public
name|RawBytesFixedLength
parameter_list|(
name|Order
...
expr_stmt|;
block|}
comment|/**    * Create a {@code RawBytesFixedLength} of the specified {@code length}.    */
specifier|public
name|RawBytesFixedLength
parameter_list|(
name|int
...
return|;
block|}
comment|/**    * Write {@code val} into {@code buff}, respecting {@code offset} and    * {@code length}.    */
specifier|public
name|int
name|encode
parameter_list|(
