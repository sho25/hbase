...
parameter_list|()
block|{}
comment|/**    * @return true when the running JVM is having sun's Unsafe package available in it.    */
specifier|public
specifier|static
name|boolean
name|isAvailable
...
comment|/**    * Copies the bytes from given array's offset to length part into the given buffer. Puts the bytes    * to buffer's current position.    * @param src    * @param srcOffset    * @param dest    * @param destOffset    * @param length    */
specifier|public
specifier|static
name|void
name|copy
...
expr_stmt|;
block|}
comment|/**    * Copies specified number of bytes from given offset of 'in' ByteBuffer to the array.    * @param src    * @param srcOffset    * @param dest    * @param destOffset    * @param length    */
specifier|public
specifier|static
name|void
name|copy
