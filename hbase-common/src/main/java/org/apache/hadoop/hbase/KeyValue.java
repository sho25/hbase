...
block|}
block|}
comment|/**    * @return an iterator over the tags in this KeyValue.    */
specifier|public
name|Iterator
argument_list|<
name|Tag
...
parameter_list|()
block|{
comment|// Subtract -1 to point to the end of the complete tag byte[]
specifier|final
name|int
name|endOffset
init|=
...
return|;
block|}
comment|/**    * This method may not be right.  But we cannot use the CellUtil.getTagIterator because we don't know    * getKeyOffset and getKeyLength    * Cannnot use the getKeyOffset and getKeyLength in CellUtil as they are not part of the Cell interface.    * Returns any tags embedded in the KeyValue.    * @return The tags    */
specifier|public
name|List
argument_list|<
name|Tag
