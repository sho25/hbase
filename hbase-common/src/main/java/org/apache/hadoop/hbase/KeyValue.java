...
return|;
block|}
comment|/**    * @param in Where to read bytes from    * @return KeyValue created by deserializing from<code>in</code>    * @throws IOException    */
specifier|public
specifier|static
name|KeyValue
name|create
...
return|;
block|}
comment|/**    * Create a KeyValue reading<code>length</code> from<code>in</code>    * @param length    * @param in    * @return Created KeyValue    * @throws IOException    */
specifier|public
specifier|static
name|KeyValue
name|create
...
name|IOException
block|{
comment|// This is how the old Writables write used to serialize KVs.  Need to figure way to make it work for all
