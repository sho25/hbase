...
block|}
block|}
comment|/**    * Clone the passed cell by copying its data into the passed buf.    */
specifier|public
specifier|static
name|Cell
name|copyCellTo
...
condition|)
block|{
comment|// When tagsLen is 0, make a NoTagsKeyValue version of Cell. This is an optimized class
