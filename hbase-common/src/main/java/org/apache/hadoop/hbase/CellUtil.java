...
return|;
block|}
comment|/**    * @return True if matching column family and the qualifier starts with<code>qual</code>    */
specifier|public
specifier|static
name|boolean
...
expr_stmt|;
block|}
comment|/**    * @return The Key portion of the passed<code>cell</code> as a String.    */
specifier|public
specifier|static
name|String
...
return|;
block|}
comment|/**    * @param cell the cell to convert    * @param rowConverter used to convert the row of the cell to a string    * @return The Key portion of the passed<code>cell</code> as a String.    */
specifier|public
specifier|static
name|String
name|getCellKeyAsString
