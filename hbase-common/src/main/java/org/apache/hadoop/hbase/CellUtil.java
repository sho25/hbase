...
return|return
operator|new
name|ShareableMemoryTagRewriteCell
argument_list|(
name|cell
argument_list|,
name|tags
...
block|}
block|}
comment|/**    * Version of TagRewriteCell where the original Cell is ShareableMemory type.    */
specifier|private
specifier|static
class|class
name|ShareableMemoryTagRewriteCell
...
expr_stmt|;
block|}
comment|/**    * Writes the row from the given cell to the output stream    * @param out The dataoutputstream to which the data has to be written    * @param cell The cell whose contents has to be written    * @param rlength the row length    * @throws IOException    */
specifier|public
specifier|static
name|void
name|writeRow
...
block|}
block|}
comment|/**    * Writes the family from the given cell to the output stream    * @param out The dataoutputstream to which the data has to be written    * @param cell The cell whose contents has to be written    * @param flength the family length    * @throws IOException    */
specifier|public
specifier|static
name|void
name|writeFamily
...
block|}
block|}
comment|/**    * Writes the qualifier from the given cell to the output stream    * @param out The dataoutputstream to which the data has to be written    * @param cell The cell whose contents has to be written    * @param qlength the qualifier length    * @throws IOException    */
specifier|public
specifier|static
name|void
name|writeQualifier
...
block|}
block|}
comment|/**    * Writes the value from the given cell to the output stream    * @param out The dataoutputstream to which the data has to be written    * @param cell The cell whose contents has to be written    * @param vlength the value length    * @throws IOException    */
specifier|public
specifier|static
name|void
name|writeValue
...
block|}
block|}
comment|/**    * Writes the tag from the given cell to the output stream    * @param out The dataoutputstream to which the data has to be written    * @param cell The cell whose contents has to be written    * @param tagsLength the tag length    * @throws IOException    */
specifier|public
specifier|static
name|void
name|writeTags
...
return|return
operator|new
name|FirstOnRowByteBufferedCell
argument_list|(
operator|(
operator|(
name|ByteBufferedCell
...
return|return
operator|new
name|FirstOnRowColByteBufferedCell
argument_list|(
operator|(
operator|(
name|ByteBufferedCell
...
return|return
operator|new
name|FirstOnRowColTSByteBufferedCell
argument_list|(
operator|(
operator|(
name|ByteBufferedCell
...
return|return
operator|new
name|LastOnRowByteBufferedCell
argument_list|(
operator|(
operator|(
name|ByteBufferedCell
...
return|return
operator|new
name|LastOnRowColByteBufferedCell
argument_list|(
operator|(
operator|(
name|ByteBufferedCell
