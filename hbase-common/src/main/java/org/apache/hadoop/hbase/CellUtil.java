...
return|;
block|}
comment|/**    * Create a Cell with specific row.  Other fields are arbitrary choices.    * @param row    * @return Cell with passed row but all other fields are arbitrary    */
specifier|public
specifier|static
name|Cell
name|createCell
...
return|;
block|}
comment|/**    * Create a Cell with specific row and value.  Other fields are arbitrary choices.    * @param row    * @param value    * @return Cell with passed row and value but all other fields are arbitrary    */
specifier|public
specifier|static
name|Cell
name|createCell
...
return|;
block|}
comment|/**    * Estimation of total number of bytes used by the cell to store its key, value and tags. When the    * cell is a {@link KeyValue} we include the extra infrastructure size used by it.    * @param cell    * @return estimated length    */
specifier|public
specifier|static
name|int
...
expr_stmt|;
block|}
comment|/**    * @param cell    * @return Key portion of the Cell including rk, cf, qualifier, ts and type.    */
specifier|public
specifier|static
name|CellKey
name|getCellKey
