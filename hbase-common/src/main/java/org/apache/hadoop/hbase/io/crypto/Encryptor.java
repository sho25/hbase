...
begin_comment
comment|/**  * Encryptors apply a cipher to an OutputStream to produce ciphertext.  */
end_comment
...
parameter_list|()
function_decl|;
comment|/**    * Get the initialization vector    */
specifier|public
name|byte
index|[]
name|getIv
...
parameter_list|)
function_decl|;
comment|/**    * Create a stream for encryption    * @param out    */
specifier|public
name|OutputStream
