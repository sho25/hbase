...
function_decl|;
comment|//5) Type
comment|/**    * see {@link #KeyValue.TYPE}    * @return The byte representation of the KeyValue.TYPE of this cell: one of Put, Delete, etc    */
name|byte
name|getTypeByte
parameter_list|()
function_decl|;
