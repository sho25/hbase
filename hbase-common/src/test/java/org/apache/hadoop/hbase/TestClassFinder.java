...
literal|null
decl_stmt|;
comment|// Default name/class filters for testing.
specifier|private
specifier|static
specifier|final
name|ClassFinder
...
name|Exception
block|{
comment|// Well, technically, we are not guaranteed that the classes will
comment|// be in dirs, but during normal build they would be.
name|ClassFinder
name|allClassesFinder
init|=
operator|new
...
return|;
block|}
comment|/**    * Makes a jar out of some class files. Unfortunately it's very tedious.    * @param filesInJar Files created via compileTestClass.    */
specifier|private
specifier|static
name|void
name|packageAndLoadJar
