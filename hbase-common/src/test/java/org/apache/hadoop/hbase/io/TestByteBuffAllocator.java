...
argument_list|()
expr_stmt|;
comment|// ByteBuff Recycler#free should put back the BB to pool.
name|assertEquals
argument_list|(
name|maxBuffersInPool
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Allocate something from HEAP
name|HEAP
operator|.
name|allocate
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Check duplicated heap allocator, say even if we passed (HEAP, HEAP, alloc1), it will only
comment|// caculate the allocation from (HEAP, alloc1).
name|HEAP
operator|.
name|allocate
argument_list|(
