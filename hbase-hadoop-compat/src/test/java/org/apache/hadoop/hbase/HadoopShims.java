...
begin_comment
comment|/**  * A compatibility shim layer for interacting with different versions of Hadoop.  */
end_comment

begin_comment
comment|//NOTE: we can move this under src/main if main code wants to use this shim layer
end_comment
